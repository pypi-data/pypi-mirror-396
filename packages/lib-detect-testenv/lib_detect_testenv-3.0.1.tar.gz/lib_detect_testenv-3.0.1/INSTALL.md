...
This guide collects every supported method to install `lib_detect_testenv`, including
...
uv pip install "git+https://github.com/bitranox/lib_detect_testenv"
# upgrade
uv tool upgrade --all
```
...
```bash
# run from PyPI
uvx lib_detect_testenv
# run from GitHub
uvx --from git+https://github.com/bitranox/lib_detect_testenv.git lib_detect_testenv
...
# install from PyPI
pip install lib_detect_testenv 
# optional install from GitHub
pip install "git+https://github.com/bitranox/lib_detect_testenv"
...
```bash
# install from PyPI
pip install --user lib_detect_testenv 
# optional install from GitHub
pip install --user "git+https://github.com/bitranox/lib_detect_testenv"
...
pipx install lib_detect_testenv
# optional install via pipx from GitHub
pipx install "git+https://github.com/bitranox/lib_detect_testenv"
# optional install from local
pipx install .
pipx upgrade lib_detect_testenv
# From Git tag/commit:
```
...
```bash
python -m build
pip install dist/lib_detect_testenv-*.whl
pip install dist/lib_detect_testenv-*.tar.gz   # sdist
```
...
```bash
# Poetry
poetry add lib_detect_testenv     # as dependency
poetry install                          # for local dev

# PDM
pdm add lib_detect_testenv
pdm install
```
...
```bash
pip install "git+https://github.com/bitranox/lib_detect_testenv#egg=lib_detect_testenv"
```
...
All methods register both the `lib_detect_testenv` and
