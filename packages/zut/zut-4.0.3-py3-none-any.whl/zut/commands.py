...
class CommandParser(ArgumentParser):
    ...
    """
    def __init__(self, settings_or_prog: Settings|str|None = None, *, prog: str|None, version: str|None = None, doc: str|None = None, configure: bool|Literal['check','warn'] = 'check', log_colors = True, log_count_on_exit = True, formatter_class = RawDescriptionHelpFormatter, **kwargs):
