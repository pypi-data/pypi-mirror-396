...
result = nanogcg_redteam.run(model, tokenizer, message, target)
```

For more detailed information, see the GitHub repository: https://github.com/GraySwanAI/nanoGCG/tree/main
"""

from .gcg import GCGConfig, GCGResult, ProbeSamplingConfig, run
from .target import APITarget, Target
