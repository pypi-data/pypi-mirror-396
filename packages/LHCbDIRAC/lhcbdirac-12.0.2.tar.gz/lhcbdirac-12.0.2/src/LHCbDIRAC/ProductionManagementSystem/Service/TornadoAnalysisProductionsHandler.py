...
class TornadoAnalysisProductionsHandler(TornadoService):
    ...
    def export_getProductions(
        ...
        return _queryToResults(results, with_lfns, with_pfns, with_transformations, bkdb=self._bkDB)
    ...
    def export_registerRequests(self, requests):
        ...
        return _queryToResults(results, with_lfns=False, with_pfns=False, with_transformations=False, bkdb=self._bkDB)
...
def _queryToResults(results, with_lfns, with_pfns, with_transformations, *, bkdb):
