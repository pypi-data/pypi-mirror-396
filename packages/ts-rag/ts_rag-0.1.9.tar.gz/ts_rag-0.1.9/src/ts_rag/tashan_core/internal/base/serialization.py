...
from tashan_core.internal.registry import _resolve_public_type
from tashan_core.internal.typings.strings_to_types import _deserialize_type_hint
from tashan_core.internal.typings.types_normalization import _normalize_type_annotation
from tashan_core.internal.typings.types_to_strings import _serialize_type_hint


if TYPE_CHECKING:
    from tashan_core.internal.data_models import _LLMCost
...
class _InstanceSerializer(BaseModel):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        from tashan_core.internal.data_models import _LLMCost, _LLMUsage
    ...
    def from_dict(cls, obj_dict: dict[str, Any]) -> Self:
        ...
        from tashan_core.internal.base.llms import _DocumentLLM
        from tashan_core.internal.data_models import _LLMUsage
