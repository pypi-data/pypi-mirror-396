...
from tashan_core.internal.suppressions import _install_litellm_noise_filters
...
# Change DEFAULT_LOGGER_LEVEL to WARNING to suppress INFO logs by default
...
# Create a namespaced logger for ContextGem (now TashanSearch)
...
def _get_colored_formatter() -> logging.Formatter:
    ...
    return colorlog.ColoredFormatter(
        "[TashanSearch] %(log_color)s%(asctime)s.%(msecs)03d%(reset)s | "
