...
from tashan_core.internal.base.concepts import (
    ...
    _ListConcept,
    _NumericalConcept,
    _PaperSelectionConcept,
    _RatingConcept,
    _StringConcept,
)
from tashan_core.internal.decorators import _expose_in_registry
...
@_expose_in_registry(additional_key=_ListConcept)
class ListConcept(_ListConcept):
    """
    A concept model for extracting lists of strings from documents.

    This class handles identification and extraction of list-based information,
    where the output is expected to be a list of strings.

    :ivar name: The name of the concept (non-empty string, stripped).
    :vartype name: str
    :ivar description: A brief description of the concept (non-empty string, stripped).
    :vartype description: str
    :ivar examples: Example strings illustrating items in the list.
    :vartype examples: list[StringExample]
    :ivar llm_role: The role of the LLM responsible for extracting the concept.
    :vartype llm_role: LLMRoleAny
    :ivar add_justifications: Whether to include justifications for extracted items.
    :vartype add_justifications: bool
    :ivar justification_depth: Justification detail level.
    :vartype justification_depth: JustificationDepth
    :ivar justification_max_sents: Maximum sentences in justification.
    :vartype justification_max_sents: int
    :ivar add_references: Whether to include source references for extracted items.
    :vartype add_references: bool
    :ivar reference_depth: Source reference granularity.
    :vartype reference_depth: ReferenceDepth
    :ivar singular_occurrence: Whether this concept is restricted to having only one extracted item.
    :vartype singular_occurrence: StrictBool
    """
...
@_expose_in_registry(additional_key=_PaperSelectionConcept)
class PaperSelectionConcept(_PaperSelectionConcept):
    """
    A concept model for selecting relevant papers from a list of abstracts.

    This class extracts a list of PaperItems (dict with paper_id, title, reason).
    """
