...
from tashan_core.internal.llm_output_structs.aspect_structs import (
...
from tashan_core.internal.suppressions import _suppress_litellm_warnings
...
def _get_template(
    ...
    if template_type == "prompt":
        template_package = resources.files("tashan_core.internal.prompts")
        template_file = f"{template_name}.{template_extension}"
    elif template_type == "system":
        template_package = resources.files("tashan_core.internal.system")
        template_file = f"{template_name}.{template_extension}"
    else:
