...
class V4WorkflowsWorkflowIdMetadataPutRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["urls", "limit", "updateInterval", "schedules", "name", "description", "tags", "location", "monitoring", "entity", "schema", "additionalData", "maxPages", "maxDepth", "pathsFilterIn", "pathsFilterOut"]
