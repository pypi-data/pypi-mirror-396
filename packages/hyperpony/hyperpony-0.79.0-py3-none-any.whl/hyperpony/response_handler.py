...
def link_response_handlers_for_requests(source: HttpRequest, target: HttpRequest):
    h = get_response_handlers_from_request(source)
    setattr(target, "__hyperpony_view_response_handlers", h)
