...
# With automatic report upload to gofile.io
jsmon -i targets.txt --gofile-api-key YOUR_GOFILE_API_KEY
```
...
| `--gofile-api-key` | Gofile.io API key for report upload | - |
