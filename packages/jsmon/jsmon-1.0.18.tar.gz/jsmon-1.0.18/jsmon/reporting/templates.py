...
<head>
    ...
    <style>
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        .body-preview.expanded .body-preview-fade {{
            display: none;
        }}
        ...
        .api-keys-header.expanded .api-keys-arrow {{
        ...
        .api-keys-header.expanded .api-keys-hint {{
            display: none;
        }}
        ...
        .api-key-toggle:hover, .api-key-copy:hover {{
            background: var(--accent-primary);
            color: white;
            border-color: var(--accent-primary);
        }}
...
<body x-data="appData()" :class="darkMode ? 'dark' : ''" x-cloak>
    ...
    <script>
        ...
        function toggleApiKey(btn) {{
            ...
            const valueEl = container.querySelector('.api-key-value');
        ...
        function toggleApiKeysSection(header) {{
...
<div class="result-card slide-down" data-status="{status}" data-method="{fetch_method}">
    ...
    <div class="card-content">
        ...
        <div class="card-url">
            ...
            <a href="{full_url}" target="_blank" rel="noopener noreferrer" class="copy-btn" style="text-decoration: none;">🔗 Open</a>
