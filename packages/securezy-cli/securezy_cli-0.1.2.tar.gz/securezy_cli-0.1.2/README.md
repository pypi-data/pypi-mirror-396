...
Securezy CLI is a lightweight, pip-installable Python toolkit for common security tasks: fast TCP port scanning, encrypted vault storage, file encryption, hashing, scan reports, and plugins.
