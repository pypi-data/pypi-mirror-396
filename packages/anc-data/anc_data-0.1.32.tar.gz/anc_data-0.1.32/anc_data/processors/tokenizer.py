...
class HFPretrainedTokenizer:
    def __init__(self, opt):
        ...
        logging.info(
            ...
            f"{list(zip(self.hf_tokenizer.all_special_tokens, self.hf_tokenizer.all_special_ids))}"
        )
    ...
    def null_token(self):
        ...
        if self.hf_tokenizer.unk_token is not None:
    ...
    def null_token_id(self):
        ...
        if self.hf_tokenizer.unk_token_id is not None:
