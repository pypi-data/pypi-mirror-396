...
class ResearchPlan(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "projectId", "items", "updatedAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [ResearchPlanItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
