...
class ResearchProject(BaseModel):
    ...
    last_message_at: Optional[StrictInt] = Field(default=None, alias="lastMessageAt")
    __properties: ClassVar[List[str]] = ["id", "userId", "title", "goal", "status", "createdAt", "updatedAt", "lastMessageAt"]
