...
class Preferences(BaseModel):
    ...
    api_keys: Optional[Dict[str, Dict[str, Any]]] = Field(default=None, alias="apiKeys")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["theme", "title", "organization", "location", "bio", "apiKeys"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "theme": obj.get("theme") if obj.get("theme") is not None else 'system',
            "title": obj.get("title"),
