...
def _build_request_args(
    start_path: str | None | None = None,
    test_case_set_ids: str | None | None = None,
    ...
    simulator_name: str | None | None = None,
    test_case_public_id: str | None | None = None,
    scoring_config_type: str | None | None = None,
    is_assigned: bool | None | None = None,
    is_sample: bool | None | None = None,
    rejected: bool | None | None = None,
    exclude_assigned_to_annotators: bool | None | None = None,
