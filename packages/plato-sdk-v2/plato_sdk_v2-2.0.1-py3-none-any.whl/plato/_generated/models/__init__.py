...
#   filename:  tmptzotuvku.json
#   timestamp: 2025-12-13T02:38:21+00:00
...
class BaseStructuredRunLog(BaseModel):
    ...
    timestamp: Annotated[str | None, Field(title="Timestamp")] = "2025-12-12T21:30:42.608385"
...
class CreateSessionRequest(BaseModel):
    envs: Annotated[
        list[EnvFromSimulator | EnvFromArtifact | EnvFromResource] | None,
        Field(discriminator="type", title="Envs"),
    ] = None
    """
    ...
    task_id: Annotated[int | None, Field(title="Task Id")] = None
    """
    Test case ID to create session from
    """
    timeout: Annotated[int | None, Field(title="Timeout")] = 1800
    """
