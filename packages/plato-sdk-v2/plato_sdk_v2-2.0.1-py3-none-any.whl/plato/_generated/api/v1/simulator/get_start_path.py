...
from plato._generated.models.start_path_request import StartPathRequest
from plato._generated.models.start_path_response import StartPathResponse
...
def sync(
    ...
    return StartPathResponse.from_dict(response.json())
