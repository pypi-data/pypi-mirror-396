...
from plato._generated.models.execute_sshrequest import ExecuteSSHRequest
from plato._generated.models.execute_sshresponse import ExecuteSSHResponse
...
def sync(
    ...
    return ExecuteSSHResponse.from_dict(response.json())
