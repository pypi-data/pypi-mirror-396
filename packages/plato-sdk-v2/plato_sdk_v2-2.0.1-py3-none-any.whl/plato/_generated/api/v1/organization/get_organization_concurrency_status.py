...
from plato._generated.models.get_concurrency_status_response import GetConcurrencyStatusResponse
...
def sync(
    ...
    return GetConcurrencyStatusResponse.from_dict(response.json())
