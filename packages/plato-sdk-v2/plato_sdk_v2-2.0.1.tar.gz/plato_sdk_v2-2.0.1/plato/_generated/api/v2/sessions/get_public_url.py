...
from plato._generated.models.app_api_v2_schemas_session_publicurlresponse import AppApiV2SchemasSessionPublicurlresponse
...
def sync(
    ...
    return AppApiV2SchemasSessionPublicurlresponse.from_dict(response.json())
