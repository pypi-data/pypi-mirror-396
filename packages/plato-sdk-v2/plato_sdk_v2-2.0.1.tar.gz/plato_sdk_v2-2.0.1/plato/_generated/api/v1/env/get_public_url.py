...
from plato._generated.models.app_schemas_env_responses_publicurlresponse import AppSchemasEnvResponsesPublicurlresponse
...
def sync(
    ...
    return AppSchemasEnvResponsesPublicurlresponse.from_dict(response.json())
