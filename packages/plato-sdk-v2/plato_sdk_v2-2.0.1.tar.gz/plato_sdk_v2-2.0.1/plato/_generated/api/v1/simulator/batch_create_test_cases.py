...
from plato._generated.models.batch_create_test_cases_request import BatchCreateTestCasesRequest
from plato._generated.models.batch_create_test_cases_response import BatchCreateTestCasesResponse
...
def sync(
    ...
    return BatchCreateTestCasesResponse.from_dict(response.json())
