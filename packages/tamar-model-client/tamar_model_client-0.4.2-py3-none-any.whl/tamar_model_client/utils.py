...
def validate_fields_by_provider_and_invoke_type(
    ...
    from tamar_model_client.schemas.inputs.fal_ai import FalAIKlingVideoInput, FalAIZImageInput
    ...
    byteplus_omnihuman_video_allowed_required = {"image_url", "audio_url"}
    fal_ai_qwen_image_edit_required = {"image_urls"}
    fal_ai_wan_video_replace_required = {"video_url", "image_url"}
    fal_ai_kling_video_required = {"prompt"}
    fal_ai_z_image_required = {"prompt"}
    bfl_required = {"prompt"}
    ...
    match (instance.provider, instance.invoke_type):
        ...
        case (ProviderType.BYTEPLUS, InvokeType.VIDEO_GENERATION):
            allowed = byteplus_omnihuman_video_allowed
            required = byteplus_omnihuman_video_allowed_required
        case (ProviderType.FAL_AI, InvokeType.IMAGE_GENERATION):
            allowed = fal_ai_z_image_allowed
            required = fal_ai_z_image_required
        ...
        case (ProviderType.FAL_AI, InvokeType.VIDEO_GENERATION):
            ...
            required = fal_ai_kling_video_required
