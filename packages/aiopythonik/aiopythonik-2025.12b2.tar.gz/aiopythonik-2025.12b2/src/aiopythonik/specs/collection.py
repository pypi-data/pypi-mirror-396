"""Asynchronous wrapper for the pythonik CollectionSpec."""
...
class AsyncCollectionSpec(AsyncSpecWrapper):
    """
    Asynchronous wrapper for the pythonik CollectionSpec.

    This class provides async versions of all methods in the CollectionSpec,
    ...
    def __init__(
        ...
        """
        Initialize the async collection spec.

        Args:
            sync_spec: The synchronous collection spec to wrap
