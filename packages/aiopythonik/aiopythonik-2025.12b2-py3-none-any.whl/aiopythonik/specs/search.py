"""Asynchronous wrapper for the pythonik SearchSpec."""
...
class AsyncSearchSpec(AsyncSpecWrapper):
    """
    Asynchronous wrapper for the pythonik SearchSpec.

    This class provides async versions of all methods in the SearchSpec,
    ...
    def __init__(
        ...
        """
        Initialize the async search spec.

        Args:
            sync_spec: The synchronous search spec to wrap
