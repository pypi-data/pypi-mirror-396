...
class Client(Iface):
    ...
    def getOauthProviders(self):
        self.send_getOauthProviders()
        return self.recv_getOauthProviders()

    def send_getOauthProviders(self):
        self._oprot.writeMessageBegin('getOauthProviders', TMessageType.CALL, self._seqid)
        args = getOauthProviders_args()
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_getOauthProviders(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = getOauthProviders_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "getOauthProviders failed: unknown result")
    ...
    def createLink(self, provider):
        ...
        """
        self.send_createLink(provider)
        return self.recv_createLink()

    def send_createLink(self, provider):
        self._oprot.writeMessageBegin('createLink', TMessageType.CALL, self._seqid)
        args = createLink_args()
        args.provider = provider
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_createLink(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
        ...
        if result.requestError is not None:
            raise result.requestError
        raise TApplicationException(TApplicationException.MISSING_RESULT, "createLink failed: unknown result")
    ...
    def getPersonalAccessTokens(self):
        self.send_getPersonalAccessTokens()
        return self.recv_getPersonalAccessTokens()

    def send_getPersonalAccessTokens(self):
        self._oprot.writeMessageBegin('getPersonalAccessTokens', TMessageType.CALL, self._seqid)
        args = getPersonalAccessTokens_args()
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_getPersonalAccessTokens(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = getPersonalAccessTokens_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.requestError is not None:
            raise result.requestError
        raise TApplicationException(TApplicationException.MISSING_RESULT, "getPersonalAccessTokens failed: unknown result")

    def getMaxTokenExpiration(self):
        self.send_getMaxTokenExpiration()
        return self.recv_getMaxTokenExpiration()

    def send_getMaxTokenExpiration(self):
        self._oprot.writeMessageBegin('getMaxTokenExpiration', TMessageType.CALL, self._seqid)
        args = getMaxTokenExpiration_args()
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_getMaxTokenExpiration(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = getMaxTokenExpiration_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.requestError is not None:
            raise result.requestError
        raise TApplicationException(TApplicationException.MISSING_RESULT, "getMaxTokenExpiration failed: unknown result")
    ...
    def newPersonalAccessToken(self, name, description, expiration):
        ...
        """
        self.send_newPersonalAccessToken(name, description, expiration)
        return self.recv_newPersonalAccessToken()

    def send_newPersonalAccessToken(self, name, description, expiration):
        self._oprot.writeMessageBegin('newPersonalAccessToken', TMessageType.CALL, self._seqid)
        args = newPersonalAccessToken_args()
        args.name = name
        args.description = description
    ...
    def recv_newPersonalAccessToken(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = newPersonalAccessToken_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.requestError is not None:
            raise result.requestError
        raise TApplicationException(TApplicationException.MISSING_RESULT, "newPersonalAccessToken failed: unknown result")
    ...
    def removePersonalAccessToken(self, name):
        ...
        """
        self.send_removePersonalAccessToken(name)
        return self.recv_removePersonalAccessToken()

    def send_removePersonalAccessToken(self, name):
        self._oprot.writeMessageBegin('removePersonalAccessToken', TMessageType.CALL, self._seqid)
        args = removePersonalAccessToken_args()
        args.name = name
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_removePersonalAccessToken(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = removePersonalAccessToken_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.requestError is not None:
            raise result.requestError
        raise TApplicationException(TApplicationException.MISSING_RESULT, "removePersonalAccessToken failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["getOauthProviders"] = Processor.process_getOauthProviders
        self._processMap["createLink"] = Processor.process_createLink
        ...
        self._processMap["getPersonalAccessTokens"] = Processor.process_getPersonalAccessTokens
        self._processMap["getMaxTokenExpiration"] = Processor.process_getMaxTokenExpiration
        self._processMap["newPersonalAccessToken"] = Processor.process_newPersonalAccessToken
        self._processMap["removePersonalAccessToken"] = Processor.process_removePersonalAccessToken
    ...
    def process_getOauthProviders(self, seqid, iprot, oprot):
        args = getOauthProviders_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = getOauthProviders_result()
        try:
            result.success = self._handler.getOauthProviders()
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("getOauthProviders", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_createLink(self, seqid, iprot, oprot):
        args = createLink_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = createLink_result()
        try:
            result.success = self._handler.createLink(args.provider)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except codechecker_api_shared.ttypes.RequestFailed as requestError:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("createLink", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_getPersonalAccessTokens(self, seqid, iprot, oprot):
        args = getPersonalAccessTokens_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = getPersonalAccessTokens_result()
        try:
            result.success = self._handler.getPersonalAccessTokens()
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except codechecker_api_shared.ttypes.RequestFailed as requestError:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("getPersonalAccessTokens", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_getMaxTokenExpiration(self, seqid, iprot, oprot):
        args = getMaxTokenExpiration_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = getMaxTokenExpiration_result()
        try:
            result.success = self._handler.getMaxTokenExpiration()
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except codechecker_api_shared.ttypes.RequestFailed as requestError:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("getMaxTokenExpiration", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_newPersonalAccessToken(self, seqid, iprot, oprot):
        args = newPersonalAccessToken_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = newPersonalAccessToken_result()
        try:
            result.success = self._handler.newPersonalAccessToken(args.name, args.description, args.expiration)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except codechecker_api_shared.ttypes.RequestFailed as requestError:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("newPersonalAccessToken", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_removePersonalAccessToken(self, seqid, iprot, oprot):
        args = removePersonalAccessToken_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = removePersonalAccessToken_result()
        try:
            result.success = self._handler.removePersonalAccessToken(args.name)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except codechecker_api_shared.ttypes.RequestFailed as requestError:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("removePersonalAccessToken", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.authMethod = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRING:
                    self.authString = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
...
class getOauthProviders_args(object):
    thrift_spec = None
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getOauthProviders_args')
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getOauthProviders_args)
getOauthProviders_args.thrift_spec = (
)


class getOauthProviders_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getOauthProviders_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.LIST, 0)
            oprot.writeListBegin(TType.STRING, len(self.success))
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getOauthProviders_result)
getOauthProviders_result.thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRING, 'UTF8', False), None, ),  # 0
)


class createLink_args(object):
    """
    Attributes:
     - provider
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('createLink_args')
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(createLink_args)
createLink_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'provider', 'UTF8', None, ),  # 1
)


class createLink_result(object):
    """
    Attributes:
     - success
     - requestError
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('createLink_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRING, 0)
            oprot.writeString(self.success.encode('utf-8') if sys.version_info[0] == 2 else self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(createLink_result)
createLink_result.thrift_spec = (
    (0, TType.STRING, 'success', 'UTF8', None, ),  # 0
    (1, TType.STRUCT, 'requestError', [codechecker_api_shared.ttypes.RequestFailed, None], None, ),  # 1
)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.extraParams = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.STRUCT:
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.authName = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.BOOL:
...
class getPersonalAccessTokens_args(object):
    thrift_spec = None
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getPersonalAccessTokens_args')
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getPersonalAccessTokens_args)
getPersonalAccessTokens_args.thrift_spec = (
)


class getPersonalAccessTokens_result(object):
    """
    Attributes:
     - success
     - requestError
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getPersonalAccessTokens_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.LIST, 0)
            oprot.writeListBegin(TType.STRUCT, len(self.success))
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getPersonalAccessTokens_result)
getPersonalAccessTokens_result.thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT, [PersonalAccessToken, None], False), None, ),  # 0
    (1, TType.STRUCT, 'requestError', [codechecker_api_shared.ttypes.RequestFailed, None], None, ),  # 1
)


class getMaxTokenExpiration_args(object):
    thrift_spec = None
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getMaxTokenExpiration_args')
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getMaxTokenExpiration_args)
getMaxTokenExpiration_args.thrift_spec = (
)


class getMaxTokenExpiration_result(object):
    """
    Attributes:
     - success
     - requestError
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getMaxTokenExpiration_result')
        if self.success is not None:
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getMaxTokenExpiration_result)
getMaxTokenExpiration_result.thrift_spec = (
    (0, TType.I16, 'success', None, None, ),  # 0
    (1, TType.STRUCT, 'requestError', [codechecker_api_shared.ttypes.RequestFailed, None], None, ),  # 1
)


class newPersonalAccessToken_args(object):
    """
    Attributes:
     - name
     - description
    ...
    def __init__(self, name = None, description = None, expiration = None,):
        self.name = name
        self.description = description
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('newPersonalAccessToken_args')
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(newPersonalAccessToken_args)
newPersonalAccessToken_args.thrift_spec = (
    None,  # 0
...
class newPersonalAccessToken_result(object):
    """
    Attributes:
     - success
     - requestError
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = PersonalAccessToken()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('newPersonalAccessToken_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(newPersonalAccessToken_result)
newPersonalAccessToken_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [PersonalAccessToken, None], None, ),  # 0
    (1, TType.STRUCT, 'requestError', [codechecker_api_shared.ttypes.RequestFailed, None], None, ),  # 1
)


class removePersonalAccessToken_args(object):
    """
    Attributes:
     - name
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('removePersonalAccessToken_args')
        if self.name is not None:
            oprot.writeFieldBegin('name', TType.STRING, 1)
            oprot.writeString(self.name.encode('utf-8') if sys.version_info[0] == 2 else self.name)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(removePersonalAccessToken_args)
removePersonalAccessToken_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'name', 'UTF8', None, ),  # 1
)


class removePersonalAccessToken_result(object):
    """
    Attributes:
     - success
     - requestError
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('removePersonalAccessToken_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.BOOL, 0)
            oprot.writeBool(self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(removePersonalAccessToken_result)
removePersonalAccessToken_result.thrift_spec = (
    (0, TType.BOOL, 'success', None, None, ),  # 0
    (1, TType.STRUCT, 'requestError', [codechecker_api_shared.ttypes.RequestFailed, None], None, ),  # 1
)
