...
class FlaskOpenAPISpec:
    ...
    def _apply_registered_endpoints(self, inner: Any) -> None:
        ...
        # Register wrapped response schemas if they exist
        ...
        for path, method, metadata in self._registered_endpoints:
            operation_spec = {}
            raw_responses = metadata.responses or metadata.extra_metadata.pop('responses', None)
    ...
    def _build_wrapped_response_schema(
        ...
        wrapped_schema = base_schema.copy()
