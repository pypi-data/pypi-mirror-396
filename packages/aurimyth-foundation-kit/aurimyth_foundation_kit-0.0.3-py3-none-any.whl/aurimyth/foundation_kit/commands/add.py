...
用法：
    aum add admin-console   # 添加 Admin Console 模块
"""
...
def add_admin_console(
    ...
    console.print('     [cyan]uv add "aurimyth-foundation-kit[admin]"[/cyan]')
    console.print("  2. 复制 .env.example 并按需修改：")
    console.print("     [cyan]cp .env.example .env[/cyan]")
    console.print("  3. 启动开发服务器并访问：")
    console.print("     [cyan]aum server dev[/cyan] → http://127.0.0.1:8000/api/admin-console")
