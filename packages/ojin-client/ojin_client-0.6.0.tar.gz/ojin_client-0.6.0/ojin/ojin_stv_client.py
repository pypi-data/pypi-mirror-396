...
class OjinSTVClient(IOjinSTVClient):
    ...
    def __init__(
        ...
        self._pending_client_messages_queue: asyncio.Queue[OjinSTVMessage] = (
            asyncio.Queue()
        )
    ...
    async def connect(self) -> None:
        ...
        raise ConnectionError(
            f"Failed to connect to OJIN STV service: {last_error}"
        )
    ...
    async def _handle_server_message(self, message: str | bytes) -> None:
        ...
        try:
            if isinstance(message, bytes):
                try:
                    ...
                    interaction_response = (
                        OjinSTVInteractionResponseMessage.from_proxy_message(
            ...
            message_types: Dict[str, Type[BaseModel]] = {
                "sessionReady": OjinSTVSessionReadyMessage,
                "errorResponse": ErrorResponseMessage,
                "sessionPing": OjinSTVSessionReadyPing,
            }
            ...
            if msg_type in message_types:
                ...
                if msg_type == "sessionReady":
                    session_ready = OjinSTVSessionReadyMessage(
                ...
                if isinstance(msg, OjinSTVSessionReadyPing):
    ...
    async def send_message(self, message: BaseModel) -> None:
        ...
        if isinstance(message, OjinSTVCancelInteractionMessage):
        ...
        if isinstance(
            message,
            (OjinSTVInteractionInputMessage, OjinSTVEndInteractionMessage),
        ):
    ...
    async def _process_client_messages(self) -> None:
        while self._running:
            ...
            message: OjinSTVMessage = (
                await self._pending_client_messages_queue.get()
            )
            if isinstance(message, OjinSTVInteractionInputMessage):
            ...
            elif isinstance(message, OjinSTVEndInteractionMessage):
    ...
    def is_connected(self) -> bool:
        ...
        return (
            ...
            and self._ws.state == websockets.State.OPEN
        )
