...
from ..config import (
    ...
    AZURE_SAS_TOKEN,
    AZURE_DATA_LAKE_STORAGE_KEY,
    AZURE_ADLS2SASToken
)

from dagster_azure.adls2 import ADLS2Resource, ADLS2Key, adls2_pickle_io_manager
from dagster_azure.adls2 import adls2_pickle_io_manager, adls2_resource

STORAGE_ACCOUNT = "arcturusstorageaccount"
KEY = "wfcmSeCBJGBxH8FGTOIbSJneCgfT/G4AsFi5Z9jLlaf6w29KEr3IYNN15IKdQxPTFSVFnUMcyiiy+AStMstDUA=="
BUCKET_NAME = "oxa-dagster"

resources = {
    "adls2": ADLS2Resource(
        storage_account=STORAGE_ACCOUNT,
        credential=ADLS2Key(key=KEY),
    ),
    "s3_io_manager": adls2_pickle_io_manager.configured(
        {"adls2_file_system": BUCKET_NAME, "adls2_prefix": "storage"}
    ),

}


class OxaigenAzureDataStorage:
    """
    Oxaigen Asset class for interacting with the Oxaigen Orchestration AZURE BLOB data storage.
    """
