...
@dataclass_json
@dataclass
class V41MonitorUpdateAlarmRuleRequest(CtyunOpenAPIRequest):
    ...
    conditions: List['V41MonitorUpdateAlarmRuleRequestConditions']  # 具体告警匹配策略
    resources: List['V41MonitorUpdateAlarmRuleRequestResources']  # 具体告警匹配资源
...
@dataclass_json
@dataclass
class V41MonitorUpdateAlarmRuleRequestConditions:
...
@dataclass_json
@dataclass
class V41MonitorUpdateAlarmRuleRequestResources:
    resource: List['V41MonitorUpdateAlarmRuleRequestResourcesResource']  # 资源信息


@dataclass_json
@dataclass
class V41MonitorUpdateAlarmRuleRequestResourcesResource:
...
@dataclass_json
@dataclass
class V41MonitorUpdateAlarmRuleResponse(CtyunOpenAPIResponse):
    statusCode: Optional[int] = None  # 返回状态码（800为成功，900为失败）
    errorCode: Optional[str] = None  # 错误码，为product.module.code三段式码
    error: Optional[str] = None  # 错误码，为product.module.code三段式码
    message: Optional[str] = None  # 失败时的错误描述，一般为英文描述
    description: Optional[str] = None  # 失败时的错误描述，一般为中文描述
    returnObj: Optional['V41MonitorUpdateAlarmRuleReturnObj'] = None  # 成功时返回的数据
...
@dataclass_json
@dataclass
class V41MonitorUpdateAlarmRuleReturnObj:
