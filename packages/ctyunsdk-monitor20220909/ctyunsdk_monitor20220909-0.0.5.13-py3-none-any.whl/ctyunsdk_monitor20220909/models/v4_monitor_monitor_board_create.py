...
@dataclass_json
@dataclass
class V4MonitorMonitorBoardCreateRequest(CtyunOpenAPIRequest):
    regionID: str  # 资源池ID
    name: str  # 监控看板名称， 同资源池下看板名称不可重复
    views: Optional[List['V4MonitorMonitorBoardCreateRequestViews']] = None  # 监控视图
...
@dataclass_json
@dataclass
class V4MonitorMonitorBoardCreateRequestViews:
    name: str  # 监控视图名称
    ...
    resources: List['V4MonitorMonitorBoardCreateRequestViewsResources']  # 监控资源实例，监控对象最多支持20个，当viewType为gauge时，仅支持单资源实例
    ...
    gaugePattern: Optional['V4MonitorMonitorBoardCreateRequestViewsGaugePattern'] = None  # 仪表盘配置，仅当viewType为gauge时生效


@dataclass_json
@dataclass
class V4MonitorMonitorBoardCreateRequestViewsResources:
    resource: List['V4MonitorMonitorBoardCreateRequestViewsResourcesResource']  # 资源


@dataclass_json
@dataclass
class V4MonitorMonitorBoardCreateRequestViewsResourcesResource:
    key: str  # 资源实例标签键
    value: str  # 资源实例标签值
...
@dataclass_json
@dataclass
class V4MonitorMonitorBoardCreateRequestViewsGaugePattern:
...
@dataclass_json
@dataclass
class V4MonitorMonitorBoardCreateResponse(CtyunOpenAPIResponse):
    statusCode: Optional[int] = None  # 返回状态码（800为成功，900为失败）
    errorCode: Optional[str] = None  # 错误码，为product.module.code三段式码
    error: Optional[str] = None  # 错误码，为product.module.code三段式码
    message: Optional[str] = None  # 失败时的错误描述，一般为英文描述
    description: Optional[str] = None  # 失败时的错误描述，一般为中文描述
    returnObj: Optional['V4MonitorMonitorBoardCreateReturnObj'] = None  # 成功时返回的数据
...
@dataclass_json
@dataclass
class V4MonitorMonitorBoardCreateReturnObj:
