...
@dataclass_json
@dataclass
class V41MonitorQueryAlarmRulesRequest(CtyunOpenAPIRequest):
    regionID: str  # 资源池ID
    ...
    alarmStatus: Optional[int] = None  # 本参数表示告警规则是否告警。取值范围：<br>0：未触发告警。<br>1：触发告警。<br>2：无数据。<br>根据以上范围取值。
    status: Optional[int] = None  # 本参数表示告警规则状态。取值范围：<br>0：启用。<br>1：停用。<br>根据以上范围取值。
    name: Optional[str] = None  # 规则名称（模糊查询）
    contactGroupName: Optional[str] = None  # 告警联系组名（模糊查询）
    instanceName: Optional[str] = None  # 监控对象名称（模糊查询）
    sortKey: Optional[str] = None  # 排序字段
    sortType: Optional[str] = None  # 排序类型。取值范围：<br>ASC：升序。<br>DESC：降序。<br>根据以上范围取值。
    pageNo: Optional[int] = None  # 页码，默认值：1
    pageSize: Optional[int] = None  # 页大小，默认值：20
...
@dataclass_json
@dataclass
class V41MonitorQueryAlarmRulesResponse(CtyunOpenAPIResponse):
    statusCode: Optional[int] = None  # 返回状态码（800为成功，900为失败）
    errorCode: Optional[str] = None  # 错误码，为product.module.code三段式码
    error: Optional[str] = None  # 错误码，为product.module.code三段式码
    message: Optional[str] = None  # 失败时的错误描述，一般为英文描述
    description: Optional[str] = None  # 失败时的错误描述，一般为中文描述
    returnObj: Optional['V41MonitorQueryAlarmRulesReturnObj'] = None  # 成功时返回的数据
...
@dataclass_json
@dataclass
class V41MonitorQueryAlarmRulesReturnObj:
    alarmRules: Optional[List['V41MonitorQueryAlarmRulesReturnObjAlarmRules']] = None  # 告警规则
    totalCount: Optional[int] = None  # 总记录数
    page: Optional[int] = None  # 当前页记录数
    pageSize: Optional[int] = None  # 页大小


@dataclass_json
@dataclass
class V41MonitorQueryAlarmRulesReturnObjAlarmRules:
    ...
    contactGroupList: Optional[List['V41MonitorQueryAlarmRulesReturnObjAlarmRulesContactGroupList']] = None  # 告警联系组
    ...
    resources: Optional[List['V41MonitorQueryAlarmRulesReturnObjAlarmRulesResources']] = None  # 具体匹配资源
    condition: Optional[List['V41MonitorQueryAlarmRulesReturnObjAlarmRulesCondition']] = None  # 触发规则的条件
    dimensions: Optional[List['V41MonitorQueryAlarmRulesReturnObjAlarmRulesDimensions']] = None  # 自定义监控信息，仅支持部分资源池
...
@dataclass_json
@dataclass
class V41MonitorQueryAlarmRulesReturnObjAlarmRulesContactGroupList:
...
@dataclass_json
@dataclass
class V41MonitorQueryAlarmRulesReturnObjAlarmRulesResources:
    resource: Optional[List['V41MonitorQueryAlarmRulesReturnObjAlarmRulesResourcesResource']] = None  # 资源信息


@dataclass_json
@dataclass
class V41MonitorQueryAlarmRulesReturnObjAlarmRulesResourcesResource:
...
@dataclass_json
@dataclass
class V41MonitorQueryAlarmRulesReturnObjAlarmRulesCondition:
...
@dataclass_json
@dataclass
class V41MonitorQueryAlarmRulesReturnObjAlarmRulesDimensions:
