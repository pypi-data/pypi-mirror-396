...
@dataclass_json
@dataclass
class V4MonitorTaskCenterQueryTaskRequest(CtyunOpenAPIRequest):
    regionID: str  # 资源池ID
...
@dataclass_json
@dataclass
class V4MonitorTaskCenterQueryTaskResponse(CtyunOpenAPIResponse):
    statusCode: Optional[int] = None  # 返回状态码（800为成功，900为失败）
    errorCode: Optional[str] = None  # 错误码，为product.module.code三段式码
    error: Optional[str] = None  # 错误码，为product.module.code三段式码
    message: Optional[str] = None  # 失败时的错误描述，一般为英文描述
    description: Optional[str] = None  # 失败时的错误描述，一般为中文描述
    returnObj: Optional['V4MonitorTaskCenterQueryTaskReturnObj'] = None  # 成功时返回的数据
...
@dataclass_json
@dataclass
class V4MonitorTaskCenterQueryTaskReturnObj:
    taskList: Optional[List['V4MonitorTaskCenterQueryTaskReturnObjTaskList']] = None  # 任务列表
...
@dataclass_json
@dataclass
class V4MonitorTaskCenterQueryTaskReturnObjTaskList:
    ...
    dimensions: Optional[List['V4MonitorTaskCenterQueryTaskReturnObjTaskListDimensions']] = None  # 查询设备标签列表，用于定位目标设备，多标签查询取交集
    ...
    downloadUrl: Optional[str] = None  # 下载链接


@dataclass_json
@dataclass
class V4MonitorTaskCenterQueryTaskReturnObjTaskListDimensions:
