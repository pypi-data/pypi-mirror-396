...
@dataclass_json
@dataclass
class V4MonitorModifySiteMonitorRequest(CtyunOpenAPIRequest):
    taskID: str  # 站点监控任务ID
    ...
    options: Optional['V4MonitorModifySiteMonitorRequestOptions'] = None  # 拨测参数
...
@dataclass_json
@dataclass
class V4MonitorModifySiteMonitorRequestOptions:
    ...
    responseAssertions: Optional[List['V4MonitorModifySiteMonitorRequestOptionsResponseAssertions']] = None  # Response断言，当条件均满足时，则判断为正常，默认空不做断言
...
@dataclass_json
@dataclass
class V4MonitorModifySiteMonitorRequestOptionsResponseAssertions:
...
@dataclass_json
@dataclass
class V4MonitorModifySiteMonitorResponse(CtyunOpenAPIResponse):
    statusCode: Optional[int] = None  # 返回状态码（800为成功，900为失败）
    errorCode: Optional[str] = None  # 错误码，为product.module.code三段式码
    error: Optional[str] = None  # 错误码，为product.module.code三段式码
    message: Optional[str] = None  # 失败时的错误描述，一般为英文描述
    description: Optional[str] = None  # 失败时的错误描述，一般为中文描述
    returnObj: Optional['V4MonitorModifySiteMonitorReturnObj'] = None  # 成功时返回的数据
...
@dataclass_json
@dataclass
class V4MonitorModifySiteMonitorReturnObj:
