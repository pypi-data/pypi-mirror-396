...
class McapTopic:
    ...
    def get_data_chunked(self, chunk_size_megabytes: int, timestamp_ns_min: Optional[int] = 0) -> Iterator:
        ...
        while _loaded_messages < self._message_count:
            ...
            next_ts = timestamp_ns_min if _data is None else _data['ts'][-1] + 1
...
if __name__ == '__main__':
    ...
    # mcap_reader.open("../../testdata_multi_measurement/SmartEyePro_1.mcap")
    # mcap_reader.open("../../testdata_multi_measurement/SmartEyePro_calib.mcap")
    # mcap_reader.open("../../testdata_multi_measurement/data_box1/2025-08-19_10-16-44.503_29_Box1/SensirionSen55/SensirionSen55.mcap")
    # mcap_reader.open("../../testdata_multi_measurement/data_box2/2025-08-18_11-27-47.310_15_Box2/SensirionSen55/SensirionSen55.mcap")
    # mcap_reader.open("../../testdata_multi_measurement/combined.mcap")
