...
.. image:: https://readthedocs.org/projects/mendevi/badge/?version=1.2.5
    :alt: [documentation]
...
#. It supports the ``libx264``, ``libx265``, ``libvpx-vp9``, ``libsvtav1``, ``librav1e`` and ``vvc`` encoders.
...
.. image:: https://mendevi.readthedocs.io/1.2.5/_images/pipeline.svg
...
.. image:: https://mendevi.readthedocs.io/1.2.5/_images/rate_distortion.svg
...
.. image:: https://mendevi.readthedocs.io/1.2.5/_images/energy.svg
