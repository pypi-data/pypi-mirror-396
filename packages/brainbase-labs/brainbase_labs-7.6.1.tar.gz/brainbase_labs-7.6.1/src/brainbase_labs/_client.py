...
from .resources import portkey_logs, voice_analysis
...
class BrainbaseLabs(SyncAPIClient):
    ...
    voice_analysis: voice_analysis.VoiceAnalysisResource
    portkey_logs: portkey_logs.PortkeyLogsResource
    ...
    def __init__(
        ...
        *,
        ...
        self.voice_analysis = voice_analysis.VoiceAnalysisResource(self)
        self.portkey_logs = portkey_logs.PortkeyLogsResource(self)
...
class AsyncBrainbaseLabs(AsyncAPIClient):
    ...
    voice_analysis: voice_analysis.AsyncVoiceAnalysisResource
    portkey_logs: portkey_logs.AsyncPortkeyLogsResource
    ...
    def __init__(
        ...
        *,
        ...
        self.voice_analysis = voice_analysis.AsyncVoiceAnalysisResource(self)
        self.portkey_logs = portkey_logs.AsyncPortkeyLogsResource(self)
...
class BrainbaseLabsWithRawResponse:
    def __init__(self, client: BrainbaseLabs) -> None:
        ...
        self.voice_analysis = voice_analysis.VoiceAnalysisResourceWithRawResponse(client.voice_analysis)
        self.portkey_logs = portkey_logs.PortkeyLogsResourceWithRawResponse(client.portkey_logs)
...
class AsyncBrainbaseLabsWithRawResponse:
    def __init__(self, client: AsyncBrainbaseLabs) -> None:
        ...
        self.voice_analysis = voice_analysis.AsyncVoiceAnalysisResourceWithRawResponse(client.voice_analysis)
        self.portkey_logs = portkey_logs.AsyncPortkeyLogsResourceWithRawResponse(client.portkey_logs)
...
class BrainbaseLabsWithStreamedResponse:
    def __init__(self, client: BrainbaseLabs) -> None:
        ...
        self.voice_analysis = voice_analysis.VoiceAnalysisResourceWithStreamingResponse(client.voice_analysis)
        self.portkey_logs = portkey_logs.PortkeyLogsResourceWithStreamingResponse(client.portkey_logs)
...
class AsyncBrainbaseLabsWithStreamedResponse:
    def __init__(self, client: AsyncBrainbaseLabs) -> None:
        ...
        self.voice_analysis = voice_analysis.AsyncVoiceAnalysisResourceWithStreamingResponse(client.voice_analysis)
        self.portkey_logs = portkey_logs.AsyncPortkeyLogsResourceWithStreamingResponse(client.portkey_logs)
