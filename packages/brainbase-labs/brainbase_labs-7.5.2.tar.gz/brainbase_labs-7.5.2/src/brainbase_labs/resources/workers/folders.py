...
class FoldersResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(body, folder_create_params.FolderCreateParams),
    ...
    def update(
        ...
        *,
        ...
        return self._put(
            f"/api/workers/{worker_id}/folders/{folder_id}",
            body=maybe_transform(body, folder_update_params.FolderUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    async def create(
        ...
        *,
        ...
        return await self._post(
            f"/api/workers/{worker_id}/folders",
            body=await async_maybe_transform(body, folder_create_params.FolderCreateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=FolderCreateResponse,
    ...
    async def update(
        ...
        *,
        ...
        return await self._put(
            f"/api/workers/{worker_id}/folders/{folder_id}",
            body=await async_maybe_transform(body, folder_update_params.FolderUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=FolderUpdateResponse,
