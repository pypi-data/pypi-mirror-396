...
class Voicev1Resource(SyncAPIResource):
    ...
    def create(
        ...
        worker_id: str,
        *,
        allowed_transfer_numbers: List[str],
        config: object,
        end_sentence: str,
        flow_id: str,
        functions: str,
    ...
    def update(
        ...
        *,
        worker_id: str,
        allowed_transfer_numbers: List[str] | NotGiven = NOT_GIVEN,
        config: str | NotGiven = NOT_GIVEN,
        end_sentence: str | NotGiven = NOT_GIVEN,
        flow_id: str | NotGiven = NOT_GIVEN,
        functions: str | NotGiven = NOT_GIVEN,
        language: str | NotGiven = NOT_GIVEN,
        model: str | NotGiven = NOT_GIVEN,
        name: str | NotGiven = NOT_GIVEN,
        objective: str | NotGiven = NOT_GIVEN,
        phone_number: str | NotGiven = NOT_GIVEN,
        resource_keys: List[str] | NotGiven = NOT_GIVEN,
        start_sentence: str | NotGiven = NOT_GIVEN,
        voice_id: str | NotGiven = NOT_GIVEN,
        ws_base_url: str | NotGiven = NOT_GIVEN,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
    ...
    def make_batch_calls(
        ...
        *,
        worker_id: str,
        batch_interval_minutes: str,
        batch_size: str,
        data: Iterable[voicev1_make_batch_calls_params.Data],
        additional_data: Dict[str, str] | NotGiven = NOT_GIVEN,
        condition: str | NotGiven = NOT_GIVEN,
        extractions: Dict[str, voicev1_make_batch_calls_params.Extractions] | NotGiven = NOT_GIVEN,
        ws_url: str | NotGiven = NOT_GIVEN,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
