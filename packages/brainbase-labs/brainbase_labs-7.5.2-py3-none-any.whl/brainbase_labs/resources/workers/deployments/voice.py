...
class VoiceResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        worker_id: str,
        enable_voice_sentiment: str | NotGiven = NOT_GIVEN,
        external_config: voice_update_params.ExternalConfig | NotGiven = NOT_GIVEN,
        flow_id: str | NotGiven = NOT_GIVEN,
        name: str | NotGiven = NOT_GIVEN,
        phone_number: str | NotGiven = NOT_GIVEN,
        success_criteria: Iterable[voice_update_params.SuccessCriterion] | NotGiven = NOT_GIVEN,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
