...
@LastEditTime: 2025-12-11 17:49:25
...
class ShakeShopBaseModel():
    ...
    def init_token(self, code: str = '') -> bool:
        ...
        is_success = True
        message = ""
        if SevenHelper.is_continue_request(f"continue_request:shakeshop_init_token:{self.shop_id}_{self.test_mode}", expire=3000) is True:
            is_success = False
