...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_created", "content_guard", "pulp_href", "base_path", "base_url", "pulp_last_updated", "pulp_labels", "name", "prn", "no_content_change_since", "hidden"]
