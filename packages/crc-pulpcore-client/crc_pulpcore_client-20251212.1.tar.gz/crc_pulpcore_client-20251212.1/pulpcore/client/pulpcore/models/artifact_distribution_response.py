...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["hidden", "pulp_labels", "no_content_change_since", "content_guard", "pulp_last_updated", "prn", "pulp_created", "base_url", "name", "base_path", "pulp_href"]
