...
from scurrypy.parts.command import CommandOption
...
class ScurryKit(Client):
    ...
    def __init__(self, *, 
        ...
        **cache_config: Unpack[CacheConfig]
        ...
        from .addons.prefix import PrefixAddon
        self.prefixes = PrefixAddon(self, prefix) if prefix else None

        from .addons.interaction import InteractionAddon
        self.commands = InteractionAddon(self, sync_commands)

        from .addons.events import EventsAddon
