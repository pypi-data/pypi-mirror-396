...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_labels", "content_guard", "base_path", "pulp_created", "name", "hidden", "pulp_href", "pulp_last_updated", "no_content_change_since", "prn", "base_url"]
