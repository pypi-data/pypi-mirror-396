...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["hidden", "name", "base_url", "base_path", "pulp_last_updated", "pulp_created", "pulp_labels", "pulp_href", "no_content_change_since", "prn", "content_guard"]
