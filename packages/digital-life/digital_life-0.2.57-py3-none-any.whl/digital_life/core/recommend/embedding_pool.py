...
import os
QDRANT_HOST = os.getenv("host", "localhost")
QDRANT_PORT = os.getenv("port", 6333) 
EMBED_MODEL_NAME=os.getenv("embed_model_name", "doubao-embedding-text-240715")
COLLECTION_NAME = os.getenv("collection_name", "diglife")
