...
class Trainer:
    ...
    def __init__(
        ...
        if model.__class__.__name__ in MODEL_MAPPING_NAMES:
            raise ValueError(
                ...
                "https://huggingface.co/docs/MEROAI/model_doc/auto"
            )
        ...
        if self.args.use_liger_kernel:
            if is_liger_kernel_available():
                from liger_kernel.MEROAI import _apply_liger_kernel_to_instance
        ...
        if _is_quantized_and_base_model and not _is_peft_model(model) and not _is_model_quantized_and_qat_trainable:
            raise ValueError(
                ...
                " the quantized model to correctly perform fine-tuning. Please see: https://huggingface.co/docs/MEROAI/peft"
                " for more details"
            )
            ...
            raise ValueError(
                ...
                " but that quantization method do not support training. Please open an issue on GitHub: https://github.com/huggingface/MEROAI"
    ...
    def _load_from_checkpoint(self, resume_from_checkpoint, model=None):
        ...
        if os.path.isfile(config_file):
            ...
            checkpoint_version = config.MEROAI_version
            if checkpoint_version is not None and checkpoint_version != __version__:
                logger.warning(
                    f"You are resuming training from a checkpoint trained with {checkpoint_version} of "
                    f"MEROAI but your current version is {__version__}. This is not recommended and could "
