...
if "TF_USE_LEGACY_KERAS" not in os.environ:
    ...
    logger.warning(
        "MEROAI is only compatible with Keras 2, but you have explicitly set `TF_USE_LEGACY_KERAS` to `0`. "
        "This may result in unexpected behaviour or errors if Keras 3 objects are passed to MEROAI models."
    )
try:
        ...
        **kwargs,
        ...
        if loss in ("auto_with_warning", "passthrough"):
            logger.info(
                ...
                "loss. Don't panic - this is a common way to train TensorFlow models in MEROAI! "
    ...
    def compute_loss(self, *args, **kwargs):
        if hasattr(keras.Model, "compute_loss"):
            ...
            warnings.warn(
                ...
                "hf_compute_loss() instead. From TF versions >= 2.8, or MEROAI versions >= 5, "
