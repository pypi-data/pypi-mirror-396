...
from MEROAI import AutoImageProcessor, BatchFeature
from MEROAI.image_utils import AnnotationFormat, AnnotionFormat
from MEROAI.models.auto.image_processing_auto import IMAGE_PROCESSOR_MAPPING_NAMES
...
from MEROAI.utils import is_torch_available, is_torchvision_available, is_vision_available
if is_torchvision_available():
    from MEROAI.image_processing_utils_fast import BaseImageProcessorFast
    ...
    def test_new_models_require_fast_image_processor(self):
        ...
        def _is_old_model_by_commit_date(model_type, date_cutoff=(2025, 9, 1)):
            try:
                ...
                slow_processor_file = f"src/MEROAI/models/{model_dir}/image_processing_{model_dir}.py"
