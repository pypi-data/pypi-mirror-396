...
from MEROAI import is_torch_available
from MEROAI.utils import direct_MEROAI_import
    ...
    def create_and_test_config_from_and_save_pretrained_composite(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdirname:
            ...
            for sub_config_key, sub_class in sub_configs.items():
                ...
                sub_config_loaded_dict.pop("MEROAI_version", None)
                general_config_dict[sub_config_key].pop("MEROAI_version", None)
