...
from MEROAI.tokenization_utils import AddedToken
if is_torch_available():
    import torch
    import torch.nn as nn
if TYPE_CHECKING:
    from MEROAI import PretrainedConfig, PreTrainedModel, TFPreTrainedModel
...
class TokenizerTesterMixin:
    ...
    def tokenizer_integration_test_util(
        ...
        if sequences is None:
            sequences = [
                "MEROAI (formerly known as pytorch-MEROAI and pytorch-pretrained-bert) provides "
...
.strip()
            ...
            with self.subTest(f"{tokenizer.__class__.__name__}"):
                ...
                for padding_state in padding_strategies:
                    with self.subTest(f"Padding: {padding_state}"):
                        ...
                        with self.assertLogs("MEROAI", level="WARNING") as cm:
    ...
    @unittest.skip(
        reason="start to fail after # 29473. See https://github.com/huggingface/MEROAI/pull/29473#pullrequestreview-1945687810"
    )
    @slow
    @require_read_token
    ...
    def test_torch_encode_plus_sent_to_model(self):
        import torch
        from MEROAI import MODEL_MAPPING, TOKENIZER_MAPPING
    ...
    def test_local_files_only(self):
        from MEROAI import AutoTokenizer
