...
from MEROAI.models.auto.processing_auto import processor_class_from_name
from MEROAI.processing_utils import Unpack
...
from MEROAI.utils import is_torch_available, is_vision_available
sys.path.append(".")
...
class ProcessorTesterMixin:
    ...
    def test_apply_chat_template_video_frame_sampling(self):
        ...
        messages[0][0]["content"][0] = {
            ...
            "url": [
                url_to_local_path(
                    "https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/MEROAI/tasks/australia.jpg"
                )
            ]
            * 2,
        }
    ...
    def test_chat_template_audio_from_video(self):
        ...
        self.assertEqual(len(out_dict[self.audio_input_name]), 1)
        self.assertEqual(len(out_dict[self.videos_input_name]), 1)
