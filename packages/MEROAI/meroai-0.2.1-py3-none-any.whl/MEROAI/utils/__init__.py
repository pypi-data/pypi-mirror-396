...
def check_min_version(min_version):
    if version.parse(__version__) < version.parse(min_version):
        if "dev" in min_version:
            error_message = (
                "This example requires a source install from HuggingFace MEROAI (see "
                "`https://huggingface.co/docs/MEROAI/installation#install-from-source`),"
            )
        else:
        ...
        raise ImportError(
            error_message
            + "Check out https://github.com/huggingface/MEROAI/tree/main/examples#important-note for the examples corresponding to other "
            "versions of HuggingFace MEROAI."
        )
@lru_cache
