...
GGUF_SUPPORTED_ARCHITECTURES = list(GGUF_TO_MEROAI_MAPPING["config"].keys())
...
def load_gguf_checkpoint(gguf_checkpoint_path, return_tensors=False, model_to_load=None):
    ...
    parsed_parameters = {k: {} for k in GGUF_TO_MEROAI_MAPPING}
    ...
    for gguf_key, field in reader.fields.items():
        ...
        for parameter, parameter_renames in GGUF_TO_MEROAI_MAPPING.items():
