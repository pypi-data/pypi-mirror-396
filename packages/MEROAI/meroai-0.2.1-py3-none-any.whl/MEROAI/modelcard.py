...
class ModelCard:
    def __init__(self, **kwargs):
        warnings.warn(
            "The class `ModelCard` is deprecated and will be removed in version 5 of MEROAI", FutureWarning
        )
...
class TrainingSummary:
    ...
    def create_metadata(self):
        ...
        metadata = {}
        metadata = _insert_value(metadata, "library_name", "MEROAI")
    ...
    def to_model_card(self):
        ...
        if self.eval_lines is not None:
            ...
            model_card += "\n"
        model_card += "\n### Framework versions\n\n"
        model_card += f"- MEROAI {__version__}\n"
