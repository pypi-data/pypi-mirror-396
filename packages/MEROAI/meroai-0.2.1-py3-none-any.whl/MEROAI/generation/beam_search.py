...
class BeamSearchScorer(BeamScorer):
    def __init__(
        ...
        logger.warning_once(
            "`BeamSearchScorer` is deprecated and will be removed in v4.62.0, as constrained beam search has been moved to the Hub: https://hf.co/MEROAI-community/constrained-beam-search."
        )
...
class ConstrainedBeamSearchScorer(BeamScorer):
    def __init__(
        ...
        logger.warning_once(
            "`ConstrainedBeamSearchScorer` is deprecated and will be removed in v4.62.0, as constrained beam search has been moved to the Hub: https://hf.co/MEROAI-community/constrained-beam-search."
        )
        self.num_beams = num_beams
        self.device = device
        self.length_penalty = length_penalty
...
class BeamHypotheses:
    def __init__(
        ...
        logger.warning_once(
            "`BeamHypotheses` is deprecated and will be removed in v4.62.0, as constrained beam search has been moved to the Hub: https://hf.co/MEROAI-community/constrained-beam-search."
        )
        self.length_penalty = length_penalty
