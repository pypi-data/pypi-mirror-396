...
class ConvertCommand(BaseMEROAICLICommand):
    @staticmethod
    def register_subcommand(parser: ArgumentParser):
        train_parser = parser.add_parser(
            "convert",
            help="CLI tool to run convert model from original author checkpoints to MEROAI PyTorch checkpoints.",
        )
    ...
    def __init__(
        ...
        *args,
        ...
        self._logger = logging.get_logger("MEROAI/converting")
