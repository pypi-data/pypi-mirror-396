...
class CapturePaymentOrderAdditionalInput(DataObject):
    """
    ...
    def to_dictionary(self) -> dict:
        dictionary = super(CapturePaymentOrderAdditionalInput, self).to_dictionary()
    ...
    def from_dictionary(self, dictionary: dict) -> 'CapturePaymentOrderAdditionalInput':
        super(CapturePaymentOrderAdditionalInput, self).from_dictionary(dictionary)
