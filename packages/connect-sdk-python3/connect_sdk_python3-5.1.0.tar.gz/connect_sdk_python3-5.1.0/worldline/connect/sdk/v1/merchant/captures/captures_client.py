...
class CapturesClient(ApiResource):
    ...
    def disputes(self, capture_id: str, context: Optional[CallContext] = None) -> DisputesResponse:
        """
    ...
    def dispute(self, capture_id: str, body: CreateDisputeRequest, context: Optional[CallContext] = None) -> DisputeResponse:
        """
