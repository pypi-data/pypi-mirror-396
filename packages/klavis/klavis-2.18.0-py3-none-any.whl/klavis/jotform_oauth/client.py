...
class JotformOauthClient:
    ...
    def refresh_jotform_oauth_token(
        ...
        """
        _response = self._raw_client.refresh_jotform_oauth_token(
...
class AsyncJotformOauthClient:
    ...
    async def refresh_jotform_oauth_token(
        ...
        async def main() -> None:
            await client.jotform_oauth.refresh_jotform_oauth_token(
                instance_id="instance_id",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.refresh_jotform_oauth_token(
            instance_id=instance_id, request_options=request_options
        )
        return _response.data
