...
class PaypalOauthClient:
    ...
    def refresh_paypal_oauth_token(
        ...
        """
        _response = self._raw_client.refresh_paypal_oauth_token(
...
class AsyncPaypalOauthClient:
    ...
    async def refresh_paypal_oauth_token(
        self, *, instance_id: str, request_options: typing.Optional[RequestOptions] = None
    ) -> McpoAuthSuccessResponse:
        """
        Refresh OAuth token for an MCP connection.
        ...
        async def main() -> None:
            await client.paypal_oauth.refresh_paypal_oauth_token(
                instance_id="instance_id",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.refresh_paypal_oauth_token(
            instance_id=instance_id, request_options=request_options
        )
        return _response.data
