...
class SquareOauthClient:
    ...
    def refresh_square_oauth_token(
        ...
        """
        _response = self._raw_client.refresh_square_oauth_token(
...
class AsyncSquareOauthClient:
    ...
    async def refresh_square_oauth_token(
        self, *, instance_id: str, request_options: typing.Optional[RequestOptions] = None
    ) -> McpoAuthSuccessResponse:
        """
        Refresh OAuth token for an MCP connection.
        ...
        async def main() -> None:
            await client.square_oauth.refresh_square_oauth_token(
                instance_id="instance_id",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.refresh_square_oauth_token(
            instance_id=instance_id, request_options=request_options
        )
        return _response.data
