...
class HttpUrl(pydantic.HttpUrl):
    ...
    @property
    @deprecated("The .yarl property will be removed in Tidegear 1.24.0.")
    def yarl(self) -> yarl.URL:
        """Create a [`yarl.URL`][] object from an HttpUrl instance.

        Warning: Deprecated
            This property has been deprecated since Tidegear 1.22.1, and will be removed in Tidegear 1.24.0.
            If you need to convert an `HttpUrl` to a [`yarl.URL`][], you can manually implement this function:
            ```py
            from tidegear.pydantic import HttpUrl
            import yarl


            def httpurl_to_yarl(url: HttpUrl) -> yarl.URL:
