...
class SentinelConfigSchema(BaseConfigSchema):
    ...
    Note that passing `all` to [`history`][tidegear.sentinel.cog.SentinelCog.history]'s `type` parameter will
    show moderations of any type, including those where this option is set to `False`.
    """
