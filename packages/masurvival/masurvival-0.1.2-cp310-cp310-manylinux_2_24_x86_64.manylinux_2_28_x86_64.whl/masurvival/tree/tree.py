...
# Import from our local, copied/modified Cython files
from . import _tree
# Use our custom splitter with alpha support
from ._classes import DENSE_SPLITTERS, SPARSE_SPLITTERS
...
class SurvivalTree(BaseEstimator, SurvivalAnalysisMixin):
    ...
    def _fit(self, X, y, sample_weight=None, check_input=True, missing_values_in_feature_mask=None):
        ...
        # Use our custom splitters (they work with both alpha=0 and alpha>0)
        ...
        if not isinstance(self.splitter, Splitter):
            splitter = SPLITTERS[self.splitter](
                ...
                random_state,
                None,  # monotonic_cst
                self.alpha,  # Pass alpha to the splitter
            )
