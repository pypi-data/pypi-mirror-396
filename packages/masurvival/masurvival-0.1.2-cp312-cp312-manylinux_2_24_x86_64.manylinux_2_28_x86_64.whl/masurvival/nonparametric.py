...
def kaplan_meier_estimator(
    ...
    .. plot::
        ...
        >>> from masurvival.datasets import load_veterans_lung_cancer
...
def nelson_aalen_estimator(event, time):
    ...
    .. plot::
        ...
        >>> import matplotlib.pyplot as plt
        >>> from masurvival.datasets import load_aids
        >>> from masurvival.nonparametric import nelson_aalen_estimator
        >>>
...
def cumulative_incidence_competing_risks(
    ...
    .. plot::
        ...
        >>> import matplotlib.pyplot as plt
        >>> from masurvival.datasets import load_bmt
        >>> from masurvival.nonparametric import cumulative_incidence_competing_risks
        >>>
        >>> dis, bmt_df = load_bmt()
        >>> event = bmt_df["status"]
        >>> time = bmt_df["ftime"]
