...
class clean(Command):
    ...
    def initialize_options(self):
        ...
        for root, dirs, files in os.walk("masurvival"):
            root = Path(root)
            for d in dirs:
                if d == "__pycache__":
...
EXTENSIONS = {
    "_binarytrees": {
        "sources": ["masurvival/bintrees/_binarytrees.pyx", "masurvival/bintrees/binarytrees.cpp"],
        "language": "c++",
    },
    "_clinical_kernel": {"sources": ["masurvival/kernels/_clinical_kernel.pyx"]},
    "_coxph_loss": {"sources": ["masurvival/ensemble/_coxph_loss.pyx"]},
    "_prsvm": {"sources": ["masurvival/svm/_prsvm.pyx"]},
    "_minlip": {"sources": ["masurvival/svm/_minlip.pyx"]},
    "_criterion": {"sources": ["masurvival/tree/_criterion.pyx"]},
    "_splitter": {"sources": ["masurvival/tree/_splitter.pyx"]},
    "_tree": {
    ...
    "_coxnet": {
        ...
        "language": "c++",
        "include_dirs": ["masurvival/linear_model/src", "masurvival/linear_model/src/eigen"],
