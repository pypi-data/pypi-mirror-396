...
def test_metaclass_cache_with_enum_member_instance() -> None:
    LazyAttr._cached.clear()
    if TYPE_CHECKING:
        from tests.fixture_lazy_attr import color_red as red1  # noqa: PLC0415
    else:
    ...
    from tests.fixture_lazy_attr import color_red as real_red  # noqa: PLC0415
...
def test_isinstance_and_issubclass_with_lazyattr_wrapper() -> None:
    if TYPE_CHECKING:
        from collections import OrderedDict as OrderedDictAttr  # noqa: PLC0415
    else:
...
def test_descriptor_protocol_delegates_to_wrapped_value() -> None:
    if TYPE_CHECKING:
        from tests.fixture_lazy_attr import descriptor as desc_attr  # noqa: PLC0415
    else:
