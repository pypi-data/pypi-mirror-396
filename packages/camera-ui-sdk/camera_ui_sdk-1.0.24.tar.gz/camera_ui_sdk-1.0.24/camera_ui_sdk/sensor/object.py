...
class ObjectDetectorSensor(ObjectSensor[TStorage], Generic[TStorage]):
    ...
    Set `inputProperties` to specify the required input format (can be set
    dynamically after model is loaded).
    ...
    Example:
        ...
        class CoreMLObjectDetector(ObjectDetectorSensor):
            async def initialize(self):
                ...
                # Set input properties after model is loaded
                self.inputProperties = {"width": 640, "height": 640, "format": "rgb"}
    ...
    def inputProperties(self) -> VideoInputProperties | None:
        ...
        Returns None if not yet set (e.g., before model is loaded).
        """
    ...
    def inputProperties(self, value: VideoInputProperties | None) -> None:
        ...
        Changes are automatically propagated to the backend.
        """
