...
class AudioDetectorSensorLike(AudioSensorLike, Protocol):
    ...
    @property
    def inputProperties(self) -> AudioInputProperties | None:
        """Required input audio properties (None if not yet set)."""
        ...
...
class AudioDetectorSensor(AudioSensor[TStorage], Generic[TStorage]):
    ...
    Example:
        ...
        class GlassBreakDetector(AudioDetectorSensor):
            def __init__(self):
                super().__init__("Glass Break Detector")
                self.inputProperties = {"sampleRate": 16000, "channels": 1, "format": "pcm16"}
    ...
    _input_properties: AudioInputProperties | None = None
    ...
    def inputProperties(self, value: AudioInputProperties | None) -> None:
