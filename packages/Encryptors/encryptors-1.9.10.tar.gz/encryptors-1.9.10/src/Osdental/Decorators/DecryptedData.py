...
from Osdental.Exception.ControlledException import (
    UnauthorizedException, ProfilePermissionDeniedException, 
...
async def validate_token(id_token: str, id_user: str, id_external_enterprise: str, id_tenant: str):
    ...
    if res.status != "DB_0004":
        raise OSDException(error="An error occurred while consuming grpc to validate authorization token.")
