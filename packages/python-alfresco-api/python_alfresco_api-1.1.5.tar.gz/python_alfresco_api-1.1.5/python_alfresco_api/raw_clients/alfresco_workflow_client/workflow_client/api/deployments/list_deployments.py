...
from ...models.deployment_paging import DeploymentPaging
...
) -> Optional[Union[Any, DeploymentPaging]]:
    if response.status_code == 200:
        response_200 = DeploymentPaging.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, DeploymentPaging]]:
    return Response(
