...
'''
    ...
    spec_path = generate_spec(str(entry), datas, binaries, hid, outdir=args.out, onefile=args.onefile or config.get("onefile", False), windowed=args.windowed or config.get("windowed", False), runtime_hook_paths=runtime_hook_paths)
