...
def generate_spec(entry: str, datas: List[Tuple[str, str]], binaries: List[Tuple[str, str]], hiddenimports: List[str], outdir: str = "dist", onefile: bool = False, windowed: bool = False, runtime_hook_paths: List[str] | None = None) -> str:
