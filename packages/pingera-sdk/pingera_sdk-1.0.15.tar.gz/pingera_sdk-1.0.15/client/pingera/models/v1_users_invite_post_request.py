...
class V1UsersInvitePostRequest(BaseModel):
    """
    V1UsersInvitePostRequest
    """ # noqa: E501
    email: StrictStr = Field(description="Email address of user to invite")
    role: Optional[StrictStr] = Field(default='viewer', description="Role to assign to invited user")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V1UsersInvitePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V1UsersInvitePostRequest from a dict"""
        if obj is None:
            return None
