...
class OAuthUnlinkResponse(BaseModel):
    ...
    OAuthUnlinkResponse
    """ # noqa: E501
    success: Optional[StrictBool] = Field(default=None, description="Whether the account was successfully unlinked")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OAuthUnlinkResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OAuthUnlinkResponse from a dict"""
        if obj is None:
            return None
