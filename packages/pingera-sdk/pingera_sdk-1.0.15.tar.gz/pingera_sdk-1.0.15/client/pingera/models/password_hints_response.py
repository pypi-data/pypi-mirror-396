...
class PasswordHintsResponse(BaseModel):
    """
    PasswordHintsResponse
    """ # noqa: E501
    hints: Optional[List[PasswordHint]] = Field(default=None, description="List of available password hints")
    __properties: ClassVar[List[str]] = ["hints"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PasswordHintsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PasswordHintsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "hints": [PasswordHint.from_dict(_item) for _item in obj["hints"]] if obj.get("hints") is not None else None
        })
        return _obj
