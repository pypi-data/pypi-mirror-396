...
class OAuthProvidersResponse(BaseModel):
    ...
    """ # noqa: E501
    providers: Optional[List[OAuthProvider]] = Field(default=None, description="List of available OAuth providers")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "providers": [OAuthProvider.from_dict(_item) for _item in obj["providers"]] if obj.get("providers") is not None else None
        })
        return _obj
