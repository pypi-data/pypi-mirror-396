...
class V1RefreshPost200Response(BaseModel):
    """
    V1RefreshPost200Response
    """ # noqa: E501
    access_token: Optional[StrictStr] = Field(default=None, description="New JWT access token")
    refresh_token: Optional[StrictStr] = Field(default=None, description="New JWT refresh token")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V1RefreshPost200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V1RefreshPost200Response from a dict"""
        if obj is None:
            return None
