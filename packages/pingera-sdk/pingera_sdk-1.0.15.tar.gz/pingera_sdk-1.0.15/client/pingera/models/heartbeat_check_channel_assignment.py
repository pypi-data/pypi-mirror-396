...
class HeartbeatCheckChannelAssignment(BaseModel):
    """
    HeartbeatCheckChannelAssignment
    """ # noqa: E501
    channel_ids: Annotated[List[StrictStr], Field(min_length=1)] = Field(description="A list of alert channel IDs to assign to the heartbeat check.")
    __properties: ClassVar[List[str]] = ["channel_ids"]
