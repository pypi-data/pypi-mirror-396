...
class UsageApi:
    ...
    def v1_usage_get(
        ...
        Get user organization usage statistics
        ...
        _param = self._v1_usage_get_serialize(
    ...
    @validate_call
    def v1_usage_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def v1_usage_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
