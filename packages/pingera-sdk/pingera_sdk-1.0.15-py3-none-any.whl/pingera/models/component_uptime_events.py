...
class ComponentUptimeEvents(BaseModel):
    """
    ComponentUptimeEvents
    """ # noqa: E501
    id: Optional[List[StrictStr]] = Field(default=None, description="List of incident IDs that affected this component during the period")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ComponentUptimeEvents from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ComponentUptimeEvents from a dict"""
        if obj is None:
            return None
