...
class LinkedOAuthAccountsResponse(BaseModel):
    """
    LinkedOAuthAccountsResponse
    """ # noqa: E501
    accounts: Optional[List[LinkedOAuthAccount]] = Field(default=None, description="List of linked OAuth accounts")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LinkedOAuthAccountsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LinkedOAuthAccountsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "accounts": [LinkedOAuthAccount.from_dict(_item) for _item in obj["accounts"]] if obj.get("accounts") is not None else None
        })
        return _obj
