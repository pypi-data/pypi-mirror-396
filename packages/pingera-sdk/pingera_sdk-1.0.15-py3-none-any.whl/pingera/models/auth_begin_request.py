...
class AuthBeginRequest(BaseModel):
    ...
    AuthBeginRequest
    """ # noqa: E501
    user_id: Optional[StrictStr] = Field(default=None, description="Optional user ID to hint which user is trying to authenticate. Enables usernameless login if omitted.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AuthBeginRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AuthBeginRequest from a dict"""
        if obj is None:
            return None
