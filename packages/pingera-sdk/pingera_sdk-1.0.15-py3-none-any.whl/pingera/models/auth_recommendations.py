...
class AuthRecommendations(BaseModel):
    ...
    AuthRecommendations
    """ # noqa: E501
    recommendations: Optional[List[Dict[str, Any]]] = Field(default=None, description="List of authentication setup recommendations")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AuthRecommendations from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AuthRecommendations from a dict"""
        if obj is None:
            return None
