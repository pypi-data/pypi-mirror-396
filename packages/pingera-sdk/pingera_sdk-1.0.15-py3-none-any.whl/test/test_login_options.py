...
class TestLoginOptions(unittest.TestCase):
    """LoginOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LoginOptions:
        """Test LoginOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LoginOptions`
        """
        model = LoginOptions()
        if include_optional:
            return LoginOptions(
