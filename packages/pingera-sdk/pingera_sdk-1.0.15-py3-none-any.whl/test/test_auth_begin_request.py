...
class TestAuthBeginRequest(unittest.TestCase):
    """AuthBeginRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthBeginRequest:
        """Test AuthBeginRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthBeginRequest`
        """
        model = AuthBeginRequest()
        if include_optional:
            return AuthBeginRequest(
                user_id = 'user_2Xy...Z1a'
            )
        else:
            return AuthBeginRequest(
        )
