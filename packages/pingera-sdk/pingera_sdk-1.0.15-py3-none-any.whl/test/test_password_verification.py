...
class TestPasswordVerification(unittest.TestCase):
    """PasswordVerification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PasswordVerification:
        """Test PasswordVerification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PasswordVerification`
        """
