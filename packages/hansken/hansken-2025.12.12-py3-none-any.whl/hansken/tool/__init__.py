...
certificate_verification = parent.add_mutually_exclusive_group(required=False)
# add an argument to disable ssl/tls certificate verification
certificate_verification.add_argument(
    '--no-verify',
    dest='verify',
    action='store_false',
    default=True,
...
# add an argument to override what requests would do when verify=True, to force use of a particular (local) CA bundle
# (this should mimic setting REQUESTS_CA_BUNDLE to that same value)
certificate_verification.add_argument(
    '--ca-cert',
    dest='verify',
    metavar='CA_BUNDLE',
    default=True,
    help='path to a CA bundle to use, overriding defaults (use with caution)',
)
    ...
    **defaults,
    ...
    with resolve_logging(args):
        ...
        if not args.verify and not _disable_insecure_request_warning():
            ...
            log.warning('failed to disable InsecureRequestWarning in 3rd party package')
...
import hansken.tool.command_backup  # noqa: E402
import hansken.tool.command_export  # noqa: E402
import hansken.tool.command_extract  # noqa: E402
import hansken.tool.command_grant  # noqa: E402
import hansken.tool.command_import  # noqa: E402
import hansken.tool.command_mount  # noqa: E402
import hansken.tool.command_quickstart  # noqa: E402
import hansken.tool.command_shell  # noqa: E402
import hansken.tool.command_stats  # noqa: E402
import hansken.tool.command_tasks  # noqa: E402
import hansken.tool.command_tools  # noqa: E402
import hansken.tool.command_upload  # noqa: E402
import hansken.tool.command_versions  # noqa: E402
