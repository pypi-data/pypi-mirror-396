...
class Admin(Connection):
    ...
    def __init__(self, base_url_or_connection, keystore_url=None, auth=None, connection_pool_size=None, verify=None):
        ...
        super().__init__(
            base_url, keystore_url=keystore_url, auth=auth, connection_pool_size=connection_pool_size, verify=verify
        )

        warnings.warn(
            'hansken.admin.Admin has been deprecated, functionality is now available on '
            'hansken.remote.Connection object',
            DeprecationWarning,
        )
