...
from .client import AdaptableAgent, ContextConfig
    ...
    def __init__(
        ...
        Args:
            ...
            enable_adaptable_agents: If True, intercepts calls to fetch context and store memories.
                                   If False, passes calls directly through to the underlying OpenAI client.
        """
    ...
    def create(
        ...
        **kwargs,
        ...
        if context and user_input:
            enhanced_prompt = self.parent.adaptable_agent.format_prompt_with_context(
                user_input, context
            )
