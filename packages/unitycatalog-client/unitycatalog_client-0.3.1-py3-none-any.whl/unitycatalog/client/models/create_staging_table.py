...
class CreateStagingTable(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "catalog_name", "schema_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateStagingTable from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateStagingTable from a dict"""
        if obj is None:
            return None
