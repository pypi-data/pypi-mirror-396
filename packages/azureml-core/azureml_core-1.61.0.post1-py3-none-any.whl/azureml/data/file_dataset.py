...
# Error message constants - should match constants defined in Rust code
FILENAME_LENGTH_ERROR_MESSAGE = "exceeds the maximum allowed length"
...
class FileDataset(AbstractDataset):
    ...
    def mount(self, mount_point=None, **kwargs):
        ...
        try:
            ...
            trace_error(_logger, f"UserErrorException encountered: {str(e)}")
            raise e
