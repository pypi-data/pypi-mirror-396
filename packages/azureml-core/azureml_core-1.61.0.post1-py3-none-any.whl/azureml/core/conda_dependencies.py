...
PYTHON_DEFAULT_VERSION = '3.10.18'
...
class CondaDependencies(object):
    ...
    .. remarks::
        ...
        .. code-block:: python
            ...
            conda_dep.add_pip_package("pillow==9.2.0")
    ...
    def sdk_origin_url():
        ...
        :rtype: str
        """
        from azureml._project.project_manager import _get_formatted_index_url
        index = _get_formatted_index_url()
        if index:
            return index
        else:
