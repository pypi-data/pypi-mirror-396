...
project = "voraus logging library"
...
release = importlib_metadata.version("voraus-logging-lib")
...
htmlhelp_basename = "voraus_logging_libdoc"
...
latex_documents = [
    (
        "index",
        "voraus_logging_lib.tex",
        "voraus logging library Documentation",
