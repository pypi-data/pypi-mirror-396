...
from converter.formats.format_detector import FormatDetector
...
def info_command(input_path, verbose):
    ...
    try:
        ...
        detected_format = detector.detect_format(input_path)
        ...
        converter = engine._get_converter(detected_format)
