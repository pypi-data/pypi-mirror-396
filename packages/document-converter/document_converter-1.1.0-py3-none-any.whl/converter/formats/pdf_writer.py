...
class TextToPDFConverter(BaseConverter):
    ...
    def _convert_text(self, input_path: str, output_path: str) -> bool:
    ...
    def _convert_markdown(self, input_path: str, output_path: str) -> bool:
        ...
        try:
            ...
            logger.error("Markdown or BeautifulSoup not installed.")
            return False
    ...
    def validate_input(self, input_path: str) -> bool:
        ...
        return input_path.lower().endswith('.txt') or input_path.lower().endswith('.md')
