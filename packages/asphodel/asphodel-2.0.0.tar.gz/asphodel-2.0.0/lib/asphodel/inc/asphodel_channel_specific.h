...
ASPHODEL_API int asphodel_get_strain_bridge_count(const AsphodelChannelInfo_t *channel_info, int *bridge_count);
...
ASPHODEL_API int asphodel_get_strain_bridge_subchannel(const AsphodelChannelInfo_t *channel_info, int bridge_index,
...
ASPHODEL_API int asphodel_get_strain_bridge_values(const AsphodelChannelInfo_t *channel_info, int bridge_index,
		float *values);
...
ASPHODEL_API int asphodel_check_strain_resistances(const AsphodelChannelInfo_t *channel_info, int bridge_index,
...
ASPHODEL_API int asphodel_get_accel_self_test_limits(const AsphodelChannelInfo_t *channel_info, float *limits);
...
ASPHODEL_API int asphodel_check_accel_self_test(const AsphodelChannelInfo_t *channel_info, double *disabled,
