...
// Asphodel protocol version 3.0.0
// NOTE: use the functions in asphodel_version.h to access the protocol version
#define ASPHODEL_PROTOCOL_VERSION_MAJOR      0x03
#define ASPHODEL_PROTOCOL_VERSION_MINOR      0x00
...
#define CMD_GET_SETTING_CATEGORY_SETTINGS    0x68
...
#define UNIT_TYPE_VOLT_PER_VOLT              24 // volt per volt
// NOTE: remember to update asphodel_unit_type_name() implementation when adding more unit types
#define UNIT_TYPE_COUNT                      25 // note: use asphodel_get_unit_type_count() to get this number
