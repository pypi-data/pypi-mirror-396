...
pub extern fn sqlite3_bind_blob(?*sqlite3_stmt, c_int, ?*const anyopaque, n: c_int, ?*align(1) const fn (?*anyopaque) callconv(.c) void) c_int;
pub extern fn sqlite3_bind_blob64(?*sqlite3_stmt, c_int, ?*const anyopaque, sqlite3_uint64, ?*align(1) const fn (?*anyopaque) callconv(.c) void) c_int;
...
pub extern fn sqlite3_bind_text(?*sqlite3_stmt, c_int, [*c]const u8, c_int, ?*align(1) const fn (?*anyopaque) callconv(.c) void) c_int;
pub extern fn sqlite3_bind_text16(?*sqlite3_stmt, c_int, ?*const anyopaque, c_int, ?*align(1) const fn (?*anyopaque) callconv(.c) void) c_int;
pub extern fn sqlite3_bind_text64(?*sqlite3_stmt, c_int, [*c]const u8, sqlite3_uint64, ?*align(1) const fn (?*anyopaque) callconv(.c) void, encoding: u8) c_int;
...
pub const sqlite3_destructor_type = ?*align(1) const fn (?*anyopaque) callconv(.c) void; // JSN: modified to change alignment for SQLITE_TRANSIENT
pub extern fn sqlite3_result_blob(?*sqlite3_context, ?*const anyopaque, c_int, ?*align(1) const fn (?*anyopaque) callconv(.c) void) void;
pub extern fn sqlite3_result_blob64(?*sqlite3_context, ?*const anyopaque, sqlite3_uint64, ?*align(1) const fn (?*anyopaque) callconv(.c) void) void;
...
pub extern fn sqlite3_result_text(?*sqlite3_context, [*c]const u8, c_int, ?*align(1) const fn (?*anyopaque) callconv(.c) void) void;
pub extern fn sqlite3_result_text64(?*sqlite3_context, [*c]const u8, sqlite3_uint64, ?*align(1) const fn (?*anyopaque) callconv(.c) void, encoding: u8) void;
pub extern fn sqlite3_result_text16(?*sqlite3_context, ?*const anyopaque, c_int, ?*align(1) const fn (?*anyopaque) callconv(.c) void) void;
pub extern fn sqlite3_result_text16le(?*sqlite3_context, ?*const anyopaque, c_int, ?*align(1) const fn (?*anyopaque) callconv(.c) void) void;
pub extern fn sqlite3_result_text16be(?*sqlite3_context, ?*const anyopaque, c_int, ?*align(1) const fn (?*anyopaque) callconv(.c) void) void;
...
pub const SQLITE_THREADSAFE = @as(c_int, 1);
pub const SQLITE_OMIT_LOAD_EXTENSION = @as(c_int, 1);
pub const SQLITE_OMIT_DEPRECATED = @as(c_int, 1);
pub const SQLITE_DEFAULT_WAL_SYNCHRONOUS = @as(c_int, 1);
pub const SQLITE3_H = "";
...
// C:\Users\Jeff\AppData\Roaming\Code\User\globalStorage\ziglang.vscode-zig\zig\x86_64-windows-0.15.2\lib\include/__stdarg_va_arg.h:17:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`");
// C:\Users\Jeff\AppData\Roaming\Code\User\globalStorage\ziglang.vscode-zig\zig\x86_64-windows-0.15.2\lib\include/__stdarg_va_arg.h:19:9
pub const va_arg = @compileError("unable to translate C expr: unexpected token 'an identifier'");
// C:\Users\Jeff\AppData\Roaming\Code\User\globalStorage\ziglang.vscode-zig\zig\x86_64-windows-0.15.2\lib\include/__stdarg_va_arg.h:20:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`");
// C:\Users\Jeff\AppData\Roaming\Code\User\globalStorage\ziglang.vscode-zig\zig\x86_64-windows-0.15.2\lib\include/__stdarg___va_copy.h:11:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`");
// C:\Users\Jeff\AppData\Roaming\Code\User\globalStorage\ziglang.vscode-zig\zig\x86_64-windows-0.15.2\lib\include/__stdarg_va_copy.h:11:9
pub const SQLITE_EXTERN = @compileError("unable to translate C expr: unexpected token 'extern'");
// sqlite3/sqlite3.h:72:10
...
pub const SQLITE_VERSION_NUMBER = @import("std").zig.c_translation.promoteIntLiteral(c_int, 3050004, .decimal);
pub const SQLITE_SOURCE_ID = "2025-07-30 19:33:53 4d8adfb30e03f9cf27f800a2c1ba3c48fb4ca1b08b0f5ed59a4d5ecbf45e20a3";
