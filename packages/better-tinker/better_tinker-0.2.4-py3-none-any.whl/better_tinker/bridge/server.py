...
class TinkerClientManager:
    ...
    def get_client(self, api_key: str):
        ...
        # CRITICAL: Always set the environment variable before ANY Tinker SDK operation
        # The Tinker SDK reads this lazily when making API calls, not at client creation
