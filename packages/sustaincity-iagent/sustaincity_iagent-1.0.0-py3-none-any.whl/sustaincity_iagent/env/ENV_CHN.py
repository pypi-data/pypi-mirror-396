...
class MSWEnv(gym.Env):
    ...
    def load_params_from_excel(self, file_path):
        df = pd.read_excel(file_path, sheet_name='per_CHN', header=None)
        disposal_params = {
    ...
    def reset(self, *, seed=None, options=None):
        ...
        self.SSP4_CARBON_W = 100.0     
        self.SSP4_SLACK_W  = 0      

    
        self.SSP4_ENERGY_W   = 10.0   # total_energy_output
        self.SSP4_COST_W     = 200.0   
        self.SSP4_RESOURCE_W = 10.0   # total_resource_output
