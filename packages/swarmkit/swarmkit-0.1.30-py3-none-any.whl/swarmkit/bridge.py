...
class BridgeManager:
    ...
    async def start(self):
        ...
        # Drain stderr to avoid pipe backpressure and preserve frame integrity on stdout
        ...
        try:
            ...
            async def read_exact(n: int) -> Optional[bytes]:
                ...
                while remaining > 0:
                    chunk = await loop.run_in_executor(
                        None, self.process.stdout.read, remaining
                    )
                    if not chunk:
                        return None
                    chunks.append(chunk)
            ...
            while True:
                ...
                try:
                    ...
                    message = await loop.run_in_executor(None, json.loads, text)
                except Exception:
    ...
    async def _drain_stderr(self):
        """Drain bridge stderr to prevent blocking; stderr is not framed."""
