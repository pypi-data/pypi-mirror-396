...
# Stop service
launchctl unload ~/Library/LaunchAgents/com.problemli.nrd.plist

# Start service
launchctl load ~/Library/LaunchAgents/com.problemli.nrd.plist
...
### macOS (LaunchAgent)
- **Config file**: `~/Library/LaunchAgents/com.problemli.nrd.plist`
...
**macOS:**
Edit `~/Library/LaunchAgents/com.problemli.nrd.plist` and change the Python path in the `ProgramArguments` array.
...
- **macOS**:
  - `com.problemli.nrd.plist` - LaunchAgent configuration template
