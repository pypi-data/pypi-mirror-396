...
class Mod1IoType(u.AStructType):
    """Mod1 IO."""
...
class Mod1Mod(u.AConfigurableMod):
    """Mod1 Module."""
    ...
    def _build(self) -> None:
        ...
        self.add_port(Mod1IoType(), "mod1_i", route="create(u_core/mod1_i)", clkrel=u.ASYNC)
        ...
        core = Mod1CoreMod(parent=self, name="u_core")
