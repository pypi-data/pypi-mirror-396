...
class PdfDocumentInformation(SpireObject):
    ...
    def CreationDate(self, value: datetime):
        ...
        CallCFunction(GetDllLibPdf().PdfDocumentInformation_set_CreationDate,self.Ptr, DatetimeToPtr(value))
    ...
    def ModificationDate(self, value: datetime):
        ...
        CallCFunction(GetDllLibPdf().PdfDocumentInformation_set_ModificationDate,self.Ptr, DatetimeToPtr(value))
