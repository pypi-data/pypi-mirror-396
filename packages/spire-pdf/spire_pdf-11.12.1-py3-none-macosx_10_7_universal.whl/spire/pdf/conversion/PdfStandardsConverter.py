...
class PdfStandardsConverter (SpireObject) :
    ...
    def __init__(self, filePath:str,password:str):
        GetDllLibPdf().PdfStandardsConverter_CreatePdfStandardsConverterFP.argtypes=[c_wchar_p,c_wchar_p]
        GetDllLibPdf().PdfStandardsConverter_CreatePdfStandardsConverterFP.restype = c_void_p
        intPtr = CallCFunction(GetDllLibPdf().PdfStandardsConverter_CreatePdfStandardsConverterFP,filePath,password)
        super(PdfStandardsConverter, self).__init__(intPtr)
    ...
    def __init__(self, stream:Stream,password:str):
        ptrStream:c_void_p = stream.Ptr
        GetDllLibPdf().PdfStandardsConverter_CreatePdfStandardsConverterSP.argtypes=[c_void_p,c_wchar_p]
        GetDllLibPdf().PdfStandardsConverter_CreatePdfStandardsConverterSP.restype = c_void_p
        intPtr = CallCFunction(GetDllLibPdf().PdfStandardsConverter_CreatePdfStandardsConverterSP,ptrStream,password)
        super(PdfStandardsConverter, self).__init__(intPtr)
