...
class PdfEmbeddedFileSpecification(PdfFileSpecificationBase):
    ...
    def CreationDate(self, value: datetime):
        ...
        CallCFunction(GetDllLibPdf().PdfEmbeddedFileSpecification_set_CreationDate,self.Ptr, DatetimeToPtr(value))
    ...
    def ModificationDate(self, value:datetime):
        ...
        CallCFunction(GetDllLibPdf().PdfEmbeddedFileSpecification_set_ModificationDate,self.Ptr, DatetimeToPtr(value))
    ...
    def SetFieldValue(self, fieldName: str, fieldValue: datetime):
        ...
        CallCFunction(GetDllLibPdf().PdfEmbeddedFileSpecification_SetFieldValueFF,self.Ptr, fieldName, DatetimeToPtr(fieldValue))
