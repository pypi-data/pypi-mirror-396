...
class InboxLeadsJob(BaseBackgroundJob, ABC):
            ...
            if messages:
                ...
                if not user_contact:
                    ...
                    if cls._is_request_answered(messages, dedicated_bot.associated_user):
                        ...
                        cls.detect_unanswered_request(dedicated_bot, messages[0], sender_id, user)
    ...
    @classmethod
    def detect_unanswered_request(cls, dedicated_bot, message, sender_id, user: UserModel):
        message_request = MessageRequest.from_slack_response(dedicated_bot, message, sender_id)
