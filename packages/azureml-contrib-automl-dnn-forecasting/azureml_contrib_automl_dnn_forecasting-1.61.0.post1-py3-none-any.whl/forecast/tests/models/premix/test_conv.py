...
def test_premix_conv_config(input_channels, kernel_size, dilation, stride, output_channels):
    config = premix.ConvPremixConfig(
...
@pytest.mark.parametrize("input_channels", [-1, 0, 1])
@pytest.mark.parametrize("output_channels", [-1, 0, 1])
@pytest.mark.parametrize("kernel_size", [-1, 0, 1])
@pytest.mark.parametrize("dilation", [-1, 0, 1])
@pytest.mark.parametrize("stride", [-1, 0, 1])
def test_premix_conv_config_failure_invalid_input(input_channels, output_channels, kernel_size, dilation, stride):
    params = [input_channels, output_channels, kernel_size, dilation, stride]
