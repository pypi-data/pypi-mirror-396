...
@pytest.mark.parametrize(
    "cls,dates",
    [
        (feat.SecondOfMinuteFeaturizer, pd.date_range(start="1/1/2019", end="1/2/2019", freq="S")),
        (feat.MinuteOfHourFeaturizer, pd.date_range(start="1/1/2019", end="1/2/2019", freq="T")),
        (feat.HourOfDayFeaturizer, pd.date_range(start="1/1/2019", end="1/2/2019", freq="H")),
        # for day+ featurizers, include 2019 (non leap year) and 2020 (leap year)
        (feat.DayOfWeekFeaturizer, pd.date_range(start="1/1/2019", end="1/1/2021", freq="D")),
        (feat.DayOfMonthFeaturizer, pd.date_range(start="1/1/2019", end="1/1/2021", freq="D")),
        (feat.DayOfYearFeaturizer, pd.date_range(start="1/1/2019", end="1/1/2021", freq="D")),
        # Not every year has 53 weeks, expand the range to include one
        (feat.WeekOfYearFeaturizer, pd.date_range(start="1/1/2019", end="1/1/2022", freq="W")),
        (feat.MonthOfYearFeaturizer, pd.date_range(start="1/1/2019", end="1/1/2020", freq="M")),
        (feat.HolidayFeaturizer, pd.date_range(start="1/1/2019", end="1/1/2021", freq="D")),
    ],
)
