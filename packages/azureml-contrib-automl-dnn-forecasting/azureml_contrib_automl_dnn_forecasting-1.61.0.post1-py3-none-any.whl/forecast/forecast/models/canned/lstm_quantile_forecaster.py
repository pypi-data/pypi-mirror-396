...
def create_lstm_quantile_forecaster(
    input_channels: int,
    ...
    backbone_config = LSTMBackboneConfig(
        depth=depth,
        multilevel=ml.name,
    ...
    head_configs = [UnboundedScalarForecastHeadConfig(horizon, dropout=dropout_rate) for _ in range(num_quantiles)]
