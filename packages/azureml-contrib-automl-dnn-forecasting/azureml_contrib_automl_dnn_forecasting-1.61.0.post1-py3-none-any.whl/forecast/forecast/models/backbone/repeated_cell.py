...
class RepeatedCellBackbone(AbstractBackbone):
    ...
    def __init__(self, config: RepeatedCellBackboneConfig, channels: int):
        ...
        if rep_mode == RepeatMode.OUTER:
            ...
            for _ in range(self.depth):
                ...
                for arch in archs:
                    cell_list.append(arch.create_cell(channels, prev_cells))
...
class RepeatedCellBackboneConfig(AbstractBackboneConfig):
    ...
    def create_backbone(self, input_channels: int) -> RepeatedCellBackbone:
        """Creates a backbone of width `input_channels`.
        ...
        return RepeatedCellBackbone(self, input_channels)
