...
class LSTMBackbone(AbstractBackbone, StatefulModule):
    ...
    def __init__(self, config: LSTMBackboneConfig, channels: int):
    ...
    def export_state(self) -> dict:
        ...
        return {"h": self._retained_state[0], "c": self._retained_state[1]}
...
class LSTMBackboneConfig(AbstractBackboneConfig):
    ...
    def create_backbone(self, input_channels: int) -> LSTMBackbone:
        ...
        """
        return LSTMBackbone(self, input_channels)
