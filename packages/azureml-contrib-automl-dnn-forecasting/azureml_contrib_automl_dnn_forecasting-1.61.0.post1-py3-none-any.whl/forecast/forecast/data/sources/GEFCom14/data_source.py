...
class GEFCom14DataSource(AbstractDataSource):
    ...
    def get_config(self) -> DataSourceConfig:
        ...
        return DataSourceConfig(
            feature_channels=1 + num_date_features, forecast_channels=1, encodings=encodings  # temp + date features
        )
    ...
    def batch_transform(self) -> bt.BatchTransform:
        ...
        return bt.GenericBatchTransform(
            ...
            normalizer=bt.BatchNormalizer(
                past_regressor=tnorm,
                past_regressand=lnorm,
                future_regressor=tnorm,
                future_regressand=lnorm,
            ),
