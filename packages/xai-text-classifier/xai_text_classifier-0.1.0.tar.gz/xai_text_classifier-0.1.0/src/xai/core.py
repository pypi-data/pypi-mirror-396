...
from src.xai.utils import get_features_from_text

@dataclass
class XAI:
    xgb_model = joblib.load(r'src\xai\XGB_model.joblib')
    rf_model = joblib.load(r'src\xai\RF_model.joblib')
    data = pd.read_csv(r'src\xai\coling.csv')
