...
class U3dImage(aspose.cad.Image):
    ...
    def get_logical_models_tree(self) -> str:
        ...
    ...
    @property
    def collections(self) -> aspose.cad.fileformats.u3d.helpers.U3dCollections:
        '''Useful collections for simplification of iterating through U3D data.'''
        ...
