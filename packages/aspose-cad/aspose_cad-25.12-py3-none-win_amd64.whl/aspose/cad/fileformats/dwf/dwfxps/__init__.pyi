...
class DwfPageEPlotXps(aspose.cad.fileformats.dwf.eplotinterface.DwfPageEPlot):
    ...
    @property
    def real_world_units(self) -> str:
        ...
    
    @property
    def real_world_max_point(self) -> aspose.cad.fileformats.cad.cadobjects.Cad3DPoint:
        ...
    
    @property
    def draw_objects_in_real_world_coordinates(self) -> List[aspose.cad.fileformats.dwf.whip.objects.drawable.DwfWhipDrawable]:
        ...
    
    @property
    def real_world_min_point(self) -> aspose.cad.fileformats.cad.cadobjects.Cad3DPoint:
        ...
    
    @property
    def real_world_coordinates_rotation(self) -> float:
        ...
