...
async def merge_transform(
    ...
    class RefactoredCode(BaseModel):
        """Python code refactored as per the instructions."""
...
"""
    ...
    res: RefactoredCode = await llm.with_structured_output(RefactoredCode).ainvoke(msgs)
    return res.refactored_code
