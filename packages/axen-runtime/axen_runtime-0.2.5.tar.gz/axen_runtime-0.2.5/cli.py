...
# Configuration
DEFAULT_API_URL = os.getenv("AGENT_PLATFORM_URL", "https://agent-runner-production-f78a.up.railway.app")
DEFAULT_FRONTEND_URL = os.getenv("AGENT_PLATFORM_FRONTEND_URL", "https://axen-runner.vercel.app")
...
EXCLUDE_PATTERNS = {
    ...
    ".venv",
    "env",
    # Note: .env files ARE included in deployment (for user API keys)
    ".git",
    ".gitignore",
    "__pycache__",
    "*.pyc",
...
def deploy(
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            agent_url = f"{DEFAULT_FRONTEND_URL}/chat/{deployment_id}"
