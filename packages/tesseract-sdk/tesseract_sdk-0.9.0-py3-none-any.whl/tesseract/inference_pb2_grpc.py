...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in tesseract.inference_pb2_grpc.py depends on'
...
def add_InferenceServiceV1Servicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('workerv1.InferenceServiceV1', rpc_method_handlers)
