...
class ContainerContainerPullThroughDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["no_content_change_since", "pulp_created", "hidden", "repository", "base_path", "pulp_last_updated", "pulp_href", "name", "content_guard", "pulp_labels", "prn", "remote", "distributions", "namespace", "private", "description"]
