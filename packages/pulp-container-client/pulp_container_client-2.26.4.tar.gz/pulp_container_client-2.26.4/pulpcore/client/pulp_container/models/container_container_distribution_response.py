...
class ContainerContainerDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_last_updated", "content_guard", "name", "prn", "no_content_change_since", "hidden", "repository", "pulp_href", "pulp_labels", "base_path", "pulp_created", "repository_version", "registry_path", "remote", "namespace", "private", "description"]
