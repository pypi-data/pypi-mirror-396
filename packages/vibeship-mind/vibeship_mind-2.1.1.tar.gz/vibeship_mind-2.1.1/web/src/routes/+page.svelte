...
<section class="get-started-cta">
	...
	<div class="install-steps">
		...
		<div class="install-step">
			...
			<div class="install-preview">
				<button class="copy-btn" onclick={(e) => { navigator.clipboard.writeText('mind init'); e.currentTarget.textContent = 'Copied!'; setTimeout(() => e.currentTarget.textContent = 'Copy', 2000); }}>Copy</button>
				<code>mind init</code>
			</div>
		...
		<div class="install-step">
			...
			<div class="install-preview prompt-style">
				<button class="copy-btn" onclick={(e) => { navigator.clipboard.writeText('Add Mind MCP server to my config. Use command "mind" with args ["mcp"]'); e.currentTarget.textContent = 'Copied!'; setTimeout(() => e.currentTarget.textContent = 'Copy', 2000); }}>Copy</button>
				<p class="prompt-text">Add Mind MCP server to my config. Use command "mind" with args ["mcp"]</p>
			</div>
