...
from netorchestr.envir.node.controller.mano.solver_deploy.solver_deploy_gatdrl_v1.train_env_net import TrainEnvPNet, TrainEnvVNet
...
class TrainEnv:
    ...
    def __get_p_net_obs(self):
        ...
        node_features = []
        node_features.append(self.p_net.get_all_nodes_attrs_values('remain_cpu'))               #1
        node_features.append(self.p_net.get_all_nodes_attrs_values('capacity_cpu'))             #2
        node_features.append(self.p_net.get_all_nodes_attrs_values('remain_ram'))               #3
        node_features.append(self.p_net.get_all_nodes_attrs_values('capacity_ram'))             #4
        # node_features.append(self.p_net.get_all_nodes_attrs_values('remain_rom'))               #5
        # node_features.append(self.p_net.get_all_nodes_attrs_values('capacity_rom'))             #6
        node_features.append(self.p_net.get_all_nodes_aggrlinks_attrs_values('remain_band'))    #7
        node_features.append(self.p_net.get_all_nodes_aggrlinks_attrs_values('capacity_band'))  #8
    ...
    def __get_v_net_obs(self):
        ...
        """
        node_features = []
        node_features.append(self.v_net.get_all_nodes_attrs_values('request_cpu'))   #1
        node_features.append(self.v_net.get_all_nodes_attrs_values('request_ram'))   #2
        # node_features.append(self.v_net.get_all_nodes_attrs_values('request_rom'))   #3
        node_features.append(self.v_net.get_all_nodes_aggrlinks_attrs_values("request_band"))  #4
