...
# -*- coding: utf-8 -*-
'''
solver_deploy_gatdrl_melt_gat.py
================================
...
from netorchestr.envir.node.controller.mano.solver_deploy.solver_deploy_gatdrl_melt_gat.train_env import TrainEnv, TrainSolution
from netorchestr.envir.node.controller.mano.solver_deploy.solver_deploy_gatdrl_melt_gat.train_net import ActorCritic, apply_mask_to_logit
from netorchestr.envir.node.controller.mano.solver_deploy.solver_deploy_gatdrl_melt_gat.buffer import RolloutBuffer
from netorchestr.envir.node.controller.mano.solver_deploy.solver_deploy_gatdrl_melt_gat.train_tracer import SolverTracer
...
class SolverDeployGatDrlMeltGat(SolverDeployBase):
    """基于 GAT (图注意力网络) 的 SFC 编排求解器模块消融 GAT 实验"""
