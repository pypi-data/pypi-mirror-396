...
async def generate(request: ImageRequest, api_key: Optional[str] = None, base_url: Optional[str] = None, ):
    ...
    if request.image:
        if 'qwen-image' in request.model.lower():
            request.model = "juyunapi/Qwen-Image-Edit-2509" # todo
...
if __name__ == '__main__':
    ...
    request = ImageRequest(
        ...
        image="https://modelscope.oss-cn-beijing.aliyuncs.com/model_depot/Qwen/Qwen-Image-Edit-2509/images/cat.png",
    )
