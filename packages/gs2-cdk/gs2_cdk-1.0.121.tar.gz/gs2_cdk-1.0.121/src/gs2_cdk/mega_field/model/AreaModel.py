...
from .options.AreaModelOptions import AreaModelOptions
...
class AreaModel:
    ...
    def __init__(
        self,
        name: str,
        options: Optional[AreaModelOptions] = AreaModelOptions(),
    ):
        self.name = name
    ...
    def properties(
        ...
        if self.layer_models is not None:
            properties["layerModels"] = [
                v.properties(
                )
                for v in self.layer_models
            ]
