...
#ifndef EN_DTYPES_UFUNCS_H_
#define EN_DTYPES_UFUNCS_H_
...
template <typename T>
struct SignMask {
    static constexpr BitsType<T> value = BitsType<T>(1) << (sizeof(BitsType<T>) * CHAR_BIT - 1);
};

template <>
struct SignMask<float4_e2m1> {
    static constexpr BitsType<float4_e2m1> value = 0b0000'1000;
};

template <>
struct SignMask<float4_e1m2> {
    static constexpr BitsType<float4_e1m2> value = 0b0000'1000;
};

template <>
struct SignMask<float6_e2m3> {
    static constexpr BitsType<float6_e2m3> value = 0b00'1'00'000;
};

template <>
struct SignMask<float6_e3m2> {
    static constexpr BitsType<float6_e3m2> value = 0b00'1'000'00;
};

template <>
struct SignMask<float8_e8m0> {
    static constexpr BitsType<float8_e8m0> value = 0b0000'0000;
};
...
std::pair<BitsType<T>, BitsType<T>> SignAndMagnitude(T x) {
  ...
  constexpr BitsType<T> kSignMask = SignMask<T>::value;
