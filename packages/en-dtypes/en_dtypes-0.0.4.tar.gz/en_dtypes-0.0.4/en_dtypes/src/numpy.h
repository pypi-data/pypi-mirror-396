...
#ifndef EN_DTYPES__NUMPY_H_
#define EN_DTYPES__NUMPY_H_
...
// We import_array in the en_dtypes init function only.
#define PY_ARRAY_UNIQUE_SYMBOL _en_dtypes_numpy_api
#ifndef EN_DTYPES_IMPORT_NUMPY
