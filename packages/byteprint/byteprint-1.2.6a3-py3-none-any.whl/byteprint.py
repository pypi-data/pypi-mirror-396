...
from typing import Any as _Any, List as _List, Union as _Union
    ...
    if inp is None:
        ...
        while True:
            try:
                ...
                if a == "exit":
                    break
                _run("还未做完，请使用exit退出 / You haven't finished it yet, please use 'exit' to exit")
        ...
        _run("还未做完，期待更新！ / Not finished yet, looking forward to the update!")
    else:
