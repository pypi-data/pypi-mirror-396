#!/usr/bin/env python3
"""Advanced TOML examples demonstrating complex configurations.

This example shows:
1. Multi-environment configuration (dev/staging/prod)
2. Array and table handling
3. Type preservation (integers, booleans, etc.)
...
def example_multi_environment():
    """Demonstrate multi-environment configuration with TOML."""
    ...
    if not manager.has_config("environments"):
        ...
        print("✓ Created environments.toml\n")
...
def example_type_handling():
    """Demonstrate TOML type handling."""
    print_section("Example 3: Type Handling in TOML")
    ...
    print("TOML preserves data types automatically:\n")
...
def main():
    """Run all examples."""
    print("\n" + "=" * 70)
    print("  VaultConfig TOML Advanced Examples")
    print("=" * 70)
