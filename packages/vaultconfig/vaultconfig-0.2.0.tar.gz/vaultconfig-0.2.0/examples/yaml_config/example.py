#!/usr/bin/env python3
"""Complete example demonstrating vaultconfig with YAML format.

This example demonstrates:
1. Loading and reading valid YAML configuration
...
def example_valid_config():
    ...
    # Initialize config manager with YAML format
...
def example_nested_config():
    """Example 4: Demonstrate nested YAML configuration."""
...
def main():
    """Run all examples."""
    print("\n" + "=" * 60)
    print("  VaultConfig YAML Format Examples")
    print("=" * 60)
