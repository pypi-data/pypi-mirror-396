...
class LicenseProvider(SpireObject):
    ...
    def _SetLicense(licenseFile:str):
        ...
        """
        GetDllLibOcr().LicenseProvider_SetLicenseFileFullPath.argtypes=[ c_wchar_p]
        CallCFunction(GetDllLibOcr().LicenseProvider_SetLicenseFileFullPath, licenseFile)
    ...
    def _SetLicense(licenseFile:Stream):
        ...
        GetDllLibOcr().LicenseProvider_SetLicenseFileStream.argtypes=[ c_void_p]
        CallCFunction(GetDllLibOcr().LicenseProvider_SetLicenseFileStream, intPtrstream)
    ...
    #    """
    #    GetDllLibOcr().SetLicenseFileFullPath.argtypes=[ c_wchar_p]
    #    CallCFunction(GetDllLibOcr().SetLicenseFileFullPath, licenseFileFullPath)
    ...
    def SetLicenseFileName(licenseFileName:str):
        ...
        """
        GetDllLibOcr().LicenseProvider_SetLicenseFileName.argtypes=[ c_wchar_p]
        CallCFunction(GetDllLibOcr().LicenseProvider_SetLicenseFileName, licenseFileName)
  ...
  #      GetDllLibOcr().SetLicenseFileStream.argtypes=[ c_void_p]
  #      CallCFunction(GetDllLibOcr().SetLicenseFileStream, intPtrstream)
    ...
    def SetLicenseKey(*args, **kwargs):
        ...
        if len(args) == 1:
            keyStr = args[0]
            GetDllLibOcr().LicenseProvider_SetLicenseKey.argtypes=[c_wchar_p]
            CallCFunction(GetDllLibOcr().LicenseProvider_SetLicenseKey, keyStr)
        elif len(args) == 2:
            keyStr = args[0]
            useDevOrTestLicense = args[1]
            GetDllLibOcr().LicenseProvider_SetLicenseKeyUseDevOrTestLicense.argtypes=[c_wchar_p, c_bool]
            CallCFunction(GetDllLibOcr().LicenseProvider_SetLicenseKeyUseDevOrTestLicense, keyStr, useDevOrTestLicense)
    ...
    #    """
    #    GetDllLibOcr().SetLicenseKey.argtypes=[ c_void_p]
    #    CallCFunction(GetDllLibOcr().SetLicenseKey, key)
    ...
    #    """
    #    GetDllLibOcr().SetLicenseKeyUseDevOrTestLicense.argtypes=[ c_wchar_p,c_bool]
    #    CallCFunction(GetDllLibOcr().SetLicenseKeyUseDevOrTestLicense, key,useDevOrTestLicense)
    ...
    def UnbindDevelopmentOrTestingLicenses()->bool:
        ...
        """
        GetDllLibOcr().LicenseProvider_UnbindDevelopmentOrTestingLicenses.restype=c_bool
        ret = CallCFunction(GetDllLibOcr().LicenseProvider_UnbindDevelopmentOrTestingLicenses)
        return ret
    ...
    def ClearLicense():
        ...
        """
        CallCFunction(GetDllLibOcr().LicenseProvider_ClearLicense)
    ...
    def LoadLicense():
        ...
        """
        CallCFunction(GetDllLibOcr().LicenseProvider_LoadLicense)
