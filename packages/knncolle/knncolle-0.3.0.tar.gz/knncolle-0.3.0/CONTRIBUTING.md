...
Welcome to `knncolle` contributor's guide.
...
If you experience bugs or general issues with `knncolle`, please have a look
...
You can help improve `knncolle` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`knncolle` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `knncolle`'s files. While this mechanism can
...
```
conda create -n knncolle python=3 six virtualenv pytest pytest-cov
conda activate knncolle
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/knncolle.git
   cd knncolle
   ```
...
5. Install [pre-commit]:
   ...
   `knncolle` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/knncolle/knncolle-py
[issue tracker]: https://github.com/knncolle/knncolle-py/issues
