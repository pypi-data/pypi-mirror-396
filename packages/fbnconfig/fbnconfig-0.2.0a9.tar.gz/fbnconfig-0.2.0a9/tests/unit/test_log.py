...
class DescribeSetup:
    ...
    def test_setup_from_scratch(self, respx_mock, capsys):
        ...
        respx_mock.get("/api/api/customentitytypes/~deployment").mock(
        ...
        assert json.loads(entity.content)["entityTypeName"] == "deployment"
    ...
    def test_setup_when_entity_exists_with_different_fields(self, respx_mock, test_input):
        ...
        respx_mock.put("/api/api/customentitytypes/~deployment").mock(
        ...
        assert entity.url == f"{self.base_url}/api/api/customentitytypes/~deployment"
...
class DescribeList:
    ...
    def test_get_returns_resource(self, respx_mock):
        ...
        respx_mock.get("/api/api/customentities/~deployment", params={"filter": filter}).mock(
    ...
    def test_remove_replaces_slashes_url(self, respx_mock, deployment_id, resource_id):
        ...
        respx_mock.delete(
            f"/api/api/customentities/~deployment/resource/{identifier}",
        ...
        request = respx_mock.calls.last.request
        assert request.url.path == f"/api/api/customentities/~deployment/resource/{identifier}"
