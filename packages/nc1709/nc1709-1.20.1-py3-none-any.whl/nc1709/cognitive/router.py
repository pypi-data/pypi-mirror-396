...
Respond with JSON only, no other text.'''
    ...
    async def _call_llm(self, prompt: str) -> str:
        ...
        if hasattr(self.llm, 'complete_async'):
            ...
            # Sync fallback - use simple complete without model override
            # The router's job is to DECIDE the model, not to force it here
...
class IntelligentRouter:
    ...
    MODEL_MAPPING = {
        ...
        TaskCategory.EXPLANATION: "ollama/qwen2.5:7b",
        TaskCategory.DOCUMENTATION: "ollama/qwen2.5:7b",
        TaskCategory.CODE_REVIEW: "ollama/qwen2.5:7b",

        # Operations → Qwen2.5 (7B for speed)
        TaskCategory.DEVOPS: "ollama/qwen2.5:7b",
        TaskCategory.DATABASE: "ollama/qwen2.5:7b",
        TaskCategory.FILE_OPERATIONS: "ollama/qwen2.5:7b",
        TaskCategory.COMMAND_EXECUTION: "ollama/qwen2.5:7b",
        TaskCategory.GIT_OPERATIONS: "ollama/qwen2.5:7b",
        TaskCategory.PROJECT_SETUP: "ollama/qwen2.5:7b",
    ...
    FALLBACK_CHAIN = {
        ...
        "ollama/qwen2.5-coder:7b": "ollama/qwen2.5:7b",
    ...
    async def route(
        ...
        primary_model = model_mapping.get(
            ...
            "ollama/qwen2.5:7b" if not self.smart_mode else "ollama/qwen2.5:32b"
        )
