...
class AICatalog:
    ...
    def get_llm(self, model_info: sch.ModelInfo) -> LLM:
    ...
    def get_settings(self, llm: LLM, embedding_model_info: sch.AzureModelInfo) -> Settings:
    ...
    def get_aws_llm(self, model_info: sch.AWSModelInfo) -> LLM:
        assert model_info.endpoint_info, "Missing endpoint info - the pydantic schema should be validating this"
    ...
    def get_azure_llm(self, model_info: sch.AzureModelInfo) -> LLM:
        assert model_info.endpoint_info, "Missing endpoint info - the pydantic schema should be validating this"
        return AzureOpenAI(
