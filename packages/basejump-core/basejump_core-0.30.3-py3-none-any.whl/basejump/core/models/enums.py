...
class RedisDeployRegion(StrEnum):
    AZURE_OPENAI_GPT4oMINI_DEPLOYMENTS = "azure_openai_gpt4omini_deployments"
    AZURE_OPENAI_GPT4o_DEPLOYMENTS = "azure_openai_deployments"
    # TODO: Remove the o in 41o
    AZURE_OPENAI_GPT41_DEPLOYMENTS = "azure_openai_gpt41o_deployments"
    AZURE_OPENAI_EMBEDDING_DEPLOYMENTS = "azure_openai_embedding3_deployments"
    AZURE_OPENAI_EMBEDDING_SMALL_DEPLOYMENTS = "azure_openai_embedding3small_deployments"
    AWS_SONNET35_DEPLOYMENTS = "aws_sonnet35_deployments"
    AWS_SONNET37_DEPLOYMENTS = "aws_sonnet37_deployments"
