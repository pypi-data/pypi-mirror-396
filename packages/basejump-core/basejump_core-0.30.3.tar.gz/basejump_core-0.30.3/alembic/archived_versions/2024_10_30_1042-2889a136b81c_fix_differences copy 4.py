...
def upgrade() -> None:
    ...
    op.drop_table("database_tables_migrate", schema="connect")
    op.drop_table("table_columns_migrate", schema="connect")
    op.drop_table("traffic_violations_p_hash_p1")
    op.drop_table("token_count_migrate", schema="ai_model")
    op.drop_table("prompt_history_migrate", schema="ai_model")
    op.drop_table("team_connection_migrate", schema="connect")
    op.drop_table("result_history_migrate", schema="ai_model")
    op.drop_table("table_connection_migrate", schema="connect")
    op.drop_table("deposit_history_migrate", schema="transaction")
    op.drop_table("basejump_credit_ledger_migrate", schema="transaction")
    op.drop_table("withdraw_history_migrate", schema="transaction")
    op.drop_table("traffic_violations_p_hash")
    op.drop_table("chat_history_migrate", schema="ai_model")
    op.drop_table("user_chat_id_migrate", schema="ai_model")
    op.alter_column(
        "chat_history",
        "msg_uuid",
    ...
    op.drop_constraint("token_count_client_id_prompt_id_fkey", "token_count", schema="ai_model", type_="foreignkey")
    ...
    op.drop_constraint("table_columns_client_id_fkey", "table_columns", schema="connect", type_="foreignkey")
    ...
    op.drop_constraint(
        "basejump_credit_ledger_client_id_fkey", "basejump_credit_ledger", schema="transaction", type_="foreignkey"
    )
    op.drop_constraint(
    ...
    op.drop_constraint("withdraw_history_client_id_fkey", "withdraw_history", schema="transaction", type_="foreignkey")
    op.drop_constraint(
        "withdraw_history_client_id_prompt_id_fkey", "withdraw_history", schema="transaction", type_="foreignkey"
    )
    op.create_foreign_key(
        None,
        "withdraw_history",
