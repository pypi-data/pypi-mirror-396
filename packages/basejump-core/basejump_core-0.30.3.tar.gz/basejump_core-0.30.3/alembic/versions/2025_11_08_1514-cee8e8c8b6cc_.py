...
Revision ID: cee8e8c8b6cc
Revises: 66c1f2e2b3a0
Create Date: 2025-11-08 15:14:55.242209
...
revision: str = "cee8e8c8b6cc"
down_revision: Union[str, None] = "66c1f2e2b3a0"
...
def upgrade() -> None:
    ...
    op.add_column("database", "ssl", schema="connect")
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column("database", "ssl", schema="connect")
