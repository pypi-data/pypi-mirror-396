"""adding chat_id col to result_hist

Revision ID: 341c15a2efbf
Revises: a4f56588b6bc
Create Date: 2024-12-05 15:58:28.334039
...
revision: str = "341c15a2efbf"
down_revision: Union[str, None] = "a4f56588b6bc"
...
def upgrade() -> None:
    ...
    op.add_column("result_history", sa.Column("chat_id", sa.Integer(), nullable=True), schema="ai_model")
...
def downgrade() -> None:
    ...
    op.drop_column("result_history", "chat_id", schema="ai_model")
    # ### end Alembic commands ###
