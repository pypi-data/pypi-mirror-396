"""add verified author user uuid

Revision ID: 6a94c1aa01e0
Revises: b56445dd4c44
Create Date: 2025-02-26 17:24:05.933439
...
revision: str = "6a94c1aa01e0"
down_revision: Union[str, None] = "b56445dd4c44"
...
def upgrade() -> None:
    ...
    op.add_column("result_history", sa.Column("verified_user_uuid", sa.Uuid(), nullable=True), schema="ai_model")
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column("result_history", "verified_user_uuid", schema="ai_model")
    from basejump.core.database.crud.crud_utils import gen_client_id_suffixes
    from basejump.core.database.db_connect import ConnectDB, conn_params_noasync
