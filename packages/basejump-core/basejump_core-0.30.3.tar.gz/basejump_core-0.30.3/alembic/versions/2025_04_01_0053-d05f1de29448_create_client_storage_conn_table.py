"""create client storage conn table

Revision ID: d05f1de29448
Revises: aceba79458bb
Create Date: 2025-04-01 00:53:18.263356
...
revision: str = "d05f1de29448"
down_revision: Union[str, None] = "a54848cd3690"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("storage_uuid", sa.UUID(), server_default=sa.text("gen_random_uuid()"), nullable=False),
        sa.Column("storage_id", sa.BigInteger(), sa.Identity(always=False), autoincrement=True, nullable=False),
        ...
        sa.Column("secret_access_key", sa.LargeBinary(), nullable=False),
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table("client_storage_conn", schema="connect")
    # ### end Alembic commands ###
