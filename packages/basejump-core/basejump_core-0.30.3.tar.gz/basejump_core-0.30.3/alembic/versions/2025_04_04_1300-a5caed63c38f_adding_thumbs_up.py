...
Revision ID: a5caed63c38f
Revises: 2111bc28e317
Create Date: 2025-04-04 13:00:47.352119
...
revision: str = "a5caed63c38f"
down_revision: Union[str, None] = "2111bc28e317"
...
def upgrade() -> None:
    ...
    op.add_column("chat_history", sa.Column("thumbs_up", sa.Boolean(), nullable=True), schema="ai_model")
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column("chat_history", "thumbs_up", schema="ai_model")
    # ### end Alembic commands ###
