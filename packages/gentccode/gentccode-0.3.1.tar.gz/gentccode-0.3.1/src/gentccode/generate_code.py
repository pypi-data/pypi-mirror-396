...
from gentccode.compose_code import ComposeCode
...
def generate_req_list_and_code_for_swagger2(
    ...
    req_model_list = api_parser.get_api_list_for_swagger(swagger2_dict)
    code_str = compose_code.generate_code_for_api_list(
        req_list=req_model_list, assert_list=assert_list_str
    )
