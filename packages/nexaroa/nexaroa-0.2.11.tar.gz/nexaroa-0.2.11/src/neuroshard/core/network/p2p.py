...
class P2PManager:
    ...
    def _announce_once(self, verbose: bool = True):
        ...
        # NOTE: Tracker announcements removed - use --seed-peers for DHT bootstrap instead
        # This is fully decentralized: nodes discover each other via DHT, not a central tracker
