...
def listWorkspaceCodingAgentConfigs(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, X_API_Key : Optional[Union[str,None]] = None) -> List[CodingAgentConfig]:
...
def getWorkspaceCodingAgentConfig(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, agent_type : CodingAgentType, X_API_Key : Optional[Union[str,None]] = None) -> CodingAgentConfig:
    api_config = api_config_override if api_config_override else APIConfig()
...
def upsertWorkspaceCodingAgentConfig(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, agent_type : CodingAgentType, data : CodingAgentConfigUpdate, X_API_Key : Optional[Union[str,None]] = None) -> CodingAgentConfig:
    api_config = api_config_override if api_config_override else APIConfig()
    ...
    return CodingAgentConfig(**body) if body is not None else CodingAgentConfig()
def deleteWorkspaceCodingAgentConfig(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, agent_type : CodingAgentType, X_API_Key : Optional[Union[str,None]] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
