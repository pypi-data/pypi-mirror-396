...
def listWorkspaces(api_config_override : Optional[APIConfig] = None, *, page : Optional[int] = None, per_page : Optional[int] = None, X_API_Key : Optional[Union[str,None]] = None) -> WorkspaceListResponse:
...
def createWorkspace(api_config_override : Optional[APIConfig] = None, *, data : CreateWorkspaceRequest, X_API_Key : Optional[Union[str,None]] = None) -> Workspace:
    api_config = api_config_override if api_config_override else APIConfig()
...
def getWorkspace(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, X_API_Key : Optional[Union[str,None]] = None) -> Workspace:
    api_config = api_config_override if api_config_override else APIConfig()
    ...
    return Workspace(**body) if body is not None else Workspace()
def deleteWorkspace(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, X_API_Key : Optional[Union[str,None]] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
def updateWorkspace(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, data : WorkspaceUpdate, X_API_Key : Optional[Union[str,None]] = None) -> Workspace:
    api_config = api_config_override if api_config_override else APIConfig()
