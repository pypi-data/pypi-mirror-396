...
async def bulkUpdateTasks(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, data : BulkUpdateTasksRequest, X_API_Key : Optional[Union[str,None]] = None) -> BulkUpdateTasksResponse:
...
async def createTask(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, data : CreateTaskRequest, X_API_Key : Optional[Union[str,None]] = None) -> Task:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def getTask(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, task_identifier : str, X_API_Key : Optional[Union[str,None]] = None) -> Task:
    api_config = api_config_override if api_config_override else APIConfig()
    ...
    return Task(**body) if body is not None else Task()
async def deleteTask(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, task_identifier : str, X_API_Key : Optional[Union[str,None]] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def updateTask(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, task_identifier : str, data : TaskUpdate, If_Match : Optional[Union[int,None]] = None, X_API_Key : Optional[Union[str,None]] = None) -> Task:
    api_config = api_config_override if api_config_override else APIConfig()
