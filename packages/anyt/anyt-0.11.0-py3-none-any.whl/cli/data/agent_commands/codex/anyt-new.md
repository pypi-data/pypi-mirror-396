...
**Usage:** `/anyt-new Add API endpoint for user comments with threading support`
...
- "Use `/anyt-work {ID}` to start working on a specific task"
- "Or use `/anyt-next` to auto-pick the next available task"
