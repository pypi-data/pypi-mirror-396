---
description: Work on a task using AnyTask cloud task management
...
**Tell the user:** "Task complete! Use `/clear` to clear context, then `/anyt-next` for the next task or `/anyt-work {ID}` for a specific task."
