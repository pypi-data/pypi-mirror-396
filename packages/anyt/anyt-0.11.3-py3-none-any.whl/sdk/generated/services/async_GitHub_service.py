...
async def getMyGitHubInstallation(api_config_override : Optional[APIConfig] = None, *, X_API_Key : Optional[Union[str,None]] = None) -> Union[GitHubInstallation,None]:
...
async def createGitHubInstallation(api_config_override : Optional[APIConfig] = None, *, data : CreateInstallationRequest, X_API_Key : Optional[Union[str,None]] = None) -> GitHubInstallation:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def deleteGitHubInstallation(api_config_override : Optional[APIConfig] = None, *, installation_db_id : int, X_API_Key : Optional[Union[str,None]] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def listInstallationRepos(api_config_override : Optional[APIConfig] = None, *, page : Optional[int] = None, per_page : Optional[int] = None, X_API_Key : Optional[Union[str,None]] = None) -> InstallationReposResponse:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def createGitHubRepository(api_config_override : Optional[APIConfig] = None, *, data : CreateRepositoryRequest, X_API_Key : Optional[Union[str,None]] = None) -> ExternalRepo:
    api_config = api_config_override if api_config_override else APIConfig()
