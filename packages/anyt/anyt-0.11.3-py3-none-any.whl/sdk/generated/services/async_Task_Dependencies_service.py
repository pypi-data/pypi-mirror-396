...
async def getTaskDependencies(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, task_identifier : str, X_API_Key : Optional[Union[str,None]] = None) -> List[DependencyTaskInfo]:
...
async def addTaskDependency(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, task_identifier : str, data : AddDependencyRequest, X_API_Key : Optional[Union[str,None]] = None) -> DependencyResponse:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def removeTaskDependency(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, task_identifier : str, depends_on_identifier : str, X_API_Key : Optional[Union[str,None]] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def getTaskDependents(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, task_identifier : str, X_API_Key : Optional[Union[str,None]] = None) -> List[DependencyTaskInfo]:
    api_config = api_config_override if api_config_override else APIConfig()
