...
def listProjects(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, page : Optional[int] = None, per_page : Optional[int] = None, status : Optional[Union[str,None]] = None, X_API_Key : Optional[Union[str,None]] = None) -> ProjectListResponse:
...
def createProject(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, data : CreateProjectRequest, X_API_Key : Optional[Union[str,None]] = None) -> Project:
    api_config = api_config_override if api_config_override else APIConfig()
...
def getProject(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, project_id : int, X_API_Key : Optional[Union[str,None]] = None) -> Project:
    api_config = api_config_override if api_config_override else APIConfig()
    ...
    return Project(**body) if body is not None else Project()
def deleteProject(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, project_id : int, X_API_Key : Optional[Union[str,None]] = None) -> ProjectDeleteResponse:
    api_config = api_config_override if api_config_override else APIConfig()
...
def updateProject(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, project_id : int, data : ProjectUpdate, X_API_Key : Optional[Union[str,None]] = None) -> Project:
    api_config = api_config_override if api_config_override else APIConfig()
    ...
    return Project(**body) if body is not None else Project()
def linkRepoToProject(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, project_id : int, data : LinkRepoRequest, X_API_Key : Optional[Union[str,None]] = None) -> Project:
    api_config = api_config_override if api_config_override else APIConfig()
    ...
    return Project(**body) if body is not None else Project()
def getProjectCloneInfoForUser(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, project_id : int, X_API_Key : Optional[Union[str,None]] = None) -> CloneInfo:
    api_config = api_config_override if api_config_override else APIConfig()
