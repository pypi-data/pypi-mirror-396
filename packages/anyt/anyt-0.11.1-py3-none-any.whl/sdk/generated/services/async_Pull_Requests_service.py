...
async def listTaskPullRequests(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, identifier : str, X_API_Key : Optional[Union[str,None]] = None) -> List[PullRequest]:
...
async def createTaskPullRequest(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, identifier : str, data : CreateTaskPRRequest, X_API_Key : Optional[Union[str,None]] = None) -> PullRequest:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def updateTaskPullRequest(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, identifier : str, pr_id : int, data : UpdatePRRequest, X_API_Key : Optional[Union[str,None]] = None) -> PullRequest:
    api_config = api_config_override if api_config_override else APIConfig()
