"""
Data loading utilities for TransJect examples.
...
# Dataset classes (self-contained, not importing from library)
...
class CustomDataset:
    """Custom dataset for language modeling or other tasks."""
    def __init__(self, inp, out):
        self.inp = inp
        self.out = out
