...
def _start_persistent_session(
    ...
    # Welcome message (like Claude Code) - clean and professional
    ...
    print("\n" + "="*60)
    print(f"Instinct8 Agent v{__version__}")
    print("="*60)
    ...
    print("  - Type 'stats' to see context usage")
    print("\n" + "="*60 + "\n")
