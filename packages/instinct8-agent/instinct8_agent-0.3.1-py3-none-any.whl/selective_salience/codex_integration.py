...
class Instinct8Agent:
    ...
    def _read_files_from_prompt(self, prompt: str) -> str:
        ...
        if any(phrase in prompt_lower for phrase in ["all files", "all the files", "review all", "look at all", "review the website", "review website", "current folder", "this folder"]):
