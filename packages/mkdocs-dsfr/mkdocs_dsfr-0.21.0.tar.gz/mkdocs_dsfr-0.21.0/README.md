...
dictionnaire avec des clés `name`, `url` et `icon` (optionnel). L'identifiant d'icône DSFR peut être trouvé sur la [page des icônes DSFR](https://www.systeme-de-design.gouv.fr/version-courante/fr/fondamentaux/icone#selection-d-icones). Par exemple, indiquer `arrow-left-line` pour afficher l'icône flèche gauche `fr-icon-arrow-left-line`.

### `logo_url`

URL relative ou absolue de l'image du logo à afficher dans l'en-tête. Par défaut, pas de logo.

### `logo_alt`

Texte alternatif pour l'image du logo dans l'en-tête. Par défaut, chaine vide "".
...
dictionnaire avec des clés `name` et `url` et `icon` (optionnel). L'identifiant d'icône DSFR peut être trouvé sur la [page des icônes DSFR](https://www.systeme-de-design.gouv.fr/version-courante/fr/fondamentaux/icone#selection-d-icones). Par exemple, indiquer `arrow-left-line` pour afficher l'icône flèche gauche `fr-icon-arrow-left-line`.
...
### Version 0.21.0 (DSFR 1.14.2)

* Ajout du logo dans l'en-tête
* Correction erreurs Sonarqube
* Correction lien page d'accueil dans l'en-tête'

### Version 0.20.0 (DSFR 1.14.2)

* Ajout des liens en en-tête de page
* Support des badges/tags multiples dans les cartes DSFR
* Support des icônes pour les liens en en-tête et pied de page
* Support du plugin [print-site](https://pypi.org/project/mkdocs-print-site-plugin/) à titre expérimental
* Correction bug sur les flux RSS
