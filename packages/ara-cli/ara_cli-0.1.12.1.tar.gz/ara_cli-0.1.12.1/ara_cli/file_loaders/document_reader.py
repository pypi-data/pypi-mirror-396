...
class DocumentReader(ABC):
    ...
    def save_and_describe_image(
        self, image_data: bytes, image_format: str, save_dir: str, image_counter: int
    ) -> Tuple[str, str]:
        """
...
class DocxReader(DocumentReader):
    ...
    def read(self, extract_images: bool = False) -> str:
        ...
        try:
            ...
            print(f"Warning: Could not extract or process an image from DOCX: {e}")
...
class PdfReader(DocumentReader):
    ...
    def read(self, extract_images: bool = False) -> str:
        ...
        try:
            ...
            print(f"Warning: Could not extract or process an image from PDF: {e}")
...
class DocumentReaderFactory:
    ...
    def create_reader(file_path: str) -> Optional[DocumentReader]:
        ...
        readers = {".docx": DocxReader, ".pdf": PdfReader, ".odt": OdtReader}
