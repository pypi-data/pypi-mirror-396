...
class DefinitionsSuitesGet200ResponseAllOfBodyInner(BaseModel):
    """
    DefinitionsSuitesGet200ResponseAllOfBodyInner
    """ # noqa: E501
    id: Optional[UUID] = Field(default=None, description="ID of suite.")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "contents", "setup", "benchmark_ids"]
