...
class Planner:
    ...
    def __init__(self, robot: Robot) -> None:
        ...
        Parameter ``robot``:
            The robot to plan the motions for.
        """
    def add_motion(self, motion: jacobi.BimanualMotion | jacobi.LinearMotion | jacobi.LowLevelMotion | jacobi.Motion | jacobi.PathFollowingMotion) -> None:
        """
        ...
        """
    def get_motion(self, name: str) -> jacobi.BimanualMotion | jacobi.LinearMotion | jacobi.LowLevelMotion | jacobi.Motion | jacobi.PathFollowingMotion:
        """
        ...
        """
    def load_motion_plan(self, file: os.PathLike | str | bytes) -> None:
        """
...
class Trainer:
    class Result:
        ...
        def loss(self) -> float:
            ...
    def __init__(self, environment: Environment, motion: Motion, max_number_waypoints: typing.SupportsInt) -> None:
        ...
    def calculate_motion_with_waypoints(self, start: Waypoint, goal: Waypoint, intermediate_positions: collections.abc.Sequence[collections.abc.Sequence[typing.SupportsFloat]]) -> Trainer.Result:
        ...
