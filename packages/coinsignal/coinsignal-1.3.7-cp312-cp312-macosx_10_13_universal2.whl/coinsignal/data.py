...
def read_data_to_features_map(data_dir, date, look_back_days, look_ahead_days, data_params_dict):
    return _data.read_data_to_features_map(data_dir, date, look_back_days, look_ahead_days, data_params_dict)

def transform_features_map_to_full_features_df(features_map):
    return _data.transform_features_map_to_full_features_df(features_map)