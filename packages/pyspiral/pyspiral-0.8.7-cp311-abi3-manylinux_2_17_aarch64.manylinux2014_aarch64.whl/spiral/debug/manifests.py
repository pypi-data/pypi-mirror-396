...
def display_scan_manifests(scan: Scan):
    ...
    display_manifests(key_space_manifest, column_group_manifests, scan.key_schema())
...
def _table_of_fragments(manifest: FragmentManifest, title: str, key_schema: Schema):
