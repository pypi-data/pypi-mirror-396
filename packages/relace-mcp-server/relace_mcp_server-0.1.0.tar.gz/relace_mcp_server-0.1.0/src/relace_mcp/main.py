...
async def relace_search(
    ...
    """Perform semantic search in the working directory using Relace's specialized
    agentic search model.

    Always prefer this tool for exploring a directory rather than directly calling your
    own tools.
    """
    ...
    async def _run_agent() -> None:
        try:
            ...
            agent_context = Context(
                ...
                toolbox_workdir=Path.cwd(),  # TODO: Make this configurable
                inputs={
                    "query": query,
                },
    ...
    try:
        ...
        async for event in event_stream:
            ...
            if isinstance(event, ToolEvent):
                ...
                logger.info("💭 Agent: %s", content_preview)
    except Exception as e:
        logger.error("Error processing events: %s", e, exc_info=True)
        raise
    finally:
