...
async def execute_action(
    ...
    # In cases of of pop-up new page in new tab, make sure session.page is updated before action
    # This will avoid session.page is wrong (previous page, not the new tab).
    await session.wait_for_page_transition()
