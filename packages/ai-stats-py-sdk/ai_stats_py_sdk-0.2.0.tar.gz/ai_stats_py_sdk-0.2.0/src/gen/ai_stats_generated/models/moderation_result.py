...
class ModerationResult(BaseModel):
    ...
    categories: Optional[ModerationCategories] = None
    category_scores: Optional[ModerationCategoryScores] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "categories": ModerationCategories.from_dict(obj["categories"]) if obj.get("categories") is not None else None,
            "category_scores": ModerationCategoryScores.from_dict(obj["category_scores"]) if obj.get("category_scores") is not None else None
        })
        return _obj
