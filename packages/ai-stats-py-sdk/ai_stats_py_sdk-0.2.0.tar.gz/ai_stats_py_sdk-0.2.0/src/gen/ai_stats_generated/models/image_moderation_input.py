...
class ImageModerationInput(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ImageModerationInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ImageModerationInput from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "image_url": ImageContentPartImageUrl.from_dict(obj["image_url"]) if obj.get("image_url") is not None else None
        })
        return _obj
