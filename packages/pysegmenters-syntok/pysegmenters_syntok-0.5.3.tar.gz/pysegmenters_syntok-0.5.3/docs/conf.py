...
import pysegmenters_pysdb


# -- Project information -----------------------------------------------------

project = "pysegmenters_pysdb"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pysegmenters_pysdb.__version__
release = pysegmenters_pysdb.__version__
...
apidoc_module_dir = os.path.dirname(pysegmenters_pysdb.__file__)
