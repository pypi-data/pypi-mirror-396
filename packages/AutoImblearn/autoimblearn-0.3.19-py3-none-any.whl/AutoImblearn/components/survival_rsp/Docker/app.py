...
class RunSurvivalResamplerAPI(BaseTransformerAPI):
    ...
    def fit(self, params, *args, **kwargs):
        ...
        event_col = getattr(params, "event_column", None) or getattr(params, "target_name", None) or "Status"
        time_col = getattr(params, "time_column", None) or "Survival_in_days"
        ...
        if 'X_train' in kwargs and 'y_train' in kwargs:
            ...
            if hasattr(y_train, "rename"):
                y_train = y_train.rename(columns={event_col: "Status", time_col: "Survival_in_days"})
        else:
