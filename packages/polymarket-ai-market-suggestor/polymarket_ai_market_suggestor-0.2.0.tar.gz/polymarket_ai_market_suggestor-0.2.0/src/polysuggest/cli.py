...
def suggest(
    ...
    count: int = typer.Option(3, "--count", help="Number of market suggestions to generate"),
...
@app.command()
def insights(limit: int = typer.Option(None, "--limit", help="Number of runs to consider")) -> None:
    """
