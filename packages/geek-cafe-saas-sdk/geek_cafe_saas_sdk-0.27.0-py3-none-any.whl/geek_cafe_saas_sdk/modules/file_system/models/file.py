...
class File(BaseTenantUserModel):
    ...
    def get_default_index_config(cls) -> Dict[str, IndexConfig]:
        ...
        return {
            ...
            "gsi6": IndexConfig(
                ...
                enabled=True,
                description="Files by virtual_path"
            ),
        }
    ...
    def __init__(self):
        ...
        self._status: str = "active"  # "active", "pending", "archived", "deleted"

        # state - Processing/operational state  
        self._state: str = "ready"  # "ready", "uploading", "processing", "validating", "converting", "failed"
