...
class DatabaseService(ABC, Generic[T]):
    ...
    def _get_model_resource_type(self, model: T) -> str:
        """
        Get the resource type name from a model.
        
        Uses model_name property if available, otherwise derives from class name.
    ...
    def _get_model_resource_name(self, model: T) -> str:
        ...
        for field in ['name', 'file_name', 'directory_name', 'title', 'display_name', 'email']:
