...
_CONNECTIONADDRESS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='id', full_name='core.api.ConnectionAddress.id', index=3,
...
_CUSTOMIZEDMESSAGE = _descriptor.Descriptor(
  name='CustomizedMessage',
  full_name='core.api.CustomizedMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='msg_type', full_name='core.api.CustomizedMessage.msg_type', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='msg_body', full_name='core.api.CustomizedMessage.msg_body', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['CustomizedMessage'] = _CUSTOMIZEDMESSAGE
...
CustomizedMessage = _reflection.GeneratedProtocolMessageType('CustomizedMessage', (_message.Message,), {
  'DESCRIPTOR' : _CUSTOMIZEDMESSAGE,
  '__module__' : 'gm.pb.common_pb2'
  # @@protoc_insertion_point(class_scope:core.api.CustomizedMessage)
  })
_sym_db.RegisterMessage(CustomizedMessage)
