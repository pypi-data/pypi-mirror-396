"""CLI for claudehooks - Delightful Claude Code hooks."""
...
HOOKS_TEMPLATE = '''\
"""Claude Code hooks."""
from claudehooks import HookApp, allow, deny
...
def version_callback(value: bool) -> None:
    ...
    if value:
        print("[green]claudehooks[/green] version: [bold]0.1.0[/bold]")
        raise typer.Exit()
...
def callback(
    ...
    """
    [bold]claudehooks[/bold] - Delightful Claude Code hooks 🪝

    Build hooks for Claude Code with a FastAPI-like developer experience.

    Read more: [link=https://github.com/oneryalcin/claudehooks]https://github.com/oneryalcin/claudehooks[/link]
    """
    pass
...
def run(
    ...
    Your hooks.py should contain:
        ...
        from claudehooks import HookApp
    ...
    if not path.exists():
        ...
        print()
        print("Create a hooks project with: [bold]claudehooks init my-hooks[/bold]")
        raise typer.Exit(code=1)
