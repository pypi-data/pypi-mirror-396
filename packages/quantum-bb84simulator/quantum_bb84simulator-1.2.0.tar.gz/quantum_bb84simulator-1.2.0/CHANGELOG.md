...
## [1.2.0] - 2025-12-13
### Added
- **Three Protocol Variants** implementing the UF research paper:
...
### Research Reference
This release implements the protocols from:
> Balakrishnan, S., Silverman, C.J., & Feng, P. (2025).
> "Enhancing BB84 Quantum Key Distribution under Depolarizing Noise:
> Bitwise vs Three-Qubit Majority Vote Protocols"
