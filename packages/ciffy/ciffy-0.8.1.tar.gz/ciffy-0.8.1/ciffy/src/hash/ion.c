...
#define IONTOTAL_KEYWORDS 25
#define IONMIN_WORD_LENGTH 1
#define IONMAX_WORD_LENGTH 3
#define IONMIN_HASH_VALUE 2
#define IONMAX_HASH_VALUE 57
  ...
  static unsigned char asso_values[] =
    {
      ...
      58, 58, 58, 58, 58, 58, 58, 58, 58, 58,
      58, 58, 58, 58, 58, 58, 58, 58, 58, 58,
      58, 58, 58, 58, 58, 13, 30, 10,  0, 30,
      58,  5, 58, 25,  0, 58, 10, 30, 10, 25,
      58, 15, 18,  3, 25,  5, 58, 58, 58, 58,
