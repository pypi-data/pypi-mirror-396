...
from src.core.license import get_current_tier, get_current_limits, Tier
...
class ChatTUI(WorkerMixin, HandlerMixin, HelperMixin, App):
    ...
    def on_mount(self):
        ...
        # Check TUI access (Pro tier required)
        try:
            require_tui()
        except FeatureGatedError as e:
            # TUI not available for this tier - show message and exit
            self.notify(
                e.user_message(),
    ...
    def handle_send_button(self):
        ...
        if is_processing:
            ...
            if not can_query:
                ...
                system_messages.write("[dim]Upgrade at: https://getconsult.dev/pricing[/dim]")
                return
    ...
    def action_show_help(self):
        ...
        system_messages.write("[yellow]Output:[/yellow] O=markdown toggle")
