...
@MODELS.register(name=":resnet:blocks:Pre_Act_Bottle_Neck_Block")
class Pre_Act_Bottle_Neck_Block(nn.Module):
    """
        Pre-activation version of the original Bottle neck module.
    """
    ...
    def __init__(self, **kwargs):
        ...
        """
        super(Pre_Act_Bottle_Neck_Block, self).__init__()
        ...
        # 校验参数
        assert p["c_in"] is not None and p["c_out"] is not None, f'{p["c_in"]}  p["c_out"]'
        ...
        self.conv2 = p["conv_for_stem"](in_channels=p["c_out"], out_channels=p["c_out"], kernel_size=p["kernel_size"],
                                        ...
                                        bias=False)
        self.bn3 = p["norm_for_stem"](p["c_out"])
...
if __name__ == '__main__':
    ...
    layer = Pre_Act_Bottle_Neck_Block(c_in=3, c_out=3, stride=2)
    print(layer(a).shape)
