...
def print_vulnerability(vuln: Vulnerability, show_fix: bool = True) -> None:
    ...
    if vuln.suggestion and vuln.reasoning:
        ...
        content.append("❌ Missing Control: ", style="bold red")
        ...
        if vuln.owasp_category:
            ...
            content.append(f"{vuln.owasp_category.value}", style="cyan")
    else:
...
def print_analysis_result(result: AnalysisResult) -> None:
    ...
    score_color = "green" if result.overall_score >= 70 else "yellow" if result.overall_score >= 30 else "red"
