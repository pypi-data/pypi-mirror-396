...
def is_macos_intel():
    """
    Check if the current system is macOS running on an Intel platform.
    Returns:
        bool: True if the system is macOS and the CPU architecture is Intel, False otherwise.
    """
...
def is_python_3_8():
    """
    Check if the current Python version is 3.8.
    Returns:
