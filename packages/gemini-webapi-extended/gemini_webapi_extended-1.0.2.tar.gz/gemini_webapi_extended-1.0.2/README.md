...
<p align="center">
    <a href="https://pypi.org/project/gemini-webapi-extended">
        <img src="https://img.shields.io/pypi/v/gemini-webapi-extended" alt="PyPI"></a>
    <a href="https://github.com/kieutb/Gemini-API/blob/master/LICENSE">
        <img src="https://img.shields.io/github/license/kieutb/Gemini-API" alt="License"></a>
    <a href="https://github.com/psf/black">
        <img src="https://img.shields.io/badge/code%20style-black-000000.svg" alt="Code style"></a>
</p>

# <img src="https://raw.githubusercontent.com/HanaokaYuzu/Gemini-API/master/assets/logo.svg" width="35px" alt="Gemini Icon" /> Gemini-API Extended

> **📦 Fork Notice:** This is an extended fork of [gemini-webapi](https://github.com/HanaokaYuzu/Gemini-API) with additional features. All credit for the core functionality goes to the original author [UZQueen](https://github.com/HanaokaYuzu).
...
- **🗑️ Delete Chat** - Programmatically delete chat conversations to avoid leaving history traces

For the original features, see below.
...
```sh
pip install -U gemini-webapi-extended
```
