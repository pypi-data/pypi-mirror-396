...
"""
    ...
    def clean_mermaid_diagram(mermaid_content: str) -> str:
        """Remove note annotations from a Mermaid class diagram.
        
        This tool removes all note statements that would render as unreadable yellow boxes.
        
        Args:
            mermaid_content: The raw Mermaid class diagram content
            
        Returns:
            Cleaned Mermaid content with all note statements removed
        """
