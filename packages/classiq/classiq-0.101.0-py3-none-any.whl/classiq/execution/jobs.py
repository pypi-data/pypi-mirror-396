...
get_execution_jobs.__doc__ = """Query execution jobs.
...
async def get_execution_actions_async(
    ...
    data = [action.model_dump() for action in execution_actions]
    return pd.DataFrame(data)


get_execution_actions = syncify_function(get_execution_actions_async)
get_execution_actions.__doc__ = """Query execution jobs with optional filters.
