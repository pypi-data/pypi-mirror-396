...
def api_return(data):
    api_list = [
        ...
        {'method': 'GET', 'api': '/core/stock/bin/', 'func_name': 'stock_bin_get', 'name': "Get Stock Bin List"},
        {'method': 'POST', 'api': '/core/stock/bin/create/', 'func_name': 'stock_bin_create', 'name': "Create Stock Bin"},
        {'method': 'POST', 'api': '/core/stock/bin/update/', 'func_name': 'stock_bin_update', 'name': "Update Stock Bin"},
        {'method': 'POST', 'api': '/core/stock/bin/delete/', 'func_name': 'stock_bin_delete', 'name': "Delete Stock Bin"},
        ...
        {'method': 'GET', 'api': '/core/dn/detail/', 'func_name': 'asn_detail_get', 'name': "Get DN Detail"},
