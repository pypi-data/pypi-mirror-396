...
HF_REPO = "videosdk-live/Namo-Turn-Detector-v1-Vietnamese"
LANGUAGE_CODE = "vi"


class _NamoTurnRunnerVietnamese(_InferenceRunner):
    """Inference runner for Vietnamese turn detection model."""

    INFERENCE_METHOD = "namo_turn_detection_vi"
    ...
    def initialize(self) -> None:
        ...
        logger.info(f"Loading Vietnamese turn detection model from {HF_REPO}")
    ...
    def run(self, data: bytes) -> bytes | None:
        ...
        try:
            ...
            logger.debug(
                f"Vietnamese turn detection completed",
                extra={
...
_InferenceRunner.register_runner(_NamoTurnRunnerVietnamese)


class VietnameseModel(NamoModelBase):
    """
    Vietnamese-specific Namo Turn Detection model.

    This model loads only the Vietnamese model file for better memory efficiency.
    """
    ...
    def _inference_method(self) -> str:
        ...
        return _NamoTurnRunnerVietnamese.INFERENCE_METHOD
