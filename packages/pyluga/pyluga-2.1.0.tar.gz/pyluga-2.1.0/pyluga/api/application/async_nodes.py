...
from pyluga.constants import USE_SSL
from pyluga.responses import PaginatedResponse


class AsyncNodes(AsyncBelugaAPI):
    """Class for interacting with the Beluga Nodes API asynchronously."""
    ...
    async def create_allocations(self, node_id, ip, ports, alias=None):
        ...
        Args:
            ...
            ports(iter): List of strings representing strings.  Can use
                ranges as supported by Beluga, e.g. ["4000", "4003-4005"]
    ...
    async def delete_allocation(self, node_id, allocation_id):
        ...
        The Beluga API currently limits delete_allocation to a single
        ...
        Args:
            node_id(int): Beluga Node ID.
            allocation_id(int): Beluga Allocation ID.  This is the
