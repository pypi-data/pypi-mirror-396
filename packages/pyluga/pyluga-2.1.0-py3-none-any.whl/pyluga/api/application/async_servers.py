...
class AsyncServers(AsyncBelugaAPI):
    """Class for interacting with the Beluga Servers API asynchronously."""
    ...
    async def get_server_info(self, server_id=None, external_id=None, detail=False,
        ...
        Args:
            server_id(int): Beluga Server ID.
    ...
    async def create_server(self, name, user_id, nest_id, egg_id, memory_limit,
        ...
        Args:
            ...
            docker_image(str): Name or URL of the Docker server to use.
                    e.g. quay.io/beluga/core:java-glibc
            ...
            default_allocation(int): Specify allocation(s) instead of using the
                    Beluga deployment service.  Uses the allocation's
    ...
    async def update_server_details(self, server_id, name, user_id, external_id=None, description=None):
        ...
        Modifies an existing server details identified by its Beluga id.
