...
class AsyncUser(AsyncBelugaAPI):
    """Class for interacting with the Beluga User API asynchronously."""
    ...
    async def create_user(self, username, email, first_name, last_name,
                    ...
                    language='en'):
        """Creates a primary user on the Beluga panel.
