...
class PPIAllNeighborsSchema(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["protein_id", "total_interactions", "interactions", "unique_neighbors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "interactions": [PPIInteractionSchema.from_dict(_item) for _item in obj["interactions"]] if obj.get("interactions") is not None else None,
