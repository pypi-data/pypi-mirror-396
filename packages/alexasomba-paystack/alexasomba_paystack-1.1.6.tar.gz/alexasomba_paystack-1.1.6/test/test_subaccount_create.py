...
from alexasomba_paystack.models.subaccount_create import SubaccountCreate  # noqa: E501
...
class TestSubaccountCreate(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `SubaccountCreate`
        """
        model = alexasomba_paystack.models.subaccount_create.SubaccountCreate()  # noqa: E501
        if include_optional :
