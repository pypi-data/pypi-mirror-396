...
from alexasomba_paystack.models.charge_submit_phone import ChargeSubmitPhone  # noqa: E501
...
class TestChargeSubmitPhone(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `ChargeSubmitPhone`
        """
        model = alexasomba_paystack.models.charge_submit_phone.ChargeSubmitPhone()  # noqa: E501
        if include_optional :
