...
from alexasomba_paystack.models.dedicated_virtual_account_create import DedicatedVirtualAccountCreate  # noqa: E501
...
class TestDedicatedVirtualAccountCreate(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `DedicatedVirtualAccountCreate`
        """
        model = alexasomba_paystack.models.dedicated_virtual_account_create.DedicatedVirtualAccountCreate()  # noqa: E501
        if include_optional :
