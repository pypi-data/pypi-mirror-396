...
from alexasomba_paystack.models.transaction_partial_debit import TransactionPartialDebit  # noqa: E501
...
class TestTransactionPartialDebit(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `TransactionPartialDebit`
        """
        model = alexasomba_paystack.models.transaction_partial_debit.TransactionPartialDebit()  # noqa: E501
        if include_optional :
