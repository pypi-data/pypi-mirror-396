...
from alexasomba_paystack.models.charge_submit_pin import ChargeSubmitPin  # noqa: E501
...
class TestChargeSubmitPin(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `ChargeSubmitPin`
        """
        model = alexasomba_paystack.models.charge_submit_pin.ChargeSubmitPin()  # noqa: E501
        if include_optional :
