...
class TransferRecipientCreateResponseDataDetails(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransferRecipientCreateResponseDataDetails:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransferRecipientCreateResponseDataDetails:
        """Create an instance of TransferRecipientCreateResponseDataDetails from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransferRecipientCreateResponseDataDetails.parse_obj(obj)

        _obj = TransferRecipientCreateResponseDataDetails.parse_obj({
