...
class TransactionFetchResponseDataCustomer(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionFetchResponseDataCustomer:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionFetchResponseDataCustomer:
        """Create an instance of TransactionFetchResponseDataCustomer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionFetchResponseDataCustomer.parse_obj(obj)

        _obj = TransactionFetchResponseDataCustomer.parse_obj({
            "id": obj.get("id"),
