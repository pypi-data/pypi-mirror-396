...
class USSD(BaseModel):
    ...
    """
    type: Optional[StrictStr] = Field(None, description="The three-digit USSD code.")
    __properties = ["type"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('737', '919', '822', '966'):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> USSD:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> USSD:
        """Create an instance of USSD from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return USSD.parse_obj(obj)
