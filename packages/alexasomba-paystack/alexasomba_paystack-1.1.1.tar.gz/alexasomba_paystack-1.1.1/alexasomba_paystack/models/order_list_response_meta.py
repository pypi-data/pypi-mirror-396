...
class OrderListResponseMeta(BaseModel):
    """
    ...
    __properties = ["total", "revenue", "skipped", "perPage", "page", "pageCount"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderListResponseMeta:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderListResponseMeta:
        """Create an instance of OrderListResponseMeta from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderListResponseMeta.parse_obj(obj)

        _obj = OrderListResponseMeta.parse_obj({
            "total": obj.get("total"),
