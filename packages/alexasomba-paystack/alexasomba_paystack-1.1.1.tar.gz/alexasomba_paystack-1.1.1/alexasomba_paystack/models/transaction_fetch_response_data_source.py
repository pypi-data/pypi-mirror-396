...
class TransactionFetchResponseDataSource(BaseModel):
    """
    ...
    __properties = ["type", "source", "identifier"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionFetchResponseDataSource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionFetchResponseDataSource:
        """Create an instance of TransactionFetchResponseDataSource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionFetchResponseDataSource.parse_obj(obj)

        _obj = TransactionFetchResponseDataSource.parse_obj({
            "type": obj.get("type"),
