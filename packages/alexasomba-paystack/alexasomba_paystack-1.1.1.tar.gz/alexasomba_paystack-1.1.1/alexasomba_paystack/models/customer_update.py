...
class CustomerUpdate(BaseModel):
    ...
    __properties = ["first_name", "last_name", "phone", "metadata"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomerUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomerUpdate:
        """Create an instance of CustomerUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomerUpdate.parse_obj(obj)

        _obj = CustomerUpdate.parse_obj({
