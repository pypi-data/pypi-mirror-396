...
class BulkChargeFetchBulkBatchChargesResponseArrayCustomer(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BulkChargeFetchBulkBatchChargesResponseArrayCustomer:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BulkChargeFetchBulkBatchChargesResponseArrayCustomer:
        """Create an instance of BulkChargeFetchBulkBatchChargesResponseArrayCustomer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BulkChargeFetchBulkBatchChargesResponseArrayCustomer.parse_obj(obj)

        _obj = BulkChargeFetchBulkBatchChargesResponseArrayCustomer.parse_obj({
            "id": obj.get("id"),
