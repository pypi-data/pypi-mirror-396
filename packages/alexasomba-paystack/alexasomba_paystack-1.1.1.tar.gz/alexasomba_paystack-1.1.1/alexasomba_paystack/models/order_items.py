...
class OrderItems(BaseModel):
    ...
    __properties = ["item", "type", "quantity", "amount"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderItems:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderItems:
        """Create an instance of OrderItems from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderItems.parse_obj(obj)

        _obj = OrderItems.parse_obj({
            "item": obj.get("item"),
            "type": obj.get("type"),
