...
class CustomerCreate(BaseModel):
    ...
    __properties = ["email", "first_name", "last_name", "phone", "metadata"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomerCreate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomerCreate:
        """Create an instance of CustomerCreate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomerCreate.parse_obj(obj)

        _obj = CustomerCreate.parse_obj({
            "email": obj.get("email"),
