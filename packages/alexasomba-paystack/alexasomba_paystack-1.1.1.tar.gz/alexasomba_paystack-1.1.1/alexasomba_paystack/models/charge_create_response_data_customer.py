...
class ChargeCreateResponseDataCustomer(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChargeCreateResponseDataCustomer:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ChargeCreateResponseDataCustomer:
        """Create an instance of ChargeCreateResponseDataCustomer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ChargeCreateResponseDataCustomer.parse_obj(obj)

        _obj = ChargeCreateResponseDataCustomer.parse_obj({
            "id": obj.get("id"),
