...
from alexasomba_paystack.models.transaction_check_authorization import TransactionCheckAuthorization  # noqa: E501
...
class TestTransactionCheckAuthorization(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `TransactionCheckAuthorization`
        """
        model = alexasomba_paystack.models.transaction_check_authorization.TransactionCheckAuthorization()  # noqa: E501
        if include_optional :
