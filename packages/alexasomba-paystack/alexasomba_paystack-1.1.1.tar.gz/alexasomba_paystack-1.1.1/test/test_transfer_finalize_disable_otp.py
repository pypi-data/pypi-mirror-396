...
from alexasomba_paystack.models.transfer_finalize_disable_otp import TransferFinalizeDisableOTP  # noqa: E501
...
class TestTransferFinalizeDisableOTP(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `TransferFinalizeDisableOTP`
        """
        model = alexasomba_paystack.models.transfer_finalize_disable_otp.TransferFinalizeDisableOTP()  # noqa: E501
        if include_optional :
