...
from alexasomba_paystack.models.subscription_toggle import SubscriptionToggle  # noqa: E501
...
class TestSubscriptionToggle(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `SubscriptionToggle`
        """
        model = alexasomba_paystack.models.subscription_toggle.SubscriptionToggle()  # noqa: E501
        if include_optional :
