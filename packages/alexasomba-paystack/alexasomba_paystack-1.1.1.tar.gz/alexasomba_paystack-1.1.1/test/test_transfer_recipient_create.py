...
from alexasomba_paystack.models.transfer_recipient_create import TransferRecipientCreate  # noqa: E501
...
class TestTransferRecipientCreate(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `TransferRecipientCreate`
        """
        model = alexasomba_paystack.models.transfer_recipient_create.TransferRecipientCreate()  # noqa: E501
        if include_optional :
