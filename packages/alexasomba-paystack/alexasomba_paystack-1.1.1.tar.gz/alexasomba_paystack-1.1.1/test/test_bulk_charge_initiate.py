...
from alexasomba_paystack.models.bulk_charge_initiate import BulkChargeInitiate  # noqa: E501
...
class TestBulkChargeInitiate(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `BulkChargeInitiate`
        """
        model = alexasomba_paystack.models.bulk_charge_initiate.BulkChargeInitiate()  # noqa: E501
        if include_optional :
