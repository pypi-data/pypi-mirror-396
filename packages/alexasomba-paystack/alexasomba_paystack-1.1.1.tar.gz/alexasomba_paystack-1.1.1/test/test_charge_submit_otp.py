...
from alexasomba_paystack.models.charge_submit_otp import ChargeSubmitOTP  # noqa: E501
...
class TestChargeSubmitOTP(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `ChargeSubmitOTP`
        """
        model = alexasomba_paystack.models.charge_submit_otp.ChargeSubmitOTP()  # noqa: E501
        if include_optional :
