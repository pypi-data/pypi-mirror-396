...
class ChargeAuthorizationResponseDataCustomer(BaseModel):
    """
    ...
    metadata: Optional[ChargeAuthorizationResponseDataCustomerMetadata] = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChargeAuthorizationResponseDataCustomer:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ChargeAuthorizationResponseDataCustomer:
        """Create an instance of ChargeAuthorizationResponseDataCustomer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ChargeAuthorizationResponseDataCustomer.parse_obj(obj)

        _obj = ChargeAuthorizationResponseDataCustomer.parse_obj({
            "id": obj.get("id"),
            ...
            "phone": obj.get("phone"),
            "metadata": ChargeAuthorizationResponseDataCustomerMetadata.from_dict(obj.get("metadata")) if obj.get("metadata") is not None else None,
