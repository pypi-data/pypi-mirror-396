...
class ChargeSubmitPhoneResponseData(BaseModel):
    """
    ...
    display_text: StrictStr = Field(...)
    __properties = ["status", "amount", "currency", "transaction_date", "reference", "domain", "redirect_url", "metadata", "gateway_response", "message", "channel", "fees", "authorization", "customer", "display_text"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChargeSubmitPhoneResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ChargeSubmitPhoneResponseData:
        """Create an instance of ChargeSubmitPhoneResponseData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ChargeSubmitPhoneResponseData.parse_obj(obj)

        _obj = ChargeSubmitPhoneResponseData.parse_obj({
