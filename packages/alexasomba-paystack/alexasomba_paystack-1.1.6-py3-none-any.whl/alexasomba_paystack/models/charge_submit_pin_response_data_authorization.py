...
class ChargeSubmitPinResponseDataAuthorization(BaseModel):
    """
    ...
    __properties = ["authorization_code", "bin", "last4", "exp_month", "exp_year", "channel", "card_type", "bank", "country_code", "brand", "reusable", "signature"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChargeSubmitPinResponseDataAuthorization:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ChargeSubmitPinResponseDataAuthorization:
        """Create an instance of ChargeSubmitPinResponseDataAuthorization from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ChargeSubmitPinResponseDataAuthorization.parse_obj(obj)

        _obj = ChargeSubmitPinResponseDataAuthorization.parse_obj({
