...
class ChargeSubmitAddress(BaseModel):
    ...
    __properties = ["address", "city", "state", "zip_code", "reference"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChargeSubmitAddress:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ChargeSubmitAddress:
        """Create an instance of ChargeSubmitAddress from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ChargeSubmitAddress.parse_obj(obj)

        _obj = ChargeSubmitAddress.parse_obj({
