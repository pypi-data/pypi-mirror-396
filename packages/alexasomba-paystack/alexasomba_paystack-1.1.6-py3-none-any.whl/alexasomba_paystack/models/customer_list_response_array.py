...
class CustomerListResponseArray(BaseModel):
    ...
    __properties = ["integration", "first_name", "last_name", "email", "phone", "metadata", "domain", "customer_code", "risk_action", "id", "createdAt", "updatedAt"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomerListResponseArray:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomerListResponseArray:
        """Create an instance of CustomerListResponseArray from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomerListResponseArray.parse_obj(obj)

        _obj = CustomerListResponseArray.parse_obj({
