...
class PaymentRequestUpdateResponseDataCustomer(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaymentRequestUpdateResponseDataCustomer:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaymentRequestUpdateResponseDataCustomer:
        """Create an instance of PaymentRequestUpdateResponseDataCustomer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaymentRequestUpdateResponseDataCustomer.parse_obj(obj)

        _obj = PaymentRequestUpdateResponseDataCustomer.parse_obj({
            "id": obj.get("id"),
