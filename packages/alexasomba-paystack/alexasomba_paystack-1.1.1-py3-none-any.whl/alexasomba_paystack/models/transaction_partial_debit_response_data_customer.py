...
class TransactionPartialDebitResponseDataCustomer(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionPartialDebitResponseDataCustomer:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionPartialDebitResponseDataCustomer:
        """Create an instance of TransactionPartialDebitResponseDataCustomer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionPartialDebitResponseDataCustomer.parse_obj(obj)

        _obj = TransactionPartialDebitResponseDataCustomer.parse_obj({
            "id": obj.get("id"),
