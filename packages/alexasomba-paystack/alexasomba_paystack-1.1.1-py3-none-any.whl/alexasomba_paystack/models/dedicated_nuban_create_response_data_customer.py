...
class DedicatedNubanCreateResponseDataCustomer(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DedicatedNubanCreateResponseDataCustomer:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DedicatedNubanCreateResponseDataCustomer:
        """Create an instance of DedicatedNubanCreateResponseDataCustomer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DedicatedNubanCreateResponseDataCustomer.parse_obj(obj)

        _obj = DedicatedNubanCreateResponseDataCustomer.parse_obj({
            "id": obj.get("id"),
