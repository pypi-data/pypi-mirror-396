...
class SplitListResponseArray(BaseModel):
    ...
    bearer_subaccount: Optional[StrictInt] = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SplitListResponseArray:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SplitListResponseArray:
        """Create an instance of SplitListResponseArray from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SplitListResponseArray.parse_obj(obj)

        _obj = SplitListResponseArray.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "type": obj.get("type"),
