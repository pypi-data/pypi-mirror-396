...
class SubscriptionListResponseArrayCustomer(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubscriptionListResponseArrayCustomer:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubscriptionListResponseArrayCustomer:
        """Create an instance of SubscriptionListResponseArrayCustomer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubscriptionListResponseArrayCustomer.parse_obj(obj)

        _obj = SubscriptionListResponseArrayCustomer.parse_obj({
            "id": obj.get("id"),
