...
@app.route('/api/download-transformer-result/<task_id>')
def download_transformer_result(task_id):
    script_dir = os.path.dirname(os.path.abspath(__file__))
    transformer_dir = os.path.join(script_dir, 'Tranformer')
    output_dir = os.path.join(transformer_dir, 'output')
    ...
    def generate():
        try:
            ...
            for i, alpha in enumerate(alphas):
                ...
                result = brain_alpha_inspector.get_alpha_variants(session, alpha, operators)
