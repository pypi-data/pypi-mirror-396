...
Input: .csv / .parquet / .jsonl (ID column default 'id').
Preprocess: StandardScaler by default; drop all-zero cols; optional near-constant drop.
Output: id + cluster (DBSCAN: -1 = outlier); formats csv/parquet/jsonl; optional JSON report.

Full contract: https://github.com/mikewong23571/vec-cluster/blob/main/docs/design.md"""
