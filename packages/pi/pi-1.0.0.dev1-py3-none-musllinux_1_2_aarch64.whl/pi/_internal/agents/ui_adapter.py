    ...
    async def make_panelable_tool_return(
        ...
        match tool_return.tool_name:
            case "rewrite" | "search_replace":
                ...
                header = (
                    f"[bold $success]{tool_return.tool_name}[/bold $success] "
                    f"[dim]({path})[/dim]"
                )
            ...
            case "list_files":
                ...
                panelable = panelables.ToolResultDetails([header, content])
            ...
            case "read_file":
                ...
                panelable = panelables.ToolResultDetails([header, syntax])
            ...
            case "read_chunk":
                ...
                header = (
                    f"[bold $success]{tool_return.tool_name}[/bold $success] "
                    f"[dim]({path})[/dim] (lines {bound_from}-{bound_to})"
                )
                syntax = rich.syntax.Syntax(
                    chunk,
                    extension,
