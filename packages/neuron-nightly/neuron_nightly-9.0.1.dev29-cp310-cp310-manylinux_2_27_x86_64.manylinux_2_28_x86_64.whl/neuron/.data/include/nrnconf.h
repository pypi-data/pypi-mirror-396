...
#define NEURON_DATA_DIR "/tmp/tmp4517bzgg/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp4517bzgg/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-dvwui0_p/bin/python)"};
