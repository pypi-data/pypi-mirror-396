...
#define NEURON_DATA_DIR "/tmp/tmpyjj9fvnc/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpyjj9fvnc/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-dqc9wkg7/bin/python)"};
