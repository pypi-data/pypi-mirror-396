...
#define NEURON_DATA_DIR "/tmp/tmppv7pz39_/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmppv7pz39_/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-i3o9lsn8/bin/python)"};
