...
#define NEURON_DATA_DIR "/tmp/tmpbr1sd812/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpbr1sd812/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-kq24vnx2/bin/python)"};
