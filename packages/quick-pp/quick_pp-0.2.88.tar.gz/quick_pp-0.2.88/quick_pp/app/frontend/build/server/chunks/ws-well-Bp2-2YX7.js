import { o as onDestroy, A as List_details, W as Wall, B as Text_wrap_disabled, C as Wash_temperature_6, E as Table } from './error.svelte-CJifmzBv.js';
  ...
  $$renderer.component(($$renderer2) => {
    ...
    const unsubscribe = workspace.subscribe((w) => {
      ...
      if (w?.selectedWell && !plotComponentLoaded) {
        import('./WsWellPlot-CMIKlwfe.js').then((module) => {
...
export { Ws_well as W };
//# sourceMappingURL=ws-well-Bp2-2YX7.js.map
