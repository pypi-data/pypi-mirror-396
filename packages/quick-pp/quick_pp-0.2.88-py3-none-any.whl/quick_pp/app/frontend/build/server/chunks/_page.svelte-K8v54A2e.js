import { o as onDestroy, a as attr, v as escape_html, c as bind_props } from './error.svelte-CJifmzBv.js';
      ...
      if (qvnRows.length && shalePoroList.length) {
        try {
          const qvnPayloadData = qvnRows.map((row, i) => ({
            vclay: row.vclay,
            phit: row.phit,
            phit_clay: shalePoroList[i] ?? 0.15
...
//# sourceMappingURL=_page.svelte-K8v54A2e.js.map
