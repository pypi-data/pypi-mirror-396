...
from .const import DOMAIN_SUFFIX_LEGACY, DOMAIN_SUFFIX_NEW, E2_PREFIX
...
def build_server_url(server: str, route: str = "") -> str:
    ...
    Supports both legacy and new DNS schemes:
    - Legacy: server -> https://server.e2.earnix.com
    - New: e2-server -> https://e2-server.earnix.com

    :param server: The server name (e.g., "dev", "e2-production")
    :type server: str
