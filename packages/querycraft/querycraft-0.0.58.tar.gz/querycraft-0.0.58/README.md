...
options:
  ...
  -f FILE, --file FILE  sql file
  -s SQL, --sql SQL     sql string
(.venv) desmontils-e@ma-desmontils-2023 querycraft % admin-sbs -h
...
Il est possible d'activer ou désactiver l'aide par IA, ainsi que de choisir le service d'IA générative à utiliser.
