...
class EventManager:
    ...
    def load_events(self):
        event_types_list = events_service.register_event_types(config.EVENTS)
        self.event_types = { e['name']: EventType(e['name'], e['version'], e['attributes']) for e in event_types_list }
