...
{str(self.denominator).center(w)}"""
    ...
    def __add__(self,a):
        if isinstance(a, self.__class__) != True:
            return "TypeError: you cannot add another types in a fraction"
    ...
    def __sub__(self,a):
        if isinstance(a, self.__class__) != True:
            return "TypeError: you cannot subtract another types in a fraction"
        lcm = self.LCM(self.denominator,a.denominator)
        s = lcm // self.denominator
        b = lcm // a.denominator
        s = Fraction(self.numerator*s,self.denominator*s)
    ...
    def __mul__(self,a):
        if isinstance(a, self.__class__) != True:
            return "TypeError: you cannot multiply another types with a fraction"
        
        f = Fraction(self.numerator*a.numerator,self.denominator*a.denominator)
        return f
    def __truediv__(self,a):
        if isinstance(a, self.__class__) != True:
            return "TypeError: you cannot divide another types with a fraction"
