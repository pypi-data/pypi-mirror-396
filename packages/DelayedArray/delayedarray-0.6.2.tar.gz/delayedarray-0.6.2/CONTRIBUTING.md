...
Welcome to `DelayedArray` contributor's guide.
...
If you experience bugs or general issues with `DelayedArray`, please have a look
...
You can help improve `DelayedArray` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`DelayedArray` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `DelayedArray`'s files. While this mechanism can
...
```
conda create -n DelayedArray python=3 six virtualenv pytest pytest-cov
conda activate DelayedArray
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/DelayedArray.git
   cd DelayedArray
   ```
...
5. Install [pre-commit]:
   ...
   `DelayedArray` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/DelayedArray
[issue tracker]: https://github.com/<USERNAME>/DelayedArray/issues
