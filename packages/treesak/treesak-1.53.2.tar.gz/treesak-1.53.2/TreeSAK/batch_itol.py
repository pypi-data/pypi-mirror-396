...
BioSAK batch_itol -api API_key -ip batch_access_tmp -a annotation_files.txt -i input.tree -o out.pdf
BioSAK batch_itol -api API_key -ip batch_access_tmp -a annotation_files.txt -i tree_dir -x tree -o out_pdf
