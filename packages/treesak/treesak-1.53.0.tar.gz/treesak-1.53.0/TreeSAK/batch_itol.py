...
BioSAK batch_itol -a annotation_dir -api API_key -project batch_access_tmp -i input.tree -o out.pdf
BioSAK batch_itol -a annotation_dir -api API_key -project batch_access_tmp -i tree_dir -x tree -o out_pdf
