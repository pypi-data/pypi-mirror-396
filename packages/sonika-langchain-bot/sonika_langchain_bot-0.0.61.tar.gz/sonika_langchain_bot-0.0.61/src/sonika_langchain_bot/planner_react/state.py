...
class ActionPlan(TypedDict):
    ...
    reasoning: str  # Razonamiento del modelo sobre qué hacer
    ...
    is_retry: bool  # Si es un retry de un intento anterior
    iteration: int  # Número de iteración del loop ReAct
...
class PlannerState(TypedDict):
    ...
    # ===== REACT LOOP =====
    react_iteration: int  # Contador de iteraciones del loop ReAct (máx 3)
