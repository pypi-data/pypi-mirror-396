...
class HookQuerySet(models.QuerySet):
    ...
    def bulk_create(
        ...
        Args:
            ...
            commit_strategy: Commit strategy (CommitStrategy enum). Defaults to ATOMIC.
        
        Returns:
            list for ATOMIC mode (backward compatible)
            BulkCreateResult for PER_BATCH/BEST_EFFORT modes
        """
