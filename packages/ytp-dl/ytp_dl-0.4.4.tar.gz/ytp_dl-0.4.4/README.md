...
- ✅ Installs `ytp-dl==0.4.4` into the virtualenv
...
#   - Installs ytp-dl==0.4.4 + gunicorn + gevent in that venv
...
pip install "ytp-dl==0.4.4" gunicorn gevent
deactivate
