...
def __lshift__(out, date_time):
    return _py_interop_metrics.__lshift__(out, date_time)

def __rshift__(_in, date_time):
    return _py_interop_metrics.__rshift__(_in, date_time)
