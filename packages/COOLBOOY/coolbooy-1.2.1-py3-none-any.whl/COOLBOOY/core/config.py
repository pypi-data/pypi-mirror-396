"""
Configuration management for COOLBOOY
...
COOLBOOY_CONFIG_FOLDER = Path(CONFIG_FOLDER) / "COOLBOOY"
COOLBOOY_CONFIG_PATH = COOLBOOY_CONFIG_FOLDER / "config"
ROLE_STORAGE_PATH = COOLBOOY_CONFIG_FOLDER / "roles"
CHAT_CACHE_PATH = Path(gettempdir()) / "COOLBOOY_chats"
CACHE_PATH = Path(gettempdir()) / "COOLBOOY_cache"
...
class Config:
    """Configuration manager for COOLBOOY"""
    ...
    def __init__(self, config_path: Optional[Path] = None):
        ...
        """
        self.config_path = config_path or COOLBOOY_CONFIG_PATH
    ...
    def _write_config_file(self) -> None:
        ...
        try:
            with open(self.config_path, "w", encoding="utf-8") as file:
                file.write("# COOLBOOY Configuration File\n")
