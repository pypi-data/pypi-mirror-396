...
class PySob:
    ...
    def __register_class_alias(subcls: type[Sob],
        ...
        The alias is obtained by concatenating the uppercase letters of the *Sob* subclass name.
        If a conflict arises, subsequent lowercase letters from the *Sob* subclass name are added to
        the alias, until the alias becomes unique.
