...
options = ClaudeAgentOptions(
    ...
    mcp_servers={
        ...
        "jarvis-requests": {
            ...
            "env": {
                "MCP_MODULES": "Requests"
            }
        },
    },
    # setting_sources=["project"],
    allowed_tools=[
        "mcp__jarvis-dp__get_html",
        "mcp__jarvis-dp__visit_url",
        "mcp__jarvis-dp__get_new_tab",
        "mcp__jarvis-dp__switch_tab",
        "mcp__jarvis-dp__close_tab",
        "mcp__jarvis-dp__check_selector",
        "mcp__jarvis-dp__assert_Static_Web",  # 判断当前页面是否为静态页面
        "mcp__jarvis-requests__assert_waf",  # 判断传入的url是否使用了瑞数，jsl等防火墙
        'Read',
        'Write',
        'Edit',
        'MultiEdit',
...
async def main():
    tasks = []
    with open("/Users/user/PycharmProjects/JARVIS/mapping_copy.json", "r", encoding="utf-8") as f:
        mapping = json.load(f)
