...
class AutoInitializer:
    ...
    def initialize_all(
        ...
        if components is None:
            components = [
                'logger', 'service_config', 'cache', 'exception_handler',
    ...
    def _initialize_service_config(self):
        ...
        if 'logger' in self.components:
            ...
            self.components['logger'].info(
                f"Cache initialized with provider: service, environment: yaml"
            )
            return config
    ...
    def print_status(self):
        ...
        print("\n" + "="*60)
        print("SDK Auto-Initialization Status")
        print("="*60)
