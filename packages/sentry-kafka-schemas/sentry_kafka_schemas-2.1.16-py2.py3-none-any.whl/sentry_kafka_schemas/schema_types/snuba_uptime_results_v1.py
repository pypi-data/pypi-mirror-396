from typing import Required, List, Union, Literal, TypedDict
...
CheckStatusReasonType = Union[Literal['timeout'], Literal['dns_error'], Literal['failure'], Literal['tls_error'], Literal['connection_error'], Literal['redirect_error'], Literal['miss_produced'], Literal['miss_backfill']]
"""
check_status_reason_type.
