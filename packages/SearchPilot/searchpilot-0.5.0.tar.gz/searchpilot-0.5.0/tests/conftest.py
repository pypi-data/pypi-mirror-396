...
def client(request: FixtureRequest) -> Iterator[SearchPilot]:
    ...
    with SearchPilot(base_url=base_url, api_jwt=api_jwt, _strict_response_validation=strict) as client:
        yield client
...
async def async_client(request: FixtureRequest) -> AsyncIterator[AsyncSearchPilot]:
    ...
    async with AsyncSearchPilot(
        base_url=base_url, api_jwt=api_jwt, _strict_response_validation=strict, http_client=http_client
    ) as client:
        yield client
