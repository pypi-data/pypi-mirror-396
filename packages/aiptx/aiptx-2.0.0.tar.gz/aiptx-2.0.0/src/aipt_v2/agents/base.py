...
class BaseAgent(metaclass=AgentMeta):
    ...
    def __init__(self, config: dict[str, Any]):
        ...
        from telemetry.tracer import get_global_tracer
    ...
    def _add_to_agents_graph(self) -> None:
        from tools.agents_graph import agents_graph_actions
    ...
    async def _wait_for_input(self) -> None:
        ...
        if self.state.has_waiting_timeout():
            ...
            try:
                from tools.agents_graph.agents_graph_actions import _agent_graph
    ...
    def _check_agent_messages(self, state: AgentState) -> None:  # noqa: PLR0912
        try:
            from tools.agents_graph.agents_graph_actions import _agent_graph, _agent_messages
