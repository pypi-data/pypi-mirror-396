...
class LineDifyIntegrator:
    ...
    async def handle_message_event(self, event: MessageEvent):
        ...
        try:
            ...
            formated_request_text = await self._format_request_text(request_text, image_bytes, conversation_session)
    ...
    async def format_request_text_default(self, request_text: str, image_bytes: bytes, conversation_session: ConversationSession) -> str:
        return request_text
