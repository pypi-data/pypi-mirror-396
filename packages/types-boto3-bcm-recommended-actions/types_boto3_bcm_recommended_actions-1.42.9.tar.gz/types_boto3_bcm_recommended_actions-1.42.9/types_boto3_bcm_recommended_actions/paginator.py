...
class ListRecommendedActionsPaginator(_ListRecommendedActionsPaginatorBase):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_bcm_recommended_actions/paginators/#listrecommendedactionspaginator)
    """
