...
class ProgressIndicator:
    ...
    @staticmethod
    def operation_failure(message: str, emoji: str = "❌") -> None:
        """
    ...
    @staticmethod
    def operation_warning(message: str, emoji: str = "⚠️") -> None:
        """
...
class ValidationWarnings:
    ...
    def check_chunk_size(chunk_size: int) -> Optional[str]:
        ...
        if chunk_size < 100:
            return (
                "⚠️  Warning: chunk_size is too small (< 100 characters)\n"
            ...
            return (
                "⚠️  Warning: chunk_size is too large (> 5000 characters)\n"
    ...
    def check_top_k(top_k: int) -> Optional[str]:
        ...
        if top_k < 1:
            return (
                "⚠️  Warning: top_k must be at least 1\n"
