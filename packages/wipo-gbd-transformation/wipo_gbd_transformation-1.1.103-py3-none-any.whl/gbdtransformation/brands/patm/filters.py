...
def translate_type(header):
    ...
    if code == 'Solicitud de Marca': return 'TRADEMARK'
    # if code == 'Renovación de Marca': return 'TRADEMARK'

    if code == 'Indicación Geográfica': return 'AO'
...
def translate_kind(trademark, header):
    ...
    if subcode == 'Marca de Productos': return ['Individual']
    if subcode == 'Marca de productos': return ['Individual']
    if subcode == 'Marca de servicios': return ['Individual']
    if subcode == 'Marca de productos y/o servic.': return ['Individual']
    if subcode == 'Denominación comercial': return ['Individual']
    if subcode == 'Exp. o Señal de propaganda': return ['Individual']
    if subcode == 'Marca de garantía': return ["Individual"]
