...
from ods_models.input_parameters import AssetSpecs, TextSpecs, LogoSpecs
from ods_models.canvas_globals import FlexPreset

# Rebuild models with forward references
AddAssetToTemplateRegistryBody.model_rebuild()
AddTextToTemplateRegistryBody.model_rebuild()
AddLogoToTemplateRegistryBody.model_rebuild()
AddFlexPresetToTemplateRegistryBody.model_rebuild()
