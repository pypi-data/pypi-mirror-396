...
def show_developer_info():
    ...
    try:
        while True:
            ...
            # Professional developer info with bold text and colors
            CY = '\033[96m'  # Cyan
            GR = '\033[92m'  # Green
            B = '\033[1m'    # Bold
            R = '\033[0m'    # Reset
...
{CY}╔══════════════════════════════════════════════════════════╗
║                                                          ║
║              {B}{GR}DEVELOPER INFORMATION{R}{CY}                         ║
║                                                          ║
╠══════════════════════════════════════════════════════════╣
║                                                          ║
║  {B}Name{R}{CY}             {GR}XyraOfficial{R}{CY}                             ║
║  {B}Role{R}{CY}             {GR}Developer & Creator{R}{CY}                      ║
║  {B}Specialization{R}{CY}   {GR}Automation & Security Systems{R}{CY}            ║
║                                                          ║
╚══════════════════════════════════════════════════════════╝{R}
"""
            print(dev_info)
...
│        {GR}╚═╝   ╚══════╝╚═╝  ╚═╝╚═╝     ╚═╝ ╚═════╝ ╚═╝  ╚═╝{CY}  │
│                                                            │
│            {B}{GR}A U T H   S Y S T E M{R}{CY}                           │
│                   {B}Created by{R} {B}{GR}XyraOfficial{R}{CY}                │
│                                                            │
╰────────────────────────────────────────────────────────────╯{R}
"""
