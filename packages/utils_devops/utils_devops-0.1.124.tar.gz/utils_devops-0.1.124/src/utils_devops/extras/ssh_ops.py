    ...
    try:
        ...
        if key_file:
            ...
            if key_path.exists():
                ...
                _logger.debug(f"Using key file: {key_path}")
            else:
                _logger.warning(f"Key file not found: {key_file}")
                    ...
                    try:
                        with ssh_connect(
                            ...
                            **kwargs
                            ...
                            auth_method = "ssh_key"
                            _logger.info(f"✅ Connected to {username}@{host}:{port} via SSH key (attempt {attempt})")
