...
T = TypeVar("T", bound="ApiErrorLaunchResourceNotFound")
...
class ApiErrorLaunchResourceNotFound:
    ...
    Attributes:
        ...
        message (str): The resource the API was unable to find.
        suggestion (str): One or more suggestions of possible ways to fix the error.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_error_launch_resource_not_found = cls(
            code=code,
            message=message,
            suggestion=suggestion,
        )

        api_error_launch_resource_not_found.additional_properties = d
        return api_error_launch_resource_not_found
