...
T = TypeVar("T", bound="ApiErrorInstanceNotFound")
...
class ApiErrorInstanceNotFound:
    ...
    Attributes:
        ...
        message (str): A description of the error. Default: 'Specified instance does not exist.'.
        suggestion (str | Unset): One or more suggestions of possible ways to fix the error.
    """

    code: Literal["global/object-does-not-exist"]
    message: str = "Specified instance does not exist."
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_error_instance_not_found = cls(
            code=code,
            message=message,
            suggestion=suggestion,
        )

        api_error_instance_not_found.additional_properties = d
        return api_error_instance_not_found
