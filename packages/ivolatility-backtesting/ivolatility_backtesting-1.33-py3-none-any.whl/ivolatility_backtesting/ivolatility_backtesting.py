...
STRATEGIES = {
    ...
    'IRON_BUTTERFLY': {
        ...
        # ✅ Options filter for stock-opts-by-param (ATM-based)
        'options_filter': {
            'selection_type': 'moneyness',
            'moneyness_from': -15,         # ATM ±15% moneyness
            'moneyness_to': 15,
            'dte_tracking_min': 0,         # ✅ Track until expiration (0 DTE)
        },
    },
    'BUTTERFLY': {
        ...
        'options_filter': {
            'selection_type': 'moneyness',
            'moneyness_from': -20,         # Wider range for butterfly wings
            'moneyness_to': 20,
            'dte_tracking_min': 0,         # ✅ Track until expiration (0 DTE)
        },
    },
    ...
    'STRADDLE': {
        ...
        'options_filter': {
            'selection_type': 'moneyness',
            'moneyness_from': -10,         # ATM ±10% moneyness
            'moneyness_to': 10,
            'dte_tracking_min': 0,         # ✅ Track until expiration (0 DTE)
        },
    },
