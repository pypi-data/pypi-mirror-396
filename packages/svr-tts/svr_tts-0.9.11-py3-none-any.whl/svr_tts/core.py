...
class SVR_TTS:
    ...
    def synthesize_batch(self, inputs: List[SynthesisInput],
                         ...
                         scaling_max: float = float('inf'),
                         prosody_cond: float = 0.4,
        ...
        Аргументы:
            ...
            prosody_cond: насколько сильно соответствовать просодии
                ...
                wave_24k, _ = \
                    self.base_model.run(
                        ["wave_24k", "duration"], {
                            ...
                            "prosody_cond": np.array([prosody_cond], dtype=np.float32)
                        })
