...
tango_event_sub_mode = click.option(
    "--tango-event-sub-mode",
    "tango_event_sub_mode",
    type=click.Choice(["Sync", "SyncRead", "Async", "AsyncRead", "Stateless"]),
    default=None,
    show_default=True,
    help="Tango subscription mode to use for change events",
)
