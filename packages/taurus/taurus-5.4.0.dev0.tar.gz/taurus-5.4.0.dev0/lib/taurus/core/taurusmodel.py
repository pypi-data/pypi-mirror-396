...
class TaurusModel(Logger):
    ...
    def getTaurusElementType(cls):
        raise NotImplementedError("TaurusModel.getTaurusElementType cannot be called")
    ...
    def getNameValidator(cls):
        raise NotImplementedError("TaurusModel.getNameValidator cannot becalled")
    ...
    def getDisplayDescrObj(self, cache=True):
        ...
        example.
        """
        raise NotImplementedError("TaurusModel.getDisplayDescrObj cannot be called")
