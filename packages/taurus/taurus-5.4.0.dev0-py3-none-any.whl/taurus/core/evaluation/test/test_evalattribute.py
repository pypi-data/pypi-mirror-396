...
from taurus.core.taurusbasetypes import AttrQuality, DataFormat, DataType
...
@insertTest(
    ...
    expected_attrv=dict(rvalue=Quantity([123, 123, 123], "dimensionless"), wvalue=None),
    expectedshape=(3,),
)
@insertTest(
    helper_name="read_attr",
...
@insertTest(
    ...
    expected_attrv=dict(rvalue=Quantity([[1, 2, 3]] * 3, "dimensionless"), wvalue=None),
    expectedshape=(3, 3),
)
@insertTest(
    helper_name="read_attr",
...
class EvalAttributeTestCase(unittest.TestCase):
    def read_attr(
        ...
        msg = (
            'read() for "{0}" did not return an EvaluationAttrValue ' + "(got a {1})"
    ...
    def write_read_attr(
        ...
        msg = (
            'read() for "%s" does not return an EvaluationAttrValue' + "(got a %s)"
