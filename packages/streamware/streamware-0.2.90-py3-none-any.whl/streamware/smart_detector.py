...
class SmartDetector:
    ...
    def analyze(
        ...
        periodic_interval = 2 if is_track_mode else self.periodic_interval  # Check every 2 frames in track mode
        ...
        if not yolo_detected and self.use_hog and self.focus == "person":
            ...
            if not has_person_hog and hog_confidence > 0.85:  # Increased threshold to be less strict
                ...
                skip_interval = 3 if self.mode == 'track' else 5
