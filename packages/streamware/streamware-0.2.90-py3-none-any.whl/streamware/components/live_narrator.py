    ...
    def _build_advanced_prompt(self, analysis: Dict) -> str:
        ...
        if self.mode == "track" and self.focus:
            ...
            if focus_obj in ("person", "people", "human"):
                ...
                # Very lenient prompt for person detection - better for tracking
                return "Look very carefully at this image for any signs of a human. A person could be: a full person, partial view, silhouette, shadow, reflection, or even a vague human-shaped object. If you see ANYTHING that might be a person, describe what they're doing. Only say 'No person visible' if you are absolutely certain the room is empty or contains only furniture/objects. Be extremely generous - it's better to say there's a person than to miss one."
