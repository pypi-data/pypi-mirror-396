...
DEFAULTS = {
    ...
    "SQ_MOTION_GATE_THRESHOLD": "1000",  # Minimum motion area in pixels to trigger detection
    "SQ_PERIODIC_INTERVAL": "30",         # Force detection every N frames even without motion
