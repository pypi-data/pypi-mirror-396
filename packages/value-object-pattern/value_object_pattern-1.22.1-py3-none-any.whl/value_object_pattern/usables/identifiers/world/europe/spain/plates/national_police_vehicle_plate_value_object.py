...
class NationalPoliceVehiclePlateValueObject(NotEmptyStringValueObject, TrimmedStringValueObject):
    ...
    _VALIDATION_REGEX: Pattern[str] = re_compile(pattern=r'CNP[0-9]{4}[A-Z]{2}')
    ...
    def _ensure_value_follows_identification_regex(self, value: str) -> None:
        ...
        if not self._IDENTIFICATION_REGEX.fullmatch(string=value):
            self._raise_value_is_not_national_police_plate(value=value)
    ...
    def _raise_value_is_not_national_police_plate(self, value: str) -> NoReturn:
        """
        ...
        """
        raise ValueError(f'NationalPoliceVehiclePlateValueObject value <<<{value}>>> is not a valid Spanish national police plate.')  # noqa: E501  # fmt: skip
