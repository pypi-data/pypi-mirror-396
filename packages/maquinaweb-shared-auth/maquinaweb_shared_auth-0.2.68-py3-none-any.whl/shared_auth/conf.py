...
def get_db_router():
    """Retorna o router de banco de dados configurado ou o padrão"""
    return get_setting("SHARED_AUTH_DB_ROUTER", "auth_db")
...
CONTACT_TABLE = get_setting("SHARED_AUTH_CONTACT_TABLE", "organization_contact")
EMAIL_TABLE = get_setting("SHARED_AUTH_EMAIL_TABLE", "organization_email")
PHONE_TABLE = get_setting("SHARED_AUTH_PHONE_TABLE", "organization_phone")
MESSAGE_TABLE = get_setting("SHARED_AUTH_MESSAGE_TABLE", "organization_message")
