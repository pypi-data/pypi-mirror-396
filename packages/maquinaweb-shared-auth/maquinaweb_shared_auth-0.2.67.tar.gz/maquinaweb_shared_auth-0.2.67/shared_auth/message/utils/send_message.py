...
from message.services.twilio_service import _send_twilio_message
from message.utils import MessageTypes
from message.utils.build_email_message import build_email_message
...
def send_message(
    ...
    try:
        if type == MessageTypes.EMAIL:
            ...
            _send_twilio_message(type, template, context)
        else:
