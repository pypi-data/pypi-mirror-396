...
def user_has_permission(
    user_id, organization_id, permission_codename, system_id, request=None
):
    """
    ...
    codenames = get_cached_permission_codenames(
        member_group.group_id, system_id, request
    )
...
def get_user_permission_codenames(user_id, organization_id, system_id, request=None):
    ...
    Usage:
        from shared_auth.permissions import get_user_permission_codenames
...
def get_organization_permissions(organization_id, system_id):
    ...
    Usage:
        from shared_auth.permissions import get_organization_permissions
    ...
    for group in group_permissions:
        permission_ids.extend(group.permissions.values_list("id", flat=True))
...
def get_organization_permission_codenames(organization_id, system_id):
    ...
    Usage:
        from shared_auth.permissions import get_organization_permission_codenames
...
def user_has_any_permission(user_id, organization_id, permission_codenames, system_id):
    ...
    Usage:
        from shared_auth.permissions import user_has_any_permission
...
def user_has_all_permissions(user_id, organization_id, permission_codenames, system_id):
    ...
    Usage:
        from shared_auth.permissions import user_has_all_permissions
