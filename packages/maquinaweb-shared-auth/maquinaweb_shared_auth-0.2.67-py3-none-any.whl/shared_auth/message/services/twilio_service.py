...
from message.utils import MessageTypes
from message.utils.build_sms_message import build_sms_message
from message.utils.build_whatsapp_message import build_whatsapp_message
...
def _send_twilio_message(
    message_type: str, template: str, context: Mapping
) -> None:
    phones = _normalize_phone_numbers(context.get("phone") or context.get("phones"))
