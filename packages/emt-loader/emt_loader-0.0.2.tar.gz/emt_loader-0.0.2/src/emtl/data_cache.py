...
class DataCache:
    """
    The DataCache caches and manages loaded data of the EMT data-loader package, thereby avoiding unnecessary reloading.
    ...
    def is_file_cached(self, file_name: str) -> bool:
        ...
        return (self._cache_dir_path / file_name).exists()
