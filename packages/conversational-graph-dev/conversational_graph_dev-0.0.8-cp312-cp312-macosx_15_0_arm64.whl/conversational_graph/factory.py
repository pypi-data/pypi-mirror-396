...
from ._internal.tools import PreDefinedToolEngine,DataModel,AuthDetails, HttpReqTool


class ConversationalDataModel(ABC):
    """
...
class HttpToolRequest(ABC):
    ...
    def __new__(cls, name:str, description:str, url:str, method:Literal["GET","POST"] = "GET", auth:ToolAuthDetails = None, params:dict = None,payload:dict = None):
