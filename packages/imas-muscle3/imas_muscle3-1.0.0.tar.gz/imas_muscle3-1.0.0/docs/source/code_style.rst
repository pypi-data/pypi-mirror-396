...
IMAS-MUSCLE3 follows `The Black Code Style
...
IMAS-MUSCLE3 uses `flake8 <https://flake8.pycqa.org/en/latest/>`_ for linting (static code
analysis). Flake8 should not report any violations when running it on the ``imas_muscle3``
...
Type checking
-------------
IMAS-MUSCLE3 uses typing hinting which is checked at compile time using `mypy 
...
Import sorting
--------------
IMAS-MUSCLE3 uses `isort <https://pycqa.github.io/isort/>`_ for automatic import sorting separated by type.
