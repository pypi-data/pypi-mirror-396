WORKFLOW_SCHEMA = {
    ...
    "properties": {
        ...
        "inputs": {
            "type": "array",
            "description": "Input fields required to start the workflow",
            "items": {
                "type": "object",
                "properties": {
                    "name": {
                        "type": "string",
                        "pattern": "^[a-zA-Z_][a-zA-Z0-9_]*$",
                        "description": "Input field name (must be valid Python identifier)"
                    },
                    "description": {
                        "type": "string",
                    ...
                    "type": {
                        "type": "string",
                        "enum": ["text", "number", "boolean", "list", "dict", "any"],
                        "description": "Input field data type"
                    },
                    "required": {
                        "type": "boolean",
