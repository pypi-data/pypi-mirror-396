...
class CollectInputStrategy(ActionStrategy):
    ...
    def execute(self, state: Dict[str, Any]) -> Dict[str, Any]:
        with trace_node_execution(
            ...
            prompt = self._generate_prompt(agent, conversation)
    ...
    def _load_agent_tools(self) -> List:
        return [
            self.engine_context.tool_repository.load(tool_name)
    ...
    def _create_agent(self, state: Dict[str, Any]) -> AgentAdapter:
        try:
            ...
            agent_tools = self._load_agent_tools()
