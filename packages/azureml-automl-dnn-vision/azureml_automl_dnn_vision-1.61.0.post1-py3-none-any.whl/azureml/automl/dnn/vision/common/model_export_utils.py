...
def prepare_model_export(run: Run, output_dir: str, task_type: str,
    ...
    inference_deps = CondaDependencies.create(python_version=python_version,
                                              conda_packages=inference.AutoMLVisionCondaPackagesList,
                                              pip_packages=inference.AutoMLVisionPipPackagesList,
                                              pin_sdk_version=True)
    strs_to_save[shared_constants.INFERENCE_DEPENDENCIES] = inference_deps
