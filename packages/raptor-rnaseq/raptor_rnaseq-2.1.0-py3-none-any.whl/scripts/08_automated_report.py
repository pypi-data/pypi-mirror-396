#!/usr/bin/env python3
"""
RAPTOR v2.1.0 Example Script: Automated Reporting
...
def print_banner():
    ...
    print("""
    ╔══════════════════════════════════════════════════════════════╗
    ║       🦖 RAPTOR v2.1.0 - Automated Reporting                ║
    ║                                                              ║
...
"""
    ...
    html_content += f"""        </table>
        ...
        <p>
            Analysis was conducted using RAPTOR v2.1.0 (RNA-seq Analysis Pipeline Testing and 
        ...
        <div class="footer">
            <p>🦖 Generated by RAPTOR v2.1.0</p>
