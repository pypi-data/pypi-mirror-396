...
from layerlearn.baseLinear import LinearForestRegressor, LinearSupportRegressor, LinearDecisionRegressor, LinearKNNRegressor, LinearXGBRRegressor, LinearCatRegressor, LinearGradientRegressor, LinearAdaRegressor, LinearLightRegressor
import warnings
...
models = {
    ...
    "Linear XGBoost Regressor": LinearXGBRRegressor(),
...
ax.set_title('Comparison of Linear Model Regressor Performance', fontsize=18, fontweight='bold')
