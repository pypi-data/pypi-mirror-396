...
class DatabaseManager:
    def __init__(self, env_path=None, dbName=None, dbType=None,dbUser=None, conn_mgr=None):
        self.conn_mgr = conn_mgr or connectionManager(env_path=env_path, dbType=dbType, dbName=dbName,dbUser=dbUser)
