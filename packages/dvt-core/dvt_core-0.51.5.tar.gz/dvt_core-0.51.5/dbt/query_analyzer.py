...
class QueryAnalyzer:
    ...
    def analyze(
        ...
        if user_compute_override:
            ...
            # This includes: seeds, snapshots, ephemeral models, OR models that only ref() other models
            # DVT v0.51.5: Models with only refs use target database (where refs are materialized)
            strategy = "pushdown"
            ...
            if has_refs and target_connection:
                ...
                primary_connection = target_connection  # Use target or default
            user_override = None
