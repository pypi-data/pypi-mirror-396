...
class StandaloneStrategy(BaseConnectionStrategy):
    ...
    def test_connectivity(self) -> Tuple[bool, str]:
        ...
        v0.51.1: Added 30-second timeout to prevent hanging when workers unavailable.
        ...
        try:
            ...
            with concurrent.futures.ThreadPoolExecutor(max_workers=1) as executor:
                ...
                try:
                    ...
                    return (False, f"Timeout: Workers not responding at '{master}' (is the cluster running?)")
