...
class CiscoDeviceSupportViewSet(NetBoxModelViewSet):
    queryset = models.CiscoDeviceSupport.objects.all().prefetch_related("device").order_by("id")
...
class CiscoDeviceTypeSupportViewSet(NetBoxModelViewSet):
    queryset = models.CiscoDeviceTypeSupport.objects.all().prefetch_related("device_type").order_by("id")
...
class FortinetDeviceSupportViewSet(NetBoxModelViewSet):
    queryset = models.FortinetDeviceSupport.objects.all().prefetch_related("device").order_by("id")
...
class PureStorageDeviceSupportViewSet(NetBoxModelViewSet):
    queryset = models.PureStorageDeviceSupport.objects.all().prefetch_related("device").order_by("id")
