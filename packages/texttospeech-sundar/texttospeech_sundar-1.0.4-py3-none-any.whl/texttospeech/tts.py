"""
texttospeech_sundar: Online + Offline Text-to-Speech
"""
...
def offline_tts(text, save_path=None, play_audio_flag=True):
...
def online_tts(text, lang="en", slow=False, save_path=None, play_audio_flag=True):
