...
class Screen:
    ...
    def search_filter(self, search_string=None, only_ids=False):
        ...
        while True:
            try:
                ids = RPCExecute(
                    'model', self.model_name, 'search', domain,
