...
from gnuhealth.common import IconFactory, Tooltips, get_align, node_attributes
from gnuhealth.common.button import Button
from gnuhealth.common.focus import (
...
from gnuhealth.gui.window.code_scanner import CodeScanner

from . import View, XMLViewParser
from .form_gtk.binary import Binary
from .form_gtk.binary_dicom import BinaryDicom
...
class ViewForm(View):
    ...
    def modified(self):
        return any(
            w.modified for widgets in self.widgets.values()
            for w in widgets)
