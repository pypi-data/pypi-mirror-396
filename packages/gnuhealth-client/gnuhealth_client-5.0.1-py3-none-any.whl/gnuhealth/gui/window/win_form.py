...
from gnuhealth.common import MODELNAME, GNUHEALTH_ICON
    ...
    def __init__(self, screen, callback=None, view_type='form',
        ...
        if view_type == 'form' and not readonly:
            if new:
                ...
                label, icon = _("Discard changes"), 'gnuhealth-cancel'
        ...
        if new and self.many:
            ...
            self.but_new.set_accel_path(
                '<from gnuhealth>/Form/New', self.accel_group)
        ...
        if self.save_current and not readonly:
            ...
            self.but_ok.set_accel_path(
                '<from gnuhealth>/Form/Save', self.accel_group)
