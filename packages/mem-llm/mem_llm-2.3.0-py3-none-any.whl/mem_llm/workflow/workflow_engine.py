    ...
    async def execute(self, context: WorkflowContext) -> Any:
        ...
        try:
            ...
            if self.agent and isinstance(self.action, str):
                ...
                logger.info(f" Agent {self.agent.agent_id if hasattr(self.agent, 'agent_id') else 'Agent'} thinking...")
            ...
            context.history.append({
                "step": self.name,
                "status": "success",
                "output": str(result)[:200] + "..." if result and len(str(result)) > 200 else result
            })
    ...
    async def run_generator(self, initial_data: Dict[str, Any] = None):
        ...
        for step in self.steps:
            ...
            try:
                ...
                output_str = str(result)[:500] + "..." if result and len(str(result)) > 500 else str(result)
