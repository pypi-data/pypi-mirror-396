...
class NotificationsService(SlobsService):
    ...
    def __init__(self, connection):
        ...
        self.notification_pushed = Event(
            connection, "notificationPushed", self.__class__.__name__
        )
        self.notification_read = Event(
            connection, "notificationRead", self.__class__.__name__
        )
