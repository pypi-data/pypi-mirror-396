...
class SelectionBase:
    ...
    async def copy_to(
        ...
        duplicate_sources: bool | None = None,
    ) -> None:
        response = await self._connection.command(
    ...
    async def get_bounding_rect(self) -> IRectangle | None:
        response = await self._connection.command(
    ...
    async def move_to(self, scene_id: str, folder_id: str | None = None) -> None:
        response = await self._connection.command(
    ...
    async def scale(self, scale: IVec2, origin: IVec2 | None = None) -> None:
        response = await self._connection.command(
