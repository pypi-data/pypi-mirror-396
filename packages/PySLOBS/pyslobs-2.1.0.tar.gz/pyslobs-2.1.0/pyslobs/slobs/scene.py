...
class Scene(SlobsClass):
    ...
    async def add_file(self, path, folder_id: str | None = None) -> SceneNode:
    ...
    async def add_source(
        self, source_id: str, options: ISceneNodeAddOptions | None = None
    ) -> SceneItem:
        options_dict = {}
        if options:
    ...
    async def create_and_add_source(
        self, name: str, type_: TSourceType, settings: dict[Any, Any] | None = None
    ):  # -> SceneItem:
        response = await self._connection.command(
    ...
    async def get_item(self, scene_folder_id: str) -> SceneItem | None:
        response = await self._connection.command(
    ...
    async def get_node_by_name(self, name: str) -> SceneNode | None:
        response = await self._connection.command(
    ...
    async def get_selection(self, ids: list[str] | None = None):
        response = await self._connection.command(
