...
class box(BaseStage):
    ...
    connection: BoxConn = BoxConn()
    buf_free_run_ronly: int | None = Field(50, alias="buf_free_run_ronly")
    buf_mode_ronly: BOX.BufModeRonly | None = Field(BOX.BufModeRonly.default, alias="buf_mode_ronly")
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: BOX.BufferingMode | None = Field(BOX.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    cell_range: str | None = Field(None, alias="range")
    codec_avro: BOX.CodecAvro | None = Field(None, alias="codec_avro")
    codec_csv: BOX.CodecCsv | None = Field(None, alias="codec_csv")
    codec_delimited: BOX.CodecDelimited | None = Field(None, alias="codec_delimited")
    codec_orc: BOX.CodecOrc | None = Field(None, alias="codec_orc")
    codec_parquet: BOX.CodecParquet | None = Field(None, alias="codec_parquet")
    collecting: BOX.Collecting | None = Field(BOX.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: BOX.CombinabilityMode | None = Field(BOX.CombinabilityMode.auto, alias="combinability")
    ...
    decimal_rounding_mode: BOX.DecimalRoundingMode | None = Field(
        BOX.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    escape_character: BOX.EscapeCharacter | None = Field(BOX.EscapeCharacter.none, alias="escape_character")
    ...
    execution_mode: BOX.ExecutionMode | None = Field(BOX.ExecutionMode.default_par, alias="execmode")
    field_delimiter: BOX.FieldDelimiter | None = Field(BOX.FieldDelimiter.comma, alias="field_delimiter")
    ...
    file_format: BOX.FileFormat | None = Field(BOX.FileFormat.csv, alias="file_format")
    ...
    invalid_data_handling: BOX.InvalidDataHandling | None = Field(
        BOX.InvalidDataHandling.fail, alias="invalid_data_handling"
    )
    ...
    partition_type: BOX.PartitionType | None = Field(BOX.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: BOX.PreservePartitioning | None = Field(
        BOX.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    quote_character: BOX.QuoteCharacter | None = Field(BOX.QuoteCharacter.none, alias="quote_character")
    quote_numeric_values: bool | None = Field(True, alias="quote_numerics")
    read_mode: BOX.ReadMode | None = Field(BOX.ReadMode.read_single, alias="read_mode")
    row_delimiter: BOX.RowDelimiter | None = Field(BOX.RowDelimiter.new_line, alias="row_delimiter")
    ...
    sorting_key: BOX.KeyColSelect | None = Field(BOX.KeyColSelect.default, alias="keyColSelect")
    ...
    write_mode: BOX.WriteMode | None = Field(BOX.WriteMode.write, alias="write_mode")
