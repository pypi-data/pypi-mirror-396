...
from ibm_watsonx_data_integration.services.datastage.models.enums import SAPIQ
from pydantic import Field
from typing import ClassVar


class sapiq(BaseStage):
    ...
    connection: SapiqConn = SapiqConn()
    batch_size: int | None = Field(2000, alias="batch_size")
    buf_free_run_ronly: int | None = Field(50, alias="buf_free_run_ronly")
    buf_mode_ronly: SAPIQ.BufModeRonly | None = Field(SAPIQ.BufModeRonly.default, alias="buf_mode_ronly")
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: SAPIQ.BufferingMode | None = Field(SAPIQ.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    collecting: SAPIQ.Collecting | None = Field(SAPIQ.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: SAPIQ.CombinabilityMode | None = Field(SAPIQ.CombinabilityMode.auto, alias="combinability")
    ...
    decimal_rounding_mode: SAPIQ.DecimalRoundingMode | None = Field(
        SAPIQ.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    execution_mode: SAPIQ.ExecutionMode | None = Field(SAPIQ.ExecutionMode.default_par, alias="execmode")
    existing_table_action: SAPIQ.ExistingTableAction | None = Field(
        SAPIQ.ExistingTableAction.append, alias="existing_table_action"
    )
    ...
    partition_type: SAPIQ.PartitionType | None = Field(SAPIQ.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: SAPIQ.PreservePartitioning | None = Field(
        SAPIQ.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_method: SAPIQ.ReadMethod | None = Field(SAPIQ.ReadMethod.general, alias="read_mode")
    ...
    sorting_key: SAPIQ.KeyColSelect | None = Field(SAPIQ.KeyColSelect.default, alias="keyColSelect")
    ...
    table_action: SAPIQ.TableAction | None = Field(SAPIQ.TableAction.append, alias="table_action")
    ...
    write_mode: SAPIQ.WriteMode | None = Field(SAPIQ.WriteMode.insert, alias="write_mode")
