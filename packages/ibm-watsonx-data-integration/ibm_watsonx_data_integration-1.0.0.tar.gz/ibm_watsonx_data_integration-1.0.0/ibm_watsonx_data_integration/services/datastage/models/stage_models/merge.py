...
from ibm_watsonx_data_integration.services.datastage.models.enums import MERGE
from pydantic import Field
from typing import ClassVar


class merge(BaseStage):
    ...
    buf_mode: MERGE.BufMode | None = Field(MERGE.BufMode.default, alias="buf_mode")
    buf_mode_ronly: MERGE.BufModeRonly | None = Field(MERGE.BufModeRonly.default, alias="buf_mode_ronly")
    coll_type: MERGE.CollType | None = Field(MERGE.CollType.auto, alias="coll_type")
    collation_sequence: MERGE.CollationSequence | None = Field(MERGE.CollationSequence.OFF, alias="collation_sequence")
    combinability: MERGE.Combinability | None = Field(MERGE.Combinability.auto, alias="combinability")
    ...
    drop_bad_masters_keep_bad_masters: MERGE.DropBadMastersKeepBadMasters | None = Field(
        MERGE.DropBadMastersKeepBadMasters.keepBadMasters, alias="dropBadMasters-keepBadMasters"
    )
    ...
    execmode: MERGE.Execmode | None = Field(MERGE.Execmode.default_par, alias="execmode")
    ...
    key_col_select: MERGE.KeyColSelect | None = Field(MERGE.KeyColSelect.default, alias="keyColSelect")
    ...
    nowarn_bad_masters_warn_bad_masters: MERGE.NowarnBadMastersWarnBadMasters | None = Field(
        MERGE.NowarnBadMastersWarnBadMasters.warnBadMasters, alias="nowarnBadMasters-warnBadMasters"
    )
    nowarn_bad_updates_warn_bad_updates: MERGE.NowarnBadUpdatesWarnBadUpdates | None = Field(
        MERGE.NowarnBadUpdatesWarnBadUpdates.warnBadUpdates, alias="nowarnBadUpdates-warnBadUpdates"
    )
    ...
    part_type: MERGE.PartType | None = Field(MERGE.PartType.auto, alias="part_type")
    ...
    preserve: MERGE.Preserve | None = Field(MERGE.Preserve.default_propagate, alias="preserve")
    ...
    def _get_parameters_props(self) -> dict:
        ...
        props = {
            ...
            "drop_bad_masters_keep_bad_masters",
            ...
            "nowarn_bad_masters_warn_bad_masters",
            "nowarn_bad_updates_warn_bad_updates",
