...
from ibm_watsonx_data_integration.services.datastage.models.enums import DB2WAREHOUSE
from pydantic import Field
from typing import ClassVar


class db2warehouse(BaseStage):
    ...
    connection: Db2warehouseConn = Db2warehouseConn()
    ...
    buf_mode_ronly: DB2WAREHOUSE.BufModeRonly | None = Field(DB2WAREHOUSE.BufModeRonly.default, alias="buf_mode_ronly")
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: DB2WAREHOUSE.BufferingMode | None = Field(DB2WAREHOUSE.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    call_procedure_statement: str | None = Field(None, alias="call_statement")
    collecting: DB2WAREHOUSE.Collecting | None = Field(DB2WAREHOUSE.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: DB2WAREHOUSE.CombinabilityMode | None = Field(
        DB2WAREHOUSE.CombinabilityMode.auto, alias="combinability"
    )
    ...
    credentials_input_method_ssl: DB2WAREHOUSE.CredentialsInputMethodSsl | None = Field(
        DB2WAREHOUSE.CredentialsInputMethodSsl.enter_credentials_manually, alias="credentials_input_method_ssl"
    )
    ...
    decimal_rounding_mode: DB2WAREHOUSE.DecimalRoundingMode | None = Field(
        DB2WAREHOUSE.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    execution_mode: DB2WAREHOUSE.ExecutionMode | None = Field(DB2WAREHOUSE.ExecutionMode.default_par, alias="execmode")
    existing_table_action: DB2WAREHOUSE.ExistingTableAction | None = Field(
        DB2WAREHOUSE.ExistingTableAction.append, alias="existing_table_action"
    )
    ...
    input_method: DB2WAREHOUSE.InputMethod | None = Field(
        DB2WAREHOUSE.InputMethod.enter_credentials_manually, alias="credentials_input_method"
    )
    ...
    partition_type: DB2WAREHOUSE.PartitionType | None = Field(DB2WAREHOUSE.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: DB2WAREHOUSE.PreservePartitioning | None = Field(
        DB2WAREHOUSE.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_method: DB2WAREHOUSE.ReadMethod | None = Field(DB2WAREHOUSE.ReadMethod.general, alias="read_mode")
    ...
    reject_uses: DB2WAREHOUSE.RejectUses | None = Field(DB2WAREHOUSE.RejectUses.rows, alias="reject_uses")
    ...
    sampling_type: DB2WAREHOUSE.SamplingType | None = Field(DB2WAREHOUSE.SamplingType.none, alias="sampling_type")
    ...
    sorting_key: DB2WAREHOUSE.KeyColSelect | None = Field(DB2WAREHOUSE.KeyColSelect.default, alias="keyColSelect")
    ...
    table_action: DB2WAREHOUSE.TableAction | None = Field(DB2WAREHOUSE.TableAction.append, alias="table_action")
    ...
    write_mode: DB2WAREHOUSE.WriteMode | None = Field(DB2WAREHOUSE.WriteMode.insert, alias="write_mode")
