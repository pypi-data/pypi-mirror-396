...
"""This module defines the Apache HBase stage."""
...
class ApacheHbaseStage(StageNode):
    """This class defines the Apache HBase stage."""

    def __init__(self, dag: "DAG", configuration: apache_hbase = None, *, label: str = None) -> None:
        """Initializes an instance of a Apache HBase stage."""
