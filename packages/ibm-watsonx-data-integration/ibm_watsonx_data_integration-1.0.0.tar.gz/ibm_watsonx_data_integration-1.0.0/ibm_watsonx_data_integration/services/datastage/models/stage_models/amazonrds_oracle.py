...
from ibm_watsonx_data_integration.services.datastage.models.enums import AMAZONRDS_ORACLE
from pydantic import Field
from typing import ClassVar


class amazonrds_oracle(BaseStage):
    ...
    connection: AmazonrdsOracleConn = AmazonrdsOracleConn()
    batch_size: int | None = Field(2000, alias="batch_size")
    buf_free_run_ronly: int | None = Field(50, alias="buf_free_run_ronly")
    buf_mode_ronly: AMAZONRDS_ORACLE.BufModeRonly | None = Field(
        AMAZONRDS_ORACLE.BufModeRonly.default, alias="buf_mode_ronly"
    )
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: AMAZONRDS_ORACLE.BufferingMode | None = Field(
        AMAZONRDS_ORACLE.BufferingMode.default, alias="buf_mode"
    )
    byte_limit: str | None = Field(None, alias="byte_limit")
    collecting: AMAZONRDS_ORACLE.Collecting | None = Field(AMAZONRDS_ORACLE.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: AMAZONRDS_ORACLE.CombinabilityMode | None = Field(
        AMAZONRDS_ORACLE.CombinabilityMode.auto, alias="combinability"
    )
    ...
    decimal_rounding_mode: AMAZONRDS_ORACLE.DecimalRoundingMode | None = Field(
        AMAZONRDS_ORACLE.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    execution_mode: AMAZONRDS_ORACLE.ExecutionMode | None = Field(
        AMAZONRDS_ORACLE.ExecutionMode.default_par, alias="execmode"
    )
    existing_table_action: AMAZONRDS_ORACLE.ExistingTableAction | None = Field(
        AMAZONRDS_ORACLE.ExistingTableAction.append, alias="existing_table_action"
    )
    ...
    number_type: AMAZONRDS_ORACLE.NumberType | None = Field(None, alias="number_type")
    ...
    partition_type: AMAZONRDS_ORACLE.PartitionType | None = Field(
        AMAZONRDS_ORACLE.PartitionType.auto, alias="part_type"
    )
    ...
    preserve_partitioning: AMAZONRDS_ORACLE.PreservePartitioning | None = Field(
        AMAZONRDS_ORACLE.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_method: AMAZONRDS_ORACLE.ReadMethod | None = Field(AMAZONRDS_ORACLE.ReadMethod.general, alias="read_mode")
    ...
    reject_uses: AMAZONRDS_ORACLE.RejectUses | None = Field(AMAZONRDS_ORACLE.RejectUses.rows, alias="reject_uses")
    ...
    sampling_type: AMAZONRDS_ORACLE.SamplingType | None = Field(
        AMAZONRDS_ORACLE.SamplingType.none, alias="sampling_type"
    )
    ...
    sorting_key: AMAZONRDS_ORACLE.KeyColSelect | None = Field(
        AMAZONRDS_ORACLE.KeyColSelect.default, alias="keyColSelect"
    )
    ...
    table_action: AMAZONRDS_ORACLE.TableAction | None = Field(AMAZONRDS_ORACLE.TableAction.append, alias="table_action")
    ...
    write_mode: AMAZONRDS_ORACLE.WriteMode | None = Field(AMAZONRDS_ORACLE.WriteMode.insert, alias="write_mode")
