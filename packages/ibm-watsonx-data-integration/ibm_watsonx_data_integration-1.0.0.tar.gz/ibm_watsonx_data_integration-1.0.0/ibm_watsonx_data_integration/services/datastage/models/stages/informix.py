...
"""This module defines the IBM Informix stage."""
...
class IBMInformixStage(StageNode):
    """This class defines the IBM Informix stage."""

    def __init__(self, dag: "DAG", configuration: informix = None, *, label: str = None) -> None:
        """Initializes an instance of a IBM Informix stage."""
