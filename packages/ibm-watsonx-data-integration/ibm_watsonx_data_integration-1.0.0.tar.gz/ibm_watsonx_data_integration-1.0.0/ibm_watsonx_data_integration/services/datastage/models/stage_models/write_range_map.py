...
from ibm_watsonx_data_integration.services.datastage.models.enums import WRITE_RANGE_MAP
from pydantic import Field
from typing import ClassVar


class write_range_map(BaseStage):
    ...
    buf_mode: WRITE_RANGE_MAP.BufMode | None = Field(WRITE_RANGE_MAP.BufMode.default, alias="buf_mode")
    buf_mode_ronly: WRITE_RANGE_MAP.BufModeRonly | None = Field(
        WRITE_RANGE_MAP.BufModeRonly.default, alias="buf_mode_ronly"
    )
    coll_type: WRITE_RANGE_MAP.CollType | None = Field(WRITE_RANGE_MAP.CollType.auto, alias="coll_type")
    combinability: WRITE_RANGE_MAP.Combinability | None = Field(
        WRITE_RANGE_MAP.Combinability.auto, alias="combinability"
    )
    ...
    execmode: WRITE_RANGE_MAP.Execmode | None = Field(WRITE_RANGE_MAP.Execmode.default_seq, alias="execmode")
    flow_dirty: str | None = Field("false", alias="flow_dirty")
    hide: bool | None = Field(False, alias="hide")
    input_count: int | None = Field(0, alias="input_count")
    input_link_description: list | None = Field("", alias="inputLinkDescription")
    inputcol_properties: list | None = Field([], alias="inputcolProperties")
    key_col_select: WRITE_RANGE_MAP.KeyColSelect | None = Field(
        WRITE_RANGE_MAP.KeyColSelect.default, alias="keyColSelect"
    )
    ...
    overwrite: WRITE_RANGE_MAP.Overwrite | None = Field(WRITE_RANGE_MAP.Overwrite.false, alias="overwrite")
    ...
    part_type: WRITE_RANGE_MAP.PartType | None = Field(WRITE_RANGE_MAP.PartType.auto, alias="part_type")
    ...
    rangemap: str = Field(None, alias="rangemap")
    ...
    def _get_input_ports_props(self) -> dict:
        ...
        props = {"key_properties", "overwrite", "rangemap", "runtime_column_propagation"}
        required = {"rangemap"}
