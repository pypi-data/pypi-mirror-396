...
from ibm_watsonx_data_integration.services.datastage.models.enums import MODIFY
from pydantic import Field
from typing import ClassVar


class modify(BaseStage):
    ...
    buf_mode: MODIFY.BufMode | None = Field(MODIFY.BufMode.default, alias="buf_mode")
    buf_mode_ronly: MODIFY.BufModeRonly | None = Field(MODIFY.BufModeRonly.default, alias="buf_mode_ronly")
    coll_type: MODIFY.CollType | None = Field(MODIFY.CollType.auto, alias="coll_type")
    combinability: MODIFY.Combinability | None = Field(MODIFY.Combinability.auto, alias="combinability")
    ...
    endingquote: str | None = Field("'", alias="endingquote")
    execmode: MODIFY.Execmode | None = Field(MODIFY.Execmode.default_par, alias="execmode")
    flow_dirty: str | None = Field("false", alias="flow_dirty")
    hide: bool | None = Field(False, alias="hide")
    input_count: int | None = Field(0, alias="input_count")
    input_link_description: list | None = Field("", alias="inputLinkDescription")
    inputcol_properties: list | None = Field([], alias="inputcolProperties")
    key_col_select: MODIFY.KeyColSelect | None = Field(MODIFY.KeyColSelect.default, alias="keyColSelect")
    ...
    modifyspec_properties: list | None = Field([], alias="modifyspecProperties")
    ...
    part_type: MODIFY.PartType | None = Field(MODIFY.PartType.auto, alias="part_type")
    ...
    preserve: MODIFY.Preserve | None = Field(MODIFY.Preserve.default_propagate, alias="preserve")
    ...
    def _validate_parameters(self) -> tuple[set, set]:
        ...
        include.add("endingquote") if ((()) and (())) else exclude.add("endingquote")
