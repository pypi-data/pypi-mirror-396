"""Module for Cassandra connection."""
...
class CassandraConn(BaseConnection):
    """Connection class for Cassandra."""

    model_config = ConfigDict(populate_by_name=True)

    datasource_type: ClassVar[str] = "e6ff8c10-4199-4b58-9a93-749411eafacd"
    ...
    read_consistency: CASSANDRA_CONNECTION.ReadConsistency | None = Field(
        CASSANDRA_CONNECTION.ReadConsistency.quorum, alias="read_consistency"
    )
    ...
    write_consistency: CASSANDRA_CONNECTION.WriteConsistency | None = Field(
        CASSANDRA_CONNECTION.WriteConsistency.quorum, alias="write_consistency"
    )
    ...
    @classmethod
    def _from_dict(cls, properties: dict[str, Any]) -> "CassandraConn":
