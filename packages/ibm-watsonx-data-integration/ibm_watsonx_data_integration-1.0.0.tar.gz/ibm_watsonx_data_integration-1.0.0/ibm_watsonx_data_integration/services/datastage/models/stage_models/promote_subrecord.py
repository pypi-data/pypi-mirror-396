...
from ibm_watsonx_data_integration.services.datastage.models.enums import PROMOTE_SUBRECORD
from pydantic import Field
from typing import ClassVar


class promote_subrecord(BaseStage):
    ...
    buf_mode: PROMOTE_SUBRECORD.BufMode | None = Field(PROMOTE_SUBRECORD.BufMode.default, alias="buf_mode")
    buf_mode_ronly: PROMOTE_SUBRECORD.BufModeRonly | None = Field(
        PROMOTE_SUBRECORD.BufModeRonly.default, alias="buf_mode_ronly"
    )
    coll_type: PROMOTE_SUBRECORD.CollType | None = Field(PROMOTE_SUBRECORD.CollType.auto, alias="coll_type")
    combinability: PROMOTE_SUBRECORD.Combinability | None = Field(
        PROMOTE_SUBRECORD.Combinability.auto, alias="combinability"
    )
    ...
    execmode: PROMOTE_SUBRECORD.Execmode | None = Field(PROMOTE_SUBRECORD.Execmode.default_par, alias="execmode")
    flow_dirty: str | None = Field("false", alias="flow_dirty")
    hide: bool | None = Field(False, alias="hide")
    input_count: int | None = Field(0, alias="input_count")
    input_link_description: list | None = Field("", alias="inputLinkDescription")
    inputcol_properties: list | None = Field([], alias="inputcolProperties")
    key_col_select: PROMOTE_SUBRECORD.KeyColSelect | None = Field(
        PROMOTE_SUBRECORD.KeyColSelect.default, alias="keyColSelect"
    )
    ...
    part_type: PROMOTE_SUBRECORD.PartType | None = Field(PROMOTE_SUBRECORD.PartType.auto, alias="part_type")
    ...
    preserve: PROMOTE_SUBRECORD.Preserve | None = Field(PROMOTE_SUBRECORD.Preserve.default_propagate, alias="preserve")
