...
from ibm_watsonx_data_integration.services.datastage.models.enums import MYSQL_COMPOSE
from pydantic import Field
from typing import ClassVar


class mysql_compose(BaseStage):
    ...
    connection: MysqlComposeConn = MysqlComposeConn()
    ...
    buf_mode_ronly: MYSQL_COMPOSE.BufModeRonly | None = Field(
        MYSQL_COMPOSE.BufModeRonly.default, alias="buf_mode_ronly"
    )
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: MYSQL_COMPOSE.BufferingMode | None = Field(MYSQL_COMPOSE.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    call_procedure_statement: str | None = Field(None, alias="call_statement")
    collecting: MYSQL_COMPOSE.Collecting | None = Field(MYSQL_COMPOSE.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: MYSQL_COMPOSE.CombinabilityMode | None = Field(
        MYSQL_COMPOSE.CombinabilityMode.auto, alias="combinability"
    )
    ...
    credentials_input_method_ssl: MYSQL_COMPOSE.CredentialsInputMethodSsl | None = Field(
        MYSQL_COMPOSE.CredentialsInputMethodSsl.enter_credentials_manually, alias="credentials_input_method_ssl"
    )
    ...
    decimal_rounding_mode: MYSQL_COMPOSE.DecimalRoundingMode | None = Field(
        MYSQL_COMPOSE.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    execution_mode: MYSQL_COMPOSE.ExecutionMode | None = Field(
        MYSQL_COMPOSE.ExecutionMode.default_par, alias="execmode"
    )
    existing_table_action: MYSQL_COMPOSE.ExistingTableAction | None = Field(
        MYSQL_COMPOSE.ExistingTableAction.append, alias="existing_table_action"
    )
    ...
    input_method: MYSQL_COMPOSE.InputMethod | None = Field(
        MYSQL_COMPOSE.InputMethod.enter_credentials_manually, alias="credentials_input_method"
    )
    ...
    partition_type: MYSQL_COMPOSE.PartitionType | None = Field(MYSQL_COMPOSE.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: MYSQL_COMPOSE.PreservePartitioning | None = Field(
        MYSQL_COMPOSE.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_method: MYSQL_COMPOSE.ReadMethod | None = Field(MYSQL_COMPOSE.ReadMethod.general, alias="read_mode")
    ...
    reject_uses: MYSQL_COMPOSE.RejectUses | None = Field(MYSQL_COMPOSE.RejectUses.rows, alias="reject_uses")
    ...
    sampling_type: MYSQL_COMPOSE.SamplingType | None = Field(MYSQL_COMPOSE.SamplingType.none, alias="sampling_type")
    ...
    sorting_key: MYSQL_COMPOSE.KeyColSelect | None = Field(MYSQL_COMPOSE.KeyColSelect.default, alias="keyColSelect")
    ...
    table_action: MYSQL_COMPOSE.TableAction | None = Field(MYSQL_COMPOSE.TableAction.append, alias="table_action")
    ...
    write_mode: MYSQL_COMPOSE.WriteMode | None = Field(MYSQL_COMPOSE.WriteMode.insert, alias="write_mode")
