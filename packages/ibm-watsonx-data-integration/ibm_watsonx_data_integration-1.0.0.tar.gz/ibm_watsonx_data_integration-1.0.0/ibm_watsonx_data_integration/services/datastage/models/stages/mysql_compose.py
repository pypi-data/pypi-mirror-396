...
"""This module defines the IBM Cloud Databases for MySQL stage."""
...
class IBMCloudDatabasesForMysqlStage(StageNode):
    """This class defines the IBM Cloud Databases for MySQL stage."""

    def __init__(self, dag: "DAG", configuration: mysql_compose = None, *, label: str = None) -> None:
        """Initializes an instance of a IBM Cloud Databases for MySQL stage."""
