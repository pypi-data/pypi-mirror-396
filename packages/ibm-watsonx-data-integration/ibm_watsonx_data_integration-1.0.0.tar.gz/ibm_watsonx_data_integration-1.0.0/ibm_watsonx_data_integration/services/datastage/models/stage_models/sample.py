...
class sample(BaseStage):
    ...
    buf_mode: SAMPLE.BufMode | None = Field(SAMPLE.BufMode.default, alias="buf_mode")
    buf_mode_ronly: SAMPLE.BufModeRonly | None = Field(SAMPLE.BufModeRonly.default, alias="buf_mode_ronly")
    coll_type: SAMPLE.CollType | None = Field(SAMPLE.CollType.auto, alias="coll_type")
    combinability: SAMPLE.Combinability | None = Field(SAMPLE.Combinability.auto, alias="combinability")
    ...
    execmode: SAMPLE.Execmode | None = Field(SAMPLE.Execmode.default_par, alias="execmode")
    ...
    maxoutputrows: int | None = Field(None, alias="maxoutputrows")
    ...
    part_type: SAMPLE.PartType | None = Field(SAMPLE.PartType.auto, alias="part_type")
    ...
    preserve: SAMPLE.Preserve | None = Field(SAMPLE.Preserve.default_propagate, alias="preserve")
    ...
    sample: int = Field(None, alias="sample")
    seed: int | None = Field(None, alias="seed")
    selection: SAMPLE.Selection | None = Field(SAMPLE.Selection.percent, alias="selection")
    ...
    totalmaxoutputrows: int | None = Field(None, alias="totalmaxoutputrows")
    ...
    def _validate_parameters(self) -> tuple[set, set]:
        ...
        (
            include.add("percent_properties")
            if (
                self.selection
                and (
        ...
        (
            ...
            if (
                self.selection
                and (
                    (hasattr(self.selection, "value") and self.selection.value == "period")
                    or (self.selection == "period")
                )
            )
