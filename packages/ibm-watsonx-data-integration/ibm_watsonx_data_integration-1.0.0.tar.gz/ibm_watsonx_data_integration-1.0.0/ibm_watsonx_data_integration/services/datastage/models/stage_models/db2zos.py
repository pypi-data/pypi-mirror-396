...
from ibm_watsonx_data_integration.services.datastage.models.enums import DB2ZOS
from pydantic import Field
from typing import ClassVar


class db2zos(BaseStage):
    ...
    connection: Db2zosConn = Db2zosConn()
    ...
    buf_mode_ronly: DB2ZOS.BufModeRonly | None = Field(DB2ZOS.BufModeRonly.default, alias="buf_mode_ronly")
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: DB2ZOS.BufferingMode | None = Field(DB2ZOS.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    call_procedure_statement: str | None = Field(None, alias="call_statement")
    collecting: DB2ZOS.Collecting | None = Field(DB2ZOS.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: DB2ZOS.CombinabilityMode | None = Field(DB2ZOS.CombinabilityMode.auto, alias="combinability")
    ...
    credentials_input_method_ssl: DB2ZOS.CredentialsInputMethodSsl | None = Field(
        DB2ZOS.CredentialsInputMethodSsl.enter_credentials_manually, alias="credentials_input_method_ssl"
    )
    ...
    decimal_rounding_mode: DB2ZOS.DecimalRoundingMode | None = Field(
        DB2ZOS.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    execution_mode: DB2ZOS.ExecutionMode | None = Field(DB2ZOS.ExecutionMode.default_par, alias="execmode")
    existing_table_action: DB2ZOS.ExistingTableAction | None = Field(
        DB2ZOS.ExistingTableAction.append, alias="existing_table_action"
    )
    ...
    input_method: DB2ZOS.InputMethod | None = Field(
        DB2ZOS.InputMethod.enter_credentials_manually, alias="credentials_input_method"
    )
    ...
    partition_type: DB2ZOS.PartitionType | None = Field(DB2ZOS.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: DB2ZOS.PreservePartitioning | None = Field(
        DB2ZOS.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_method: DB2ZOS.ReadMethod | None = Field(DB2ZOS.ReadMethod.general, alias="read_mode")
    ...
    reject_uses: DB2ZOS.RejectUses | None = Field(DB2ZOS.RejectUses.rows, alias="reject_uses")
    ...
    sampling_type: DB2ZOS.SamplingType | None = Field(DB2ZOS.SamplingType.none, alias="sampling_type")
    ...
    sorting_key: DB2ZOS.KeyColSelect | None = Field(DB2ZOS.KeyColSelect.default, alias="keyColSelect")
    ...
    table_action: DB2ZOS.TableAction | None = Field(DB2ZOS.TableAction.append, alias="table_action")
    ...
    write_mode: DB2ZOS.WriteMode | None = Field(DB2ZOS.WriteMode.insert, alias="write_mode")
