...
from ibm_watsonx_data_integration.services.datastage.models.enums import TERADATA
from pydantic import Field
from typing import ClassVar


class teradata(BaseStage):
    ...
    connection: TeradataConn = TeradataConn()
    ...
    buf_mode_ronly: TERADATA.BufModeRonly | None = Field(TERADATA.BufModeRonly.default, alias="buf_mode_ronly")
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: TERADATA.BufferingMode | None = Field(TERADATA.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    call_procedure_statement: str | None = Field(None, alias="call_statement")
    collecting: TERADATA.Collecting | None = Field(TERADATA.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: TERADATA.CombinabilityMode | None = Field(
        TERADATA.CombinabilityMode.auto, alias="combinability"
    )
    ...
    decimal_rounding_mode: TERADATA.DecimalRoundingMode | None = Field(
        TERADATA.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    execution_mode: TERADATA.ExecutionMode | None = Field(TERADATA.ExecutionMode.default_par, alias="execmode")
    existing_table_action: TERADATA.ExistingTableAction | None = Field(
        TERADATA.ExistingTableAction.append, alias="existing_table_action"
    )
    ...
    partition_type: TERADATA.PartitionType | None = Field(TERADATA.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: TERADATA.PreservePartitioning | None = Field(
        TERADATA.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_method: TERADATA.ReadMethod | None = Field(TERADATA.ReadMethod.general, alias="read_mode")
    ...
    reject_uses: TERADATA.RejectUses | None = Field(TERADATA.RejectUses.rows, alias="reject_uses")
    ...
    sampling_type: TERADATA.SamplingType | None = Field(TERADATA.SamplingType.none, alias="sampling_type")
    ...
    sorting_key: TERADATA.KeyColSelect | None = Field(TERADATA.KeyColSelect.default, alias="keyColSelect")
    ...
    table_action: TERADATA.TableAction | None = Field(TERADATA.TableAction.append, alias="table_action")
    ...
    write_mode: TERADATA.WriteMode | None = Field(TERADATA.WriteMode.insert, alias="write_mode")
