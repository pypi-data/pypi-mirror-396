...
class external_target(BaseStage):
    ...
    field_option: EXTERNAL_TARGET.FieldOption | None = Field(EXTERNAL_TARGET.FieldOption.delimiter, alias="fieldOption")
    ...
    print_field: EXTERNAL_TARGET.PrintField | None = Field(EXTERNAL_TARGET.PrintField.print_field, alias="print_field")
    ...
    record_delim: EXTERNAL_TARGET.RecordDelim | None = Field(EXTERNAL_TARGET.RecordDelim.newline, alias="record_delim")
    ...
    record_prefix: EXTERNAL_TARGET.RecordPrefix | None = Field(EXTERNAL_TARGET.RecordPrefix.one, alias="record_prefix")
    ...
    vector_prefix: EXTERNAL_TARGET.VectorPrefix | None = Field(EXTERNAL_TARGET.VectorPrefix.one, alias="vector_prefix")
