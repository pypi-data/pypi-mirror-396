...
from ibm_watsonx_data_integration.services.datastage.models.enums import VERTICA
from pydantic import Field
from typing import ClassVar


class vertica(BaseStage):
    ...
    connection: VerticaConn = VerticaConn()
    batch_size: int | None = Field(2000, alias="batch_size")
    buf_free_run_ronly: int | None = Field(50, alias="buf_free_run_ronly")
    buf_mode_ronly: VERTICA.BufModeRonly | None = Field(VERTICA.BufModeRonly.default, alias="buf_mode_ronly")
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: VERTICA.BufferingMode | None = Field(VERTICA.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    collecting: VERTICA.Collecting | None = Field(VERTICA.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: VERTICA.CombinabilityMode | None = Field(VERTICA.CombinabilityMode.auto, alias="combinability")
    ...
    decimal_rounding_mode: VERTICA.DecimalRoundingMode | None = Field(
        VERTICA.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    execution_mode: VERTICA.ExecutionMode | None = Field(VERTICA.ExecutionMode.default_par, alias="execmode")
    existing_table_action: VERTICA.ExistingTableAction | None = Field(
        VERTICA.ExistingTableAction.append, alias="existing_table_action"
    )
    ...
    partition_type: VERTICA.PartitionType | None = Field(VERTICA.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: VERTICA.PreservePartitioning | None = Field(
        VERTICA.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_method: VERTICA.ReadMethod | None = Field(VERTICA.ReadMethod.general, alias="read_mode")
    ...
    reject_uses: VERTICA.RejectUses | None = Field(VERTICA.RejectUses.rows, alias="reject_uses")
    ...
    sampling_type: VERTICA.SamplingType | None = Field(VERTICA.SamplingType.none, alias="sampling_type")
    ...
    sorting_key: VERTICA.KeyColSelect | None = Field(VERTICA.KeyColSelect.default, alias="keyColSelect")
    ...
    table_action: VERTICA.TableAction | None = Field(VERTICA.TableAction.append, alias="table_action")
    ...
    write_mode: VERTICA.WriteMode | None = Field(VERTICA.WriteMode.insert, alias="write_mode")
