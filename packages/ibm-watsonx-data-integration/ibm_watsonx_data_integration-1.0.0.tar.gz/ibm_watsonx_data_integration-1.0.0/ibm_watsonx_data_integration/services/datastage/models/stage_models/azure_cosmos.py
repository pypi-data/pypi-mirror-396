...
class azure_cosmos(BaseStage):
    ...
    buf_mode_ronly: AZURE_COSMOS.BufModeRonly | None = Field(AZURE_COSMOS.BufModeRonly.default, alias="buf_mode_ronly")
    ...
    execution_mode: AZURE_COSMOS.ExecutionMode | None = Field(AZURE_COSMOS.ExecutionMode.default_par, alias="execmode")
