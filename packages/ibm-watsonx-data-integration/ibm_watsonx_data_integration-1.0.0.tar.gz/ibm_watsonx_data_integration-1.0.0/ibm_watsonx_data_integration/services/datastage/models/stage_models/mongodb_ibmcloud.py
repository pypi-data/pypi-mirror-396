...
from ibm_watsonx_data_integration.services.datastage.models.enums import MONGODB_IBMCLOUD
from pydantic import Field
from typing import ClassVar


class mongodb_ibmcloud(BaseStage):
    ...
    connection: MongodbIbmcloudConn = MongodbIbmcloudConn()
    auth_method: MONGODB_IBMCLOUD.AuthMethod | None = Field(None, alias="auth_method")
    batch_size: int | None = Field(2000, alias="batch_size")
    buf_free_run_ronly: int | None = Field(50, alias="buf_free_run_ronly")
    buf_mode_ronly: MONGODB_IBMCLOUD.BufModeRonly | None = Field(
        MONGODB_IBMCLOUD.BufModeRonly.default, alias="buf_mode_ronly"
    )
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: MONGODB_IBMCLOUD.BufferingMode | None = Field(
        MONGODB_IBMCLOUD.BufferingMode.default, alias="buf_mode"
    )
    byte_limit: str | None = Field(None, alias="byte_limit")
    collecting: MONGODB_IBMCLOUD.Collecting | None = Field(MONGODB_IBMCLOUD.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: MONGODB_IBMCLOUD.CombinabilityMode | None = Field(
        MONGODB_IBMCLOUD.CombinabilityMode.auto, alias="combinability"
    )
    ...
    decimal_rounding_mode: MONGODB_IBMCLOUD.DecimalRoundingMode | None = Field(
        MONGODB_IBMCLOUD.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    execution_mode: MONGODB_IBMCLOUD.ExecutionMode | None = Field(
        MONGODB_IBMCLOUD.ExecutionMode.default_par, alias="execmode"
    )
    ...
    partition_type: MONGODB_IBMCLOUD.PartitionType | None = Field(
        MONGODB_IBMCLOUD.PartitionType.auto, alias="part_type"
    )
    ...
    preserve_partitioning: MONGODB_IBMCLOUD.PreservePartitioning | None = Field(
        MONGODB_IBMCLOUD.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_method: MONGODB_IBMCLOUD.ReadMethod | None = Field(MONGODB_IBMCLOUD.ReadMethod.general, alias="read_mode")
    ...
    sorting_key: MONGODB_IBMCLOUD.KeyColSelect | None = Field(
        MONGODB_IBMCLOUD.KeyColSelect.default, alias="keyColSelect"
    )
    ...
    table_action: MONGODB_IBMCLOUD.TableAction | None = Field(MONGODB_IBMCLOUD.TableAction.append, alias="table_action")
    ...
    write_mode: MONGODB_IBMCLOUD.WriteMode | None = Field(MONGODB_IBMCLOUD.WriteMode.insert, alias="write_mode")
