...
from ibm_watsonx_data_integration.services.datastage.models.enums import DERBY
from pydantic import Field
from typing import ClassVar


class derby(BaseStage):
    ...
    connection: DerbyConn = DerbyConn()
    batch_size: int | None = Field(2000, alias="batch_size")
    buf_free_run_ronly: int | None = Field(50, alias="buf_free_run_ronly")
    buf_mode_ronly: DERBY.BufModeRonly | None = Field(DERBY.BufModeRonly.default, alias="buf_mode_ronly")
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: DERBY.BufferingMode | None = Field(DERBY.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    collecting: DERBY.Collecting | None = Field(DERBY.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: DERBY.CombinabilityMode | None = Field(DERBY.CombinabilityMode.auto, alias="combinability")
    ...
    decimal_rounding_mode: DERBY.DecimalRoundingMode | None = Field(
        DERBY.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    execution_mode: DERBY.ExecutionMode | None = Field(DERBY.ExecutionMode.default_par, alias="execmode")
    ...
    partition_type: DERBY.PartitionType | None = Field(DERBY.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: DERBY.PreservePartitioning | None = Field(
        DERBY.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_method: DERBY.ReadMethod | None = Field(DERBY.ReadMethod.general, alias="read_mode")
    ...
    sorting_key: DERBY.KeyColSelect | None = Field(DERBY.KeyColSelect.default, alias="keyColSelect")
    ...
    table_action: DERBY.TableAction | None = Field(DERBY.TableAction.append, alias="table_action")
    ...
    write_mode: DERBY.WriteMode | None = Field(DERBY.WriteMode.insert, alias="write_mode")
