"""Module for Singlestore connection."""
...
class SinglestoreConn(BaseConnection):
    """Connection class for Singlestore."""

    model_config = ConfigDict(populate_by_name=True)

    datasource_type: ClassVar[str] = "54221732-8b20-4857-8be1-233c5e98d0ad"
    ...
    @classmethod
    def _from_dict(cls, properties: dict[str, Any]) -> "SinglestoreConn":
