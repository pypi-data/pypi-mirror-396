...
from ibm_watsonx_data_integration.services.datastage.models.enums import COMBINE_RECORDS
from pydantic import Field
from typing import ClassVar


class combine_records(BaseStage):
    ...
    buf_mode: COMBINE_RECORDS.BufMode | None = Field(COMBINE_RECORDS.BufMode.default, alias="buf_mode")
    buf_mode_ronly: COMBINE_RECORDS.BufModeRonly | None = Field(
        COMBINE_RECORDS.BufModeRonly.default, alias="buf_mode_ronly"
    )
    coll_type: COMBINE_RECORDS.CollType | None = Field(COMBINE_RECORDS.CollType.auto, alias="coll_type")
    collation_sequence: COMBINE_RECORDS.CollationSequence | None = Field(
        COMBINE_RECORDS.CollationSequence.OFF, alias="collation_sequence"
    )
    combinability: COMBINE_RECORDS.Combinability | None = Field(
        COMBINE_RECORDS.Combinability.auto, alias="combinability"
    )
    ...
    execmode: COMBINE_RECORDS.Execmode | None = Field(COMBINE_RECORDS.Execmode.default_par, alias="execmode")
    ...
    key_col_select: COMBINE_RECORDS.KeyColSelect | None = Field(
        COMBINE_RECORDS.KeyColSelect.default, alias="keyColSelect"
    )
    ...
    part_type: COMBINE_RECORDS.PartType | None = Field(COMBINE_RECORDS.PartType.auto, alias="part_type")
    ...
    preserve: COMBINE_RECORDS.Preserve | None = Field(COMBINE_RECORDS.Preserve.default_propagate, alias="preserve")
    ...
    subrecname: str = Field(None, alias="subrecname")
    toplevelkeys: COMBINE_RECORDS.Toplevelkeys | None = Field(COMBINE_RECORDS.Toplevelkeys.false, alias="toplevelkeys")
