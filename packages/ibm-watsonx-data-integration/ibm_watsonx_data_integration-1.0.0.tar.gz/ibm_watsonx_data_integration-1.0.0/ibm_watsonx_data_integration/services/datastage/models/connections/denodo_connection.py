...
class DenodoConn(BaseConnection):
    """Connection class for Denodo."""

    model_config = ConfigDict(populate_by_name=True)

    datasource_type: ClassVar[str] = "denodo"
    ...
    @classmethod
    def _from_dict(cls, properties: dict[str, Any]) -> "DenodoConn":
