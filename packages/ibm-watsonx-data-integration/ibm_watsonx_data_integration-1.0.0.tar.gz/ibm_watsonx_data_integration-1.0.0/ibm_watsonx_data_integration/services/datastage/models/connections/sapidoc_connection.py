"""Module for Sapidoc connection."""

from ibm_watsonx_data_integration.services.datastage.models.connections.base_connection import BaseConnection
from ibm_watsonx_data_integration.services.datastage.models.enums import SAPIDOC_CONNECTION
from pydantic import ConfigDict, Field
from typing import Any, ClassVar


class SapidocConn(BaseConnection):
    """Connection class for Sapidoc."""

    model_config = ConfigDict(populate_by_name=True)

    datasource_type: ClassVar[str] = "ec42cd4a-18ab-469c-bfd7-f6dc82e1db17"
    ...
    connection_type: SAPIDOC_CONNECTION.ConnectionType = Field(
        SAPIDOC_CONNECTION.ConnectionType.application_server, alias="connection_type"
    )
    ...
    snc_qop: SAPIDOC_CONNECTION.SncQop | None = Field(SAPIDOC_CONNECTION.SncQop.auth_integrity_privacy, alias="snc_qop")
    ...
    @classmethod
    def _from_dict(cls, properties: dict[str, Any]) -> "SapidocConn":
