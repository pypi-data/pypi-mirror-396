...
from ibm_watsonx_data_integration.services.datastage.models.enums import GENERIC
from pydantic import Field
from typing import ClassVar


class generic(BaseStage):
    ...
    buf_mode: GENERIC.BufMode | None = Field(GENERIC.BufMode.default, alias="buf_mode")
    buf_mode_ronly: GENERIC.BufModeRonly | None = Field(GENERIC.BufModeRonly.default, alias="buf_mode_ronly")
    coll_type: GENERIC.CollType | None = Field(GENERIC.CollType.auto, alias="coll_type")
    combinability: GENERIC.Combinability | None = Field(GENERIC.Combinability.auto, alias="combinability")
    ...
    execmode: GENERIC.Execmode | None = Field(GENERIC.Execmode.default_par, alias="execmode")
    ...
    key_col_select: GENERIC.KeyColSelect | None = Field(GENERIC.KeyColSelect.default, alias="keyColSelect")
    ...
    name_properties: list | None = Field([], alias="nameProperties")
    ...
    part_type: GENERIC.PartType | None = Field(GENERIC.PartType.auto, alias="part_type")
    ...
    preserve: GENERIC.Preserve | None = Field(GENERIC.Preserve.default_propagate, alias="preserve")
    ...
    def _validate_parameters(self) -> tuple[set, set]:
        ...
        include.add("name_properties") if (()) else exclude.add("name_properties")
