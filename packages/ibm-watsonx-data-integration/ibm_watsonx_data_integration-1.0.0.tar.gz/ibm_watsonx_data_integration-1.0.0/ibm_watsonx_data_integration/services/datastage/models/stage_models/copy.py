...
from ibm_watsonx_data_integration.services.datastage.models.enums import COPY
from pydantic import Field
from typing import ClassVar


class copy(BaseStage):
    ...
    buf_mode: COPY.BufMode | None = Field(COPY.BufMode.default, alias="buf_mode")
    buf_mode_ronly: COPY.BufModeRonly | None = Field(COPY.BufModeRonly.default, alias="buf_mode_ronly")
    coll_type: COPY.CollType | None = Field(COPY.CollType.auto, alias="coll_type")
    combinability: COPY.Combinability | None = Field(COPY.Combinability.auto, alias="combinability")
    ...
    execmode: COPY.Execmode | None = Field(COPY.Execmode.default_par, alias="execmode")
    flow_dirty: str | None = Field("false", alias="flow_dirty")
    force: COPY.Force | None = Field(COPY.Force.false, alias="force")
    hide: bool | None = Field(False, alias="hide")
    input_count: int | None = Field(0, alias="input_count")
    input_link_description: list | None = Field("", alias="inputLinkDescription")
    inputcol_properties: list | None = Field([], alias="inputcolProperties")
    key_col_select: COPY.KeyColSelect | None = Field(COPY.KeyColSelect.default, alias="keyColSelect")
    ...
    part_type: COPY.PartType | None = Field(COPY.PartType.auto, alias="part_type")
    ...
    preserve: COPY.Preserve | None = Field(COPY.Preserve.default_propagate, alias="preserve")
