...
from ibm_watsonx_data_integration.services.datastage.models.enums import SAPHANA
from pydantic import Field
from typing import ClassVar


class saphana(BaseStage):
    ...
    connection: SaphanaConn = SaphanaConn()
    batch_size: int | None = Field(2000, alias="batch_size")
    buf_free_run_ronly: int | None = Field(50, alias="buf_free_run_ronly")
    buf_mode_ronly: SAPHANA.BufModeRonly | None = Field(SAPHANA.BufModeRonly.default, alias="buf_mode_ronly")
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: SAPHANA.BufferingMode | None = Field(SAPHANA.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    collecting: SAPHANA.Collecting | None = Field(SAPHANA.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: SAPHANA.CombinabilityMode | None = Field(SAPHANA.CombinabilityMode.auto, alias="combinability")
    ...
    decimal_rounding_mode: SAPHANA.DecimalRoundingMode | None = Field(
        SAPHANA.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    execution_mode: SAPHANA.ExecutionMode | None = Field(SAPHANA.ExecutionMode.default_par, alias="execmode")
    existing_table_action: SAPHANA.ExistingTableAction | None = Field(
        SAPHANA.ExistingTableAction.append, alias="existing_table_action"
    )
    ...
    partition_type: SAPHANA.PartitionType | None = Field(SAPHANA.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: SAPHANA.PreservePartitioning | None = Field(
        SAPHANA.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_method: SAPHANA.ReadMethod | None = Field(SAPHANA.ReadMethod.general, alias="read_mode")
    ...
    reject_uses: SAPHANA.RejectUses | None = Field(SAPHANA.RejectUses.rows, alias="reject_uses")
    ...
    sorting_key: SAPHANA.KeyColSelect | None = Field(SAPHANA.KeyColSelect.default, alias="keyColSelect")
    ...
    table_action: SAPHANA.TableAction | None = Field(SAPHANA.TableAction.append, alias="table_action")
    ...
    write_mode: SAPHANA.WriteMode | None = Field(SAPHANA.WriteMode.insert, alias="write_mode")
