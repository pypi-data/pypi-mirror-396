...
from ibm_watsonx_data_integration.services.datastage.models.enums import GREENPLUM
from pydantic import Field
from typing import ClassVar


class greenplum(BaseStage):
    ...
    connection: GreenplumConn = GreenplumConn()
    batch_size: int | None = Field(2000, alias="batch_size")
    buf_free_run_ronly: int | None = Field(50, alias="buf_free_run_ronly")
    buf_mode_ronly: GREENPLUM.BufModeRonly | None = Field(GREENPLUM.BufModeRonly.default, alias="buf_mode_ronly")
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: GREENPLUM.BufferingMode | None = Field(GREENPLUM.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    collecting: GREENPLUM.Collecting | None = Field(GREENPLUM.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: GREENPLUM.CombinabilityMode | None = Field(
        GREENPLUM.CombinabilityMode.auto, alias="combinability"
    )
    ...
    decimal_rounding_mode: GREENPLUM.DecimalRoundingMode | None = Field(
        GREENPLUM.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    execution_mode: GREENPLUM.ExecutionMode | None = Field(GREENPLUM.ExecutionMode.default_par, alias="execmode")
    existing_table_action: GREENPLUM.ExistingTableAction | None = Field(
        GREENPLUM.ExistingTableAction.append, alias="existing_table_action"
    )
    ...
    partition_type: GREENPLUM.PartitionType | None = Field(GREENPLUM.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: GREENPLUM.PreservePartitioning | None = Field(
        GREENPLUM.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_method: GREENPLUM.ReadMethod | None = Field(GREENPLUM.ReadMethod.general, alias="read_mode")
    ...
    reject_uses: GREENPLUM.RejectUses | None = Field(GREENPLUM.RejectUses.rows, alias="reject_uses")
    ...
    sorting_key: GREENPLUM.KeyColSelect | None = Field(GREENPLUM.KeyColSelect.default, alias="keyColSelect")
    ...
    table_action: GREENPLUM.TableAction | None = Field(GREENPLUM.TableAction.append, alias="table_action")
    ...
    write_mode: GREENPLUM.WriteMode | None = Field(GREENPLUM.WriteMode.insert, alias="write_mode")
