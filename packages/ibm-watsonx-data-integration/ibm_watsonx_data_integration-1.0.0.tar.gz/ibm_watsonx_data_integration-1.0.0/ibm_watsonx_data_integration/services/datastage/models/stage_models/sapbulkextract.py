...
class sapbulkextract(BaseStage):
    ...
    buffering_mode: SAPBULKEXTRACT.BufferingMode | None = Field(SAPBULKEXTRACT.BufferingMode.default, alias="buf_mode")
    ...
    sorting_key: SAPBULKEXTRACT.KeyColSelect | None = Field(SAPBULKEXTRACT.KeyColSelect.default, alias="keyColSelect")
    ...
    def _validate_source(self) -> tuple[set, set]:
        ...
        (
            ...
            if ((self.generate_sql_query) or (self.generate_sql_query and "#" in str(self.generate_sql_query)))
        ...
        (
            ...
            if ((not self.generate_sql_query) or (self.generate_sql_query and "#" in str(self.generate_sql_query)))
