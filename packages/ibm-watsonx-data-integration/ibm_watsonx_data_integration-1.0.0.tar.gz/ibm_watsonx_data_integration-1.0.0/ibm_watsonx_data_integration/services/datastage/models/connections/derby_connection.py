...
class DerbyConn(BaseConnection):
    """Connection class for Derby."""

    model_config = ConfigDict(populate_by_name=True)

    datasource_type: ClassVar[str] = "82696f1d-600c-4f78-a03c-d8349ea1976f"
    ...
    @classmethod
    def _from_dict(cls, properties: dict[str, Any]) -> "DerbyConn":
