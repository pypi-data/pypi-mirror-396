...
from ibm_watsonx_data_integration.services.datastage.models.enums import APACHE_HBASE
from pydantic import Field
from typing import ClassVar


class apache_hbase(BaseStage):
    ...
    connection: ApacheHbaseConn = ApacheHbaseConn()
    autoflush_enabled: bool | None = Field(True, alias="hbase.write.is_auto_flush")
    buf_free_run_ronly: int | None = Field(50, alias="buf_free_run_ronly")
    buf_mode_ronly: APACHE_HBASE.BufModeRonly | None = Field(APACHE_HBASE.BufModeRonly.default, alias="buf_mode_ronly")
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: APACHE_HBASE.BufferingMode | None = Field(APACHE_HBASE.BufferingMode.default, alias="buf_mode")
    collecting: APACHE_HBASE.Collecting | None = Field(APACHE_HBASE.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: APACHE_HBASE.CombinabilityMode | None = Field(
        APACHE_HBASE.CombinabilityMode.auto, alias="combinability"
    )
    ...
    detect_regions_changes_row_size: int | None = Field(
        100000, alias="detect_splits_and_merges_group.detection_step_size"
    )
    ...
    enable_detecting_regions_changes: bool | None = Field(
        True, alias="detect_splits_and_merges_group.detect_splits_and_merges"
    )
    ...
    execution_mode: APACHE_HBASE.ExecutionMode | None = Field(APACHE_HBASE.ExecutionMode.default_par, alias="execmode")
    flow_dirty: str | None = Field("false", alias="flow_dirty")
    has_reference_output: bool | None = Field(False, alias="has_ref_output")
    hbase_namespace: str = Field("default", alias="hbase.namespace")
    ...
    lookup_type: APACHE_HBASE.LookupType | None = Field(APACHE_HBASE.LookupType.empty, alias="lookup_type")
    ...
    partition_type: APACHE_HBASE.PartitionType | None = Field(APACHE_HBASE.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: APACHE_HBASE.PreservePartitioning | None = Field(
        APACHE_HBASE.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    sorting_key: APACHE_HBASE.KeyColSelect | None = Field(APACHE_HBASE.KeyColSelect.default, alias="keyColSelect")
    stable: bool | None = Field(None, alias="part_stable")
    stage_description: list | None = Field("", alias="stageDescription")
    strict_type_checking: bool | None = Field(True, alias="hbase.read.strict_type_checking")
    target_table: str = Field("table", alias="hbase.table")
    type_of_row_keys_in_the_target_table: APACHE_HBASE.TypeOfRowKeysInTheTargetTable | None = Field(
        APACHE_HBASE.TypeOfRowKeysInTheTargetTable.uniform_byte_arrays, alias="row_key_type"
    )
    unique: bool | None = Field(None, alias="part_unique")
    use_cas_lite_service: bool | None = Field(True, alias="use_cas_lite")
    use_parallel_read: bool | None = Field(True, alias="use_parallel_read")
    write_mode: APACHE_HBASE.HbaseWriteMode | None = Field(APACHE_HBASE.HbaseWriteMode.put, alias="hbase.write.mode")
    ...
    def _get_source_props(self) -> dict:
        ...
        props = {
            ...
            "db2_table_name",
            "detect_regions_changes_row_size",
            "disk_write_inc_ronly",
            "disk_write_increment_bytes",
            "enable_detecting_regions_changes",
            ...
            "target_table",
            "type_of_row_keys_in_the_target_table",
            "unique",
            "use_parallel_read",
        }
        required = {
            ...
            "output_acp_should_hide",
            "password",
            "simple_authentication_sasl_username",
            "target_table",
