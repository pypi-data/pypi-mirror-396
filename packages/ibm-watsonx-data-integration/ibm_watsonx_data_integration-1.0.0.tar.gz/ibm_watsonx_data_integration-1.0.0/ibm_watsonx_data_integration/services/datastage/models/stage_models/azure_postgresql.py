...
from ibm_watsonx_data_integration.services.datastage.models.enums import AZURE_POSTGRESQL
from pydantic import Field
from typing import ClassVar


class azure_postgresql(BaseStage):
    ...
    connection: AzurePostgresqlConn = AzurePostgresqlConn()
    ...
    buf_mode_ronly: AZURE_POSTGRESQL.BufModeRonly | None = Field(
        AZURE_POSTGRESQL.BufModeRonly.default, alias="buf_mode_ronly"
    )
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: AZURE_POSTGRESQL.BufferingMode | None = Field(
        AZURE_POSTGRESQL.BufferingMode.default, alias="buf_mode"
    )
    byte_limit: str | None = Field(None, alias="byte_limit")
    call_procedure_statement: str | None = Field(None, alias="call_statement")
    collecting: AZURE_POSTGRESQL.Collecting | None = Field(AZURE_POSTGRESQL.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: AZURE_POSTGRESQL.CombinabilityMode | None = Field(
        AZURE_POSTGRESQL.CombinabilityMode.auto, alias="combinability"
    )
    ...
    decimal_rounding_mode: AZURE_POSTGRESQL.DecimalRoundingMode | None = Field(
        AZURE_POSTGRESQL.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    execution_mode: AZURE_POSTGRESQL.ExecutionMode | None = Field(
        AZURE_POSTGRESQL.ExecutionMode.default_par, alias="execmode"
    )
    existing_table_action: AZURE_POSTGRESQL.ExistingTableAction | None = Field(
        AZURE_POSTGRESQL.ExistingTableAction.append, alias="existing_table_action"
    )
    ...
    lookup_type: AZURE_POSTGRESQL.LookupType | None = Field(AZURE_POSTGRESQL.LookupType.empty, alias="lookup_type")
    ...
    partition_type: AZURE_POSTGRESQL.PartitionType | None = Field(
        AZURE_POSTGRESQL.PartitionType.auto, alias="part_type"
    )
    ...
    preserve_partitioning: AZURE_POSTGRESQL.PreservePartitioning | None = Field(
        AZURE_POSTGRESQL.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_method: AZURE_POSTGRESQL.ReadMethod | None = Field(AZURE_POSTGRESQL.ReadMethod.general, alias="read_mode")
    ...
    reject_uses: AZURE_POSTGRESQL.RejectUses | None = Field(AZURE_POSTGRESQL.RejectUses.rows, alias="reject_uses")
    ...
    sampling_type: AZURE_POSTGRESQL.SamplingType | None = Field(
        AZURE_POSTGRESQL.SamplingType.none, alias="sampling_type"
    )
    ...
    sorting_key: AZURE_POSTGRESQL.KeyColSelect | None = Field(
        AZURE_POSTGRESQL.KeyColSelect.default, alias="keyColSelect"
    )
    ...
    table_action: AZURE_POSTGRESQL.TableAction | None = Field(AZURE_POSTGRESQL.TableAction.append, alias="table_action")
    ...
    write_mode: AZURE_POSTGRESQL.WriteMode | None = Field(AZURE_POSTGRESQL.WriteMode.insert, alias="write_mode")
