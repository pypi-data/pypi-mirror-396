...
from ibm_watsonx_data_integration.services.datastage.models.enums import MAKE_VECTOR
from pydantic import Field
from typing import ClassVar


class make_vector(BaseStage):
    ...
    buf_mode: MAKE_VECTOR.BufMode | None = Field(MAKE_VECTOR.BufMode.default, alias="buf_mode")
    buf_mode_ronly: MAKE_VECTOR.BufModeRonly | None = Field(MAKE_VECTOR.BufModeRonly.default, alias="buf_mode_ronly")
    coll_type: MAKE_VECTOR.CollType | None = Field(MAKE_VECTOR.CollType.auto, alias="coll_type")
    combinability: MAKE_VECTOR.Combinability | None = Field(MAKE_VECTOR.Combinability.auto, alias="combinability")
    ...
    execmode: MAKE_VECTOR.Execmode | None = Field(MAKE_VECTOR.Execmode.default_par, alias="execmode")
    flow_dirty: str | None = Field("false", alias="flow_dirty")
    hide: bool | None = Field(False, alias="hide")
    input_count: int | None = Field(0, alias="input_count")
    input_link_description: list | None = Field("", alias="inputLinkDescription")
    inputcol_properties: list | None = Field([], alias="inputcolProperties")
    key_col_select: MAKE_VECTOR.KeyColSelect | None = Field(MAKE_VECTOR.KeyColSelect.default, alias="keyColSelect")
    ...
    part_type: MAKE_VECTOR.PartType | None = Field(MAKE_VECTOR.PartType.auto, alias="part_type")
    ...
    preserve: MAKE_VECTOR.Preserve | None = Field(MAKE_VECTOR.Preserve.default_propagate, alias="preserve")
