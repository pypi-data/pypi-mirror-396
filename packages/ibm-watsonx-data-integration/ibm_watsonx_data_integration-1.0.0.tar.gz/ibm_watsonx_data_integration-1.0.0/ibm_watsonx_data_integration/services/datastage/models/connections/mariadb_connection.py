...
class MariadbConn(BaseConnection):
    """Connection class for Mariadb."""

    model_config = ConfigDict(populate_by_name=True)

    datasource_type: ClassVar[str] = "mariadb"
    ...
    @classmethod
    def _from_dict(cls, properties: dict[str, Any]) -> "MariadbConn":
