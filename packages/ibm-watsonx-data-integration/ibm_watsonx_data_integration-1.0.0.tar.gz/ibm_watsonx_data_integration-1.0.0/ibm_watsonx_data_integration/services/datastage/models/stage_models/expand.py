...
from ibm_watsonx_data_integration.services.datastage.models.enums import EXPAND
from pydantic import Field
from typing import ClassVar


class expand(BaseStage):
    ...
    buf_mode: EXPAND.BufMode | None = Field(EXPAND.BufMode.default, alias="buf_mode")
    buf_mode_ronly: EXPAND.BufModeRonly | None = Field(EXPAND.BufModeRonly.default, alias="buf_mode_ronly")
    coll_type: EXPAND.CollType | None = Field(EXPAND.CollType.auto, alias="coll_type")
    combinability: EXPAND.Combinability | None = Field(EXPAND.Combinability.auto, alias="combinability")
    command: EXPAND.Command | None = Field(EXPAND.Command.compress, alias="command")
    ...
    execmode: EXPAND.Execmode | None = Field(EXPAND.Execmode.default_par, alias="execmode")
    flow_dirty: str | None = Field("false", alias="flow_dirty")
    hide: bool | None = Field(False, alias="hide")
    input_count: int | None = Field(0, alias="input_count")
    input_link_description: list | None = Field("", alias="inputLinkDescription")
    inputcol_properties: list | None = Field([], alias="inputcolProperties")
    key_col_select: EXPAND.KeyColSelect | None = Field(EXPAND.KeyColSelect.default, alias="keyColSelect")
    ...
    part_type: EXPAND.PartType | None = Field(EXPAND.PartType.auto, alias="part_type")
    ...
    preserve: EXPAND.Preserve | None = Field(EXPAND.Preserve.default_propagate, alias="preserve")
