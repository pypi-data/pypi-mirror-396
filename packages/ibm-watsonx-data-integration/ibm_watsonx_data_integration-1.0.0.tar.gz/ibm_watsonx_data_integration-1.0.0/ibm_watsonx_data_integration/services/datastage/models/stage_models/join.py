...
from ibm_watsonx_data_integration.services.datastage.models.enums import JOIN
from pydantic import Field
from typing import ClassVar


class join(BaseStage):
    ...
    buf_mode: JOIN.BufMode | None = Field(JOIN.BufMode.default, alias="buf_mode")
    buf_mode_ronly: JOIN.BufModeRonly | None = Field(JOIN.BufModeRonly.default, alias="buf_mode_ronly")
    coll_type: JOIN.CollType | None = Field(JOIN.CollType.auto, alias="coll_type")
    collation_sequence: JOIN.CollationSequence | None = Field(JOIN.CollationSequence.OFF, alias="collation_sequence")
    combinability: JOIN.Combinability | None = Field(JOIN.Combinability.auto, alias="combinability")
    ...
    execmode: JOIN.Execmode | None = Field(JOIN.Execmode.default_par, alias="execmode")
    ...
    key_col_select: JOIN.KeyColSelect | None = Field(JOIN.KeyColSelect.default, alias="keyColSelect")
    ...
    operator: JOIN.Operator | None = Field(JOIN.Operator.innerjoin, alias="operator")
    ...
    part_type: JOIN.PartType | None = Field(JOIN.PartType.auto, alias="part_type")
    ...
    preserve: JOIN.Preserve | None = Field(JOIN.Preserve.default_propagate, alias="preserve")
