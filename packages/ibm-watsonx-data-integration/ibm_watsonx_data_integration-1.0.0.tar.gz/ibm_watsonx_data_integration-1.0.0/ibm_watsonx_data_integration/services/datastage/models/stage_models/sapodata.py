...
from ibm_watsonx_data_integration.services.datastage.models.enums import SAPODATA
from pydantic import Field
from typing import ClassVar


class sapodata(BaseStage):
    ...
    connection: SapodataConn = SapodataConn()
    buf_free_run_ronly: int | None = Field(50, alias="buf_free_run_ronly")
    buf_mode_ronly: SAPODATA.BufModeRonly | None = Field(SAPODATA.BufModeRonly.default, alias="buf_mode_ronly")
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: SAPODATA.BufferingMode | None = Field(SAPODATA.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    collecting: SAPODATA.Collecting | None = Field(SAPODATA.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: SAPODATA.CombinabilityMode | None = Field(
        SAPODATA.CombinabilityMode.auto, alias="combinability"
    )
    create_data_asset: bool | None = Field(False, alias="registerDataAsset")
    csrf_protection_enabled: bool | None = Field(True, alias="csrf_protection")
    ...
    entity_set: str = Field(None, alias="entity_set_name")
    execution_mode: SAPODATA.ExecutionMode | None = Field(SAPODATA.ExecutionMode.default_par, alias="execmode")
    ...
    job_start_timestamp: str | None = Field(None, alias="datastage_job_start_timestamp")
    ...
    multiple_link_support: bool | None = Field(False, alias="multipleLinkSupport")
    ...
    partition_type: SAPODATA.PartitionType | None = Field(SAPODATA.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: SAPODATA.PreservePartitioning | None = Field(
        SAPODATA.PreservePartitioning.default_propagate, alias="preserve"
    )
    query_options: str | None = Field(None, alias="query_options")
    ...
    row_to_start_reading: int | None = Field(None, alias="row_start")
    runtime_column_propagation: bool | None = Field(None, alias="runtime_column_propagation")
    service_group: str | None = Field(None, alias="service_group")
    service_name: str = Field(None, alias="service_name")
    service_version: int | None = Field(None, alias="service_version")
    ...
    sorting_key: SAPODATA.KeyColSelect | None = Field(SAPODATA.KeyColSelect.default, alias="keyColSelect")
    ...
    use_multi_link_thread: bool | None = Field(True, alias="use_multilink_threads")
    validate_ssl_certificate: bool | None = Field(None, alias="ssl_certificate_validation")
    write_mode: SAPODATA.WriteMode | None = Field(SAPODATA.WriteMode.insert, alias="write_mode")
