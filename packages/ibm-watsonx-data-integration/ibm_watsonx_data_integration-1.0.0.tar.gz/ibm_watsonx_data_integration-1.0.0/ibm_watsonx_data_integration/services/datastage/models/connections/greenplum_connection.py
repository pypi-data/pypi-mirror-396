"""Module for Greenplum connection."""
...
class GreenplumConn(BaseConnection):
    """Connection class for Greenplum."""

    model_config = ConfigDict(populate_by_name=True)

    datasource_type: ClassVar[str] = "e278eff1-a7c4-4d60-9a02-bde1bb1d26ef"
    ...
    prepare_statement_support: bool | None = Field(False, alias="prepare_statement_support")
    ...
    @classmethod
    def _from_dict(cls, properties: dict[str, Any]) -> "GreenplumConn":
