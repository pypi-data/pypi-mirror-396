"""Module for Azuresynapse connection."""
...
class AzuresynapseConn(BaseConnection):
    """Connection class for Azuresynapse."""

    model_config = ConfigDict(populate_by_name=True)

    datasource_type: ClassVar[str] = "eaed62e9-8f63-4ea2-a54f-a9671f62af84"
    asset_id: str | None = None
    proj_id: str | None = None
    name: str = Field(None, alias="name")
    authentication_method: AZURESYNAPSE_CONNECTION.AuthMethod | None = Field(
        AZURESYNAPSE_CONNECTION.AuthMethod.user_credentials, alias="auth_method"
    )
    ...
    @classmethod
    def _from_dict(cls, properties: dict[str, Any]) -> "AzuresynapseConn":
