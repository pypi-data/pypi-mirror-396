"""Module for Datastax connection."""

from ibm_watsonx_data_integration.services.datastage.models.connections.base_connection import BaseConnection
from ibm_watsonx_data_integration.services.datastage.models.enums import DATASTAX_CONNECTION
from pydantic import ConfigDict, Field
from typing import Any, ClassVar


class DatastaxConn(BaseConnection):
    """Connection class for Datastax."""

    model_config = ConfigDict(populate_by_name=True)

    datasource_type: ClassVar[str] = "datastax"
    ...
    read_consistency: DATASTAX_CONNECTION.ReadConsistency | None = Field(
        DATASTAX_CONNECTION.ReadConsistency.quorum, alias="read_consistency"
    )
    ...
    write_consistency: DATASTAX_CONNECTION.WriteConsistency | None = Field(
        DATASTAX_CONNECTION.WriteConsistency.quorum, alias="write_consistency"
    )
    ...
    @classmethod
    def _from_dict(cls, properties: dict[str, Any]) -> "DatastaxConn":
