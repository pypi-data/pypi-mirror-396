"""Module for smallint schema field."""
...
T = TypeVar("T", bound="SmallInt")


class SmallInt(BaseField):
    """Class for smallint schema field."""

    def __init__(self, name: str) -> None:
        """Initializes a schema field."""
        super().__init__(name)
        self._set_model_type("integer")
        self._set_app_type_code("INT16")
        self._set_app_odbc_type("SMALLINT")
