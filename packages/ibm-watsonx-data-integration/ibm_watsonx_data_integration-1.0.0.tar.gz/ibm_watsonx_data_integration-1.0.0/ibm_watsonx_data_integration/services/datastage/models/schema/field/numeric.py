"""Module for numeric schema field."""
...
class Numeric(BaseField):
    """Class for numeric schema field."""
    ...
    def __init__(self, name: str) -> None:
        ...
        self._set_app_odbc_type("NUMERIC")
    ...
    def length(self, length: int) -> "BaseField":
        ...
        """
        return self._length(length)._decimal_precision(length)._max_length(length)

    # I don't think the user will be able/willing to set this. I think this is basically covered by the length method
    # def precision(self, precision: int) -> "BaseField":
    #     """Sets the precision, or number of digits, of the field."""
    #     return self._decimal_precision(precision)
