...
from ibm_watsonx_data_integration.services.datastage.models.enums import MINIO
from pydantic import Field
from typing import ClassVar


class minio(BaseStage):
    ...
    connection: MinioConn = MinioConn()
    bucket: str | None = Field(None, alias="bucket")
    buf_free_run_ronly: int | None = Field(50, alias="buf_free_run_ronly")
    buf_mode_ronly: MINIO.BufModeRonly | None = Field(MINIO.BufModeRonly.default, alias="buf_mode_ronly")
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: MINIO.BufferingMode | None = Field(MINIO.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    cell_range: str | None = Field(None, alias="range")
    codec_avro: MINIO.CodecAvro | None = Field(None, alias="codec_avro")
    codec_csv: MINIO.CodecCsv | None = Field(None, alias="codec_csv")
    codec_delimited: MINIO.CodecDelimited | None = Field(None, alias="codec_delimited")
    codec_orc: MINIO.CodecOrc | None = Field(None, alias="codec_orc")
    codec_parquet: MINIO.CodecParquet | None = Field(None, alias="codec_parquet")
    collecting: MINIO.Collecting | None = Field(MINIO.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: MINIO.CombinabilityMode | None = Field(MINIO.CombinabilityMode.auto, alias="combinability")
    ...
    decimal_rounding_mode: MINIO.DecimalRoundingMode | None = Field(
        MINIO.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    escape_character: MINIO.EscapeCharacter | None = Field(MINIO.EscapeCharacter.none, alias="escape_character")
    ...
    execution_mode: MINIO.ExecutionMode | None = Field(MINIO.ExecutionMode.default_seq, alias="execmode")
    field_delimiter: MINIO.FieldDelimiter | None = Field(MINIO.FieldDelimiter.comma, alias="field_delimiter")
    ...
    file_format: MINIO.FileFormat | None = Field(MINIO.FileFormat.csv, alias="file_format")
    ...
    invalid_data_handling: MINIO.InvalidDataHandling | None = Field(
        MINIO.InvalidDataHandling.fail, alias="invalid_data_handling"
    )
    ...
    partition_type: MINIO.PartitionType | None = Field(MINIO.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: MINIO.PreservePartitioning | None = Field(
        MINIO.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    quote_character: MINIO.QuoteCharacter | None = Field(MINIO.QuoteCharacter.none, alias="quote_character")
    quote_numeric_values: bool | None = Field(True, alias="quote_numerics")
    read_mode: MINIO.ReadMode | None = Field(MINIO.ReadMode.read_single, alias="read_mode")
    read_part_size: int | None = Field(None, alias="read_part_size")
    row_delimiter: MINIO.RowDelimiter | None = Field(MINIO.RowDelimiter.new_line, alias="row_delimiter")
    ...
    sorting_key: MINIO.KeyColSelect | None = Field(MINIO.KeyColSelect.default, alias="keyColSelect")
    ...
    table_action: MINIO.TableAction | None = Field(MINIO.TableAction.append, alias="table_action")
    table_data_file_compression_codec: MINIO.TableDataFileCompressionCodec | None = Field(
        None, alias="table_data_file_compression_codec"
    )
    table_data_file_format: MINIO.TableDataFileFormat | None = Field(
        MINIO.TableDataFileFormat.avro, alias="table_data_file_format"
    )
    table_format: MINIO.TableFormat | None = Field(None, alias="table_format")
    ...
    write_mode: MINIO.WriteMode | None = Field(MINIO.WriteMode.write, alias="write_mode")
