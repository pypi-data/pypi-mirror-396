"""Module for longvarchar schema field."""
...
T = TypeVar("T", bound="LongVarChar")


class LongVarChar(BaseField):
    """Class for longvarchar schema field."""
    ...
    def __init__(self, name: str) -> None:
        ...
        self._set_app_odbc_type("LONGVARCHAR")
    ...
    def export_ebcdic_as_ascii(self) -> "BaseField":
        """Sets export abcdic as ascii."""
        return self._export_ebcdic_as_ascii()
