"""Module for varchar schema field."""
...
T = TypeVar("T", bound="VarChar")


class VarChar(BaseField):
    """Class for varchar schema field."""
    ...
    def __init__(self, name: str) -> None:
        ...
        self._set_app_odbc_type("VARCHAR")
