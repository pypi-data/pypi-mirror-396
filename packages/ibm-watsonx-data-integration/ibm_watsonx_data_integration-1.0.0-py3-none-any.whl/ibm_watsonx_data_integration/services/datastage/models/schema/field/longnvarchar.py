"""Module for longnvarchar schema field."""
...
T = TypeVar("T", bound="LongNVarChar")


class LongNVarChar(BaseField):
    """Class for longnvarchar schema field."""
    ...
    def __init__(self, name: str) -> None:
        ...
        self._set_app_odbc_type("WLONGVARCHAR")
