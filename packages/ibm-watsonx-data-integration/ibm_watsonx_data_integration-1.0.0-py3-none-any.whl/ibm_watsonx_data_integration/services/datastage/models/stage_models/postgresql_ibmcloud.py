...
from ibm_watsonx_data_integration.services.datastage.models.enums import POSTGRESQL_IBMCLOUD
from pydantic import Field
from typing import ClassVar


class postgresql_ibmcloud(BaseStage):
    ...
    connection: PostgresqlIbmcloudConn = PostgresqlIbmcloudConn()
    ...
    buf_mode_ronly: POSTGRESQL_IBMCLOUD.BufModeRonly | None = Field(
        POSTGRESQL_IBMCLOUD.BufModeRonly.default, alias="buf_mode_ronly"
    )
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: POSTGRESQL_IBMCLOUD.BufferingMode | None = Field(
        POSTGRESQL_IBMCLOUD.BufferingMode.default, alias="buf_mode"
    )
    byte_limit: str | None = Field(None, alias="byte_limit")
    call_procedure_statement: str | None = Field(None, alias="call_statement")
    collecting: POSTGRESQL_IBMCLOUD.Collecting | None = Field(POSTGRESQL_IBMCLOUD.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: POSTGRESQL_IBMCLOUD.CombinabilityMode | None = Field(
        POSTGRESQL_IBMCLOUD.CombinabilityMode.auto, alias="combinability"
    )
    ...
    execution_mode: POSTGRESQL_IBMCLOUD.ExecutionMode | None = Field(
        POSTGRESQL_IBMCLOUD.ExecutionMode.default_par, alias="execmode"
    )
    existing_table_action: POSTGRESQL_IBMCLOUD.ExistingTableAction | None = Field(
        POSTGRESQL_IBMCLOUD.ExistingTableAction.append, alias="existing_table_action"
    )
    ...
    lookup_type: POSTGRESQL_IBMCLOUD.LookupType | None = Field(
        POSTGRESQL_IBMCLOUD.LookupType.empty, alias="lookup_type"
    )
    ...
    partition_type: POSTGRESQL_IBMCLOUD.PartitionType | None = Field(
        POSTGRESQL_IBMCLOUD.PartitionType.auto, alias="part_type"
    )
    ...
    preserve_partitioning: POSTGRESQL_IBMCLOUD.PreservePartitioning | None = Field(
        POSTGRESQL_IBMCLOUD.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_method: POSTGRESQL_IBMCLOUD.ReadMethod | None = Field(
        POSTGRESQL_IBMCLOUD.ReadMethod.general, alias="read_mode"
    )
    ...
    reject_uses: POSTGRESQL_IBMCLOUD.RejectUses | None = Field(POSTGRESQL_IBMCLOUD.RejectUses.rows, alias="reject_uses")
    ...
    sampling_type: POSTGRESQL_IBMCLOUD.SamplingType | None = Field(
        POSTGRESQL_IBMCLOUD.SamplingType.none, alias="sampling_type"
    )
    ...
    sorting_key: POSTGRESQL_IBMCLOUD.KeyColSelect | None = Field(
        POSTGRESQL_IBMCLOUD.KeyColSelect.default, alias="keyColSelect"
    )
    ...
    table_action: POSTGRESQL_IBMCLOUD.TableAction | None = Field(
        POSTGRESQL_IBMCLOUD.TableAction.append, alias="table_action"
    )
    ...
    write_mode: POSTGRESQL_IBMCLOUD.WriteMode | None = Field(POSTGRESQL_IBMCLOUD.WriteMode.insert, alias="write_mode")
