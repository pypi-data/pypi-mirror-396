...
class lookup(BaseStage):
    ...
    allow_dups: LOOKUP.AllowDups | None = Field(LOOKUP.AllowDups.false, alias="allow_dups")
    ...
    buf_mode: LOOKUP.BufMode | None = Field(LOOKUP.BufMode.default, alias="buf_mode")
    buf_mode_ronly: LOOKUP.BufModeRonly | None = Field(LOOKUP.BufModeRonly.default, alias="buf_mode_ronly")
    coll_type: LOOKUP.CollType | None = Field(LOOKUP.CollType.auto, alias="coll_type")
    collation_sequence: LOOKUP.CollationSequence | None = Field(
        LOOKUP.CollationSequence.OFF, alias="collation_sequence"
    )
    combinability: LOOKUP.Combinability | None = Field(LOOKUP.Combinability.auto, alias="combinability")
    ...
    execmode: LOOKUP.Execmode | None = Field(LOOKUP.Execmode.default_par, alias="execmode")
    flow_dirty: str | None = Field("false", alias="flow_dirty")
    globalconstraints_items: LOOKUP.GlobalconstraintsItems | None = Field(
        LOOKUP.GlobalconstraintsItems.custom, alias="globalconstraintsItems"
    )
    has_key: bool | None = Field(False, alias="hasKey")
    has_primary_link: bool | None = Field(False, alias="hasPrimaryLink")
    hide: bool | None = Field(False, alias="hide")
    input_count: int | None = Field(0, alias="input_count")
    input_link_description: list | None = Field("", alias="inputLinkDescription")
    inputcol_properties: list | None = Field([], alias="inputcolProperties")
    inputlink_ordering_list: list | None = Field([], alias="InputlinkOrderingList")
    key_col_select: LOOKUP.KeyColSelect | None = Field(LOOKUP.KeyColSelect.default, alias="keyColSelect")
    key_cols_coll: list | None = Field([], alias="keyColsColl")
    key_cols_coll_ordered: list | None = Field([], alias="keyColsCollOrdered")
    key_cols_coll_robin: list | None = Field([], alias="keyColsCollRobin")
    key_cols_none: list | None = Field([], alias="keyColsNone")
    key_cols_part: list | None = Field([], alias="keyColsPart")
    lookup_derivation: list[lookup.LookupDerivation] | None = Field([], alias="lookupDerivation")
    lookup_fail: LOOKUP.LookupFail | None = Field(LOOKUP.LookupFail.fail, alias="lookupFail")
    ...
    part_type: LOOKUP.PartType | None = Field(LOOKUP.PartType.auto, alias="part_type")
    ...
    preserve: LOOKUP.Preserve | None = Field(LOOKUP.Preserve.default_propagate, alias="preserve")
    primary_key_columns_items: list | None = Field([], alias="primaryKeyColumnsItems")
    ...
    save: str | None = Field(None, alias="save")
