...
from ibm_watsonx_data_integration.services.datastage.models.enums import DV
...
class dv(BaseStage):
    ...
    connection: DvConn = DvConn()
    buf_free_run_ronly: int | None = Field(50, alias="buf_free_run_ronly")
    buf_mode_ronly: DV.BufModeRonly | None = Field(DV.BufModeRonly.default, alias="buf_mode_ronly")
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: DV.BufferingMode | None = Field(DV.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    collecting: DV.Collecting | None = Field(DV.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: DV.CombinabilityMode | None = Field(DV.CombinabilityMode.auto, alias="combinability")
    ...
    decimal_rounding_mode: DV.DecimalRoundingMode | None = Field(
        DV.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    execution_mode: DV.ExecutionMode | None = Field(DV.ExecutionMode.default_par, alias="execmode")
    ...
    partition_type: DV.PartitionType | None = Field(DV.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: DV.PreservePartitioning | None = Field(
        DV.PreservePartitioning.default_propagate, alias="preserve"
    )
    push_filters: str | None = Field(None, alias="push_filters")
    pushed_filters: str | None = Field(None, alias="pushed_filters")
    query_data_size: int | None = Field(262143, alias="query_data_size")
    ...
    read_method: DV.ReadMethod | None = Field(DV.ReadMethod.general, alias="read_mode")
    ...
    sorting_key: DV.KeyColSelect | None = Field(DV.KeyColSelect.default, alias="keyColSelect")
