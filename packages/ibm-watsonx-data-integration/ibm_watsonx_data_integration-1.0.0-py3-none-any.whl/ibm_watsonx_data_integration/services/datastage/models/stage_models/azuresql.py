...
from ibm_watsonx_data_integration.services.datastage.models.enums import AZURESQL
from pydantic import Field
from typing import ClassVar


class azuresql(BaseStage):
    ...
    connection: AzuresqlConn = AzuresqlConn()
    ...
    buf_mode_ronly: AZURESQL.BufModeRonly | None = Field(AZURESQL.BufModeRonly.default, alias="buf_mode_ronly")
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: AZURESQL.BufferingMode | None = Field(AZURESQL.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    call_procedure_statement: str | None = Field(None, alias="call_statement")
    collecting: AZURESQL.Collecting | None = Field(AZURESQL.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: AZURESQL.CombinabilityMode | None = Field(
        AZURESQL.CombinabilityMode.auto, alias="combinability"
    )
    ...
    decimal_rounding_mode: AZURESQL.DecimalRoundingMode | None = Field(
        AZURESQL.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    execution_mode: AZURESQL.ExecutionMode | None = Field(AZURESQL.ExecutionMode.default_par, alias="execmode")
    existing_table_action: AZURESQL.ExistingTableAction | None = Field(
        AZURESQL.ExistingTableAction.append, alias="existing_table_action"
    )
    ...
    partition_type: AZURESQL.PartitionType | None = Field(AZURESQL.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: AZURESQL.PreservePartitioning | None = Field(
        AZURESQL.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_method: AZURESQL.ReadMethod | None = Field(AZURESQL.ReadMethod.general, alias="read_mode")
    ...
    reject_uses: AZURESQL.RejectUses | None = Field(AZURESQL.RejectUses.rows, alias="reject_uses")
    ...
    sampling_type: AZURESQL.SamplingType | None = Field(AZURESQL.SamplingType.none, alias="sampling_type")
    ...
    sorting_key: AZURESQL.KeyColSelect | None = Field(AZURESQL.KeyColSelect.default, alias="keyColSelect")
    ...
    table_action: AZURESQL.TableAction | None = Field(AZURESQL.TableAction.append, alias="table_action")
    ...
    write_mode: AZURESQL.WriteMode | None = Field(AZURESQL.WriteMode.insert, alias="write_mode")
