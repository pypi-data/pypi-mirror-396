...
class google_pub_sub(BaseStage):
    ...
    buffering_mode: GOOGLE_PUB_SUB.BufferingMode | None = Field(GOOGLE_PUB_SUB.BufferingMode.default, alias="buf_mode")
    ...
    sorting_key: GOOGLE_PUB_SUB.KeyColSelect | None = Field(GOOGLE_PUB_SUB.KeyColSelect.default, alias="keyColSelect")
