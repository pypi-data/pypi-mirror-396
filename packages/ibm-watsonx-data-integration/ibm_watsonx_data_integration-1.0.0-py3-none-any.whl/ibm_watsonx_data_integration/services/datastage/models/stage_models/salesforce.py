...
from ibm_watsonx_data_integration.services.datastage.models.enums import SALESFORCE
from pydantic import Field
from typing import ClassVar


class salesforce(BaseStage):
    ...
    connection: SalesforceConn = SalesforceConn()
    batch_size: int | None = Field(2000, alias="batch_size")
    buf_free_run_ronly: int | None = Field(50, alias="buf_free_run_ronly")
    buf_mode_ronly: SALESFORCE.BufModeRonly | None = Field(SALESFORCE.BufModeRonly.default, alias="buf_mode_ronly")
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: SALESFORCE.BufferingMode | None = Field(SALESFORCE.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    collecting: SALESFORCE.Collecting | None = Field(SALESFORCE.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: SALESFORCE.CombinabilityMode | None = Field(
        SALESFORCE.CombinabilityMode.auto, alias="combinability"
    )
    ...
    decimal_rounding_mode: SALESFORCE.DecimalRoundingMode | None = Field(
        SALESFORCE.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    execution_mode: SALESFORCE.ExecutionMode | None = Field(SALESFORCE.ExecutionMode.default_par, alias="execmode")
    existing_table_action: SALESFORCE.ExistingTableAction | None = Field(
        SALESFORCE.ExistingTableAction.append, alias="existing_table_action"
    )
    ...
    partition_type: SALESFORCE.PartitionType | None = Field(SALESFORCE.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: SALESFORCE.PreservePartitioning | None = Field(
        SALESFORCE.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_method: SALESFORCE.ReadMethod | None = Field(SALESFORCE.ReadMethod.general, alias="read_mode")
    ...
    sorting_key: SALESFORCE.KeyColSelect | None = Field(SALESFORCE.KeyColSelect.default, alias="keyColSelect")
    ...
    table_action: SALESFORCE.TableAction | None = Field(SALESFORCE.TableAction.append, alias="table_action")
    ...
    write_mode: SALESFORCE.WriteMode | None = Field(SALESFORCE.WriteMode.insert, alias="write_mode")
