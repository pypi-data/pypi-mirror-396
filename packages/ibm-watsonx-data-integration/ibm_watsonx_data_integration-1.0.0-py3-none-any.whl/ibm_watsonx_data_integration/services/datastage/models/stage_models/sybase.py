...
from ibm_watsonx_data_integration.services.datastage.models.enums import SYBASE
from pydantic import Field
from typing import ClassVar


class sybase(BaseStage):
    ...
    connection: SybaseConn = SybaseConn()
    ...
    buf_mode_ronly: SYBASE.BufModeRonly | None = Field(SYBASE.BufModeRonly.default, alias="buf_mode_ronly")
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: SYBASE.BufferingMode | None = Field(SYBASE.BufferingMode.default, alias="buf_mode")
    ...
    collecting: SYBASE.Collecting | None = Field(SYBASE.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: SYBASE.CombinabilityMode | None = Field(SYBASE.CombinabilityMode.auto, alias="combinability")
    ...
    decimal_rounding_mode: SYBASE.DecimalRoundingMode | None = Field(
        SYBASE.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    execution_mode: SYBASE.ExecutionMode | None = Field(SYBASE.ExecutionMode.default_par, alias="execmode")
    existing_table_action: SYBASE.ExistingTableAction | None = Field(
        SYBASE.ExistingTableAction.append, alias="existing_table_action"
    )
    ...
    partition_type: SYBASE.PartitionType | None = Field(SYBASE.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: SYBASE.PreservePartitioning | None = Field(
        SYBASE.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_method: SYBASE.ReadMethod | None = Field(SYBASE.ReadMethod.general, alias="read_mode")
    ...
    reject_uses: SYBASE.RejectUses | None = Field(SYBASE.RejectUses.rows, alias="reject_uses")
    ...
    sorting_key: SYBASE.KeyColSelect | None = Field(SYBASE.KeyColSelect.default, alias="keyColSelect")
    ...
    table_action: SYBASE.TableAction | None = Field(SYBASE.TableAction.append, alias="table_action")
    ...
    write_mode: SYBASE.WriteMode | None = Field(SYBASE.WriteMode.insert, alias="write_mode")
