...
from ibm_watsonx_data_integration.services.datastage.models.enums import MONGODB
from pydantic import Field
from typing import ClassVar


class mongodb(BaseStage):
    ...
    connection: MongodbConn = MongodbConn()
    auth_method: MONGODB.AuthMethod | None = Field(None, alias="auth_method")
    batch_size: int | None = Field(2000, alias="batch_size")
    buf_free_run_ronly: int | None = Field(50, alias="buf_free_run_ronly")
    buf_mode_ronly: MONGODB.BufModeRonly | None = Field(MONGODB.BufModeRonly.default, alias="buf_mode_ronly")
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: MONGODB.BufferingMode | None = Field(MONGODB.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    collecting: MONGODB.Collecting | None = Field(MONGODB.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: MONGODB.CombinabilityMode | None = Field(MONGODB.CombinabilityMode.auto, alias="combinability")
    ...
    decimal_rounding_mode: MONGODB.DecimalRoundingMode | None = Field(
        MONGODB.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    execution_mode: MONGODB.ExecutionMode | None = Field(MONGODB.ExecutionMode.default_par, alias="execmode")
    ...
    partition_type: MONGODB.PartitionType | None = Field(MONGODB.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: MONGODB.PreservePartitioning | None = Field(
        MONGODB.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_method: MONGODB.ReadMethod | None = Field(MONGODB.ReadMethod.general, alias="read_mode")
    ...
    sorting_key: MONGODB.KeyColSelect | None = Field(MONGODB.KeyColSelect.default, alias="keyColSelect")
    ...
    table_action: MONGODB.TableAction | None = Field(MONGODB.TableAction.append, alias="table_action")
    ...
    write_mode: MONGODB.WriteMode | None = Field(MONGODB.WriteMode.insert, alias="write_mode")
