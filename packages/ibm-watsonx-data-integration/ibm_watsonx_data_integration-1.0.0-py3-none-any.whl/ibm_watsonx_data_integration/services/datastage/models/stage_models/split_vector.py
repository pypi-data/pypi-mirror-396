...
from ibm_watsonx_data_integration.services.datastage.models.enums import SPLIT_VECTOR
from pydantic import Field
from typing import ClassVar


class split_vector(BaseStage):
    ...
    buf_mode: SPLIT_VECTOR.BufMode | None = Field(SPLIT_VECTOR.BufMode.default, alias="buf_mode")
    buf_mode_ronly: SPLIT_VECTOR.BufModeRonly | None = Field(SPLIT_VECTOR.BufModeRonly.default, alias="buf_mode_ronly")
    coll_type: SPLIT_VECTOR.CollType | None = Field(SPLIT_VECTOR.CollType.auto, alias="coll_type")
    combinability: SPLIT_VECTOR.Combinability | None = Field(SPLIT_VECTOR.Combinability.auto, alias="combinability")
    ...
    execmode: SPLIT_VECTOR.Execmode | None = Field(SPLIT_VECTOR.Execmode.default_par, alias="execmode")
    flow_dirty: str | None = Field("false", alias="flow_dirty")
    hide: bool | None = Field(False, alias="hide")
    input_count: int | None = Field(0, alias="input_count")
    input_link_description: list | None = Field("", alias="inputLinkDescription")
    inputcol_properties: list | None = Field([], alias="inputcolProperties")
    key_col_select: SPLIT_VECTOR.KeyColSelect | None = Field(SPLIT_VECTOR.KeyColSelect.default, alias="keyColSelect")
    ...
    part_type: SPLIT_VECTOR.PartType | None = Field(SPLIT_VECTOR.PartType.auto, alias="part_type")
    ...
    preserve: SPLIT_VECTOR.Preserve | None = Field(SPLIT_VECTOR.Preserve.default_propagate, alias="preserve")
