...
class fileset(BaseStage):
    ...
    allow_all_zeros: FILESET.AllowAllZeros | None = Field(FILESET.AllowAllZeros.nofix_zero, alias="allow_all_zeros")
    allow_per_column_mapping: FILESET.AllowPerColumnMapping | None = Field(
        FILESET.AllowPerColumnMapping.false, alias="allow_column_mapping"
    )
    allow_signed_import: FILESET.AllowSignedImport | None = Field(
        FILESET.AllowSignedImport.allow_signed_import, alias="allow_signed_import"
    )
    ...
    buffering_mode: FILESET.BufferingMode | None = Field(FILESET.BufferingMode.default, alias="buf_mode")
    byte_order: FILESET.ByteOrder | None = Field(FILESET.ByteOrder.native_endian, alias="byte_order")
    c_format: str | None = Field("", alias="c_format")
    character_set: FILESET.CharacterSet | None = Field(FILESET.CharacterSet.ascii, alias="charset")
    check_intact: FILESET.CheckIntact | None = Field(FILESET.CheckIntact.check_intact, alias="check_intact")
    cleanup_on_failure: FILESET.CleanupOnFailure | None = Field(FILESET.CleanupOnFailure.false, alias="nocleanup")
    collecting: FILESET.Collecting | None = Field(FILESET.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: FILESET.CombinabilityMode | None = Field(FILESET.CombinabilityMode.auto, alias="combinability")
    ...
    data_format: FILESET.DataFormat | None = Field(FILESET.DataFormat.text, alias="data_format")
    date_format: str | None = Field("", alias="date_format")
    date_options: FILESET.DateOption | None = Field(FILESET.DateOption.none, alias="dateOption")
    ...
    decimal_options: FILESET.DecimalOption | None = Field([], alias="decimalOption")
    decimal_packed: FILESET.DecimalPacked | None = Field(FILESET.DecimalPacked.packed, alias="decimal_packed")
    decimal_packed_check: FILESET.DecimalPackedCheck | None = Field(
        FILESET.DecimalPackedCheck.check, alias="decimal_packed_check"
    )
    decimal_packed_sign_position: FILESET.DecimalPackedSignPosition | None = Field(
        FILESET.DecimalPackedSignPosition.trailing, alias="decimal_packed_sign_position"
    )
    decimal_packed_signed: FILESET.DecimalPackedSigned | None = Field(
        FILESET.DecimalPackedSigned.signed, alias="decimal_packed_signed"
    )
    decimal_sep_value: str | None = Field("", alias="decimal_sep_value")
    decimal_separator: FILESET.DecimalSeparator | None = Field(
        FILESET.DecimalSeparator.period, alias="decimal_separator"
    )
    delim_value: str | None = Field("", alias="delim_value")
    delimiter: FILESET.Delimiter | None = Field(FILESET.Delimiter.comma, alias="delim")
    ...
    execution_mode: FILESET.ExecutionMode | None = Field(FILESET.ExecutionMode.default_par, alias="execmode")
    export_ebcdic_as_ascii: FILESET.ExportEbcdicAsAscii | None = Field(
        FILESET.ExportEbcdicAsAscii.export_ebcdic_as_ascii, alias="export_ebcdic_as_ascii"
    )
    field_defaults_options: FILESET.FieldOption | None = Field(FILESET.FieldOption.delimiter, alias="fieldOption")
    ...
    file_set: str = Field(None, alias="fileset")
    file_set_schema_policy: FILESET.OmitSchemaWriteSchema | None = Field(
        FILESET.OmitSchemaWriteSchema.writeSchema, alias="omitSchema-writeSchema"
    )
    ...
    file_suffix: str | None = Field(None, alias="suffix")
    fill_char: FILESET.FillChar | None = Field(FILESET.FillChar.null, alias="fill")
    ...
    final_delimiter: FILESET.FinalDelimiter | None = Field(FILESET.FinalDelimiter.end, alias="final_delim")
    final_delimiter_string: str | None = Field("", alias="final_delim_string")
    flow_dirty: str | None = Field("false", alias="flow_dirty")
    general_options: FILESET.GeneralOption | None = Field([], alias="generalOption")
    hide: bool | None = Field(False, alias="hide")
    import_ascii_as_ebcdic: FILESET.ImportAsciiAsEbcdic | None = Field(
        FILESET.ImportAsciiAsEbcdic.import_ascii_as_ebcdic, alias="import_ascii_as_ebcdic"
    )
    ...
    is_julian: FILESET.IsJulian | None = Field(FILESET.IsJulian.julian, alias="is_julian")
    is_midnight_seconds: FILESET.IsMidnightSeconds | None = Field(
        FILESET.IsMidnightSeconds.midnight_seconds, alias="is_midnight_seconds"
    )
    keep_file_partitions: FILESET.KeepPartitions | None = Field(FILESET.KeepPartitions.false, alias="keepPartitions")
    key_cols_coll: list | None = Field([], alias="keyColsColl")
    key_cols_coll_ordered: list | None = Field([], alias="keyColsCollOrdered")
    key_cols_coll_robin: list | None = Field([], alias="keyColsCollRobin")
    key_cols_none: list | None = Field([], alias="keyColsNone")
    key_cols_part: list | None = Field([], alias="keyColsPart")
    map_name: FILESET.MapName | None = Field(FILESET.MapName.UTF_8, alias="nls_map_name")
    ...
    null_field_value_separator: FILESET.NullFieldValueSeparator | None = Field(
        FILESET.NullFieldValueSeparator.comma, alias="null_field_sep"
    )
    numeric_options: FILESET.NumericOption | None = Field([], alias="numericOption")
    ...
    pad_char: FILESET.PadChar | None = Field(FILESET.PadChar.false_, alias="padchar")
    ...
    partition_type: FILESET.PartitionType | None = Field(FILESET.PartitionType.auto, alias="part_type")
    ...
    prefix_bytes: FILESET.PrefixBytes | None = Field(FILESET.PrefixBytes.one, alias="prefix")
    preserve_partitioning: FILESET.PreservePartitioning | None = Field(
        FILESET.PreservePartitioning.default_clear, alias="preserve"
    )
    print_field: FILESET.PrintField | None = Field(FILESET.PrintField.print_field, alias="print_field")
    ...
    quote: FILESET.Quote | None = Field(FILESET.Quote.double, alias="quote")
    quote_value: str | None = Field("", alias="quote_value")
    record_delim_value: str | None = Field("", alias="record_delim_value")
    record_delimiter: FILESET.RecordDelimiter | None = Field(FILESET.RecordDelimiter.newline, alias="record_delim")
    record_delimiter_string: str | None = Field("", alias="record_delim_string")
    record_len_value: int | None = Field(0, alias="record_len_value")
    record_length: FILESET.RecordLength | None = Field(FILESET.RecordLength.fixed, alias="record_length")
    record_level_options: FILESET.RecLevelOption | None = Field([], alias="recLevelOption")
    record_prefix: FILESET.RecordPrefix | None = Field(FILESET.RecordPrefix.one, alias="record_prefix")
    record_type: FILESET.RecordType | None = Field(FILESET.RecordType.type_implicit, alias="record_format")
    reject_mode: FILESET.RejectMode | None = Field(FILESET.RejectMode.cont, alias="rejects")
    reject_reason_column: str | None = Field(None, alias="rejectReasonField")
    report_progress: FILESET.ReportProgress | None = Field(FILESET.ReportProgress.yes, alias="reportProgress")
    rounding: FILESET.Rounding | None = Field(FILESET.Rounding.trunc_zero, alias="round")
    ...
    single_file_per_partition: FILESET.SingleFilePerPartition | None = Field(
        FILESET.SingleFilePerPartition.false, alias="singleFilePerPartition"
    )
    ...
    string_options: FILESET.StringOption | None = Field([], alias="stringOption")
    strip_bom: FILESET.StripBom | None = Field(FILESET.StripBom.false, alias="stripbom")
    time_format: str | None = Field("", alias="time_format")
    time_options: FILESET.TimeOption | None = Field(FILESET.TimeOption.none, alias="timeOption")
    timestamp_format: str | None = Field("", alias="timestamp_format")
    timestamp_options: FILESET.TimestampOption | None = Field(FILESET.TimestampOption.none, alias="timestampOption")
    unique: bool | None = Field(None, alias="part_unique")
    use_schema_defined_in_file_set: FILESET.UseSchemaDefinedInFileSet | None = Field(
        FILESET.UseSchemaDefinedInFileSet.true, alias="schemafileset"
    )
    vector_prefix: FILESET.VectorPrefix | None = Field(FILESET.VectorPrefix.one, alias="vector_prefix")
