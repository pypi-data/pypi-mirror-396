...
from ibm_watsonx_data_integration.services.datastage.models.enums import DATASTAX
from pydantic import Field
from typing import ClassVar


class datastax(BaseStage):
    ...
    connection: DatastaxConn = DatastaxConn()
    batch_size: int | None = Field(2000, alias="batch_size")
    buf_free_run_ronly: int | None = Field(50, alias="buf_free_run_ronly")
    buf_mode_ronly: DATASTAX.BufModeRonly | None = Field(DATASTAX.BufModeRonly.default, alias="buf_mode_ronly")
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: DATASTAX.BufferingMode | None = Field(DATASTAX.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    collecting: DATASTAX.Collecting | None = Field(DATASTAX.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: DATASTAX.CombinabilityMode | None = Field(
        DATASTAX.CombinabilityMode.auto, alias="combinability"
    )
    ...
    decimal_rounding_mode: DATASTAX.DecimalRoundingMode | None = Field(
        DATASTAX.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    execution_mode: DATASTAX.ExecutionMode | None = Field(DATASTAX.ExecutionMode.default_par, alias="execmode")
    ...
    partition_type: DATASTAX.PartitionType | None = Field(DATASTAX.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: DATASTAX.PreservePartitioning | None = Field(
        DATASTAX.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_method: DATASTAX.ReadMethod | None = Field(DATASTAX.ReadMethod.general, alias="read_mode")
    ...
    sorting_key: DATASTAX.KeyColSelect | None = Field(DATASTAX.KeyColSelect.default, alias="keyColSelect")
    ...
    table_action: DATASTAX.TableAction | None = Field(DATASTAX.TableAction.append, alias="table_action")
    ...
    write_mode: DATASTAX.WriteMode | None = Field(DATASTAX.WriteMode.insert, alias="write_mode")
