...
class change_apply(BaseStage):
    ...
    buf_mode_ronly: CHANGE_APPLY.BufModeRonly | None = Field(CHANGE_APPLY.BufModeRonly.default, alias="buf_mode_ronly")
    ...
    selection_ci_cs: CHANGE_APPLY.SelectionCiCs | None = Field(CHANGE_APPLY.SelectionCiCs.cs, alias="selection-ci-cs")
