...
from ibm_watsonx_data_integration.services.datastage.models.enums import HEAD
from pydantic import Field
from typing import ClassVar


class head(BaseStage):
    ...
    all: HEAD.All | None = Field(HEAD.All.false, alias="all")
    ...
    buf_mode: HEAD.BufMode | None = Field(HEAD.BufMode.default, alias="buf_mode")
    buf_mode_ronly: HEAD.BufModeRonly | None = Field(HEAD.BufModeRonly.default, alias="buf_mode_ronly")
    coll_type: HEAD.CollType | None = Field(HEAD.CollType.auto, alias="coll_type")
    combinability: HEAD.Combinability | None = Field(HEAD.Combinability.auto, alias="combinability")
    ...
    execmode: HEAD.Execmode | None = Field(HEAD.Execmode.default_par, alias="execmode")
    flow_dirty: str | None = Field("false", alias="flow_dirty")
    hide: bool | None = Field(False, alias="hide")
    input_count: int | None = Field(0, alias="input_count")
    input_link_description: list | None = Field("", alias="inputLinkDescription")
    inputcol_properties: list | None = Field([], alias="inputcolProperties")
    key_col_select: HEAD.KeyColSelect | None = Field(HEAD.KeyColSelect.default, alias="keyColSelect")
    ...
    part: list | None = Field([], alias="part")
    ...
    part_type: HEAD.PartType | None = Field(HEAD.PartType.auto, alias="part_type")
    ...
    preserve: HEAD.Preserve | None = Field(HEAD.Preserve.default_propagate, alias="preserve")
    ...
    selection: HEAD.Selection | None = Field(HEAD.Selection.true, alias="selection")
