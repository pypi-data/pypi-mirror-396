...
from ibm_watsonx_data_integration.services.datastage.models.enums import DATA_RULES
from pydantic import Field
from typing import ClassVar


class data_rules(BaseStage):
    ...
    buf_mode: DATA_RULES.BufMode | None = Field(DATA_RULES.BufMode.default, alias="buf_mode")
    buf_mode_ronly: DATA_RULES.BufModeRonly | None = Field(DATA_RULES.BufModeRonly.default, alias="buf_mode_ronly")
    coll_type: DATA_RULES.CollType | None = Field(DATA_RULES.CollType.auto, alias="coll_type")
    combinability: DATA_RULES.Combinability | None = Field(DATA_RULES.Combinability.auto, alias="combinability")
    ...
    execmode: DATA_RULES.Execmode | None = Field(DATA_RULES.Execmode.default_par, alias="execmode")
    flow_dirty: str | None = Field("false", alias="flow_dirty")
    hide: bool | None = Field(False, alias="hide")
    input_count: int | None = Field(0, alias="input_count")
    input_link_description: list | None = Field("", alias="inputLinkDescription")
    inputcol_properties: list | None = Field([], alias="inputcolProperties")
    key_col_select: DATA_RULES.KeyColSelect | None = Field(DATA_RULES.KeyColSelect.default, alias="keyColSelect")
    key_cols_coll: list | None = Field([], alias="keyColsColl")
    key_cols_coll_ordered: list | None = Field([], alias="keyColsCollOrdered")
    key_cols_coll_robin: list | None = Field([], alias="keyColsCollRobin")
    key_cols_none: list | None = Field([], alias="keyColsNone")
    key_cols_part: list | None = Field([], alias="keyColsPart")
    logic: str = Field(None, alias="logic")
    ...
    part_type: DATA_RULES.PartType | None = Field(DATA_RULES.PartType.auto, alias="part_type")
    ...
    preserve: DATA_RULES.Preserve | None = Field(DATA_RULES.Preserve.default_propagate, alias="preserve")
