...
from ibm_watsonx_data_integration.services.datastage.models.enums import MYSQL
from pydantic import Field
from typing import ClassVar


class mysql(BaseStage):
    ...
    connection: MysqlConn = MysqlConn()
    ...
    buf_mode_ronly: MYSQL.BufModeRonly | None = Field(MYSQL.BufModeRonly.default, alias="buf_mode_ronly")
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: MYSQL.BufferingMode | None = Field(MYSQL.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    call_procedure_statement: str | None = Field(None, alias="call_statement")
    collecting: MYSQL.Collecting | None = Field(MYSQL.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: MYSQL.CombinabilityMode | None = Field(MYSQL.CombinabilityMode.auto, alias="combinability")
    ...
    decimal_rounding_mode: MYSQL.DecimalRoundingMode | None = Field(
        MYSQL.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    execution_mode: MYSQL.ExecutionMode | None = Field(MYSQL.ExecutionMode.default_par, alias="execmode")
    existing_table_action: MYSQL.ExistingTableAction | None = Field(
        MYSQL.ExistingTableAction.append, alias="existing_table_action"
    )
    ...
    partition_type: MYSQL.PartitionType | None = Field(MYSQL.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: MYSQL.PreservePartitioning | None = Field(
        MYSQL.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_method: MYSQL.ReadMethod | None = Field(MYSQL.ReadMethod.general, alias="read_mode")
    ...
    reject_uses: MYSQL.RejectUses | None = Field(MYSQL.RejectUses.rows, alias="reject_uses")
    ...
    sampling_type: MYSQL.SamplingType | None = Field(MYSQL.SamplingType.none, alias="sampling_type")
    ...
    sorting_key: MYSQL.KeyColSelect | None = Field(MYSQL.KeyColSelect.default, alias="keyColSelect")
    ...
    table_action: MYSQL.TableAction | None = Field(MYSQL.TableAction.append, alias="table_action")
    ...
    write_mode: MYSQL.WriteMode | None = Field(MYSQL.WriteMode.insert, alias="write_mode")
