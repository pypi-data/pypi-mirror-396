...
from ibm_watsonx_data_integration.services.datastage.models.enums import TAIL
from pydantic import Field
from typing import ClassVar


class tail(BaseStage):
    ...
    buf_mode: TAIL.BufMode | None = Field(TAIL.BufMode.default, alias="buf_mode")
    buf_mode_ronly: TAIL.BufModeRonly | None = Field(TAIL.BufModeRonly.default, alias="buf_mode_ronly")
    coll_type: TAIL.CollType | None = Field(TAIL.CollType.auto, alias="coll_type")
    combinability: TAIL.Combinability | None = Field(TAIL.Combinability.auto, alias="combinability")
    ...
    execmode: TAIL.Execmode | None = Field(TAIL.Execmode.default_par, alias="execmode")
    flow_dirty: str | None = Field("false", alias="flow_dirty")
    hide: bool | None = Field(False, alias="hide")
    input_count: int | None = Field(0, alias="input_count")
    input_link_description: list | None = Field("", alias="inputLinkDescription")
    inputcol_properties: list | None = Field([], alias="inputcolProperties")
    key_col_select: TAIL.KeyColSelect | None = Field(TAIL.KeyColSelect.default, alias="keyColSelect")
    ...
    part_type: TAIL.PartType | None = Field(TAIL.PartType.auto, alias="part_type")
    ...
    preserve: TAIL.Preserve | None = Field(TAIL.Preserve.default_propagate, alias="preserve")
    ...
    selection: TAIL.Selection | None = Field(TAIL.Selection.true, alias="selection")
