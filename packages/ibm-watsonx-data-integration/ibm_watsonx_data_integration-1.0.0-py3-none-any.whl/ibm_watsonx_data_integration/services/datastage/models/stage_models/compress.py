...
from ibm_watsonx_data_integration.services.datastage.models.enums import COMPRESS
from pydantic import Field
from typing import ClassVar


class compress(BaseStage):
    ...
    buf_mode: COMPRESS.BufMode | None = Field(COMPRESS.BufMode.default, alias="buf_mode")
    buf_mode_ronly: COMPRESS.BufModeRonly | None = Field(COMPRESS.BufModeRonly.default, alias="buf_mode_ronly")
    coll_type: COMPRESS.CollType | None = Field(COMPRESS.CollType.auto, alias="coll_type")
    combinability: COMPRESS.Combinability | None = Field(COMPRESS.Combinability.auto, alias="combinability")
    command: COMPRESS.Command | None = Field(COMPRESS.Command.compress, alias="command")
    ...
    execmode: COMPRESS.Execmode | None = Field(COMPRESS.Execmode.default_par, alias="execmode")
    flow_dirty: str | None = Field("false", alias="flow_dirty")
    hide: bool | None = Field(False, alias="hide")
    input_count: int | None = Field(0, alias="input_count")
    input_link_description: list | None = Field("", alias="inputLinkDescription")
    inputcol_properties: list | None = Field([], alias="inputcolProperties")
    key_col_select: COMPRESS.KeyColSelect | None = Field(COMPRESS.KeyColSelect.default, alias="keyColSelect")
    ...
    part_type: COMPRESS.PartType | None = Field(COMPRESS.PartType.auto, alias="part_type")
    ...
    preserve: COMPRESS.Preserve | None = Field(COMPRESS.Preserve.default_set, alias="preserve")
