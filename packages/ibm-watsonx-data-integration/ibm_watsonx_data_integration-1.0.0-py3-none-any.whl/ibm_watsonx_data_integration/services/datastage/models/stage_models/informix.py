...
from ibm_watsonx_data_integration.services.datastage.models.enums import INFORMIX
from pydantic import Field
from typing import ClassVar


class informix(BaseStage):
    ...
    connection: InformixConn = InformixConn()
    allow_per_column_mapping: INFORMIX.AllowPerColumnMapping | None = Field(
        INFORMIX.AllowPerColumnMapping.false, alias="allow_column_mapping"
    )
    batch_size: int | None = Field(2000, alias="batch_size")
    buf_free_run_ronly: int | None = Field(50, alias="buf_free_run_ronly")
    buf_mode_ronly: INFORMIX.BufModeRonly | None = Field(INFORMIX.BufModeRonly.default, alias="buf_mode_ronly")
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: INFORMIX.BufferingMode | None = Field(INFORMIX.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    catalog_name: str | None = Field(None, alias="catalog_name")
    collecting: INFORMIX.Collecting | None = Field(INFORMIX.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: INFORMIX.CombinabilityMode | None = Field(
        INFORMIX.CombinabilityMode.auto, alias="combinability"
    )
    ...
    credentials_input_method_ssl: INFORMIX.CredentialsInputMethodSsl | None = Field(
        INFORMIX.CredentialsInputMethodSsl.enter_credentials_manually, alias="credentials_input_method_ssl"
    )
    ...
    decimal_rounding_mode: INFORMIX.DecimalRoundingMode | None = Field(
        INFORMIX.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    execution_mode: INFORMIX.ExecutionMode | None = Field(INFORMIX.ExecutionMode.default_par, alias="execmode")
    existing_table_action: INFORMIX.ExistingTableAction | None = Field(
        INFORMIX.ExistingTableAction.append, alias="existing_table_action"
    )
    ...
    input_method: INFORMIX.InputMethod | None = Field(
        INFORMIX.InputMethod.enter_credentials_manually, alias="credentials_input_method"
    )
    ...
    map_name: INFORMIX.MapName | None = Field(INFORMIX.MapName.UTF_8, alias="nls_map_name")
    ...
    partition_type: INFORMIX.PartitionType | None = Field(INFORMIX.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: INFORMIX.PreservePartitioning | None = Field(
        INFORMIX.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_method: INFORMIX.ReadMethod | None = Field(INFORMIX.ReadMethod.general, alias="read_mode")
    ...
    reject_uses: INFORMIX.RejectUses | None = Field(INFORMIX.RejectUses.rows, alias="reject_uses")
    ...
    sampling_type: INFORMIX.SamplingType | None = Field(INFORMIX.SamplingType.none, alias="sampling_type")
    ...
    sorting_key: INFORMIX.KeyColSelect | None = Field(INFORMIX.KeyColSelect.default, alias="keyColSelect")
    ...
    table_action: INFORMIX.TableAction | None = Field(INFORMIX.TableAction.append, alias="table_action")
    ...
    write_mode: INFORMIX.WriteMode | None = Field(INFORMIX.WriteMode.insert, alias="write_mode")
    ...
    def _validate_source(self) -> tuple[set, set]:
        ...
        (
            ...
            if (
                ...
                and ((not self.catalog_name) or (self.catalog_name and "#" in str(self.catalog_name)))
            )
            else exclude.add("select_statement")
        )
        (
