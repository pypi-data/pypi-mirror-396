...
from ibm_watsonx_data_integration.services.datastage.models.enums import EXASOL
from pydantic import Field
from typing import ClassVar


class exasol(BaseStage):
    ...
    connection: ExasolConn = ExasolConn()
    batch_size: int | None = Field(2000, alias="batch_size")
    buf_free_run_ronly: int | None = Field(50, alias="buf_free_run_ronly")
    buf_mode_ronly: EXASOL.BufModeRonly | None = Field(EXASOL.BufModeRonly.default, alias="buf_mode_ronly")
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: EXASOL.BufferingMode | None = Field(EXASOL.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    collecting: EXASOL.Collecting | None = Field(EXASOL.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: EXASOL.CombinabilityMode | None = Field(EXASOL.CombinabilityMode.auto, alias="combinability")
    ...
    decimal_rounding_mode: EXASOL.DecimalRoundingMode | None = Field(
        EXASOL.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    execution_mode: EXASOL.ExecutionMode | None = Field(EXASOL.ExecutionMode.default_par, alias="execmode")
    existing_table_action: EXASOL.ExistingTableAction | None = Field(
        EXASOL.ExistingTableAction.append, alias="existing_table_action"
    )
    ...
    partition_type: EXASOL.PartitionType | None = Field(EXASOL.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: EXASOL.PreservePartitioning | None = Field(
        EXASOL.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_method: EXASOL.ReadMethod | None = Field(EXASOL.ReadMethod.general, alias="read_mode")
    ...
    sorting_key: EXASOL.KeyColSelect | None = Field(EXASOL.KeyColSelect.default, alias="keyColSelect")
    ...
    table_action: EXASOL.TableAction | None = Field(EXASOL.TableAction.append, alias="table_action")
    ...
    write_mode: EXASOL.WriteMode | None = Field(EXASOL.WriteMode.insert, alias="write_mode")
