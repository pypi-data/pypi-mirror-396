...
from ibm_watsonx_data_integration.services.datastage.models.enums import SPLIT_SUBRECORD
from pydantic import Field
from typing import ClassVar


class split_subrecord(BaseStage):
    ...
    buf_mode: SPLIT_SUBRECORD.BufMode | None = Field(SPLIT_SUBRECORD.BufMode.default, alias="buf_mode")
    buf_mode_ronly: SPLIT_SUBRECORD.BufModeRonly | None = Field(
        SPLIT_SUBRECORD.BufModeRonly.default, alias="buf_mode_ronly"
    )
    coll_type: SPLIT_SUBRECORD.CollType | None = Field(SPLIT_SUBRECORD.CollType.auto, alias="coll_type")
    combinability: SPLIT_SUBRECORD.Combinability | None = Field(
        SPLIT_SUBRECORD.Combinability.auto, alias="combinability"
    )
    ...
    execmode: SPLIT_SUBRECORD.Execmode | None = Field(SPLIT_SUBRECORD.Execmode.default_par, alias="execmode")
    flow_dirty: str | None = Field("false", alias="flow_dirty")
    hide: bool | None = Field(False, alias="hide")
    input_count: int | None = Field(0, alias="input_count")
    input_link_description: list | None = Field("", alias="inputLinkDescription")
    inputcol_properties: list | None = Field([], alias="inputcolProperties")
    key_col_select: SPLIT_SUBRECORD.KeyColSelect | None = Field(
        SPLIT_SUBRECORD.KeyColSelect.default, alias="keyColSelect"
    )
    ...
    part_type: SPLIT_SUBRECORD.PartType | None = Field(SPLIT_SUBRECORD.PartType.auto, alias="part_type")
    ...
    preserve: SPLIT_SUBRECORD.Preserve | None = Field(SPLIT_SUBRECORD.Preserve.default_propagate, alias="preserve")
