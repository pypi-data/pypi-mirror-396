...
from ibm_watsonx_data_integration.services.datastage.models.enums import DECODE
from pydantic import Field
from typing import ClassVar


class decode(BaseStage):
    ...
    buf_mode: DECODE.BufMode | None = Field(DECODE.BufMode.default, alias="buf_mode")
    buf_mode_ronly: DECODE.BufModeRonly | None = Field(DECODE.BufModeRonly.default, alias="buf_mode_ronly")
    coll_type: DECODE.CollType | None = Field(DECODE.CollType.auto, alias="coll_type")
    combinability: DECODE.Combinability | None = Field(DECODE.Combinability.auto, alias="combinability")
    ...
    execmode: DECODE.Execmode | None = Field(DECODE.Execmode.default_par, alias="execmode")
    flow_dirty: str | None = Field("false", alias="flow_dirty")
    hide: bool | None = Field(False, alias="hide")
    input_count: int | None = Field(0, alias="input_count")
    input_link_description: list | None = Field("", alias="inputLinkDescription")
    inputcol_properties: list | None = Field([], alias="inputcolProperties")
    key_col_select: DECODE.KeyColSelect | None = Field(DECODE.KeyColSelect.default, alias="keyColSelect")
    ...
    part_type: DECODE.PartType | None = Field(DECODE.PartType.auto, alias="part_type")
    ...
    preserve: DECODE.Preserve | None = Field(DECODE.Preserve.default_propagate, alias="preserve")
