...
class match360(BaseStage):
    ...
    buffering_mode: MATCH360.BufferingMode | None = Field(MATCH360.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    collecting: MATCH360.Collecting | None = Field(MATCH360.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    columns: str | None = Field(None, alias="record_sub_type_columns")
    combinability_mode: MATCH360.CombinabilityMode | None = Field(
        MATCH360.CombinabilityMode.auto, alias="combinability"
    )
    ...
    data_category: MATCH360.DataCategory = Field(MATCH360.DataCategory.records, alias="model_type_name")
    data_stage_folder: str | None = Field(None, alias="ds-folder-name")
    data_subtype: str | None = Field(None, alias="record_sub_type_name")
    data_type: str = Field(None, alias="model_sub_type_name")
    ...
    execution_mode: MATCH360.ExecutionMode | None = Field(MATCH360.ExecutionMode.default_par, alias="execmode")
    export_job_id: str | None = Field(None, alias="export_job_id")
    filter_rule: str | None = Field(None, alias="filter_rule")
    ...
    partition_type: MATCH360.PartitionType | None = Field(MATCH360.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: MATCH360.PreservePartitioning | None = Field(
        MATCH360.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    write_method: MATCH360.WriteMethod = Field(None, alias="write_method")
    zip_downloaded: bool | None = Field(None, alias="zip_downloaded")
