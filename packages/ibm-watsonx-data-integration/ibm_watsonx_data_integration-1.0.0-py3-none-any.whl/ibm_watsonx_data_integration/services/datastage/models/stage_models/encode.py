...
from ibm_watsonx_data_integration.services.datastage.models.enums import ENCODE
from pydantic import Field
from typing import ClassVar


class encode(BaseStage):
    ...
    buf_mode: ENCODE.BufMode | None = Field(ENCODE.BufMode.default, alias="buf_mode")
    buf_mode_ronly: ENCODE.BufModeRonly | None = Field(ENCODE.BufModeRonly.default, alias="buf_mode_ronly")
    coll_type: ENCODE.CollType | None = Field(ENCODE.CollType.auto, alias="coll_type")
    combinability: ENCODE.Combinability | None = Field(ENCODE.Combinability.auto, alias="combinability")
    ...
    execmode: ENCODE.Execmode | None = Field(ENCODE.Execmode.default_par, alias="execmode")
    flow_dirty: str | None = Field("false", alias="flow_dirty")
    hide: bool | None = Field(False, alias="hide")
    input_count: int | None = Field(0, alias="input_count")
    input_link_description: list | None = Field("", alias="inputLinkDescription")
    inputcol_properties: list | None = Field([], alias="inputcolProperties")
    key_col_select: ENCODE.KeyColSelect | None = Field(ENCODE.KeyColSelect.default, alias="keyColSelect")
    ...
    part_type: ENCODE.PartType | None = Field(ENCODE.PartType.auto, alias="part_type")
    ...
    preserve: ENCODE.Preserve | None = Field(ENCODE.Preserve.default_set, alias="preserve")
