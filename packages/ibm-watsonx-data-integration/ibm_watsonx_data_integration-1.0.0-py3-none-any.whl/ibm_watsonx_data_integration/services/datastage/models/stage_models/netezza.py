...
from ibm_watsonx_data_integration.services.datastage.models.enums import NETEZZA
from pydantic import Field
from typing import ClassVar


class netezza(BaseStage):
    ...
    connection: NetezzaConn = NetezzaConn()
    batch_size: int | None = Field(2000, alias="batch_size")
    buf_free_run_ronly: int | None = Field(50, alias="buf_free_run_ronly")
    buf_mode_ronly: NETEZZA.BufModeRonly | None = Field(NETEZZA.BufModeRonly.default, alias="buf_mode_ronly")
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: NETEZZA.BufferingMode | None = Field(NETEZZA.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    collecting: NETEZZA.Collecting | None = Field(NETEZZA.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: NETEZZA.CombinabilityMode | None = Field(NETEZZA.CombinabilityMode.auto, alias="combinability")
    ...
    credentials_input_method_ssl: NETEZZA.CredentialsInputMethodSsl | None = Field(
        NETEZZA.CredentialsInputMethodSsl.enter_credentials_manually, alias="credentials_input_method_ssl"
    )
    ...
    decimal_rounding_mode: NETEZZA.DecimalRoundingMode | None = Field(
        NETEZZA.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    execution_mode: NETEZZA.ExecutionMode | None = Field(NETEZZA.ExecutionMode.default_par, alias="execmode")
    existing_table_action: NETEZZA.ExistingTableAction | None = Field(
        NETEZZA.ExistingTableAction.append, alias="existing_table_action"
    )
    ...
    input_method: NETEZZA.InputMethod | None = Field(
        NETEZZA.InputMethod.enter_credentials_manually, alias="credentials_input_method"
    )
    ...
    partition_type: NETEZZA.PartitionType | None = Field(NETEZZA.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: NETEZZA.PreservePartitioning | None = Field(
        NETEZZA.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_method: NETEZZA.ReadMethod | None = Field(NETEZZA.ReadMethod.general, alias="read_mode")
    ...
    reject_uses: NETEZZA.RejectUses | None = Field(NETEZZA.RejectUses.rows, alias="reject_uses")
    ...
    sampling_type: NETEZZA.SamplingType | None = Field(NETEZZA.SamplingType.none, alias="sampling_type")
    ...
    sorting_key: NETEZZA.KeyColSelect | None = Field(NETEZZA.KeyColSelect.default, alias="keyColSelect")
    ...
    table_action: NETEZZA.TableAction | None = Field(NETEZZA.TableAction.append, alias="table_action")
    ...
    write_mode: NETEZZA.WriteMode | None = Field(NETEZZA.WriteMode.insert, alias="write_mode")
