...
from ibm_watsonx_data_integration.services.datastage.models.enums import COLUMN_GENERATOR
from pydantic import Field
from typing import ClassVar


class column_generator(BaseStage):
    ...
    buf_mode: COLUMN_GENERATOR.BufMode | None = Field(COLUMN_GENERATOR.BufMode.default, alias="buf_mode")
    buf_mode_ronly: COLUMN_GENERATOR.BufModeRonly | None = Field(
        COLUMN_GENERATOR.BufModeRonly.default, alias="buf_mode_ronly"
    )
    coll_type: COLUMN_GENERATOR.CollType | None = Field(COLUMN_GENERATOR.CollType.auto, alias="coll_type")
    combinability: COLUMN_GENERATOR.Combinability | None = Field(
        COLUMN_GENERATOR.Combinability.auto, alias="combinability"
    )
    ...
    execmode: COLUMN_GENERATOR.Execmode | None = Field(COLUMN_GENERATOR.Execmode.default_par, alias="execmode")
    flow_dirty: str | None = Field("false", alias="flow_dirty")
    hide: bool | None = Field(False, alias="hide")
    input_count: int | None = Field(0, alias="input_count")
    input_link_description: list | None = Field("", alias="inputLinkDescription")
    inputcol_properties: list | None = Field([], alias="inputcolProperties")
    key_col_select: COLUMN_GENERATOR.KeyColSelect | None = Field(
        COLUMN_GENERATOR.KeyColSelect.default, alias="keyColSelect"
    )
    ...
    part_type: COLUMN_GENERATOR.PartType | None = Field(COLUMN_GENERATOR.PartType.auto, alias="part_type")
    ...
    preserve: COLUMN_GENERATOR.Preserve | None = Field(COLUMN_GENERATOR.Preserve.default_propagate, alias="preserve")
    ...
    schema_: list = Field([], alias="schema")
    schema_name_check: bool | None = Field(None, alias="schemaNameCheck")
    schemafile: str = Field(None, alias="schemafile")
    selection: COLUMN_GENERATOR.Selection | None = Field(COLUMN_GENERATOR.Selection.explicit, alias="selection")
