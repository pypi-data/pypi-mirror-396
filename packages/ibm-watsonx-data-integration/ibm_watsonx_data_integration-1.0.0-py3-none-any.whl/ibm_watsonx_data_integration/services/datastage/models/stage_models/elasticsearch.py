...
from ibm_watsonx_data_integration.services.datastage.models.enums import ELASTICSEARCH
from pydantic import Field
from typing import ClassVar


class elasticsearch(BaseStage):
    ...
    connection: ElasticsearchConn = ElasticsearchConn()
    buf_free_run_ronly: int | None = Field(50, alias="buf_free_run_ronly")
    buf_mode_ronly: ELASTICSEARCH.BufModeRonly | None = Field(
        ELASTICSEARCH.BufModeRonly.default, alias="buf_mode_ronly"
    )
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: ELASTICSEARCH.BufferingMode | None = Field(ELASTICSEARCH.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    collecting: ELASTICSEARCH.Collecting | None = Field(ELASTICSEARCH.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: ELASTICSEARCH.CombinabilityMode | None = Field(
        ELASTICSEARCH.CombinabilityMode.auto, alias="combinability"
    )
    create_data_asset: bool | None = Field(False, alias="registerDataAsset")
    create_index_body: str | None = Field(None, alias="create_index_body")
    ...
    execution_mode: ELASTICSEARCH.ExecutionMode | None = Field(
        ELASTICSEARCH.ExecutionMode.default_par, alias="execmode"
    )
    file_action: ELASTICSEARCH.FileAction | None = Field(ELASTICSEARCH.FileAction.append, alias="file_action")
    ...
    partition_type: ELASTICSEARCH.PartitionType | None = Field(ELASTICSEARCH.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: ELASTICSEARCH.PreservePartitioning | None = Field(
        ELASTICSEARCH.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_mode: ELASTICSEARCH.ReadMode | None = Field(ELASTICSEARCH.ReadMode.read_single, alias="read_mode")
    ...
    search_query_body: str | None = Field(None, alias="query_body")
    search_query_string: str | None = Field(None, alias="query_string")
    ...
    sorting_key: ELASTICSEARCH.KeyColSelect | None = Field(ELASTICSEARCH.KeyColSelect.default, alias="keyColSelect")
    ...
    write_mode: ELASTICSEARCH.WriteMode | None = Field(ELASTICSEARCH.WriteMode.write, alias="write_mode")
    ...
    def _validate_source(self) -> tuple[set, set]:
        ...
        include.add("search_query_body") if (not self.search_query_string) else exclude.add("search_query_body")
        include.add("search_query_string") if (not self.search_query_body) else exclude.add("search_query_string")
        (
            include.add("search_query_body")
            if ((not self.search_query_string) or (self.search_query_string and "#" in str(self.search_query_string)))
            else exclude.add("search_query_body")
        )
        (
            include.add("search_query_string")
            if ((not self.search_query_body) or (self.search_query_body and "#" in str(self.search_query_body)))
            else exclude.add("search_query_string")
        )
