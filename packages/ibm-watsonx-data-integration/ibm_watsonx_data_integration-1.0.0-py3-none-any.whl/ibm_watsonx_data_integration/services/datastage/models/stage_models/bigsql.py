...
from ibm_watsonx_data_integration.services.datastage.models.enums import BIGSQL
from pydantic import Field
from typing import ClassVar


class bigsql(BaseStage):
    ...
    connection: BigsqlConn = BigsqlConn()
    ...
    buf_mode_ronly: BIGSQL.BufModeRonly | None = Field(BIGSQL.BufModeRonly.default, alias="buf_mode_ronly")
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: BIGSQL.BufferingMode | None = Field(BIGSQL.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    call_procedure_statement: str | None = Field(None, alias="call_statement")
    collecting: BIGSQL.Collecting | None = Field(BIGSQL.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: BIGSQL.CombinabilityMode | None = Field(BIGSQL.CombinabilityMode.auto, alias="combinability")
    ...
    credentials_input_method_ssl: BIGSQL.CredentialsInputMethodSsl | None = Field(
        BIGSQL.CredentialsInputMethodSsl.enter_credentials_manually, alias="credentials_input_method_ssl"
    )
    ...
    decimal_rounding_mode: BIGSQL.DecimalRoundingMode | None = Field(
        BIGSQL.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    execution_mode: BIGSQL.ExecutionMode | None = Field(BIGSQL.ExecutionMode.default_par, alias="execmode")
    existing_table_action: BIGSQL.ExistingTableAction | None = Field(
        BIGSQL.ExistingTableAction.append, alias="existing_table_action"
    )
    ...
    input_method: BIGSQL.InputMethod | None = Field(
        BIGSQL.InputMethod.enter_credentials_manually, alias="credentials_input_method"
    )
    ...
    partition_type: BIGSQL.PartitionType | None = Field(BIGSQL.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: BIGSQL.PreservePartitioning | None = Field(
        BIGSQL.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_method: BIGSQL.ReadMethod | None = Field(BIGSQL.ReadMethod.general, alias="read_mode")
    ...
    reject_uses: BIGSQL.RejectUses | None = Field(BIGSQL.RejectUses.rows, alias="reject_uses")
    ...
    sorting_key: BIGSQL.KeyColSelect | None = Field(BIGSQL.KeyColSelect.default, alias="keyColSelect")
    ...
    table_action: BIGSQL.TableAction | None = Field(BIGSQL.TableAction.append, alias="table_action")
    ...
    write_mode: BIGSQL.WriteMode | None = Field(BIGSQL.WriteMode.insert, alias="write_mode")
