...
class cassandra_datastage(BaseStage):
    ...
    buffering_mode: CASSANDRA_DATASTAGE.BufferingMode | None = Field(
        CASSANDRA_DATASTAGE.BufferingMode.default, alias="buf_mode"
    )
    check_schema_agreement: bool | None = Field(True, alias="check_schema_agreement")
    collecting: CASSANDRA_DATASTAGE.Collecting | None = Field(CASSANDRA_DATASTAGE.Collecting.auto, alias="coll_type")
    ...
    combinability_mode: CASSANDRA_DATASTAGE.CombinabilityMode | None = Field(
        CASSANDRA_DATASTAGE.CombinabilityMode.auto, alias="combinability"
    )
    current_output_link_type: str = Field("PRIMARY", alias="currentOutputLinkType")
    custom_type_codecs: str | None = Field("", alias="custom_typecodecs")
    ...
    enable_cql_statement_tracing: bool | None = Field(False, alias="tracing_statements")
    enable_flow_acp_control: bool = Field(True, alias="enableFlowAcpControl")
    enable_quoted_identifiers: bool | None = Field(False, alias="enable_quoted_identifiers")
    ...
    execution_mode: CASSANDRA_DATASTAGE.ExecutionMode | None = Field(
        CASSANDRA_DATASTAGE.ExecutionMode.default_par, alias="execmode"
    )
    flow_dirty: str | None = Field("false", alias="flow_dirty")
    has_reference_output: bool | None = Field(False, alias="has_ref_output")
    hide: bool | None = Field(False, alias="hide")
    ignore_blob_column_value_truncation_errors: bool | None = Field(False, alias="ignore_blob_truncation_errors")
    ignore_string_column_value_truncation_errors: bool | None = Field(False, alias="ignore_string_truncation_errors")
    ...
    keyspace_name: str = Field(None, alias="cassandra_keyspace")
    lookup_type: CASSANDRA_DATASTAGE.LookupType | None = Field(
        CASSANDRA_DATASTAGE.LookupType.empty, alias="lookup_type"
    )
    ...
    modification_type: CASSANDRA_DATASTAGE.ModificationType | None = Field(
        CASSANDRA_DATASTAGE.ModificationType.insert, alias="mutation_type"
    )
    ...
    page_size: int | None = Field(10, alias="page_size")
    parallel_read_strategy: CASSANDRA_DATASTAGE.ParallelReadStrategy | None = Field(
        CASSANDRA_DATASTAGE.ParallelReadStrategy.equal_splitter, alias="parallel_read_strategy"
    )
    ...
    partition_type: CASSANDRA_DATASTAGE.PartitionType | None = Field(
        CASSANDRA_DATASTAGE.PartitionType.auto, alias="part_type"
    )
    ...
    pre_fetching_threshold: int | None = Field(2, alias="prefetching_threshold")
    preserve_partitioning: CASSANDRA_DATASTAGE.PreservePartitioning | None = Field(
        CASSANDRA_DATASTAGE.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_consistency_level: CASSANDRA_DATASTAGE.ReadConsistencyLevel | None = Field(
        CASSANDRA_DATASTAGE.ReadConsistencyLevel.quorum, alias="read_consistency_level"
    )
    reconcile_tables_definitions: bool | None = Field(False, alias="reconcile_tables_definitions")
    runtime_column_propagation: bool | None = Field(None, alias="runtime_column_propagation")
    save_null_values: bool | None = Field(True, alias="save_null_values")
    ...
    table_name: str = Field(None, alias="cassandra_table")
    unique: bool | None = Field(None, alias="part_unique")
    use_json_encoded_map_for_a_single_row: bool | None = Field(False, alias="use_json_mapped_rows")
    use_parallel_read: bool | None = Field(False, alias="use_parallel_read")
    write_consistency_level: CASSANDRA_DATASTAGE.WriteConsistencyLevel | None = Field(
        CASSANDRA_DATASTAGE.WriteConsistencyLevel.quorum, alias="write_consistency_level"
    )
    ...
    def _validate_source(self) -> tuple[set, set]:
        ...
        (
            include.add("reconcile_tables_definitions")
            if (not self.use_json_encoded_map_for_a_single_row)
        ...
        (
            ...
            if (
                ...
                or (
                    self.use_json_encoded_map_for_a_single_row
                    and "#" in str(self.use_json_encoded_map_for_a_single_row)
                )
            )
            else exclude.add("reconcile_tables_definitions")
        )
        (
            include.add("parallel_read_strategy")
            if ((self.use_parallel_read) or (self.use_parallel_read and "#" in str(self.use_parallel_read)))
        ...
        (
            include.add("parallel_read_strategy")
            if (self.use_parallel_read and "true" in str(self.use_parallel_read))
            else exclude.add("parallel_read_strategy")
        )
        (
            include.add("reconcile_tables_definitions")
            if (
                self.use_json_encoded_map_for_a_single_row
                and "false" in str(self.use_json_encoded_map_for_a_single_row)
            )
            else exclude.add("reconcile_tables_definitions")
        )
        return include, exclude
    ...
    def _validate_target(self) -> tuple[set, set]:
        ...
        (
            include.add("use_json_encoded_map_for_a_single_row")
            if (
