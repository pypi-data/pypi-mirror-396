...
from ibm_watsonx_data_integration.services.datastage.models.enums import DB2
...
class db2(BaseStage):
    ...
    buf_mode_ronly: DB2.BufModeRonly | None = Field(DB2.BufModeRonly.default, alias="buf_mode_ronly")
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: DB2.BufferingMode | None = Field(DB2.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    call_procedure_statement: str | None = Field(None, alias="call_statement")
    collecting: DB2.Collecting | None = Field(DB2.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: DB2.CombinabilityMode | None = Field(DB2.CombinabilityMode.auto, alias="combinability")
    ...
    credentials_input_method_ssl: DB2.CredentialsInputMethodSsl | None = Field(
        DB2.CredentialsInputMethodSsl.enter_credentials_manually, alias="credentials_input_method_ssl"
    )
    ...
    decimal_rounding_mode: DB2.DecimalRoundingMode | None = Field(
        DB2.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    execution_mode: DB2.ExecutionMode | None = Field(DB2.ExecutionMode.default_par, alias="execmode")
    existing_table_action: DB2.ExistingTableAction | None = Field(
        DB2.ExistingTableAction.append, alias="existing_table_action"
    )
    ...
    input_method: DB2.InputMethod | None = Field(
        DB2.InputMethod.enter_credentials_manually, alias="credentials_input_method"
    )
    ...
    partition_type: DB2.PartitionType | None = Field(DB2.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: DB2.PreservePartitioning | None = Field(
        DB2.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_method: DB2.ReadMethod | None = Field(DB2.ReadMethod.general, alias="read_mode")
    ...
    reject_uses: DB2.RejectUses | None = Field(DB2.RejectUses.rows, alias="reject_uses")
    ...
    sampling_type: DB2.SamplingType | None = Field(DB2.SamplingType.none, alias="sampling_type")
    ...
    sorting_key: DB2.KeyColSelect | None = Field(DB2.KeyColSelect.default, alias="keyColSelect")
    ...
    table_action: DB2.TableAction | None = Field(DB2.TableAction.append, alias="table_action")
    ...
    write_mode: DB2.WriteMode | None = Field(DB2.WriteMode.insert, alias="write_mode")
    ...
    def _get_source_props(self) -> dict:
        ...
        required = {
            ...
            "kerberos_user_principal_password",
            "output_acp_should_hide",
            "password",
            "port",
            "select_statement",
    ...
    def _get_parameters_props(self) -> dict:
        ...
        props = {"execution_mode", "input_count", "output_count", "preserve_partitioning", "read_method", "write_mode"}
        required = set()
        props = props & (self.model_fields_set | required)
        conflict = exclude & self.model_fields_set & props
        if conflict:
