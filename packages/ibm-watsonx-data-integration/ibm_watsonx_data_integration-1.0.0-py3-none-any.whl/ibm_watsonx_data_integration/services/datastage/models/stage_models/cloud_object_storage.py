...
class cloud_object_storage(BaseStage):
    ...
    connection: CloudObjectStorageConn = CloudObjectStorageConn()
    ...
    buf_mode_ronly: CLOUD_OBJECT_STORAGE.BufModeRonly | None = Field(
        CLOUD_OBJECT_STORAGE.BufModeRonly.default, alias="buf_mode_ronly"
    )
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: CLOUD_OBJECT_STORAGE.BufferingMode | None = Field(
        CLOUD_OBJECT_STORAGE.BufferingMode.default, alias="buf_mode"
    )
    byte_limit: str | None = Field(None, alias="byte_limit")
    cell_range: str | None = Field(None, alias="range")
    codec_avro: CLOUD_OBJECT_STORAGE.CodecAvro | None = Field(None, alias="codec_avro")
    codec_csv: CLOUD_OBJECT_STORAGE.CodecCsv | None = Field(None, alias="codec_csv")
    codec_delimited: CLOUD_OBJECT_STORAGE.CodecDelimited | None = Field(None, alias="codec_delimited")
    codec_orc: CLOUD_OBJECT_STORAGE.CodecOrc | None = Field(None, alias="codec_orc")
    codec_parquet: CLOUD_OBJECT_STORAGE.CodecParquet | None = Field(None, alias="codec_parquet")
    collecting: CLOUD_OBJECT_STORAGE.Collecting | None = Field(CLOUD_OBJECT_STORAGE.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: CLOUD_OBJECT_STORAGE.CombinabilityMode | None = Field(
        CLOUD_OBJECT_STORAGE.CombinabilityMode.auto, alias="combinability"
    )
    ...
    decimal_rounding_mode: CLOUD_OBJECT_STORAGE.DecimalRoundingMode | None = Field(
        CLOUD_OBJECT_STORAGE.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    escape_character: CLOUD_OBJECT_STORAGE.EscapeCharacter | None = Field(
        CLOUD_OBJECT_STORAGE.EscapeCharacter.none, alias="escape_character"
    )
    ...
    execution_mode: CLOUD_OBJECT_STORAGE.ExecutionMode | None = Field(
        CLOUD_OBJECT_STORAGE.ExecutionMode.default_par, alias="execmode"
    )
    field_delimiter: CLOUD_OBJECT_STORAGE.FieldDelimiter | None = Field(
        CLOUD_OBJECT_STORAGE.FieldDelimiter.comma, alias="field_delimiter"
    )
    ...
    file_format: CLOUD_OBJECT_STORAGE.FileFormat | None = Field(
        CLOUD_OBJECT_STORAGE.FileFormat.csv, alias="file_format"
    )
    ...
    invalid_data_handling: CLOUD_OBJECT_STORAGE.InvalidDataHandling | None = Field(
        CLOUD_OBJECT_STORAGE.InvalidDataHandling.fail, alias="invalid_data_handling"
    )
    ...
    partition_type: CLOUD_OBJECT_STORAGE.PartitionType | None = Field(
        CLOUD_OBJECT_STORAGE.PartitionType.auto, alias="part_type"
    )
    ...
    preserve_partitioning: CLOUD_OBJECT_STORAGE.PreservePartitioning | None = Field(
        CLOUD_OBJECT_STORAGE.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    quote_character: CLOUD_OBJECT_STORAGE.QuoteCharacter | None = Field(
        CLOUD_OBJECT_STORAGE.QuoteCharacter.none, alias="quote_character"
    )
    quote_numeric_values: bool | None = Field(True, alias="quote_numerics")
    read_mode: CLOUD_OBJECT_STORAGE.ReadMode | None = Field(
        CLOUD_OBJECT_STORAGE.ReadMode.read_single, alias="read_mode"
    )
    read_part_size: int | None = Field(None, alias="read_part_size")
    row_delimiter: CLOUD_OBJECT_STORAGE.RowDelimiter | None = Field(
        CLOUD_OBJECT_STORAGE.RowDelimiter.new_line, alias="row_delimiter"
    )
    ...
    sorting_key: CLOUD_OBJECT_STORAGE.KeyColSelect | None = Field(
        CLOUD_OBJECT_STORAGE.KeyColSelect.default, alias="keyColSelect"
    )
    stable: bool | None = Field(None, alias="part_stable")
    stage_description: list | None = Field("", alias="stageDescription")
    storage_class: CLOUD_OBJECT_STORAGE.StorageClass | None = Field(
        CLOUD_OBJECT_STORAGE.StorageClass.standard, alias="storage_class"
    )
    store_shared_strings_in_the_temporary_file: bool | None = Field(None, alias="use_sst_temp_file")
    table_action: CLOUD_OBJECT_STORAGE.TableAction | None = Field(
        CLOUD_OBJECT_STORAGE.TableAction.append, alias="table_action"
    )
    table_data_file_compression_codec: CLOUD_OBJECT_STORAGE.TableDataFileCompressionCodec | None = Field(
        None, alias="table_data_file_compression_codec"
    )
    table_data_file_format: CLOUD_OBJECT_STORAGE.TableDataFileFormat | None = Field(
        CLOUD_OBJECT_STORAGE.TableDataFileFormat.avro, alias="table_data_file_format"
    )
    table_format: CLOUD_OBJECT_STORAGE.TableFormat | None = Field(None, alias="table_format")
    ...
    write_mode: CLOUD_OBJECT_STORAGE.WriteMode | None = Field(CLOUD_OBJECT_STORAGE.WriteMode.write, alias="write_mode")
    ...
    def _validate_target(self) -> tuple[set, set]:
        ...
        (include.add("file_size_threshold") if (self.append_unique_identifier) else exclude.add("file_size_threshold"))
        (
            include.add("quote_character")
            if (
                self.file_format
