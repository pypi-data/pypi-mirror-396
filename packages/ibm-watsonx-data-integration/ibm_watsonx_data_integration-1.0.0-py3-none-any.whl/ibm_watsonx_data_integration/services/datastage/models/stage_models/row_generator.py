...
from ibm_watsonx_data_integration.services.datastage.models.enums import ROW_GENERATOR
from pydantic import Field
from typing import ClassVar


class row_generator(BaseStage):
    ...
    buf_mode: ROW_GENERATOR.BufMode | None = Field(ROW_GENERATOR.BufMode.default, alias="buf_mode")
    buf_mode_ronly: ROW_GENERATOR.BufModeRonly | None = Field(
        ROW_GENERATOR.BufModeRonly.default, alias="buf_mode_ronly"
    )
    coll_type: ROW_GENERATOR.CollType | None = Field(ROW_GENERATOR.CollType.auto, alias="coll_type")
    combinability: ROW_GENERATOR.Combinability | None = Field(ROW_GENERATOR.Combinability.auto, alias="combinability")
    ...
    execmode: ROW_GENERATOR.Execmode | None = Field(ROW_GENERATOR.Execmode.default_seq, alias="execmode")
    flow_dirty: str | None = Field("false", alias="flow_dirty")
    hide: bool | None = Field(False, alias="hide")
    input_count: int | None = Field(0, alias="input_count")
    input_link_description: list | None = Field("", alias="inputLinkDescription")
    inputcol_properties: list | None = Field([], alias="inputcolProperties")
    key_col_select: ROW_GENERATOR.KeyColSelect | None = Field(ROW_GENERATOR.KeyColSelect.default, alias="keyColSelect")
    ...
    part_type: ROW_GENERATOR.PartType | None = Field(ROW_GENERATOR.PartType.auto, alias="part_type")
    ...
    preserve: ROW_GENERATOR.Preserve | None = Field(ROW_GENERATOR.Preserve.default_propagate, alias="preserve")
    ...
    records: int = Field(10, alias="records")
    ...
    def _get_output_ports_props(self) -> dict:
        include, exclude = self._validate()
        props = {"additional_properties_set_options", "records", "schemafile"}
        required = {"records"}
        props = props & (self.model_fields_set | required)
        conflict = exclude & self.model_fields_set & props
        if conflict:
