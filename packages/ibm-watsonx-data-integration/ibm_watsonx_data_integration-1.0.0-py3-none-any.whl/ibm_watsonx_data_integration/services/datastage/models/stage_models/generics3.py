...
from ibm_watsonx_data_integration.services.datastage.models.enums import GENERICS3
from pydantic import Field
from typing import ClassVar


class generics3(BaseStage):
    ...
    connection: Generics3Conn = Generics3Conn()
    bucket: str | None = Field(None, alias="bucket")
    buf_free_run_ronly: int | None = Field(50, alias="buf_free_run_ronly")
    buf_mode_ronly: GENERICS3.BufModeRonly | None = Field(GENERICS3.BufModeRonly.default, alias="buf_mode_ronly")
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: GENERICS3.BufferingMode | None = Field(GENERICS3.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    cell_range: str | None = Field(None, alias="range")
    codec_avro: GENERICS3.CodecAvro | None = Field(None, alias="codec_avro")
    codec_csv: GENERICS3.CodecCsv | None = Field(None, alias="codec_csv")
    codec_delimited: GENERICS3.CodecDelimited | None = Field(None, alias="codec_delimited")
    codec_orc: GENERICS3.CodecOrc | None = Field(None, alias="codec_orc")
    codec_parquet: GENERICS3.CodecParquet | None = Field(None, alias="codec_parquet")
    collecting: GENERICS3.Collecting | None = Field(GENERICS3.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: GENERICS3.CombinabilityMode | None = Field(
        GENERICS3.CombinabilityMode.auto, alias="combinability"
    )
    ...
    decimal_rounding_mode: GENERICS3.DecimalRoundingMode | None = Field(
        GENERICS3.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    deltalake_pfk: str | None = Field(None, alias="deltalake_pfk")
    deltalake_pfv: str | None = Field(None, alias="deltalake_pfv")
    ...
    escape_character: GENERICS3.EscapeCharacter | None = Field(GENERICS3.EscapeCharacter.none, alias="escape_character")
    ...
    execution_mode: GENERICS3.ExecutionMode | None = Field(GENERICS3.ExecutionMode.default_par, alias="execmode")
    field_delimiter: GENERICS3.FieldDelimiter | None = Field(GENERICS3.FieldDelimiter.comma, alias="field_delimiter")
    ...
    file_format: GENERICS3.FileFormat | None = Field(GENERICS3.FileFormat.csv, alias="file_format")
    ...
    invalid_data_handling: GENERICS3.InvalidDataHandling | None = Field(
        GENERICS3.InvalidDataHandling.fail, alias="invalid_data_handling"
    )
    ...
    partition_type: GENERICS3.PartitionType | None = Field(GENERICS3.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: GENERICS3.PreservePartitioning | None = Field(
        GENERICS3.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    quote_character: GENERICS3.QuoteCharacter | None = Field(GENERICS3.QuoteCharacter.none, alias="quote_character")
    ...
    read_mode: GENERICS3.ReadMode | None = Field(GENERICS3.ReadMode.read_single, alias="read_mode")
    read_part_size: int | None = Field(None, alias="read_part_size")
    row_delimiter: GENERICS3.RowDelimiter | None = Field(GENERICS3.RowDelimiter.new_line, alias="row_delimiter")
    ...
    sorting_key: GENERICS3.KeyColSelect | None = Field(GENERICS3.KeyColSelect.default, alias="keyColSelect")
    ...
    table_action: GENERICS3.TableAction | None = Field(GENERICS3.TableAction.append, alias="table_action")
    table_data_file_compression_codec: GENERICS3.TableDataFileCompressionCodec | None = Field(
        None, alias="table_data_file_compression_codec"
    )
    table_data_file_format: GENERICS3.TableDataFileFormat | None = Field(
        GENERICS3.TableDataFileFormat.avro, alias="table_data_file_format"
    )
    table_format: GENERICS3.TableFormat | None = Field(None, alias="table_format")
    ...
    write_mode: GENERICS3.WriteMode | None = Field(GENERICS3.WriteMode.write, alias="write_mode")
