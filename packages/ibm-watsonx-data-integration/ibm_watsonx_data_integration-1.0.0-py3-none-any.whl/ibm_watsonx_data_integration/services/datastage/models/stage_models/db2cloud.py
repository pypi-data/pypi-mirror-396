...
from ibm_watsonx_data_integration.services.datastage.models.enums import DB2CLOUD
from pydantic import Field
from typing import ClassVar


class db2cloud(BaseStage):
    ...
    connection: Db2cloudConn = Db2cloudConn()
    ...
    buf_mode_ronly: DB2CLOUD.BufModeRonly | None = Field(DB2CLOUD.BufModeRonly.default, alias="buf_mode_ronly")
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: DB2CLOUD.BufferingMode | None = Field(DB2CLOUD.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    call_procedure_statement: str | None = Field(None, alias="call_statement")
    collecting: DB2CLOUD.Collecting | None = Field(DB2CLOUD.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: DB2CLOUD.CombinabilityMode | None = Field(
        DB2CLOUD.CombinabilityMode.auto, alias="combinability"
    )
    ...
    credentials_input_method_ssl: DB2CLOUD.CredentialsInputMethodSsl | None = Field(
        DB2CLOUD.CredentialsInputMethodSsl.enter_credentials_manually, alias="credentials_input_method_ssl"
    )
    ...
    decimal_rounding_mode: DB2CLOUD.DecimalRoundingMode | None = Field(
        DB2CLOUD.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    execution_mode: DB2CLOUD.ExecutionMode | None = Field(DB2CLOUD.ExecutionMode.default_par, alias="execmode")
    existing_table_action: DB2CLOUD.ExistingTableAction | None = Field(
        DB2CLOUD.ExistingTableAction.append, alias="existing_table_action"
    )
    ...
    input_method: DB2CLOUD.InputMethod | None = Field(
        DB2CLOUD.InputMethod.enter_credentials_manually, alias="credentials_input_method"
    )
    ...
    partition_type: DB2CLOUD.PartitionType | None = Field(DB2CLOUD.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: DB2CLOUD.PreservePartitioning | None = Field(
        DB2CLOUD.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_method: DB2CLOUD.ReadMethod | None = Field(DB2CLOUD.ReadMethod.general, alias="read_mode")
    ...
    reject_uses: DB2CLOUD.RejectUses | None = Field(DB2CLOUD.RejectUses.rows, alias="reject_uses")
    ...
    sorting_key: DB2CLOUD.KeyColSelect | None = Field(DB2CLOUD.KeyColSelect.default, alias="keyColSelect")
    ...
    table_action: DB2CLOUD.TableAction | None = Field(DB2CLOUD.TableAction.append, alias="table_action")
    ...
    write_mode: DB2CLOUD.WriteMode | None = Field(DB2CLOUD.WriteMode.insert, alias="write_mode")
