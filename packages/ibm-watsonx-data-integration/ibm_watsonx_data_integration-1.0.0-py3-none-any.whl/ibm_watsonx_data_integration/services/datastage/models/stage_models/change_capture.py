...
from ibm_watsonx_data_integration.services.datastage.models.enums import CHANGE_CAPTURE
from pydantic import Field
from typing import ClassVar


class change_capture(BaseStage):
    ...
    buf_mode: CHANGE_CAPTURE.BufMode | None = Field(CHANGE_CAPTURE.BufMode.default, alias="buf_mode")
    buf_mode_ronly: CHANGE_CAPTURE.BufModeRonly | None = Field(
        CHANGE_CAPTURE.BufModeRonly.default, alias="buf_mode_ronly"
    )
    code_field: str | None = Field(None, alias="codeField")
    coll_type: CHANGE_CAPTURE.CollType | None = Field(CHANGE_CAPTURE.CollType.auto, alias="coll_type")
    collation_sequence: CHANGE_CAPTURE.CollationSequence | None = Field(None, alias="collation_sequence")
    combinability: CHANGE_CAPTURE.Combinability | None = Field(CHANGE_CAPTURE.Combinability.auto, alias="combinability")
    ...
    do_stats: CHANGE_CAPTURE.DoStats | None = Field(CHANGE_CAPTURE.DoStats.false, alias="doStats")
    ...
    execmode: CHANGE_CAPTURE.Execmode | None = Field(CHANGE_CAPTURE.Execmode.default_par, alias="execmode")
    ...
    keep_copy_drop_copy: CHANGE_CAPTURE.KeepCopyDropCopy | None = Field(
        CHANGE_CAPTURE.KeepCopyDropCopy.dropCopy, alias="keepCopy-dropCopy"
    )
    keep_delete_drop_delete: CHANGE_CAPTURE.KeepDeleteDropDelete | None = Field(
        CHANGE_CAPTURE.KeepDeleteDropDelete.keepDelete, alias="keepDelete-dropDelete"
    )
    keep_edit_drop_edit: CHANGE_CAPTURE.KeepEditDropEdit | None = Field(
        CHANGE_CAPTURE.KeepEditDropEdit.keepEdit, alias="keepEdit-dropEdit"
    )
    keep_insert_drop_insert: CHANGE_CAPTURE.KeepInsertDropInsert | None = Field(
        CHANGE_CAPTURE.KeepInsertDropInsert.keepInsert, alias="keepInsert-dropInsert"
    )
    key_col_select: CHANGE_CAPTURE.KeyColSelect | None = Field(
        CHANGE_CAPTURE.KeyColSelect.default, alias="keyColSelect"
    )
    ...
    part_type: CHANGE_CAPTURE.PartType | None = Field(CHANGE_CAPTURE.PartType.auto, alias="part_type")
    ...
    preserve: CHANGE_CAPTURE.Preserve | None = Field(CHANGE_CAPTURE.Preserve.default_set, alias="preserve")
    ...
    selection: CHANGE_CAPTURE.Selection | None = Field(CHANGE_CAPTURE.Selection.custom, alias="selection")
    selection_asc_desc: CHANGE_CAPTURE.SelectionAscDesc | None = Field(
        CHANGE_CAPTURE.SelectionAscDesc.asc, alias="selection-asc-desc"
    )
    selection_ci_cs: CHANGE_CAPTURE.SelectionCiCs | None = Field(
        CHANGE_CAPTURE.SelectionCiCs.cs, alias="selection-ci-cs"
    )
    selection_nulls: CHANGE_CAPTURE.SelectionNulls | None = Field(
        CHANGE_CAPTURE.SelectionNulls.first, alias="selection-nulls"
    )
    ...
    def _get_parameters_props(self) -> dict:
        ...
        props = {
            ...
            "insert_code",
            "keep_copy_drop_copy",
            "keep_delete_drop_delete",
            "keep_edit_drop_edit",
            "keep_insert_drop_insert",
            "key_col_select",
            "key_cols_coll",
