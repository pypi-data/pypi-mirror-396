...
from ibm_watsonx_data_integration.services.datastage.models.enums import SAPDELTAEXTRACT
from pydantic import Field
from typing import ClassVar


class sapdeltaextract(BaseStage):
    ...
    connection: SapdeltaextractConn = SapdeltaextractConn()
    buf_free_run_ronly: int | None = Field(50, alias="buf_free_run_ronly")
    buf_mode_ronly: SAPDELTAEXTRACT.BufModeRonly | None = Field(
        SAPDELTAEXTRACT.BufModeRonly.default, alias="buf_mode_ronly"
    )
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: SAPDELTAEXTRACT.BufferingMode | None = Field(
        SAPDELTAEXTRACT.BufferingMode.default, alias="buf_mode"
    )
    collecting: SAPDELTAEXTRACT.Collecting | None = Field(SAPDELTAEXTRACT.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: SAPDELTAEXTRACT.CombinabilityMode | None = Field(
        SAPDELTAEXTRACT.CombinabilityMode.auto, alias="combinability"
    )
    current_output_link_type: str = Field("PRIMARY", alias="currentOutputLinkType")
    data_fetch_mode: SAPDELTAEXTRACT.DataFetchMode | None = Field(
        SAPDELTAEXTRACT.DataFetchMode.full_mode, alias="sap_data_fetch_mode"
    )
    ...
    execution_mode: SAPDELTAEXTRACT.ExecutionMode | None = Field(
        SAPDELTAEXTRACT.ExecutionMode.default_par, alias="execmode"
    )
    flow_dirty: str | None = Field("false", alias="flow_dirty")
    generate_unicode_type_columns: bool | None = Field(False, alias="generate_unicode_columns")
    hide: bool | None = Field(False, alias="hide")
    hierarchy_class: str | None = Field(None, alias="sap_hierarchy_class")
    hierarchy_name: str | None = Field(None, alias="sap_hierarchy_name")
    hierarchy_valid_from: str | None = Field(None, alias="sap_hierarchy_valid_from")
    hierarchy_valid_to: str | None = Field(None, alias="sap_hierarchy_valid_to")
    ...
    odp_context: SAPDELTAEXTRACT.OdpContext | None = Field(SAPDELTAEXTRACT.OdpContext.sapi, alias="odp_context")
    odp_description: str | None = Field("<Empty>", alias="sap_odp_description")
    odp_name: str | None = Field(None, alias="sap_odp_name")
    odp_type: SAPDELTAEXTRACT.OdpType | None = Field(SAPDELTAEXTRACT.OdpType.transactional, alias="sap_odp_type")
    ...
    package_size_in_bytes: int | None = Field(None, alias="package_size")
    ...
    partition_type: SAPDELTAEXTRACT.PartitionType | None = Field(SAPDELTAEXTRACT.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: SAPDELTAEXTRACT.PreservePartitioning | None = Field(
        SAPDELTAEXTRACT.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    sap_data_filter: str | None = Field(None, alias="sap_data_filter_list")
    ...
    sorting_key: SAPDELTAEXTRACT.KeyColSelect | None = Field(SAPDELTAEXTRACT.KeyColSelect.default, alias="keyColSelect")
    ...
    use_custom_package_size: bool | None = Field(None, alias="ispackage_size_enabled")
    ...
    def _validate_source(self) -> tuple[set, set]:
        ...
        (
            include.add("package_size_in_bytes")
            if (self.use_custom_package_size)
            else exclude.add("package_size_in_bytes")
        )
        (
            include.add("package_size_in_bytes")
            if (
                (self.use_custom_package_size)
                or (self.use_custom_package_size and "#" in str(self.use_custom_package_size))
            )
            else exclude.add("package_size_in_bytes")
        )
        ...
        (
            include.add("package_size_in_bytes")
            if (self.use_custom_package_size == "true" or self.use_custom_package_size)
            else exclude.add("package_size_in_bytes")
        )
        return include, exclude
