...
from ibm_watsonx_data_integration.services.datastage.models.enums import FUNNEL
from pydantic import Field
from typing import ClassVar


class funnel(BaseStage):
    ...
    buf_mode: FUNNEL.BufMode | None = Field(FUNNEL.BufMode.default, alias="buf_mode")
    buf_mode_ronly: FUNNEL.BufModeRonly | None = Field(FUNNEL.BufModeRonly.default, alias="buf_mode_ronly")
    coll_type: FUNNEL.CollType | None = Field(FUNNEL.CollType.auto, alias="coll_type")
    collation_sequence: FUNNEL.CollationSequence | None = Field(
        FUNNEL.CollationSequence.OFF, alias="collation_sequence"
    )
    combinability: FUNNEL.Combinability | None = Field(FUNNEL.Combinability.auto, alias="combinability")
    ...
    execmode: FUNNEL.Execmode | None = Field(FUNNEL.Execmode.default_par, alias="execmode")
    ...
    key_col_select: FUNNEL.KeyColSelect | None = Field(FUNNEL.KeyColSelect.default, alias="keyColSelect")
    ...
    operator: FUNNEL.Operator | None = Field(FUNNEL.Operator.funnel, alias="operator")
    ...
    part_type: FUNNEL.PartType | None = Field(FUNNEL.PartType.auto, alias="part_type")
    ...
    preserve: FUNNEL.Preserve | None = Field(FUNNEL.Preserve.default_propagate, alias="preserve")
    ...
    def _validate_parameters(self) -> tuple[set, set]:
        ...
        (
            ...
            if (
                self.operator
                and (
                    (hasattr(self.operator, "value") and self.operator.value == "sortfunnel")
                    or (self.operator == "sortfunnel")
                )
            )
        ...
        (
            include.add("inputlink_ordering_list")
            if (
                self.operator
                and (
                    (hasattr(self.operator, "value") and self.operator.value == "sequence")
                    or (self.operator == "sequence")
                )
            )
            else exclude.add("inputlink_ordering_list")
        )
