...
from ibm_watsonx_data_integration.services.datastage.models.enums import DREMIO
from pydantic import Field
from typing import ClassVar


class dremio(BaseStage):
    ...
    connection: DremioConn = DremioConn()
    buf_free_run_ronly: int | None = Field(50, alias="buf_free_run_ronly")
    buf_mode_ronly: DREMIO.BufModeRonly | None = Field(DREMIO.BufModeRonly.default, alias="buf_mode_ronly")
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: DREMIO.BufferingMode | None = Field(DREMIO.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    collecting: DREMIO.Collecting | None = Field(DREMIO.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: DREMIO.CombinabilityMode | None = Field(DREMIO.CombinabilityMode.auto, alias="combinability")
    ...
    execution_mode: DREMIO.ExecutionMode | None = Field(DREMIO.ExecutionMode.default_par, alias="execmode")
    existing_table_action: DREMIO.ExistingTableAction | None = Field(
        DREMIO.ExistingTableAction.append, alias="existing_table_action"
    )
    ...
    partition_type: DREMIO.PartitionType | None = Field(DREMIO.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: DREMIO.PreservePartitioning | None = Field(
        DREMIO.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_method: DREMIO.ReadMethod | None = Field(DREMIO.ReadMethod.general, alias="read_mode")
    ...
    sampling_type: DREMIO.SamplingType | None = Field(DREMIO.SamplingType.none, alias="sampling_type")
    ...
    sorting_key: DREMIO.KeyColSelect | None = Field(DREMIO.KeyColSelect.default, alias="keyColSelect")
    ...
    table_action: DREMIO.TableAction | None = Field(DREMIO.TableAction.append, alias="table_action")
    ...
    write_mode: DREMIO.WriteMode | None = Field(DREMIO.WriteMode.insert, alias="write_mode")
