...
from ibm_watsonx_data_integration.services.datastage.models.enums import DB2ISERIES
from pydantic import Field
from typing import ClassVar


class db2iseries(BaseStage):
    ...
    connection: Db2iseriesConn = Db2iseriesConn()
    ...
    buf_mode_ronly: DB2ISERIES.BufModeRonly | None = Field(DB2ISERIES.BufModeRonly.default, alias="buf_mode_ronly")
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: DB2ISERIES.BufferingMode | None = Field(DB2ISERIES.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    call_procedure_statement: str | None = Field(None, alias="call_statement")
    collecting: DB2ISERIES.Collecting | None = Field(DB2ISERIES.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: DB2ISERIES.CombinabilityMode | None = Field(
        DB2ISERIES.CombinabilityMode.auto, alias="combinability"
    )
    ...
    credentials_input_method_ssl: DB2ISERIES.CredentialsInputMethodSsl | None = Field(
        DB2ISERIES.CredentialsInputMethodSsl.enter_credentials_manually, alias="credentials_input_method_ssl"
    )
    ...
    decimal_rounding_mode: DB2ISERIES.DecimalRoundingMode | None = Field(
        DB2ISERIES.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    execution_mode: DB2ISERIES.ExecutionMode | None = Field(DB2ISERIES.ExecutionMode.default_par, alias="execmode")
    existing_table_action: DB2ISERIES.ExistingTableAction | None = Field(
        DB2ISERIES.ExistingTableAction.append, alias="existing_table_action"
    )
    ...
    input_method: DB2ISERIES.InputMethod | None = Field(
        DB2ISERIES.InputMethod.enter_credentials_manually, alias="credentials_input_method"
    )
    ...
    partition_type: DB2ISERIES.PartitionType | None = Field(DB2ISERIES.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: DB2ISERIES.PreservePartitioning | None = Field(
        DB2ISERIES.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_method: DB2ISERIES.ReadMethod | None = Field(DB2ISERIES.ReadMethod.general, alias="read_mode")
    ...
    reject_uses: DB2ISERIES.RejectUses | None = Field(DB2ISERIES.RejectUses.rows, alias="reject_uses")
    ...
    sorting_key: DB2ISERIES.KeyColSelect | None = Field(DB2ISERIES.KeyColSelect.default, alias="keyColSelect")
    ...
    table_action: DB2ISERIES.TableAction | None = Field(DB2ISERIES.TableAction.append, alias="table_action")
    ...
    write_mode: DB2ISERIES.WriteMode | None = Field(DB2ISERIES.WriteMode.insert, alias="write_mode")
