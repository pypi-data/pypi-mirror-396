...
from ibm_watsonx_data_integration.services.datastage.models.enums import DENODO
from pydantic import Field
from typing import ClassVar


class denodo(BaseStage):
    ...
    connection: DenodoConn = DenodoConn()
    buf_free_run_ronly: int | None = Field(50, alias="buf_free_run_ronly")
    buf_mode_ronly: DENODO.BufModeRonly | None = Field(DENODO.BufModeRonly.default, alias="buf_mode_ronly")
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: DENODO.BufferingMode | None = Field(DENODO.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    collecting: DENODO.Collecting | None = Field(DENODO.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: DENODO.CombinabilityMode | None = Field(DENODO.CombinabilityMode.auto, alias="combinability")
    ...
    decimal_rounding_mode: DENODO.DecimalRoundingMode | None = Field(
        DENODO.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    execution_mode: DENODO.ExecutionMode | None = Field(DENODO.ExecutionMode.default_par, alias="execmode")
    ...
    partition_type: DENODO.PartitionType | None = Field(DENODO.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: DENODO.PreservePartitioning | None = Field(
        DENODO.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_method: DENODO.ReadMethod | None = Field(DENODO.ReadMethod.general, alias="read_mode")
    ...
    sorting_key: DENODO.KeyColSelect | None = Field(DENODO.KeyColSelect.default, alias="keyColSelect")
    ...
    write_mode: DENODO.WriteMode | None = Field(DENODO.WriteMode.update_statement, alias="write_mode")
