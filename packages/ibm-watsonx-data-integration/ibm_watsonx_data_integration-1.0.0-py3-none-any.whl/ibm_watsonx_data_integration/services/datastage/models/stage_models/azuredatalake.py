...
from ibm_watsonx_data_integration.services.datastage.models.enums import AZUREDATALAKE
from pydantic import Field
from typing import ClassVar


class azuredatalake(BaseStage):
    ...
    connection: AzuredatalakeConn = AzuredatalakeConn()
    buf_free_run_ronly: int | None = Field(50, alias="buf_free_run_ronly")
    buf_mode_ronly: AZUREDATALAKE.BufModeRonly | None = Field(
        AZUREDATALAKE.BufModeRonly.default, alias="buf_mode_ronly"
    )
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: AZUREDATALAKE.BufferingMode | None = Field(AZUREDATALAKE.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    cell_range: str | None = Field(None, alias="range")
    codec_avro: AZUREDATALAKE.CodecAvro | None = Field(None, alias="codec_avro")
    codec_csv: AZUREDATALAKE.CodecCsv | None = Field(None, alias="codec_csv")
    codec_delimited: AZUREDATALAKE.CodecDelimited | None = Field(None, alias="codec_delimited")
    codec_orc: AZUREDATALAKE.CodecOrc | None = Field(None, alias="codec_orc")
    codec_parquet: AZUREDATALAKE.CodecParquet | None = Field(None, alias="codec_parquet")
    collecting: AZUREDATALAKE.Collecting | None = Field(AZUREDATALAKE.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: AZUREDATALAKE.CombinabilityMode | None = Field(
        AZUREDATALAKE.CombinabilityMode.auto, alias="combinability"
    )
    ...
    decimal_rounding_mode: AZUREDATALAKE.DecimalRoundingMode | None = Field(
        AZUREDATALAKE.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    escape_character: AZUREDATALAKE.EscapeCharacter | None = Field(
        AZUREDATALAKE.EscapeCharacter.none, alias="escape_character"
    )
    ...
    execution_mode: AZUREDATALAKE.ExecutionMode | None = Field(
        AZUREDATALAKE.ExecutionMode.default_par, alias="execmode"
    )
    field_delimiter: AZUREDATALAKE.FieldDelimiter | None = Field(
        AZUREDATALAKE.FieldDelimiter.comma, alias="field_delimiter"
    )
    ...
    file_format: AZUREDATALAKE.FileFormat | None = Field(AZUREDATALAKE.FileFormat.csv, alias="file_format")
    ...
    invalid_data_handling: AZUREDATALAKE.InvalidDataHandling | None = Field(
        AZUREDATALAKE.InvalidDataHandling.fail, alias="invalid_data_handling"
    )
    ...
    partition_type: AZUREDATALAKE.PartitionType | None = Field(AZUREDATALAKE.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: AZUREDATALAKE.PreservePartitioning | None = Field(
        AZUREDATALAKE.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    quote_character: AZUREDATALAKE.QuoteCharacter | None = Field(
        AZUREDATALAKE.QuoteCharacter.none, alias="quote_character"
    )
    quote_numeric_values: bool | None = Field(True, alias="quote_numerics")
    read_mode: AZUREDATALAKE.ReadMode | None = Field(AZUREDATALAKE.ReadMode.read_single, alias="read_mode")
    row_delimiter: AZUREDATALAKE.RowDelimiter | None = Field(AZUREDATALAKE.RowDelimiter.new_line, alias="row_delimiter")
    ...
    sorting_key: AZUREDATALAKE.KeyColSelect | None = Field(AZUREDATALAKE.KeyColSelect.default, alias="keyColSelect")
    ...
    table_action: AZUREDATALAKE.TableAction | None = Field(AZUREDATALAKE.TableAction.append, alias="table_action")
    table_data_file_compression_codec: AZUREDATALAKE.TableDataFileCompressionCodec | None = Field(
        None, alias="table_data_file_compression_codec"
    )
    table_data_file_format: AZUREDATALAKE.TableDataFileFormat | None = Field(
        AZUREDATALAKE.TableDataFileFormat.avro, alias="table_data_file_format"
    )
    table_format: AZUREDATALAKE.TableFormat | None = Field(None, alias="table_format")
    ...
    write_mode: AZUREDATALAKE.WriteMode | None = Field(AZUREDATALAKE.WriteMode.write, alias="write_mode")
    ...
    def _validate_source(self) -> tuple[set, set]:
        ...
        include.add("use_home_as_root") if (()) else exclude.add("use_home_as_root")
        (
            include.add("type_mapping")
            if (
                (
