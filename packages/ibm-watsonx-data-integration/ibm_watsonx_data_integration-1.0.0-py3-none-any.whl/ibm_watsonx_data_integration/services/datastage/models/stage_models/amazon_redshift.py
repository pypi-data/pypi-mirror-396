...
from ibm_watsonx_data_integration.services.datastage.models.enums import AMAZON_REDSHIFT
from pydantic import Field
from typing import ClassVar


class amazon_redshift(BaseStage):
    ...
    connection: AmazonRedshiftConn = AmazonRedshiftConn()
    ...
    buf_mode_ronly: AMAZON_REDSHIFT.BufModeRonly | None = Field(
        AMAZON_REDSHIFT.BufModeRonly.default, alias="buf_mode_ronly"
    )
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: AMAZON_REDSHIFT.BufferingMode | None = Field(
        AMAZON_REDSHIFT.BufferingMode.default, alias="buf_mode"
    )
    byte_limit: str | None = Field(None, alias="byte_limit")
    collecting: AMAZON_REDSHIFT.Collecting | None = Field(AMAZON_REDSHIFT.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: AMAZON_REDSHIFT.CombinabilityMode | None = Field(
        AMAZON_REDSHIFT.CombinabilityMode.auto, alias="combinability"
    )
    ...
    decimal_rounding_mode: AMAZON_REDSHIFT.DecimalRoundingMode | None = Field(
        AMAZON_REDSHIFT.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    default_maximum_length_for_columns: int | None = Field(20000, alias="default_max_string_binary_precision")
    defer_credentials: bool | None = Field(False, alias="defer_credentials")
    disable_partitioning: bool | None = Field(False, alias="disable_partitioning")
    ...
    execution_mode: AMAZON_REDSHIFT.ExecutionMode | None = Field(
        AMAZON_REDSHIFT.ExecutionMode.default_par, alias="execmode"
    )
    existing_table_action: AMAZON_REDSHIFT.ExistingTableAction | None = Field(
        AMAZON_REDSHIFT.ExistingTableAction.append, alias="existing_table_action"
    )
    ...
    partition_type: AMAZON_REDSHIFT.PartitionType | None = Field(AMAZON_REDSHIFT.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: AMAZON_REDSHIFT.PreservePartitioning | None = Field(
        AMAZON_REDSHIFT.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_method: AMAZON_REDSHIFT.ReadMethod | None = Field(AMAZON_REDSHIFT.ReadMethod.general, alias="read_mode")
    ...
    reject_uses: AMAZON_REDSHIFT.RejectUses | None = Field(AMAZON_REDSHIFT.RejectUses.rows, alias="reject_uses")
    ...
    sampling_type: AMAZON_REDSHIFT.SamplingType | None = Field(AMAZON_REDSHIFT.SamplingType.none, alias="sampling_type")
    ...
    sorting_key: AMAZON_REDSHIFT.KeyColSelect | None = Field(AMAZON_REDSHIFT.KeyColSelect.default, alias="keyColSelect")
    ...
    table_action: AMAZON_REDSHIFT.TableAction | None = Field(AMAZON_REDSHIFT.TableAction.append, alias="table_action")
    ...
    write_mode: AMAZON_REDSHIFT.WriteMode | None = Field(AMAZON_REDSHIFT.WriteMode.insert, alias="write_mode")
        ...
        (
            ...
            if (
                (
                    self.write_mode
                    and (
                        (hasattr(self.write_mode, "value") and self.write_mode.value == "load")
                        or (self.write_mode == "load")
                    )
                )
            ...
            if (
                ...
                and (
                    (
                        hasattr(self.write_mode, "value")
                        and self.write_mode.value
                        and "load" in str(self.write_mode.value)
                    )
                    or ("load" in str(self.write_mode))
                )
            )
            and (not self.static_statement)
            and (not self.update_statement)
            ...
            and (
                ...
                and (
                    (
                        hasattr(self.write_mode, "value")
                        and self.write_mode.value
                        and "load" not in str(self.write_mode.value)
                    )
                    or ("load" not in str(self.write_mode))
                )
                and self.write_mode
                and (
                    (
