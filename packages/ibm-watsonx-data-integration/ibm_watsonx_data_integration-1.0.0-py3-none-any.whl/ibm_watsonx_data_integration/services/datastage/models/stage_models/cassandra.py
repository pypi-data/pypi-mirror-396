...
from ibm_watsonx_data_integration.services.datastage.models.enums import CASSANDRA
from pydantic import Field
from typing import ClassVar


class cassandra(BaseStage):
    ...
    connection: CassandraConn = CassandraConn()
    batch_size: int | None = Field(2000, alias="batch_size")
    buf_free_run_ronly: int | None = Field(50, alias="buf_free_run_ronly")
    buf_mode_ronly: CASSANDRA.BufModeRonly | None = Field(CASSANDRA.BufModeRonly.default, alias="buf_mode_ronly")
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: CASSANDRA.BufferingMode | None = Field(CASSANDRA.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    collecting: CASSANDRA.Collecting | None = Field(CASSANDRA.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: CASSANDRA.CombinabilityMode | None = Field(
        CASSANDRA.CombinabilityMode.auto, alias="combinability"
    )
    ...
    decimal_rounding_mode: CASSANDRA.DecimalRoundingMode | None = Field(
        CASSANDRA.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    execution_mode: CASSANDRA.ExecutionMode | None = Field(CASSANDRA.ExecutionMode.default_par, alias="execmode")
    ...
    partition_type: CASSANDRA.PartitionType | None = Field(CASSANDRA.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: CASSANDRA.PreservePartitioning | None = Field(
        CASSANDRA.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_method: CASSANDRA.ReadMethod | None = Field(CASSANDRA.ReadMethod.general, alias="read_mode")
    ...
    sorting_key: CASSANDRA.KeyColSelect | None = Field(CASSANDRA.KeyColSelect.default, alias="keyColSelect")
    ...
    table_action: CASSANDRA.TableAction | None = Field(CASSANDRA.TableAction.append, alias="table_action")
    ...
    write_mode: CASSANDRA.WriteMode | None = Field(CASSANDRA.WriteMode.insert, alias="write_mode")
