...
from ibm_watsonx_data_integration.services.datastage.models.enums import DROPBOX
from pydantic import Field
from typing import ClassVar


class dropbox(BaseStage):
    ...
    connection: DropboxConn = DropboxConn()
    buf_free_run_ronly: int | None = Field(50, alias="buf_free_run_ronly")
    buf_mode_ronly: DROPBOX.BufModeRonly | None = Field(DROPBOX.BufModeRonly.default, alias="buf_mode_ronly")
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: DROPBOX.BufferingMode | None = Field(DROPBOX.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    cell_range: str | None = Field(None, alias="range")
    codec_avro: DROPBOX.CodecAvro | None = Field(None, alias="codec_avro")
    codec_csv: DROPBOX.CodecCsv | None = Field(None, alias="codec_csv")
    codec_delimited: DROPBOX.CodecDelimited | None = Field(None, alias="codec_delimited")
    codec_orc: DROPBOX.CodecOrc | None = Field(None, alias="codec_orc")
    codec_parquet: DROPBOX.CodecParquet | None = Field(None, alias="codec_parquet")
    collecting: DROPBOX.Collecting | None = Field(DROPBOX.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: DROPBOX.CombinabilityMode | None = Field(DROPBOX.CombinabilityMode.auto, alias="combinability")
    ...
    decimal_rounding_mode: DROPBOX.DecimalRoundingMode | None = Field(
        DROPBOX.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    escape_character: DROPBOX.EscapeCharacter | None = Field(DROPBOX.EscapeCharacter.none, alias="escape_character")
    ...
    execution_mode: DROPBOX.ExecutionMode | None = Field(DROPBOX.ExecutionMode.default_par, alias="execmode")
    field_delimiter: DROPBOX.FieldDelimiter | None = Field(DROPBOX.FieldDelimiter.comma, alias="field_delimiter")
    ...
    file_format: DROPBOX.FileFormat | None = Field(DROPBOX.FileFormat.csv, alias="file_format")
    ...
    invalid_data_handling: DROPBOX.InvalidDataHandling | None = Field(
        DROPBOX.InvalidDataHandling.fail, alias="invalid_data_handling"
    )
    ...
    partition_type: DROPBOX.PartitionType | None = Field(DROPBOX.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: DROPBOX.PreservePartitioning | None = Field(
        DROPBOX.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    quote_character: DROPBOX.QuoteCharacter | None = Field(DROPBOX.QuoteCharacter.none, alias="quote_character")
    quote_numeric_values: bool | None = Field(True, alias="quote_numerics")
    read_mode: DROPBOX.ReadMode | None = Field(DROPBOX.ReadMode.read_single, alias="read_mode")
    row_delimiter: DROPBOX.RowDelimiter | None = Field(DROPBOX.RowDelimiter.new_line, alias="row_delimiter")
    ...
    sorting_key: DROPBOX.KeyColSelect | None = Field(DROPBOX.KeyColSelect.default, alias="keyColSelect")
    ...
    write_mode: DROPBOX.WriteMode | None = Field(DROPBOX.WriteMode.write, alias="write_mode")
