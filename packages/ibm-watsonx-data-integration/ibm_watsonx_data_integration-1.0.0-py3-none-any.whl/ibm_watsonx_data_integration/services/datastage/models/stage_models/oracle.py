...
from ibm_watsonx_data_integration.services.datastage.models.enums import ORACLE
from pydantic import Field
from typing import ClassVar


class oracle(BaseStage):
    ...
    connection: OracleConn = OracleConn()
    ...
    buf_mode_ronly: ORACLE.BufModeRonly | None = Field(ORACLE.BufModeRonly.default, alias="buf_mode_ronly")
    buffer_free_run_percent: int | None = Field(50, alias="buf_free_run")
    buffering_mode: ORACLE.BufferingMode | None = Field(ORACLE.BufferingMode.default, alias="buf_mode")
    byte_limit: str | None = Field(None, alias="byte_limit")
    call_procedure_statement: str | None = Field(None, alias="call_statement")
    collecting: ORACLE.Collecting | None = Field(ORACLE.Collecting.auto, alias="coll_type")
    column_metadata_change_propagation: bool | None = Field(None, alias="auto_column_propagation")
    combinability_mode: ORACLE.CombinabilityMode | None = Field(ORACLE.CombinabilityMode.auto, alias="combinability")
    ...
    decimal_rounding_mode: ORACLE.DecimalRoundingMode | None = Field(
        ORACLE.DecimalRoundingMode.floor, alias="decimal_rounding_mode"
    )
    ...
    execution_mode: ORACLE.ExecutionMode | None = Field(ORACLE.ExecutionMode.default_par, alias="execmode")
    existing_table_action: ORACLE.ExistingTableAction | None = Field(
        ORACLE.ExistingTableAction.append, alias="existing_table_action"
    )
    ...
    input_timestamp_parameters: str | None = Field("false", alias="input_timestamp_parameters")
    ...
    number_type: ORACLE.NumberType | None = Field(None, alias="number_type")
    ...
    partition_type: ORACLE.PartitionType | None = Field(ORACLE.PartitionType.auto, alias="part_type")
    ...
    preserve_partitioning: ORACLE.PreservePartitioning | None = Field(
        ORACLE.PreservePartitioning.default_propagate, alias="preserve"
    )
    ...
    read_method: ORACLE.ReadMethod | None = Field(ORACLE.ReadMethod.general, alias="read_mode")
    ...
    reject_uses: ORACLE.RejectUses | None = Field(ORACLE.RejectUses.rows, alias="reject_uses")
    ...
    sampling_type: ORACLE.SamplingType | None = Field(ORACLE.SamplingType.none, alias="sampling_type")
    ...
    sorting_key: ORACLE.KeyColSelect | None = Field(ORACLE.KeyColSelect.default, alias="keyColSelect")
    ...
    table_action: ORACLE.TableAction | None = Field(ORACLE.TableAction.append, alias="table_action")
    ...
    write_mode: ORACLE.WriteMode | None = Field(ORACLE.WriteMode.insert, alias="write_mode")
