...
from ibm_watsonx_data_integration.services.datastage.models.enums import MAKE_SUBRECORD
from pydantic import Field
from typing import ClassVar


class make_subrecord(BaseStage):
    ...
    buf_mode: MAKE_SUBRECORD.BufMode | None = Field(MAKE_SUBRECORD.BufMode.default, alias="buf_mode")
    buf_mode_ronly: MAKE_SUBRECORD.BufModeRonly | None = Field(
        MAKE_SUBRECORD.BufModeRonly.default, alias="buf_mode_ronly"
    )
    coll_type: MAKE_SUBRECORD.CollType | None = Field(MAKE_SUBRECORD.CollType.auto, alias="coll_type")
    combinability: MAKE_SUBRECORD.Combinability | None = Field(MAKE_SUBRECORD.Combinability.auto, alias="combinability")
    ...
    execmode: MAKE_SUBRECORD.Execmode | None = Field(MAKE_SUBRECORD.Execmode.default_par, alias="execmode")
    flow_dirty: str | None = Field("false", alias="flow_dirty")
    hide: bool | None = Field(False, alias="hide")
    input_count: int | None = Field(0, alias="input_count")
    input_link_description: list | None = Field("", alias="inputLinkDescription")
    inputcol_properties: list | None = Field([], alias="inputcolProperties")
    key_col_select: MAKE_SUBRECORD.KeyColSelect | None = Field(
        MAKE_SUBRECORD.KeyColSelect.default, alias="keyColSelect"
    )
    ...
    part_type: MAKE_SUBRECORD.PartType | None = Field(MAKE_SUBRECORD.PartType.auto, alias="part_type")
    ...
    preserve: MAKE_SUBRECORD.Preserve | None = Field(MAKE_SUBRECORD.Preserve.default_propagate, alias="preserve")
    ...
    variable: MAKE_SUBRECORD.Variable | None = Field(MAKE_SUBRECORD.Variable.false, alias="variable")
