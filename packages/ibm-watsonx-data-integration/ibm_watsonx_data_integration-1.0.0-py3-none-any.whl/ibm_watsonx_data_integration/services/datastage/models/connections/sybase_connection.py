...
class SybaseConn(BaseConnection):
    """Connection class for Sybase."""

    model_config = ConfigDict(populate_by_name=True)

    datasource_type: ClassVar[str] = "6976a3fc-b2ad-4db6-818c-ea049cac309d"
    ...
    @classmethod
    def _from_dict(cls, properties: dict[str, Any]) -> "SybaseConn":
