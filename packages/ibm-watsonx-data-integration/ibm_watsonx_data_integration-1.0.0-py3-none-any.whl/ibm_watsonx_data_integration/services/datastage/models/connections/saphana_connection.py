...
class SaphanaConn(BaseConnection):
    """Connection class for Saphana."""

    model_config = ConfigDict(populate_by_name=True)

    datasource_type: ClassVar[str] = "4656c47e-3ada-467e-a541-466c0c55df05"
    ...
    @classmethod
    def _from_dict(cls, properties: dict[str, Any]) -> "SaphanaConn":
