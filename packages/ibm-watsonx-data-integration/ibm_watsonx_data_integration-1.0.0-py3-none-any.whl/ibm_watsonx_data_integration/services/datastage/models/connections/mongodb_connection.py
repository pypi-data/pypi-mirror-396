...
from ibm_watsonx_data_integration.services.datastage.models.enums import MONGODB_CONNECTION
from pydantic import ConfigDict, Field
from typing import Any, ClassVar


class MongodbConn(BaseConnection):
    """Connection class for Mongodb."""

    model_config = ConfigDict(populate_by_name=True)

    datasource_type: ClassVar[str] = "c6fb9293-51eb-4f2b-b20c-4dafa3136744"
    ...
    special_character_behavior: MONGODB_CONNECTION.SpecialCharBehavior | None = Field(
    ...
    @classmethod
    def _from_dict(cls, properties: dict[str, Any]) -> "MongodbConn":
