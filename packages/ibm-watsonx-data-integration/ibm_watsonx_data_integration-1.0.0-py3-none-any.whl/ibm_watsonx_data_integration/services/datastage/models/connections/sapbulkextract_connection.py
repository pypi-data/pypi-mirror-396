"""Module for Sapbulkextract connection."""

from ibm_watsonx_data_integration.services.datastage.models.connections.base_connection import BaseConnection
from ibm_watsonx_data_integration.services.datastage.models.enums import SAPBULKEXTRACT_CONNECTION
from pydantic import ConfigDict, Field
from typing import Any, ClassVar


class SapbulkextractConn(BaseConnection):
    """Connection class for Sapbulkextract."""

    model_config = ConfigDict(populate_by_name=True)

    datasource_type: ClassVar[str] = "ec42cd4a-18ab-469c-bfd7-f6dc52e1db22"
    ...
    connection_type: SAPBULKEXTRACT_CONNECTION.ConnectionType = Field(
        SAPBULKEXTRACT_CONNECTION.ConnectionType.application_server, alias="connection_type"
    )
    ...
    snc_qop: SAPBULKEXTRACT_CONNECTION.SncQop | None = Field(
        SAPBULKEXTRACT_CONNECTION.SncQop.auth_integrity_privacy, alias="snc_qop"
    )
    ...
    @classmethod
    def _from_dict(cls, properties: dict[str, Any]) -> "SapbulkextractConn":
