"""Module for Informix connection."""
...
class InformixConn(BaseConnection):
    """Connection class for Informix."""

    model_config = ConfigDict(populate_by_name=True)

    datasource_type: ClassVar[str] = "029e5d1c-ba73-4b09-b742-14c3a39b6cf9"
    ...
    database_locale: str | None = Field(None, alias="db_locale")
    ...
    @classmethod
    def _from_dict(cls, properties: dict[str, Any]) -> "InformixConn":
