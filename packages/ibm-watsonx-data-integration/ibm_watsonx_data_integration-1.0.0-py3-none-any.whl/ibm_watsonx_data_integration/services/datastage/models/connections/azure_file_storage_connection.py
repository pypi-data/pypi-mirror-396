"""Module for Azure File Storage connection."""

from ibm_watsonx_data_integration.services.datastage.models.connections.base_connection import BaseConnection
from ibm_watsonx_data_integration.services.datastage.models.enums import AZURE_FILE_STORAGE_CONNECTION
from pydantic import ConfigDict, Field
from typing import Any, ClassVar


class AzureFileStorageConn(BaseConnection):
    """Connection class for Azure File Storage."""

    model_config = ConfigDict(populate_by_name=True)

    datasource_type: ClassVar[str] = "2a7b4fa1-c770-4807-8871-a3c5def5aa2d"
    asset_id: str | None = None
    proj_id: str | None = None
    name: str = Field(None, alias="name")
    authentication_method: AZURE_FILE_STORAGE_CONNECTION.AuthMethod | None = Field(
        AZURE_FILE_STORAGE_CONNECTION.AuthMethod.connection_string, alias="auth_method"
    )
    ...
    @classmethod
    def _from_dict(cls, properties: dict[str, Any]) -> "AzureFileStorageConn":
