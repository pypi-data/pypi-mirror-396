"""Module for Postgresql connection."""
...
class PostgresqlConn(BaseConnection):
    ...
    datasource_type: ClassVar[str] = "e1c23729-99d8-4407-b3df-336e33ffdc82"
    ...
    @classmethod
    def _from_dict(cls, properties: dict[str, Any]) -> "PostgresqlConn":
