...
class SapiqConn(BaseConnection):
    """Connection class for Sapiq."""

    model_config = ConfigDict(populate_by_name=True)

    datasource_type: ClassVar[str] = "49079262-fac2-4762-99d1-452c1caf6b49"
    ...
    @classmethod
    def _from_dict(cls, properties: dict[str, Any]) -> "SapiqConn":
