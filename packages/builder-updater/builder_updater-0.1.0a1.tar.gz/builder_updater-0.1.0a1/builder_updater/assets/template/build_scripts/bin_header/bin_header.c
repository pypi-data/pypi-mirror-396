...
#define CALC_CRC32(buf_, size_, crc_) CRC_SOFT_CalcPartTable32(buf_, size_, crc_, crc32Table);
#else
#define CALC_CRC32(buf_, size_, crc_) CRC_SOFT_CalcPart32(buf_, size_, crc_, CRC_SOFT_IEEE_802_3_POLY);
#endif
...
{
#if (BIN_HEADER_CRC_TABLE_EN == 1)
    CRC_SOFT_GenTable32(crc32Table, CRC_SOFT_IEEE_802_3_POLY);
#endif
}
