...
$(PRS): $(OUT) $(GCC_MAP_PARSER)
	@echo "Generate: $@"
	@$(ENV_PYTHON_EXE) $(GCC_MAP_PARSER) -p $< -l $@ -z -s -m -f \
...
# Т.к. в режиме -n выполнение цели all не достигается, то и рекурсивного вызова make не происходит
	@echo "Generate: $@"
	@$(ENV_PYTHON_EXE) -m compiledb -n -o $@ make -f build_scripts/builder.mk -j 8
...
$(OUT): $(RAW) $(MODIFY_HEADER)
	@$(CP) $(RAW) $(OUT)
	@$(ENV_PYTHON_EXE) $(MODIFY_HEADER) -p $@ -d $(OBJDUMP) -c $(OBJCOPY)
