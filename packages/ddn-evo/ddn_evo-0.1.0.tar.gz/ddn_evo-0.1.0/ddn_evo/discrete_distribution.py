...
class SplitableModuleMixin:
    def split(module, split_idxs, predict_c, optimizers=None):
        ...
        with torch.no_grad():
            ...
            # EMRE: Extract weight slices for both nodes
            ...
            weight_disapear = weight[disapear_slice].clone()
            
            # EMRE: Create crossover offspring
            ...
            # EMRE: Assign offspring to nodes 
                    ...
                    if weight in optimizer.state:
                        for k in optimizer.state[weight]:
                            ...
                            if (
                                ...
                                state_disapear = state_value[disapear_slice].clone()
