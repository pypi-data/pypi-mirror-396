...
def pause_workflow(workflow_id: str) -> dict[str, Any]:
    ...
    with workflow_store.edit_workflow(workflow_id) as workflow:
        ...
        return {
            ...
            "message": f"Workflow paused at step '{step_name}'. Use resume_workflow to continue.",
        }
...
def _get_step_classes(workflow_class) -> dict[str, type]:
    ...
    to_visit = [workflow_class._start_step]
    visited = set()
    step_base_class = workflow_class.Step
