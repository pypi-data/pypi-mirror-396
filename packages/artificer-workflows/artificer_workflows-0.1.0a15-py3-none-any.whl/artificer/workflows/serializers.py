...
class StepSerializer:
    ...
    def to_dict(self, step) -> dict[str, Any]:
...
class WorkflowSerializer:
    ...
    def _serialize_step(self, step) -> dict[str, Any]:
        ...
        serializer = type(step).serializer_class()
        return serializer.to_dict(step)
    ...
    def _deserialize_step(self, data: dict[str, Any], workflow: "Workflow") -> Any:
        ...
        serializer = step_cls.serializer_class()
        return serializer.from_dict(data, step_cls)

    def find_step_class(self, step_class_name: str, workflow: "Workflow") -> Optional[type]:
