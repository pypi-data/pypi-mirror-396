...
from marsguard import MarsGuardClient, AppModel, ModelSpec, GenerateGuardrailsRequest
    ...
    project_spec = {
        "app": {
            "id": "my_app_id",  # Unique identifier for the app/project
            "name": "My App",  # Human-readable name of the app
            "description": "Short description of what the app does"  # Brief description of the app's purpose
        },
        "domain": "YourDomain",  # The domain or industry context for the app (e.g., "Healthcare", "Finance")
        "audience": {
        ...
        "model": {
            "provider": "provider_name",  # LLM provider (e.g., "openai", "anthropic")
            "name": "model_name",  # Model name (e.g., "gpt-4o")
            "has_builtin_safety": False  # Whether the model has built-in safety features
        },
