...
try:
    ...
    version = getattr(qqabc, "__version__", "dev")
    release = version
except ImportError:
...
html_theme_options = {
    ...
    "source_repository": "https://github.com/HYChou0515/qqabc/",
...
if os.environ.get("GITHUB_ACTIONS"):
    html_baseurl = "https://hychou0515.github.io/qqabc/"
