...
class TemplatedPromptJudgeGrader[T: BaseTemplatedPromptJudgeOutput](Grader[SuccessJudgeLog | FailedJudgeLog]):
    ...
    def __init__(
        ...
        Args:
            ...
            extra_template_variables: Additional variables to make available in templates
        ...
        self.template_variables = extra_template_variables or {}
    ...
    def render_template(
        ...
        context = cls._extract_template_context(thread, output_model, extra_template_variables)
