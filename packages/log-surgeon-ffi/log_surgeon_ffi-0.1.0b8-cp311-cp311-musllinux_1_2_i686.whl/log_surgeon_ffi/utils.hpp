#ifndef LOG_SURGEON_FFI_UTILS_HPP
#define LOG_SURGEON_FFI_UTILS_HPP
...
/*
 * Handles a `clp::TraceableException` by setting a Python exception
 * accordingly.
 * @param exception
 */
...
/**
 * @param sv
 * @return A new reference to the constructed Python string object from the
 * given string view `sv`.
...
#endif  // LOG_SURGEON_FFI_UTILS_HPP
