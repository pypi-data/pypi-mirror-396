        ...
        with open(temp_file_path, 'rb') as f:
            ...
            if result.get('success'):
                ...
                return {
                    ...
                    "instruction": "Present the download link to the user in Markdown (e.g., [下載檔案]({download_url})). Do NOT expose a bare URL and do NOT call the download_and_upload tool again for this file."
                }
            else:
                return {
                    "success": False,
