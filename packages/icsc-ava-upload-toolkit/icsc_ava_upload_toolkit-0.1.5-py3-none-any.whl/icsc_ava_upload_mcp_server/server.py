        ...
        with open(temp_file_path, 'rb') as f:
            ...
            if result.get('success'):
                ...
                return {
                    ...
                    "instruction": "Provide a succinct confirmation message without rendering or exposing the download_url in the chat. Do NOT output any hyperlink or raw URL. Do NOT call the download_and_upload tool again for this file.",
