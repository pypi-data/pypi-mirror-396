...
def get_version_info():
    ...
    from .enhanced_runtime import get_version_info as _get_version_info
    return _get_version_info()

def get_supported_operators():
    """Get list of supported operators"""
    from .enhanced_runtime import get_supported_operators as _get_supported_operators
    return _get_supported_operators()

# Export public API
__all__ = [
    # Core classes
    'Engine', 'Device', 'EnhancedMLERuntime', 'MLEFormatV2',
