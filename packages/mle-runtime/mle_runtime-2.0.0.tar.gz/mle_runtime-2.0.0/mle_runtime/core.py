...
def load_model(path: Union[str, Path], device: str = "cpu") -> 'EnhancedMLERuntime':
    """Load MLE model with enhanced features"""
    from .enhanced_runtime import EnhancedMLERuntime
...
def inspect_model(path: Union[str, Path]) -> dict:
    ...
    from .enhanced_runtime import ModelInspector
