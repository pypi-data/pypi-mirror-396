...
class OpenRouterProvider(OpenAICompatibleProvider):
    ...
    def __init__(self, timeout: int = 300):
        ...
        self.client = AsyncOpenAI(
            ...
            max_retries=2,
            default_headers={
                "HTTP-Referer": "https://github.com/mcp-llm-orchestrator", # Required by OpenRouter
                "X-Title": "MCP LLM Orchestrator"
            }
        )

    def list_models(self):
        # We could implement a fetch from openrouter.ai/api/v1/models here
        # For now, return a hint
        return ["openrouter/auto (or any specific model)"]
