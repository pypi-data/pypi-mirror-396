...
class CreateAccountingPeriodRequest(BaseModel):
    ...
    fiscal_quarter: Optional[StrictInt] = Field(default=None, description="Fiscal quarter of the accounting period. One number between 1 and 4.", alias="fiscalQuarter")
    name: Annotated[str, Field(min_length=1, strict=True, max_length=100)] = Field(description="Name of the accounting period.  Accounting period name must be unique. Maximum of 100 characters. ")
