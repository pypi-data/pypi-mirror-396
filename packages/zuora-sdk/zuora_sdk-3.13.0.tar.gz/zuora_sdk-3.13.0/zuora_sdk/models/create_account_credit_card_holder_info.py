...
class CreateAccountCreditCardHolderInfo(BaseModel):
    ...
    address_line1: Annotated[str, Field(strict=True, max_length=255)] = Field(description="First address line, 255 characters or less. ", alias="addressLine1")
    ...
    card_holder_name: Annotated[str, Field(min_length=1, strict=True, max_length=50)] = Field(description="The card holder's full name as it appears on the card, e.g., \"John J Smith\", 50 characters or less.", alias="cardHolderName")
    city: Annotated[str, Field(strict=True, max_length=40)] = Field(description="City, 40 characters or less.  It is recommended to provide the city and country information when creating a payment method. The information will be used to process payments. If the information is not provided during payment method creation, the city and country data will be missing during payment processing.")
    country: Annotated[str, Field(strict=True, max_length=64)] = Field(description="Country; must be a valid country name or abbreviation.  It is recommended to provide the city and country information when creating a payment method. The information will be used to process payments. If the information is not provided during payment method creation, the city and country data will be missing during payment processing.")
    ...
    state: Annotated[str, Field(strict=True, max_length=50)] = Field(description="State; must be a valid state name or 2-character abbreviation. ")
    zip_code: Annotated[str, Field(strict=True, max_length=20)] = Field(description="Zip code, 20 characters or less. ", alias="zipCode")
