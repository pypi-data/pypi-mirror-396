...
class ChargeUpdate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["billing", "chargeNumber", "estimatedStartDate", "newRatePlanChargeId", "customFields", "description", "effectiveDate", "pricing", "uniqueToken", "pricingAttributes", "negotiatedPriceTable"]
