...
class BillingPreviewRunFilter(BaseModel):
    """
    ...
    filter_type: StrictStr = Field(description="The type of filter to apply. ", alias="filterType")
    account_id: Annotated[str, Field(strict=True)] = Field(description="The target account ID. ", alias="accountId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["filterType", "accountId"]
