...
class CreateSequenceSetRequest(BaseModel):
    ...
    name: Annotated[str, Field(min_length=1, strict=True, max_length=15)] = Field(description="The name of the sequence set to configure for billing documents, payments, and refunds.")
