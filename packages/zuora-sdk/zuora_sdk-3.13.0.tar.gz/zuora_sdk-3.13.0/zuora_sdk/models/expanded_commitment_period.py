...
class ExpandedCommitmentPeriod(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "version", "commitmentId", "type", "priority", "startDate", "endDate", "amount", "createdDate", "updatedDate", "createdById", "updatedById"]
