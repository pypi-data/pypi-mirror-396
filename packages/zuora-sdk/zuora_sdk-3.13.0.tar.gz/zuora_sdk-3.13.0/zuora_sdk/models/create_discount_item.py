...
class CreateDiscountItem(BaseModel):
    ...
    accounts_receivable_accounting_code: Optional[Annotated[str, Field(strict=True, max_length=100)]] = Field(default=None, description="The accounting code for accounts receivable. ", alias="accountsReceivableAccountingCode")
    ...
    booking_reference: Optional[Annotated[str, Field(strict=True, max_length=100)]] = Field(default=None, description="The booking reference of the discount item. ", alias="bookingReference")
    ...
    charge_name: Optional[Annotated[str, Field(strict=True, max_length=130)]] = Field(default=None, description="The name of the charge associated with the discount item. This field is required if the `productRatePlanChargeId` field is not specified in the request body. ", alias="chargeName")
