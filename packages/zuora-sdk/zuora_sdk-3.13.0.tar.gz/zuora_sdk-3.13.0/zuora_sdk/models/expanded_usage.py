...
class ExpandedUsage(BaseModel):
    ...
    rated_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="ratedAmount")
    ...
    __properties: ClassVar[List[str]] = ["accountId", "accountNumber", "ratePlanChargeId", "endDateTime", "productRatePlanChargeId", "quantity", "ratedAmount", "rbeStatus", "sourceType", "startDateTime", "subscriptionId", "submissionDateTime", "uOM", "description", "id", "createdById", "createdDate", "updatedById", "updatedDate", "importId", "uniqueKey", "fileId", "fileName", "account"]
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "ratedAmount": obj.get("ratedAmount"),
