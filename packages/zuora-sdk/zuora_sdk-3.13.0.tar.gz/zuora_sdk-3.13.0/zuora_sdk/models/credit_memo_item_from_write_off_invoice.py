...
class CreditMemoItemFromWriteOffInvoice(BaseModel):
    ...
    comment: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Comments about the credit memo item. ")
    ...
    def service_end_date_validate_regular_expression(cls, value):
    ...
    @field_validator('service_start_date')
    def service_start_date_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
