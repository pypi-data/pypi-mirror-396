...
**subscriptions** | [**List[PreviewOrderSubscriptions]**](PreviewOrderSubscriptions.md) | Each item includes a set of order actions, which will be applied to the same base subscription. | [optional] 
...
preview_order_request_instance = PreviewOrderRequest.from_json(json)
# print the JSON string representation of the object
print(PreviewOrderRequest.to_json())

# convert the object into a dict
preview_order_request_dict = preview_order_request_instance.to_dict()
# create an instance of PreviewOrderRequest from a dict
preview_order_request_from_dict = PreviewOrderRequest.from_dict(preview_order_request_dict)
```
