...
recurring_tiered_pricing_override_instance = RecurringTieredPricingOverride.from_json(json)
# print the JSON string representation of the object
print(RecurringTieredPricingOverride.to_json())

# convert the object into a dict
recurring_tiered_pricing_override_dict = recurring_tiered_pricing_override_instance.to_dict()
# create an instance of RecurringTieredPricingOverride from a dict
recurring_tiered_pricing_override_from_dict = RecurringTieredPricingOverride.from_dict(recurring_tiered_pricing_override_dict)
```
