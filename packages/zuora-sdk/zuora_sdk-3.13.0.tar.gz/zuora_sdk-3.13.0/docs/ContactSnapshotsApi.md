...
> ContactSnapshotResponse get_contact_snapshot(contact_snapshot_id, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
...
with zuora_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve a contact snapshot
        api_response = api_instance.get_contact_snapshot(contact_snapshot_id, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
