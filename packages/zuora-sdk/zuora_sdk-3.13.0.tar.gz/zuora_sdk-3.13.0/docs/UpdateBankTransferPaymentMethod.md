...
update_bank_transfer_payment_method_instance = UpdateBankTransferPaymentMethod.from_json(json)
# print the JSON string representation of the object
print(UpdateBankTransferPaymentMethod.to_json())

# convert the object into a dict
update_bank_transfer_payment_method_dict = update_bank_transfer_payment_method_instance.to_dict()
# create an instance of UpdateBankTransferPaymentMethod from a dict
update_bank_transfer_payment_method_from_dict = UpdateBankTransferPaymentMethod.from_dict(update_bank_transfer_payment_method_dict)
```
