...
usage_tiered_pricing_update_instance = UsageTieredPricingUpdate.from_json(json)
# print the JSON string representation of the object
print(UsageTieredPricingUpdate.to_json())

# convert the object into a dict
usage_tiered_pricing_update_dict = usage_tiered_pricing_update_instance.to_dict()
# create an instance of UsageTieredPricingUpdate from a dict
usage_tiered_pricing_update_from_dict = UsageTieredPricingUpdate.from_dict(usage_tiered_pricing_update_dict)
```
