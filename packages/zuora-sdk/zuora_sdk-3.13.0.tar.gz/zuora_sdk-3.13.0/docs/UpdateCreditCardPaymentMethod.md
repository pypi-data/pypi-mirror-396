...
update_credit_card_payment_method_instance = UpdateCreditCardPaymentMethod.from_json(json)
# print the JSON string representation of the object
print(UpdateCreditCardPaymentMethod.to_json())

# convert the object into a dict
update_credit_card_payment_method_dict = update_credit_card_payment_method_instance.to_dict()
# create an instance of UpdateCreditCardPaymentMethod from a dict
update_credit_card_payment_method_from_dict = UpdateCreditCardPaymentMethod.from_dict(update_credit_card_payment_method_dict)
```
