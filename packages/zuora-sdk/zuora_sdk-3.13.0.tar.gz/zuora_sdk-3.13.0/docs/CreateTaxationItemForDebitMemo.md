...
**finance_information** | [**CreateTaxationItemForDebitMemoFinanceInformation**](CreateTaxationItemForDebitMemoFinanceInformation.md) |  | [optional] 
...
create_taxation_item_for_debit_memo_instance = CreateTaxationItemForDebitMemo.from_json(json)
# print the JSON string representation of the object
print(CreateTaxationItemForDebitMemo.to_json())

# convert the object into a dict
create_taxation_item_for_debit_memo_dict = create_taxation_item_for_debit_memo_instance.to_dict()
# create an instance of CreateTaxationItemForDebitMemo from a dict
create_taxation_item_for_debit_memo_from_dict = CreateTaxationItemForDebitMemo.from_dict(create_taxation_item_for_debit_memo_dict)
```
