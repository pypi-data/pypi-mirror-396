...
**pricing_attributes** | **Dict[str, object]** | Container for pricing attributes that provide additional context for dynamic pricing.  **Note:** This field requires the DynamicPricing permission to be enabled.  | [optional] 
