...
**finance_information** | [**GetCreditMemoTaxItemFinanceInformation**](GetCreditMemoTaxItemFinanceInformation.md) |  | [optional] 
...
get_credit_memo_taxation_item_response_instance = GetCreditMemoTaxationItemResponse.from_json(json)
# print the JSON string representation of the object
print(GetCreditMemoTaxationItemResponse.to_json())

# convert the object into a dict
get_credit_memo_taxation_item_response_dict = get_credit_memo_taxation_item_response_instance.to_dict()
# create an instance of GetCreditMemoTaxationItemResponse from a dict
get_credit_memo_taxation_item_response_from_dict = GetCreditMemoTaxationItemResponse.from_dict(get_credit_memo_taxation_item_response_dict)
```
