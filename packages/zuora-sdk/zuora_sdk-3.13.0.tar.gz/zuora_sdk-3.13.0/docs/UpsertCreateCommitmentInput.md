...
**currency** | **str** |  | 
**periods** | [**List[UpsertCreateCommitmentInputAllOfPeriods]**](UpsertCreateCommitmentInputAllOfPeriods.md) | The new periods are required when creating a new Commitment. | [optional] 
...
**schedules** | [**List[UpsertCreateCommitmentInputAllOfSchedules]**](UpsertCreateCommitmentInputAllOfSchedules.md) | The new schedules for creating a new Commitment with auto-generated periods. | 
