...
subscribe_to_product_instance = SubscribeToProduct.from_json(json)
# print the JSON string representation of the object
print(SubscribeToProduct.to_json())

# convert the object into a dict
subscribe_to_product_dict = subscribe_to_product_instance.to_dict()
# create an instance of SubscribeToProduct from a dict
subscribe_to_product_from_dict = SubscribeToProduct.from_dict(subscribe_to_product_dict)
```
