...
**commitments** | [**List[UpsertCommitmentInput]**](UpsertCommitmentInput.md) | It contains a list of commitments to create or update.  using the action to indicate whether to create or update the commitment.  | [optional] 
