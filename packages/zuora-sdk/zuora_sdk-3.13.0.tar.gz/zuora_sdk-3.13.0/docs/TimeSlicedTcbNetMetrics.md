...
**generated_reason** | [**TimeSlicedTcbNetMetricsGeneratedReason**](TimeSlicedTcbNetMetricsGeneratedReason.md) |  | [optional] 
...
**type** | [**TimeSlicedTcbNetMetricsType**](TimeSlicedTcbNetMetricsType.md) |  | [optional] 
...
time_sliced_tcb_net_metrics_instance = TimeSlicedTcbNetMetrics.from_json(json)
# print the JSON string representation of the object
print(TimeSlicedTcbNetMetrics.to_json())

# convert the object into a dict
time_sliced_tcb_net_metrics_dict = time_sliced_tcb_net_metrics_instance.to_dict()
# create an instance of TimeSlicedTcbNetMetrics from a dict
time_sliced_tcb_net_metrics_from_dict = TimeSlicedTcbNetMetrics.from_dict(time_sliced_tcb_net_metrics_dict)
```
