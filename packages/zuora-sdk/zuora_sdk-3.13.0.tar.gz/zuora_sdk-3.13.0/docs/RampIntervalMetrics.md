...
ramp_interval_metrics_instance = RampIntervalMetrics.from_json(json)
# print the JSON string representation of the object
print(RampIntervalMetrics.to_json())

# convert the object into a dict
ramp_interval_metrics_dict = ramp_interval_metrics_instance.to_dict()
# create an instance of RampIntervalMetrics from a dict
ramp_interval_metrics_from_dict = RampIntervalMetrics.from_dict(ramp_interval_metrics_dict)
```
