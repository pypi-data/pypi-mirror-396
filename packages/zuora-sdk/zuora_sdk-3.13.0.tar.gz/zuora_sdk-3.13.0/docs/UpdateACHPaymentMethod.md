...
update_ach_payment_method_instance = UpdateACHPaymentMethod.from_json(json)
# print the JSON string representation of the object
print(UpdateACHPaymentMethod.to_json())

# convert the object into a dict
update_ach_payment_method_dict = update_ach_payment_method_instance.to_dict()
# create an instance of UpdateACHPaymentMethod from a dict
update_ach_payment_method_from_dict = UpdateACHPaymentMethod.from_dict(update_ach_payment_method_dict)
```
