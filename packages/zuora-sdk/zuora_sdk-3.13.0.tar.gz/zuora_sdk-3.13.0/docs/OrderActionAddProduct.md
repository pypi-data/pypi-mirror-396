...
order_action_add_product_instance = OrderActionAddProduct.from_json(json)
# print the JSON string representation of the object
print(OrderActionAddProduct.to_json())

# convert the object into a dict
order_action_add_product_dict = order_action_add_product_instance.to_dict()
# create an instance of OrderActionAddProduct from a dict
order_action_add_product_from_dict = OrderActionAddProduct.from_dict(order_action_add_product_dict)
```
