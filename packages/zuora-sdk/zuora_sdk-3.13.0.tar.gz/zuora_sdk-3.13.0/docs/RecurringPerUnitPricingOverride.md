...
recurring_per_unit_pricing_override_instance = RecurringPerUnitPricingOverride.from_json(json)
# print the JSON string representation of the object
print(RecurringPerUnitPricingOverride.to_json())

# convert the object into a dict
recurring_per_unit_pricing_override_dict = recurring_per_unit_pricing_override_instance.to_dict()
# create an instance of RecurringPerUnitPricingOverride from a dict
recurring_per_unit_pricing_override_from_dict = RecurringPerUnitPricingOverride.from_dict(recurring_per_unit_pricing_override_dict)
```
