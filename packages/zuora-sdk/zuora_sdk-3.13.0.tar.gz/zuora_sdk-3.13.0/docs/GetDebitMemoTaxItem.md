...
get_debit_memo_tax_item_instance = GetDebitMemoTaxItem.from_json(json)
# print the JSON string representation of the object
print(GetDebitMemoTaxItem.to_json())

# convert the object into a dict
get_debit_memo_tax_item_dict = get_debit_memo_tax_item_instance.to_dict()
# create an instance of GetDebitMemoTaxItem from a dict
get_debit_memo_tax_item_from_dict = GetDebitMemoTaxItem.from_dict(get_debit_memo_tax_item_dict)
```
