...
class AddSubscriptionRatePlan(BaseModel):
    ...
    product_rate_plan_id: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="ID of a product rate plan for this subscription ", alias="productRatePlanId")
