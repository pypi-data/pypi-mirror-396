...
class CreateContactRequest(BaseModel):
    ...
    first_name: Annotated[str, Field(min_length=1, strict=True, max_length=100)] = Field(description="The contact's first name. ", alias="firstName")
    ...
    last_name: Annotated[str, Field(min_length=1, strict=True, max_length=100)] = Field(description="The contact's last name. ", alias="lastName")
