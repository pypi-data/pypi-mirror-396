...
class CreateTaxationItem(BaseModel):
    ...
    jurisdiction: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="The jurisdiction that applies the tax or VAT. This value is typically a state, province, county, or city.")
    location_code: Optional[Annotated[str, Field(strict=True, max_length=32)]] = Field(default=None, description="The identifier for the location based on the value of the `taxCode` field.", alias="locationCode")
    name: Annotated[str, Field(min_length=1, strict=True, max_length=128)] = Field(description="The name of taxation.")
    ...
    tax_code: Annotated[str, Field(min_length=1, strict=True, max_length=64)] = Field(description="The tax code identifies which tax rules and tax rates to apply to a specific invoice item.", alias="taxCode")
    tax_code_description: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="The description of the tax code.", alias="taxCodeDescription")
    ...
    tax_rate_description: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="The description of the tax rate.", alias="taxRateDescription")
