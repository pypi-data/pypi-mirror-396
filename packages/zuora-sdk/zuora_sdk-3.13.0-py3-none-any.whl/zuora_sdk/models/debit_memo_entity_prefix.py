...
class DebitMemoEntityPrefix(BaseModel):
    ...
    prefix: Annotated[str, Field(min_length=1, strict=True, max_length=16)] = Field(description="The prefix of debit memos. ")
    start_number: Annotated[int, Field(strict=True, ge=1)] = Field(description="The starting document number of debit memos. ", alias="startNumber")
