...
class RatePlan(BaseModel):
    ...
    product_rate_plan_id: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Internal identifier of the product rate plan that the rate plan is based on.", alias="productRatePlanId")
