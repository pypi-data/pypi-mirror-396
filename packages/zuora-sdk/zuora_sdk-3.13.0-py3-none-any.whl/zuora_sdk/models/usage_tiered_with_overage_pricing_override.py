...
class UsageTieredWithOveragePricingOverride(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["priceChangeOption", "priceIncreasePercentage", "numberOfPeriods", "overagePrice", "overageUnusedUnitsCreditOption", "tiers", "unusedUnitsCreditRates", "originalListPrice"]
