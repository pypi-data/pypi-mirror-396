...
class PreviewSubscriptionAccountInfo(BaseModel):
    ...
    bill_cycle_day: Annotated[int, Field(le=31, strict=True, ge=0)] = Field(description="The account's bill cycle day (BCD), when bill runs generate invoices for the account. Specify any day of the month (`1`-`31`, where `31` = end-of-month), or `0` for auto-set.", alias="billCycleDay")
    bill_to_contact: PreviewSubscriptionBillToContact = Field(alias="billToContact")
    currency: Annotated[str, Field(min_length=3, strict=True, max_length=3)] = Field(description="A currency as defined in Billing Settings. ")
