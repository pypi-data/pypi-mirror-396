...
class AddSubscriptionComponent(BaseModel):
    ...
    number: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(default=None, description="Unique number that identifies the charge. System-generated if not provided. ")
    number_of_periods: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, description="Specifies the number of periods to use when calculating charges in an overage smoothing charge model.  Available for the following charge type for the Overage and Tiered with Overage charge models:  * Usage-based ", alias="numberOfPeriods")
    ...
    product_rate_plan_charge_id: Annotated[str, Field(strict=True)] = Field(alias="productRatePlanChargeId")
