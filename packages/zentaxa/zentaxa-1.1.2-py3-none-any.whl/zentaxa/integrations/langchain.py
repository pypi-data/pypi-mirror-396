...
def calculate_cost(model_name: str, prompt_tokens: int, completion_tokens: int) -> float:
    ...
    # Normalize model name (lowercase, strip version suffixes)
    ...
    if model_key in MODEL_PRICING:
        ...
        for key, prices in MODEL_PRICING.items():
            ...
            # Default to a reasonable estimate (similar to GPT-3.5)
            input_price, output_price = 0.50, 1.50
        ...
        **kwargs: Any
        ...
        try:
            ...
            self.client.agent_event(
                ...
                cost_usd=cost_usd,  # Now sending calculated cost
                metadata=llm_output
            )
