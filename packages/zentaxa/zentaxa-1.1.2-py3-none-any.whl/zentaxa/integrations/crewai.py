...
class CrewAIObserver:
    ...
    def __init__(
        ...
        self.task_start_times: Dict[int, float] = {}  # step_number -> start_time
    ...
    def track_task_start(
        ...
        try:
            self.step_counter += 1
            self.task_start_times[self.step_counter] = time.time()  # Track start time
    ...
    def track_task_complete(
        ...
        try:
            ...
            if latency_ms is None:
                start_time = self.task_start_times.get(self.step_counter, time.time())
