...
class AutoGenTracer:
    ...
    def __init__(
        ...
        self.last_message_time: Optional[float] = None  # Track time between messages
    ...
    def track_message(
        ...
        try:
            ...
            latency_ms = (current_time - (self.last_message_time or current_time)) * 1000
            ...
            self.client.metric(
                run_id=self.run_id,
                metric_name="message_latency_ms",
                value=latency_ms,
    ...
    def track_function_call(
        ...
        try:
            ...
            self.client.metric(
                run_id=self.run_id,
                metric_name="function_latency_ms",
                value=latency_ms,
