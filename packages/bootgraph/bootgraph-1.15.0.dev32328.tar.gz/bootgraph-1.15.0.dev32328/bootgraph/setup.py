    ...
    def get_auth(cls, module: "Graphemy", request_type: str) -> BasePermission:
        ...
        class IsAuthenticated(BasePermission):
            async def has_permission(
                ...
                context_with_args["__resolver_args__"] = kwargs
                # persist resolver args for downstream resolvers
                try:
                    info.context["__resolver_args__"] = kwargs
                except Exception:
                    pass
                if not await cls.has_permission(module, context_with_args, request_type):
