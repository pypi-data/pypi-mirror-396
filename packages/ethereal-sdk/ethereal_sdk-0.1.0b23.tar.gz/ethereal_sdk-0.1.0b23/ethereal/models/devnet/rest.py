...
#   timestamp: 2025-11-24T16:37:55+00:00
...
class TotalSubaccountVolumeDto(BaseModel):
    volume_usd: str = Field(
        ...,
        alias="volumeUsd",
        description="Volume in USD up to now, expressed as a decimal (precision: 9)",
        examples=["150.75"],
    )
...
class V1TokenTransferGetParametersQuery(BaseModel):
    ...
    types: Optional[List[Type6]] = Field(None, examples=["WITHDRAW"])
    order_by: Optional[OrderBy11] = Field(None, alias="orderBy", examples=["createdAt"])
    created_after: Optional[float] = Field(None, alias="createdAfter")
    created_before: Optional[float] = Field(None, alias="createdBefore")
...
class ArchiveV1SubaccountBalanceGetParametersQuery(BaseModel):
    ...
    end_time: Optional[float] = Field("2025-11-24T04:41:11.895Z", alias="endTime")
    resolution: Resolution = Field(..., examples=["hour2"])
    order_by: Optional[OrderBy15] = Field(None, alias="orderBy", examples=["time"])
    subaccount_id: UUID = Field(..., alias="subaccountId")
...
class ArchiveV1SubaccountFundingGetParametersQuery(BaseModel):
    ...
    cursor: Optional[str] = None
    start_time: float = Field(..., alias="startTime")
    end_time: Optional[float] = Field("2025-11-24T04:41:11.022Z", alias="endTime")
    order_by: Optional[OrderBy15] = Field(None, alias="orderBy", examples=["time"])
    subaccount_id: UUID = Field(
...
class ArchiveV1SubaccountUnrealizedPnlGetParametersQuery(BaseModel):
    ...
    cursor: Optional[str] = None
    start_time: float = Field(..., alias="startTime")
    end_time: Optional[float] = Field("2025-11-24T04:41:11.907Z", alias="endTime")
    resolution: Resolution = Field(..., examples=["hour2"])
    order_by: Optional[OrderBy15] = Field(None, alias="orderBy", examples=["time"])
    subaccount_id: UUID = Field(..., alias="subaccountId")
    product_ids: Optional[List[UUID]] = Field(None, alias="productIds", min_length=1)
...
class ArchiveV1SubaccountVolumeGetParametersQuery(BaseModel):
    ...
    cursor: Optional[str] = None
    start_time: float = Field(..., alias="startTime")
    end_time: Optional[float] = Field("2025-11-24T04:41:11.911Z", alias="endTime")
    resolution: Resolution = Field(..., examples=["hour2"])
    order_by: Optional[OrderBy15] = Field(None, alias="orderBy", examples=["time"])
    subaccount_id: UUID = Field(..., alias="subaccountId")
