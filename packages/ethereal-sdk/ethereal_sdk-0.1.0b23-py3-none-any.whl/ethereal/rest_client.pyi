...
class RESTClient:
    ...
    def cancel_all_orders(self, subaccount_id: UUID, product_ids: Optional[List[UUID]] = None, **kwargs) -> List[CancelOrderResultDto]: ...

    def cancel_order(self, order_to_cancel: CancelOrderDto, **kwargs) -> List[CancelOrderResultDto]: ...

    def cancel_orders(self, order_ids: List[UUID], sender: Optional[str] = None, subaccount: Optional[str] = None, client_order_ids: List[str] = [], sign: bool = True, submit: bool = True, **kwargs) -> Union[List[CancelOrderResultDto], CancelOrderDto]: ...

    def create_order(self, order_type: str, quantity: float, side: int, price: Optional[float] = None, ticker: Optional[str] = None, product_id: Optional[UUID] = None, client_order_id: Optional[str] = None, sender: Optional[str] = None, subaccount: Optional[str] = None, time_in_force: Optional[str] = None, post_only: Optional[bool] = None, reduce_only: Optional[bool] = False, close: Optional[bool] = None, stop_price: Optional[float] = None, stop_type: Optional[int] = None, expires_at: Optional[int] = None, group_id: Optional[str] = None, group_contingency_type: Optional[int] = None, sign: bool = True, dry_run: bool = False, submit: bool = True) -> Union[SubmitOrderCreatedDto, DryRunOrderCreatedDto, SubmitOrderDto]: ...
    ...
    def get_maintenance_margin(self, subaccount_id: UUID, positions: Optional[List[PositionDto] | List[Dict[str, Any]]] = None, products: Optional[List[ProductDto] | List[Dict[str, Any]]] = None, product_ids: Optional[List[UUID]] = None) -> Decimal: ...
    ...
    def link_signer(self, signer: str, subaccount_id: UUID, subaccount: Optional[str] = None, sender: Optional[str] = None, signer_private_key: Optional[str] = None, nonce: Optional[str] = None, signed_at: Optional[int] = None, sign_sender: bool = True, sign_signer: bool = True, submit: bool = True, **kwargs) -> Union[SignerDto, LinkSignerDto]: ...
    ...
    def prepare_cancel_order(self, sender: str, subaccount: str, order_ids: List[UUID] = [], client_order_ids: List[str] = [], include_signature: bool = False, **kwargs) -> CancelOrderDto: ...

    def prepare_linked_signer(self, sender: str, signer: str, subaccount: str, subaccount_id: UUID, signer_signature: str = '', include_signature: bool = False, **kwargs) -> LinkSignerDto: ...
    ...
    def prepare_revoke_linked_signer(self, sender: str, signer: str, subaccount: str, subaccount_id: UUID, include_signature: bool = False, **kwargs) -> RevokeLinkedSignerDto: ...
    ...
    def replace_order(self, order: Optional[OrderDto] = None, order_id: Optional[UUID] = None, quantity: Optional[float] = None, price: Optional[float] = None, time_in_force: Optional[str] = None, post_only: Optional[bool] = None, reduce_only: Optional[bool] = False) -> Tuple[SubmitOrderCreatedDto, bool]: ...

    def revoke_linked_signer(self, dto: RevokeLinkedSignerDto, **kwargs) -> SignerDto: ...

    def revoke_signer(self, signer: str, subaccount_id: UUID, subaccount: Optional[str] = None, sender: Optional[str] = None, sign: bool = True, submit: bool = True, **kwargs) -> Union[SignerDto, RevokeLinkedSignerDto]: ...
    ...
    def sign_revoke_linked_signer(self, revoke_to_sign: RevokeLinkedSignerDto, private_key: Union[str, None] = None) -> RevokeLinkedSignerDto: ...
    ...
    def withdraw_token(self, dto: InitiateWithdrawDto, token_id: UUID, **kwargs) -> WithdrawDto: ...
