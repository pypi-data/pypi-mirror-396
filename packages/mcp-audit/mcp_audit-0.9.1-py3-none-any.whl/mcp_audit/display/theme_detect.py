"""Theme detection utilities for mcp-audit TUI.
...
def detect_terminal_mode() -> TerminalMode:
    ...
    1. MCP_AUDIT_THEME environment variable (explicit override)
    ...
    env_theme = os.environ.get("MCP_AUDIT_THEME", "").lower()
...
def get_active_theme(
    ...
    2. MCP_AUDIT_THEME environment variable
