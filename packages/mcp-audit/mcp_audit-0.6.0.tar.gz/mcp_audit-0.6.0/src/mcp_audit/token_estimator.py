...
GITHUB_REPO = "littlebearapps/mcp-audit"
...
class TokenEstimator:
    ...
    def _get_gemma_tokenizer_path() -> Optional[Path]:
        ...
        Checks in order:
        1. Bundled with package: src/mcp_audit/tokenizers/tokenizer.model
        2. User cache: ~/.cache/mcp-audit/tokenizer.model
    ...
    def get_cache_dir() -> Path:
        """Get the mcp-audit cache directory."""
        cache_dir = Path.home() / ".cache" / "mcp-audit"
    ...
    try:
        ...
        if "401" in error_msg or "unauthorized" in error_msg.lower():
            return (
                ...
                "4. Run: mcp-audit tokenizer download --token YOUR_TOKEN",
            )
    ...
    try:
        ...
        if e.code == 404:
            ...
            return (
                ...
                "• Use HuggingFace: mcp-audit tokenizer download --source huggingface",
            )
        ...
        return (
            ...
            f"• Download manually from: https://github.com/{GITHUB_REPO}/releases\n"
            "• Extract tokenizer.model to: ~/.cache/mcp-audit/",
        )
    except Exception as e:
