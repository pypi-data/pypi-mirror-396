...
def post_upgrade_hook():
    ...
    try:
        ...
        target_v3_4 = (0, 3, 4)
        # 3. old < 0.3.6 AND new >= 0.3.6 (Additional config changes)
        target_v3_6 = (0, 3, 6)
        # 4. old < 0.3.7 AND new >= 0.3.7 (Token management update)
        target_v3_7 = (0, 3, 7)
        ...
        if curr_tuple < target_v2_1 and new_tuple >= target_v2_1:
            ...
            need_clear = True
        elif curr_tuple < target_v3_6 and new_tuple >= target_v3_6:
            need_clear = True
        elif curr_tuple < target_v3_7 and new_tuple >= target_v3_7:
            need_clear = True
