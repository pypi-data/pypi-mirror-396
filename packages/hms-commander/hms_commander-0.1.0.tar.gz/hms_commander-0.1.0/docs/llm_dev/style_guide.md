...
For the complete style guide, see: [STYLE_GUIDE.md](https://github.com/billk-FM/hms-commander/blob/main/STYLE_GUIDE.md) in the repository root.
...
See [full style guide](https://github.com/billk-FM/hms-commander/blob/main/STYLE_GUIDE.md) for detailed patterns and examples.
