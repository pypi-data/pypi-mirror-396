...
# Custom log levels (between INFO and WARNING)
...
class CliLogger:
    ...
    def fail(self, msg: str):
        """Log a failure message (✗ prefix, red).
    ...
    def done(self, msg: str):
        """Log a completion message (✓ prefix, green).
    ...
    def tip(self, msg: str):
        """Log a tip message (Tip: prefix).

        Use for helpful suggestions that the user might not know.
        Example: logger.tip("Run 'djb --help' for more options")
        Output:  Tip: Run 'djb --help' for more options
        """
        self.logger.info(f"{CliFormatter.TIP}{msg}")
