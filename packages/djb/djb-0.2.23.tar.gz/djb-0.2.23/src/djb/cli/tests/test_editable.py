...
class TestInstallEditableDjb:
    ...
    def test_successful_install(self, tmp_path, mock_run_cmd):
    ...
    def test_returns_false_when_djb_not_found(self, tmp_path, mock_run_cmd):
    ...
    def test_failure_on_uv_add(self, tmp_path, mock_run_cmd):
