...
def gen_hierarchy(pts, eval_pts = None, N_max = 128, theta = 0.77, s = 3, p = 3, periodic_axes = (), pbc_lvls = 5, pbc_no_monopole = True, L0_boxcen = None, L0_boxlen = None, no_cross_level = False, debug_info = False):
    r"""
