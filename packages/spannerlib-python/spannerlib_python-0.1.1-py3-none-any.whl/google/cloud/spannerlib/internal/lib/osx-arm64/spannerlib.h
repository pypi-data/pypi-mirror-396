...
//
extern GoInt32 Release(GoInt64 pinnerId);
...
//
extern struct CreatePool_return CreatePool(GoString connectionString);
...
//
extern struct ClosePool_return ClosePool(GoInt64 id);
...
//
extern struct CreateConnection_return CreateConnection(GoInt64 poolId);
...
//
extern struct CloseConnection_return CloseConnection(GoInt64 poolId, GoInt64 connId);
...
//
extern struct WriteMutations_return WriteMutations(GoInt64 poolId, GoInt64 connectionId, GoSlice mutationsBytes);
...
//
extern struct Execute_return Execute(GoInt64 poolId, GoInt64 connectionId, GoSlice statement);
...
//
extern struct ExecuteBatch_return ExecuteBatch(GoInt64 poolId, GoInt64 connectionId, GoSlice statements);
...
//
extern struct Metadata_return Metadata(GoInt64 poolId, GoInt64 connId, GoInt64 rowsId);
...
//
extern struct ResultSetStats_return ResultSetStats(GoInt64 poolId, GoInt64 connId, GoInt64 rowsId);
...
//
extern struct NextResultSet_return NextResultSet(GoInt64 poolId, GoInt64 connId, GoInt64 rowsId);
...
//
extern struct Next_return Next(GoInt64 poolId, GoInt64 connId, GoInt64 rowsId, GoInt32 numRows, GoInt32 encodeRowOption);
...
//
extern struct CloseRows_return CloseRows(GoInt64 poolId, GoInt64 connId, GoInt64 rowsId);
...
//
extern struct BeginTransaction_return BeginTransaction(GoInt64 poolId, GoInt64 connectionId, GoSlice txOpts);
...
//
extern struct Commit_return Commit(GoInt64 poolId, GoInt64 connectionId);
...
//
extern struct Rollback_return Rollback(GoInt64 poolId, GoInt64 connectionId);
