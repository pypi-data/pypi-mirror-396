...
If you also want to run tests against a local postgreSQL instance, create a .env and (for now) set `MAIN_DB_URL` to you local db connection string. The db will get altered!
You can run the the postgreSQL test suite with
