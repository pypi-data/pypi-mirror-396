...
class Query(object):
    ...
    see: https://docs.oracle.com/javase/8/docs/api/java/time/format/DateTimeFormatter.html
     ...
     - clusteringColumn: Optional clustering column for non-partitioned tables (e.g., Delta clustering by timestamp).
    If present, the planner will build range predicates on this column instead of partition pruning.
    Only one of partitionColumn or clusteringColumn should be set.

     - clusteringFormat: Format of the clustering column when stored as string; use Java DateTimeFormatter patterns.
    Omit when the clustering column is a native timestamp/timestamp_ntz type.
    ...
    def __init__(self, selects = None, wheres = None, startPartition = None, endPartition = None, timeColumn = None, setups = None, mutationTimeColumn = None, reversalColumn = None, partitionColumn = None, partitionFormat = None, clusteringColumn = None, clusteringFormat = None, partitionInterval = None, partitionLag = None, subPartitionsToWaitFor = None,):
        ...
        self.clusteringFormat = clusteringFormat
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.clusteringColumn = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 26:
                if ftype == TType.STRING:
                    self.clusteringFormat = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 22:
    ...
    def write(self, oprot):
        ...
        if self.subPartitionsToWaitFor is not None:
            ...
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.clusteringColumn is not None:
            oprot.writeFieldBegin('clusteringColumn', TType.STRING, 25)
            oprot.writeString(self.clusteringColumn.encode('utf-8') if sys.version_info[0] == 2 else self.clusteringColumn)
            oprot.writeFieldEnd()
        if self.clusteringFormat is not None:
            oprot.writeFieldBegin('clusteringFormat', TType.STRING, 26)
            oprot.writeString(self.clusteringFormat.encode('utf-8') if sys.version_info[0] == 2 else self.clusteringFormat)
            oprot.writeFieldEnd()
...
Query.thrift_spec = (
    ...
    (25, TType.STRING, 'clusteringColumn', 'UTF8', None, ),  # 25
    (26, TType.STRING, 'clusteringFormat', 'UTF8', None, ),  # 26
)
