...
class NodeContent(object):
    ...
    def __init__(self, sourceWithFilter = None, joinBootstrap = None, joinPart = None, joinMerge = None, joinDerivation = None, monolithJoin = None, stagingQuery = None, unionJoin = None, joinMetadataUpload = None, externalSourceSensor = None, modelTransformsUpload = None, modelTransformsBackfill = None, groupByBackfill = None, groupByUpload = None, groupByStreaming = None, groupByUploadToKV = None, stagingQueryBackfill = None,):
