...
.. "auto_examples/paradigm_examples/plot_cross_subject_ssvep.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_paradigm_examples_plot_cross_subject_ssvep.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_paradigm_examples_plot_cross_subject_ssvep.py:
...
.. _sphx_glr_download_auto_examples_paradigm_examples_plot_cross_subject_ssvep.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-zip
      ...
      :download:`Download zipped: plot_cross_subject_ssvep.zip <plot_cross_subject_ssvep.zip>`
