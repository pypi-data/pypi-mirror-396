...
# ============================================================================
# Global Mocks (autouse)
# ============================================================================


@pytest.fixture(autouse=True)
def mock_ssl_and_fortinet():
    """Auto-mock SSL configuration and FortiGate hooks for all tests."""
    with (
        patch("mcp_atlassian.jira.client.configure_ssl_verification"),
        patch("mcp_atlassian.jira.client.install_fortinet_hook"),
    ):
        yield
