...
class JwtAuthSettings(EnvSettings):
    ...
    # JWTAUTH_ALGORITHM
    authjwt_algorithm: str | None = Field(default="HS256")
    # JWTAUTH_DECODE_ALGORITHMS
    authjwt_decode_algorithms: list[str] | None = Field(default=None)
    # JWTAUTH_DECODE_LEEWAY
    authjwt_decode_leeway: int | timedelta | None = Field(default=0)
    # JWTAUTH_ENCODE_ISSUER
    authjwt_encode_issuer: str | None = Field(default=None)
    # JWTAUTH_DECODE_ISSUER
    authjwt_decode_issuer: str | None = Field(default=None)
    # JWTAUTH_DECODE_AUDIENCE
    authjwt_decode_audience: str | None = Field(default="authenticated")
    # JWTAUTH_DENYLIST_ENABLED
    authjwt_denylist_enabled: bool | None = Field(default=False)
    # JWTAUTH_DENYLIST_TOKEN_CHECKS
    authjwt_denylist_token_checks: set[str] | None = Field(
        default={
            "access",
            "refresh",
        }
    ...
    # JWTAUTH_HEADER_NAME
    authjwt_header_name: str | None = Field(default="Authorization")
    # JWTAUTH_HEADER_TYPE
    authjwt_header_type: str | None = Field(default="Bearer")
    # JWTAUTH_ACCESS_TOKEN_EXPIRES
    authjwt_access_token_expires: bool | int | timedelta | None = Field(
        default=timedelta(minutes=15)
    )
    # JWTAUTH_REFRESH_TOKEN_EXPIRES
    authjwt_refresh_token_expires: bool | int | timedelta | None = Field(default=timedelta(days=30))

    # JWTAUTH_ACCESS_COOKIE_KEY
    authjwt_access_cookie_key: str | None = Field(default="access_token_cookie")
    # JWTAUTH_REFRESH_COOKIE_KEY
    authjwt_refresh_cookie_key: str | None = Field(default="refresh_token_cookie")
    # JWTAUTH_ACCESS_COOKIE_PATH
    authjwt_access_cookie_path: str | None = Field(default="/")
    # JWTAUTH_REFRESH_COOKIE_PATH
    authjwt_refresh_cookie_path: str | None = Field(default="/")
    # JWTAUTH_COOKIE_MAX_AGE
    authjwt_cookie_max_age: int | None = Field(default=None)
    # JWTAUTH_COOKIE_DOMAIN
    authjwt_cookie_domain: str | None = Field(default=None)
    # JWTAUTH_COOKIE_SECURE
    authjwt_cookie_secure: bool | None = Field(default=False)
    # JWTAUTH_COOKIE_SAMESITE
    authjwt_cookie_samesite: str | None = Field(default="none")

    # option for double submit csrf protection
    # JWTAUTH_COOKIE_CSRF_PROTECT
    authjwt_cookie_csrf_protect: bool | None = Field(default=True)
    # JWTAUTH_ACCESS_CSRF_COOKIE_KEY
    authjwt_access_csrf_cookie_key: str | None = Field(default="csrf_access_token")
    # JWTAUTH_REFRESH_CSRF_COOKIE_KEY
    authjwt_refresh_csrf_cookie_key: str | None = Field(default="csrf_refresh_token")
    # JWTAUTH_ACCESS_CSRF_COOKIE_PATH
    authjwt_access_csrf_cookie_path: str | None = Field(default="/")
    # JWTAUTH_REFRESH_CSRF_COOKIE_PATH
    authjwt_refresh_csrf_cookie_path: str | None = Field(default="/")
    # JWTAUTH_ACCESS_CSRF_HEADER_NAME
    authjwt_access_csrf_header_name: str | None = Field(default="X-CSRF-Token")
    # JWTAUTH_REFRESH_CSRF_HEADER_NAME
    authjwt_refresh_csrf_header_name: str | None = Field(default="X-CSRF-Token")
    # JWTAUTH_CSRF_METHODS
    authjwt_csrf_methods: set[str] | None = Field(
        default={
            "POST",
            "PUT",
            "PATCH",
