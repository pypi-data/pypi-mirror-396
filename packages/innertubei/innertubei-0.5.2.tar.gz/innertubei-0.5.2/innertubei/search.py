...
from innertubei.core.channelsearch import ChannelSearchCore
from innertubei.core.constants import SearchMode
from innertubei.core.search import SearchCore
...
class ChannelSearch(ChannelSearchCore):
    ...
    def __init__(
        ...
        super().__init__(
            query, language, region, search_preferences, browse_id, timeout
        )
