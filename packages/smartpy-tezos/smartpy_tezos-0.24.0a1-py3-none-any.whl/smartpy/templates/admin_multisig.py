...
def main():
    ...
    def failIfNotSigner(address):
        ...
        assert address in self.data.signers, ERR.SignerUnknown
    ...
    class MultisigAdmin(sp.Contract):
        ...
        def registerEndorsement(self, params):
            assert params.proposalId in self.data.activeProposals, ERR.ProposalUnknown
                                ...
                                match changeSigners:
                                    case removed(removeSet):
                                        for address in removeSet.elements():
                                            if address in self.data.signers:
                                                # Remove signer
