...
def m2():
    ...
    class MultisignAdmin(sp.Contract):
        ...
        def registerVote(self, params):
            ...
            assert not (params.voterId in proposal.yay) and not (
                params.voterId in proposal.nay
            ), MultisignAdmin_AlreadyVoted
            if params.yay:
                            ...
                            match action:
                                ...
                                case changeVoters(changeVoters):
                                    ...
                                    for voter in changeVoters.added:
                                        assert not (
                                            voter.addr in self.data.addrVoterId
                                        ) and not (
                                            voter.publicKey in self.data.keyVoterId
