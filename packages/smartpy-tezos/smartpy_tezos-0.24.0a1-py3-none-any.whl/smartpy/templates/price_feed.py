...
def m():
    ...
    class PriceAggregator(sp.Contract):
        ...
        def updatePrevious(self, submission):
            ...
            assert not (
                sp.sender in previousRoundDetails.submissions
        ...
        def updateCurrent(self, submission):
            ...
            assert not (
                sp.sender in currentRoundDetails.submissions
        ...
        def submit(self, params):
            ...
            assert sp.sender in self.data.oracles, Aggregator_NotOracle
            assert (
        ...
        def getRoundData(self, roundId):
            ...
            Returns:
                ...
                between queries.
            """
            if roundId in self.data.rounds:
