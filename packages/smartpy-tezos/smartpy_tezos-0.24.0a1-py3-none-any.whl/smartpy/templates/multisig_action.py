...
def main():
    ...
    class MultisigAction(sp.Contract):
        ...
        def send_proposal(self, proposal):
            ...
            """
            assert sp.sender in self.data.signers, "Only signers can propose"
        ...
        def vote(self, pId):
            ...
            """
            assert sp.sender in self.data.signers, "Only signers can vote"
            assert pId in self.data.votes, "Proposal unknown"
