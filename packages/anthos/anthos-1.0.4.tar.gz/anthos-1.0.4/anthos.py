...
class anthosWidget(Canvas):
    def __init__(self, master = None, audio_path = None, cnf = {}, wave_cnf = {}):
        super(anthosWidget, self).__init__(master, cnf)
...
def path():
    try:
        anthosWidget.__init__(audio_path=str())
    except:
        SyntaxError("Anthos does not support automatically setting paths.")