...
from cattle_hugs.testing.fixtures import *  # noqa
...
async def test_actor_for_id_not_found_no_fetcher(sql_session):
    with pytest.raises(ActorNotFoundError):
        await actor_for_id(sql_session, None, "http://host.test/actor/id")
