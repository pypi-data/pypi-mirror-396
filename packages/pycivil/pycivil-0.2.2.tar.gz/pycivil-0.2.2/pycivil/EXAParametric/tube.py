...
class CircularTubeShape01:
    ...
    def buildFEModel(self):
        ...
        self.__model.assignMultiFrameSectionShape(
            2, tagsMacro=self.__model.getFramesByPhysicalName("arco-SX")
        )
        self.__model.assignMultiFrameSectionShape(
            2, tagsMacro=self.__model.getFramesByPhysicalName("arco-DX")
        )
        self.__model.assignMultiFrameSectionShape(
            3, tagsMacro=self.__model.getFramesByPhysicalName("fondazione")
        )

        self.__model.addLoadCase(id="SW", tp="R", descr="peso proprio strutture")
        ...
        arcoSX = self.__model.framesModelTags(
            filter=self.__model.getFramesByPhysicalName("arco-SX")
        )
        arcoDX = self.__model.framesModelTags(
            filter=self.__model.getFramesByPhysicalName("arco-DX")
        )
        ...
        arcoSX_macro = self.__model.getFramesByPhysicalName("arco-SX")
        arcoDX_macro = self.__model.getFramesByPhysicalName("arco-DX")
