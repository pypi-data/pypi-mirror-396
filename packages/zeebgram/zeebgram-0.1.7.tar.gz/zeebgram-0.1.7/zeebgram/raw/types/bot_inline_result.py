...
class BotInlineResult(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~zeebgram.raw.base.BotInlineResult`.
    ...
    Parameters:
        ...
        send_message (:obj:`BotInlineMessage <zeebgram.raw.base.BotInlineMessage>`):
            N/A
        ...
        thumb (:obj:`WebDocument <zeebgram.raw.base.WebDocument>`, *optional*):
            N/A

        content (:obj:`WebDocument <zeebgram.raw.base.WebDocument>`, *optional*):
            N/A
