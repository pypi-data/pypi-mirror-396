...
class MediaAreaSuggestedReaction(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~zeebgram.raw.base.MediaArea`.
    ...
    Parameters:
        coordinates (:obj:`MediaAreaCoordinates <zeebgram.raw.base.MediaAreaCoordinates>`):
            N/A

        reaction (:obj:`Reaction <zeebgram.raw.base.Reaction>`):
            N/A
