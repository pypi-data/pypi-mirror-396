...
class AppUpdate(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~zeebgram.raw.base.help.AppUpdate`.
    ...
    Parameters:
        ...
        entities (List of :obj:`MessageEntity <zeebgram.raw.base.MessageEntity>`):
            N/A
        ...
        sticker (:obj:`Document <zeebgram.raw.base.Document>`, *optional*):
            N/A
