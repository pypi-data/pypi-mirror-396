...
class PremiumPromo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~zeebgram.raw.base.help.PremiumPromo`.
    ...
    Parameters:
        ...
        status_entities (List of :obj:`MessageEntity <zeebgram.raw.base.MessageEntity>`):
            N/A

        video_sections (List of ``str``):
            N/A

        videos (List of :obj:`Document <zeebgram.raw.base.Document>`):
            N/A

        period_options (List of :obj:`PremiumSubscriptionOption <zeebgram.raw.base.PremiumSubscriptionOption>`):
            N/A
