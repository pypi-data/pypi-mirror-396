...
class InputThemeSettings(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~zeebgram.raw.base.InputThemeSettings`.
    ...
    Parameters:
        base_theme (:obj:`BaseTheme <zeebgram.raw.base.BaseTheme>`):
            N/A
        ...
        wallpaper (:obj:`InputWallPaper <zeebgram.raw.base.InputWallPaper>`, *optional*):
            N/A

        wallpaper_settings (:obj:`WallPaperSettings <zeebgram.raw.base.WallPaperSettings>`, *optional*):
            N/A
