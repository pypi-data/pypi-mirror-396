...
class SearchResultsCalendar(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~zeebgram.raw.base.messages.SearchResultsCalendar`.
    ...
    Parameters:
        ...
        periods (List of :obj:`SearchResultsCalendarPeriod <zeebgram.raw.base.SearchResultsCalendarPeriod>`):
            N/A
