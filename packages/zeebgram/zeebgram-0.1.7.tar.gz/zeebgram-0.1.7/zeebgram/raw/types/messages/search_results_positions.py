...
class SearchResultsPositions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~zeebgram.raw.base.messages.SearchResultsPositions`.
    ...
    Parameters:
        ...
        positions (List of :obj:`SearchResultsPosition <zeebgram.raw.base.SearchResultsPosition>`):
            N/A
