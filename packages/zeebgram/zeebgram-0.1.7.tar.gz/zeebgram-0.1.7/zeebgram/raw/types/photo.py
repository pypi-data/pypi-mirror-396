...
class Photo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~zeebgram.raw.base.Photo`.
    ...
    Parameters:
        ...
        sizes (List of :obj:`PhotoSize <zeebgram.raw.base.PhotoSize>`):
            N/A
        ...
        video_sizes (List of :obj:`VideoSize <zeebgram.raw.base.VideoSize>`, *optional*):
            N/A
