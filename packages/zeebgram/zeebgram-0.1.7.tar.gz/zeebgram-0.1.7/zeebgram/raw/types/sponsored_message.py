...
class SponsoredMessage(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~zeebgram.raw.base.SponsoredMessage`.
    ...
    Parameters:
        ...
        chat_invite (:obj:`ChatInvite <zeebgram.raw.base.ChatInvite>`, *optional*):
            N/A
        ...
        webpage (:obj:`SponsoredWebPage <zeebgram.raw.base.SponsoredWebPage>`, *optional*):
            N/A
