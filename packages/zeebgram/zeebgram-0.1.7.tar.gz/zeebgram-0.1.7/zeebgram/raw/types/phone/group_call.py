...
class GroupCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~zeebgram.raw.base.phone.GroupCall`.
    ...
    Parameters:
        call (:obj:`GroupCall <zeebgram.raw.base.GroupCall>`):
            N/A

        participants (List of :obj:`GroupCallParticipant <zeebgram.raw.base.GroupCallParticipant>`):
            N/A
