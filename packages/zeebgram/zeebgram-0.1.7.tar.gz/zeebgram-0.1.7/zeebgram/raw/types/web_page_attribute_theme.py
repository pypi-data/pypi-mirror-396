...
class WebPageAttributeTheme(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~zeebgram.raw.base.WebPageAttribute`.
    ...
    Parameters:
        documents (List of :obj:`Document <zeebgram.raw.base.Document>`, *optional*):
            N/A

        settings (:obj:`ThemeSettings <zeebgram.raw.base.ThemeSettings>`, *optional*):
            N/A
