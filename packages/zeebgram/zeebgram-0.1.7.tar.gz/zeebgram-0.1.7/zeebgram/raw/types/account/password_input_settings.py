...
class PasswordInputSettings(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~zeebgram.raw.base.account.PasswordInputSettings`.
    ...
    Parameters:
        new_algo (:obj:`PasswordKdfAlgo <zeebgram.raw.base.PasswordKdfAlgo>`, *optional*):
            N/A
        ...
        new_secure_settings (:obj:`SecureSecretSettings <zeebgram.raw.base.SecureSecretSettings>`, *optional*):
            N/A
