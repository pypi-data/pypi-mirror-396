...
class AuthorizationForm(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~zeebgram.raw.base.account.AuthorizationForm`.
    ...
    Parameters:
        required_types (List of :obj:`SecureRequiredType <zeebgram.raw.base.SecureRequiredType>`):
            N/A

        values (List of :obj:`SecureValue <zeebgram.raw.base.SecureValue>`):
            N/A

        errors (List of :obj:`SecureValueError <zeebgram.raw.base.SecureValueError>`):
            N/A
