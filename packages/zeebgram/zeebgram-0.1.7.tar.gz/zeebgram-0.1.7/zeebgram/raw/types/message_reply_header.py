...
class MessageReplyHeader(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~zeebgram.raw.base.MessageReplyHeader`.
    ...
    Parameters:
        ...
        reply_to_peer_id (:obj:`Peer <zeebgram.raw.base.Peer>`, *optional*):
            N/A

        reply_from (:obj:`MessageFwdHeader <zeebgram.raw.base.MessageFwdHeader>`, *optional*):
            N/A

        reply_media (:obj:`MessageMedia <zeebgram.raw.base.MessageMedia>`, *optional*):
            N/A
        ...
        quote_entities (List of :obj:`MessageEntity <zeebgram.raw.base.MessageEntity>`, *optional*):
            N/A
