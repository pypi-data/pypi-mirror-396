...
class AttachMenuBotIcon(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~zeebgram.raw.base.AttachMenuBotIcon`.
    ...
    Parameters:
        ...
        icon (:obj:`Document <zeebgram.raw.base.Document>`):
            N/A

        colors (List of :obj:`AttachMenuBotIconColor <zeebgram.raw.base.AttachMenuBotIconColor>`, *optional*):
            N/A
