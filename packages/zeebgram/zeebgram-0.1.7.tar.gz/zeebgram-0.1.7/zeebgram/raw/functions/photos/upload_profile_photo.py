...
class UploadProfilePhoto(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        bot (:obj:`InputUser <zeebgram.raw.base.InputUser>`, *optional*):
            N/A

        file (:obj:`InputFile <zeebgram.raw.base.InputFile>`, *optional*):
            N/A

        video (:obj:`InputFile <zeebgram.raw.base.InputFile>`, *optional*):
            N/A

        video_start_ts (``float`` ``64-bit``, *optional*):
            N/A

        video_emoji_markup (:obj:`VideoSize <zeebgram.raw.base.VideoSize>`, *optional*):
            N/A

    Returns:
        :obj:`photos.Photo <zeebgram.raw.base.photos.Photo>`
    """
