...
class ValidateRequestedInfo(TLObject):  # type: ignore
    ...
    Parameters:
        invoice (:obj:`InputInvoice <zeebgram.raw.base.InputInvoice>`):
            N/A

        info (:obj:`PaymentRequestedInfo <zeebgram.raw.base.PaymentRequestedInfo>`):
            N/A
    ...
    Returns:
        :obj:`payments.ValidatedRequestedInfo <zeebgram.raw.base.payments.ValidatedRequestedInfo>`
    """
