...
from zeebgram.connection import Connection
from zeebgram.crypto import aes, rsa, prime
from zeebgram.errors import SecurityCheckMismatch
from zeebgram.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "zeebgram.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
