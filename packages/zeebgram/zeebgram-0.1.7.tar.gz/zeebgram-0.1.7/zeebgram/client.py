...
import zeebgram
from zeebgram import __version__, __license__
from zeebgram import enums
from zeebgram import raw
from zeebgram import utils
from zeebgram.crypto import aes
from zeebgram.errors import CDNFileHashMismatch
from zeebgram.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    BadRequest, AuthBytesInvalid
)
from zeebgram.handlers.handler import Handler
from zeebgram.methods import Methods
from zeebgram.session import Auth, Session
from zeebgram.storage import FileStorage, MemoryStorage
from zeebgram.types import User, TermsOfService
from zeebgram.utils import ainput
...
class Client(Methods):
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~zeebgram.Client.export_session_string` before stopping the client to get a session string you can
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~zeebgram.enums.ParseMode`):
        ...
        if session_empty:
            if not self.api_id or not self.api_hash:
                raise AttributeError("The API key is required for new authorizations. "
                                     "More info: https://docs.zeebgram.org/start/auth")
    ...
    async def get_file(
        ...
        async with self.get_file_semaphore:
            ...
            except zeebgram.StopTransmission:
                raise
            except Exception as e:
                log.exception(e)
