...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~zeebgram.types.InputMediaPhoto`, :obj:`~zeebgram.types.InputMediaVideo`, :obj:`~zeebgram.types.InputMediaAudio` and :obj:`~zeebgram.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~zeebgram.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from zeebgram.types import InputMediaPhoto, InputMediaVideo
