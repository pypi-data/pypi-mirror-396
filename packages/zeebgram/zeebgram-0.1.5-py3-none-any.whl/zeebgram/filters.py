...
from zeebgram.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "zeebgram.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~zeebgram.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from.
            For example, in a :obj:`~zeebgram.handlers.MessageHandler` the *update* argument will be a :obj:`~zeebgram.types.Message`; in a :obj:`~zeebgram.handlers.CallbackQueryHandler` the *update* will be a :obj:`~zeebgram.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~zeebgram.filters.command` or :meth:`~zeebgram.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~zeebgram.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~zeebgram.types.Document` objects."""
...
"""Filter messages that contain :obj:`~zeebgram.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~zeebgram.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~zeebgram.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~zeebgram.types.Game` objects."""
...
"""Filter messages that contain :obj:`~zeebgram.types.Giveaway` objects."""
...
"""Filter messages that contain :obj:`~zeebgram.types.Video` objects."""
...
"""Filter messages that contain :obj:`~zeebgram.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~zeebgram.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~zeebgram.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~zeebgram.types.Location` objects."""
...
"""Filter messages that contain :obj:`~zeebgram.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~zeebgram.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~zeebgram.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~zeebgram.types.Message`.
    ...
    async def func(flt, client: zeebgram.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~zeebgram.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~zeebgram.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~zeebgram.types.InlineQuery`: The filter will match ``query``.
