...
class Folder(Object):
    ...
    Parameters:
        ...
        pinned_peers (List of :obj:`~zeebgram.types.Chat`):
            A list of pinned chats in folder.

        included_peers (List of :obj:`~zeebgram.types.Chat`):
            A list of included chats in folder.

        excluded_peers (List of :obj:`~zeebgram.types.Chat`, *optional*):
    ...
    async def delete(self):
        """Bound method *delete* of :obj:`~zeebgram.types.Folder`.
    ...
    async def update_peers(self, pinned_peers: List[Union[int, str]], included_peers: List[Union[int, str]], excluded_peers: List[Union[int, str]]):
        """Bound method *update_peers* of :obj:`~zeebgram.types.Folder`.
    ...
    async def pin_chat(self, chat_id: Union[int, str]):
        """Bound method *pin_chat* of :obj:`~zeebgram.types.Folder`.
    ...
    async def include_chat(self, chat_id: Union[int, str]):
        """Bound method *include_chat* of :obj:`~zeebgram.types.Folder`.
    ...
    async def exclude_chat(self, chat_id: Union[int, str]):
        """Bound method *exclude_chat* of :obj:`~zeebgram.types.Folder`.
    ...
    async def export_link(self):
        """Bound method *export_link* of :obj:`~zeebgram.types.Folder`.
