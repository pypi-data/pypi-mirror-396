...
import zeebgram
from zeebgram import raw, enums, utils
...
class Poll(Object, Update):
    ...
    Parameters:
        ...
        options (List of :obj:`~zeebgram.types.PollOption`):
        ...
        explanation_entities (List of :obj:`~zeebgram.types.MessageEntity`, *optional*):
