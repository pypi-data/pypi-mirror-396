...
import zeebgram
from zeebgram.methods.utilities.idle import idle
...
class Run:
    def run(
        ...
        :meth:`~zeebgram.Client.start`, :meth:`~zeebgram.idle` and :meth:`~zeebgram.Client.stop` in sequence.
        ...
        If you want to run multiple clients at once, see :meth:`zeebgram.compose`.
