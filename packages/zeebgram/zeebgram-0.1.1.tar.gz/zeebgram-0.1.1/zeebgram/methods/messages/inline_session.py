...
from zeebgram.errors import AuthBytesInvalid
from zeebgram.session import Session
from zeebgram.session.auth import Auth


async def get_session(client: "zeebgram.Client", dc_id: int):
