...
class Object:
    def __init__(self, client: "zeebgram.Client" = None):
        self._client = client

    def bind(self, client: "zeebgram.Client"):
        """Bind a Client instance to this and to all nested Pyrogram objects.

        Parameters:
            client (:obj:`~zeebgram.types.Client`):
    ...
    def default(obj: "Object"):
        ...
        # https://t.me/zeebgramchat/167281
