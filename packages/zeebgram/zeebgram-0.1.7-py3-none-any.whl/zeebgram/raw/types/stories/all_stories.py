...
class AllStories(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~zeebgram.raw.base.stories.AllStories`.
    ...
    Parameters:
        ...
        peer_stories (List of :obj:`PeerStories <zeebgram.raw.base.PeerStories>`):
            N/A
        ...
        stealth_mode (:obj:`StoriesStealthMode <zeebgram.raw.base.StoriesStealthMode>`):
            N/A
