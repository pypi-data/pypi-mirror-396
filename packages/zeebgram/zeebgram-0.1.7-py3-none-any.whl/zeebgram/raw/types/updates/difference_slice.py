...
class DifferenceSlice(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~zeebgram.raw.base.updates.Difference`.
    ...
    Parameters:
        new_messages (List of :obj:`Message <zeebgram.raw.base.Message>`):
            N/A

        new_encrypted_messages (List of :obj:`EncryptedMessage <zeebgram.raw.base.EncryptedMessage>`):
            N/A

        other_updates (List of :obj:`Update <zeebgram.raw.base.Update>`):
            N/A
        ...
        intermediate_state (:obj:`updates.State <zeebgram.raw.base.updates.State>`):
            N/A
