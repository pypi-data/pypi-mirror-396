...
class Config(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~zeebgram.raw.base.Config`.
    ...
    Parameters:
        ...
        dc_options (List of :obj:`DcOption <zeebgram.raw.base.DcOption>`):
            N/A
        ...
        reactions_default (:obj:`Reaction <zeebgram.raw.base.Reaction>`, *optional*):
            N/A
