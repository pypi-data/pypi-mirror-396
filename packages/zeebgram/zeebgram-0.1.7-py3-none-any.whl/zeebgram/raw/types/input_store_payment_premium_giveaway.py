...
class InputStorePaymentPremiumGiveaway(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~zeebgram.raw.base.InputStorePaymentPurpose`.
    ...
    Parameters:
        boost_peer (:obj:`InputPeer <zeebgram.raw.base.InputPeer>`):
            N/A
        ...
        additional_peers (List of :obj:`InputPeer <zeebgram.raw.base.InputPeer>`, *optional*):
            N/A
