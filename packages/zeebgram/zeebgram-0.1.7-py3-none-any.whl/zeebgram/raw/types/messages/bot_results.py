...
class BotResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~zeebgram.raw.base.messages.BotResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`BotInlineResult <zeebgram.raw.base.BotInlineResult>`):
            N/A
        ...
        switch_pm (:obj:`InlineBotSwitchPM <zeebgram.raw.base.InlineBotSwitchPM>`, *optional*):
            N/A

        switch_webview (:obj:`InlineBotWebView <zeebgram.raw.base.InlineBotWebView>`, *optional*):
            N/A
