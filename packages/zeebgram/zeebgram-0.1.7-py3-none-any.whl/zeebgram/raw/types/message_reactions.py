...
class MessageReactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~zeebgram.raw.base.MessageReactions`.
    ...
    Parameters:
        results (List of :obj:`ReactionCount <zeebgram.raw.base.ReactionCount>`):
            N/A
        ...
        recent_reactions (List of :obj:`MessagePeerReaction <zeebgram.raw.base.MessagePeerReaction>`, *optional*):
            N/A
