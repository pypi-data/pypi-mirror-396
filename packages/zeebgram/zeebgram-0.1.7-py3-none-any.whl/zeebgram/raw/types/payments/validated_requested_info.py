...
class ValidatedRequestedInfo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~zeebgram.raw.base.payments.ValidatedRequestedInfo`.
    ...
    Parameters:
        ...
        shipping_options (List of :obj:`ShippingOption <zeebgram.raw.base.ShippingOption>`, *optional*):
            N/A
