...
class BoostsStatus(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~zeebgram.raw.base.premium.BoostsStatus`.
    ...
    Parameters:
        ...
        premium_audience (:obj:`StatsPercentValue <zeebgram.raw.base.StatsPercentValue>`, *optional*):
            N/A

        prepaid_giveaways (List of :obj:`PrepaidGiveaway <zeebgram.raw.base.PrepaidGiveaway>`, *optional*):
            N/A
