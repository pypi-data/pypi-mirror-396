...
class TranslateText(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        peer (:obj:`InputPeer <zeebgram.raw.base.InputPeer>`, *optional*):
            N/A

        id (List of ``int`` ``32-bit``, *optional*):
            N/A

        text (List of :obj:`TextWithEntities <zeebgram.raw.base.TextWithEntities>`, *optional*):
            N/A

    Returns:
        :obj:`messages.TranslatedText <zeebgram.raw.base.messages.TranslatedText>`
    """
