...
import zeebgram
from zeebgram import StopTransmission, enums
from zeebgram import raw
from zeebgram import types
from zeebgram import utils
from zeebgram.errors import FilePartMissing
from zeebgram.file_id import FileType
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~zeebgram.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~zeebgram.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~zeebgram.Client.stop_transmission`, None is returned.
