...
class SentCode(Object):
    ...
    Parameters:
        type (:obj:`~zeebgram.enums.SentCodeType`):
            Type of the current sent code.

        phone_code_hash (``str``):
            Confirmation code identifier useful for the next authorization steps (either
            :meth:`~zeebgram.Client.sign_in` or :meth:`~zeebgram.Client.sign_up`).

        next_type (:obj:`~zeebgram.enums.NextCodeType`, *optional*):
            Type of the next code to be sent with :meth:`~zeebgram.Client.resend_code`.

        timeout (``int``, *optional*):
            Delay in seconds before calling :meth:`~zeebgram.Client.resend_code`.
    """
