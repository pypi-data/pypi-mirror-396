...
class SubmitInjectionItem(BaseModel):
    ...
    batch_index: StrictInt | None = Field(default=None, description="Index of the batch this injection belongs to")
    task_id: StrictStr | None = None
    trace_id: StrictStr | None = None
    additional_properties: dict[str, Any] = {}
    __properties: ClassVar[list[str]] = ["batch_index", "task_id", "trace_id"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {"batch_index": obj.get("batch_index"), "task_id": obj.get("task_id"), "trace_id": obj.get("trace_id")}
        )
