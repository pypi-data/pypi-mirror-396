...
class AcadHatch(AcadEntity):
    ...
    def AppendInnerLoop(self, Loop: In[vObjectArray[AcadArc | AcadCircle | AcadEllipse | AcadLine | AcadPolyline | AcadRegion | AcadSpline]]) -> None: ...
    def AppendOuterLoop(self, Loop: In[vObjectArray[AcadArc | AcadCircle | AcadEllipse | AcadLine | AcadPolyline | AcadRegion | AcadSpline]]) -> None: ...
