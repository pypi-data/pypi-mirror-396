...
class AcadViewport(AcadObject):
    ...
    def SetGridSpacing(self, XSpacing: In[float], YSpacing: In[float]) -> None: 
        self._obj.SetGridSpacing(XSpacing, YSpacing)

    def SetSnapSpacing(self, XSpacing: In[float], YSpacing: In[float]) -> None: 
        self._obj.SetSnapSpacing(XSpacing, YSpacing)

    def SetView(self, View: In[AcadView]) -> None: 
        self._obj.SetView(View())

    def Split(self, NumWins: In[AcViewportSplitType]) -> None: 
