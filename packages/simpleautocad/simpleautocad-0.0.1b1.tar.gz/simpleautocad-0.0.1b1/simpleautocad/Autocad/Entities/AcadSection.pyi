...
class AcadSection(AcadEntity):
    ...
    def AddVertex(self, Index: In[int], Point: In[PyGePoint3d]) -> None: ...
    def Copy(self) -> AcadSection: ...
    def CreateJog(self, varPt: In[PyGePoint3d]) -> None: ...
    def GenerateSectionGeometry(self, pEntity: In[AcadEntity]) -> tuple[vObjectArray]: ...
    def HitTest(self, varPtHit: In[PyGePoint3d]) -> tuple[bool, int, Variant, AcSectionSubItem]: ...
    def RemoveVertex(self, nIndex: In[int]) -> None: ...
