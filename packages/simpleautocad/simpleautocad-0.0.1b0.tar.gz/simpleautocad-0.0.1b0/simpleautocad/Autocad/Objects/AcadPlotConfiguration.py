...
class AcadPlotConfiguration(AcadObject):
    ...
    def CopyFrom(self, SourceObject: In[AcadPlotConfiguration]) -> None:
    ...
    def GetLocaleMediaName(self, Name: In[str]) -> str: 
    ...
    def SetCustomScale(self, Numerator: In[float], Denominator: In[float]) -> None:
        self._obj.SetCustomScale(Numerator, Denominator)
        
    def SetWindowToPlot(self, LowerLeft: In[PyGePoint2d], UpperRight: In[PyGePoint2d]) -> None:
