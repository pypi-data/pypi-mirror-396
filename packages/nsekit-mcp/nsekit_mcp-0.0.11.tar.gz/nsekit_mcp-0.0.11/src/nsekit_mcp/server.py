...
@mcp.tool()
def nifty_price_chart(timeframe: str = "1D"):
    """
    TOOL: nifty_price_chart
...
@mcp.tool()
def stock_price_chart(symbol: str, timeframe: str = "1D"):
    """
    TOOL: stock_price_chart
