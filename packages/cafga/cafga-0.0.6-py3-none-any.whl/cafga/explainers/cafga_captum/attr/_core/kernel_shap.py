...
import torch
from cafga.explainers.cafga_captum._utils.models.linear_model import SkLearnLinearRegression
from cafga.explainers.cafga_captum._utils.typing import BaselineType, TargetType, TensorOrTupleOfTensorsGeneric
from cafga.explainers.cafga_captum.attr._core.lime import construct_feature_mask, Lime
from cafga.explainers.cafga_captum.attr._utils.common import _format_input_baseline
...
class KernelShap(Lime):
    ...
    def attribute(  # type: ignore
        ...
        probs[0] = 0.0
        n_samples = n_samples + n_test_samples
    ...
    def explain(self, *args, **kwargs):
        r"""
        This method is an alias to the attribute method.
        """
