...
class SGDLinearModel(LinearModel):
    ...
    def __init__(self, **kwargs) -> None:
        ...
        """
        # avoid cycles
        from cafga.explainers.cafga_captum._utils.models.linear_model.train import sgd_train_linear_model
...
class SGDLasso(SGDLinearModel):
    ...
    def fit(self, train_data: DataLoader, **kwargs):
        # avoid cycles
        from cafga.explainers.cafga_captum._utils.models.linear_model.train import l2_loss
...
class SkLearnLinearModel(LinearModel):
    ...
    def __init__(self, sklearn_module: str, **kwargs) -> None:
        ...
        """
        # avoid cycles
        from cafga.explainers.cafga_captum._utils.models.linear_model.train import sklearn_train_linear_model
