...
class YtextractError(Exception):
    """Base ytextract exception that all others inherit.
...
class MaxRetriesExceeded(YtextractError):
    """Maximum number of retries exceeded."""


class HTMLParseError(YtextractError):
    """HTML could not be parsed"""


class ExtractError(YtextractError):
...
class VideoUnavailable(YtextractError):
