...
class StatsPublisher:
    ...
    async def _handle_channel_all_stats(self, request: dict) -> dict[str, Any]:
        ...
        top_users_limit = request.get("top_users_limit", 10)
        media_history_limit = request.get("media_history_limit", 50)
        leaderboard_limit = request.get("leaderboard_limit", 10)
