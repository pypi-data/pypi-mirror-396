...
class ReleaseManager:
    ...
    def build_swagger_web_api_doc(
        ...
        try:
            ...
            print(f"composer require {parent_module_name}:{parent_module_version} ${suggested}")
            os.system(f"composer require {parent_module_name}:{parent_module_version} ${suggested}")
