# Generated by Django 5.1.6 on 2025-09-05 20:26
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        (
            "enap_designsystem",
            "0390_alter_areaaluno_body_alter_cursoeadpage_curso_and_more",
        ),
    ]
        ...
        migrations.AlterField(
            ...
            field=wagtail.fields.StreamField(
                ...
                block_lookup={
                    ...
                    94: (
                        ...
                        [
                            [
                                ("value", 89),
                                ("action_type", 90),
                                ("target_section_name", 91),
                                ("finish_message", 92),
                                ("custom_thank_you_title", 93),
                            ]
                        ],
                    ...
                    99: (
                        "wagtail.blocks.StructBlock",
                        [[("label", 97), ("help_text", 98), ("required", 12)]],
                        {},
                    ),
                    100: (
                        "wagtail.blocks.CharBlock",
                    ...
                    108: (
                        ...
                        [
                            [
                                ("estado_label", 100),
                                ("estado_help_text", 101),
                                ("estado_required", 102),
                                ("cidade_label", 103),
                                ("cidade_help_text", 104),
                                ("cidade_required", 105),
                                ("layout", 106),
                                ("show_state_code", 107),
                            ]
                    ...
                    116: (
                        "wagtail.blocks.StructBlock",
                        [[("value", 76), ("action", 77), ("fields_to_show", 115)]],
                        {"label": "Opção com Ação"},
                    ),
                    117: (
                        "wagtail.blocks.StreamBlock",
                    ...
                    119: (
                        ...
                        [
                            [
                                ...
                                ("checkbox_multi_redirect_field", 73),
                                ("conditional_field", 81),
                                ("conditional_field_Condicional", 118),
                                ("section_divider", 86),
                                ("smart_navigation_field", 96),
                                ("cnpj_field", 99),
                                ("estado_cidade_field", 108),
