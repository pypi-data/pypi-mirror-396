...
class CloudRunner:
    ...
    def _collect_all_dependencies(self, func: Callable) -> Tuple[Set[str], List[str]]:
        """
        Recursively collect all dependencies (imports and helper functions/classes).

        Returns:
            tuple: (set of import statements, list of dependency sources)
        """
        all_imports = set()
        all_dependencies = []
        ...
        return all_imports, all_dependencies
    ...
    def _build_execution_code(
        ...
        """
        # Collect all imports and dependencies recursively
        imports, dependency_sources = self._collect_all_dependencies(func)
