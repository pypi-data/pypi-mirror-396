...
def cli():
    ...
    # Initialize or reload config BEFORE importing core.app
    # This ensures .bloggy file is loaded before the app is created
    config = reload_config() if args.directory else get_config()
    
    # Now import app after config is set up
