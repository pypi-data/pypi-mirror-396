...
class Opt_func_dispatcher:
    ...
    def load_tblite_calc(self, method, solvent):
        ...
        try:
            ...
            raise Exception(('Cannot import tblite python bindings for FIRECODE. Install them with:\n'
                            '>>> pip install tblite'))
    ...
    def load_xtb_calc(self, method, solvent):
        try:
            ...
            raise Exception(('Cannot import xtb python bindings for FIRECODE. Install them with:\n'
