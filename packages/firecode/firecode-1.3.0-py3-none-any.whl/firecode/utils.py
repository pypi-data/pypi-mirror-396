...
from firecode.algebra import (dihedral, get_alignment_matrix, norm, norm_of,
...
def scramble_check(embedded_structure, embedded_atomnos, excluded_atoms, mols_graphs, max_newbonds=0, logfunction=None, title=None) -> bool:
    '''
    ...
    new_bonds = {tuple(sorted((a, b))) for a, b in list(graphize(embedded_structure, embedded_atomnos).edges) if a != b}
