...
def xtb_get_free_energy(coords, atomnos, method='GFN2-xTB', solvent=None,
                        charge=0, title='temp', sph=False, grep='G', debug=False, **kwargs):
    '''
...
def xtb_gsolv(coords, atomnos, model='alpb', charge=0, mult=1, solvent='ch2cl2', title='temp', assert_convergence=True):
    '''
