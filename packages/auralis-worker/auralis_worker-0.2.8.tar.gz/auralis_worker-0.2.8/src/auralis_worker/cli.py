...
\__|  \__| \______/ \__|      \_______|\__|\__|\_______/        \______/ \__| \______/  \______/  \_______|      
                         ...
                         Distributed AI Compute Platform — Worker Node v0.2.8
"""

DEFAULT_API_URL = "https://www.auraliscloud.xyz"
...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Your worker authentication token (from auraliscloud.xyz/dashboard/provide)"
    )
    ...
    parser.add_argument(
        ...
        help="API URL (default: https://www.auraliscloud.xyz)"
    )
...
async def run_worker(args):
    ...
    if not await worker.verify_token():
        logger.error("Invalid token. Get one at https://auraliscloud.xyz/dashboard/provide")
        return 1
