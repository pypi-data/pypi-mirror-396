...
class TestMatch8594217096LaneSummary:
    ...
    def test_all_heroes_have_lane_assigned(self, lane_summary_2):
        ...
        for hero in lane_summary_2.hero_stats:
            assert hero.lane in ["top", "mid", "bot", "jungle"]
...
class TestMatch8594217096CombatLog:
    ...
    def test_combat_log_narrative_count(self, combat_log_narrative_2):
        """30:00-31:40 has 333 NARRATIVE events."""
        assert len(combat_log_narrative_2) == 333

    def test_combat_log_tactical_count(self, combat_log_tactical_2):
        """30:00-31:40 has 1345 TACTICAL events."""
        assert len(combat_log_tactical_2) == 1345

    def test_combat_log_full_count(self, combat_log_full_2):
        """30:00-31:40 has 4212 FULL events."""
        assert len(combat_log_full_2) == 4212
    ...
    def test_combat_log_juggernaut_filter(self, combat_log_juggernaut_2):
        """Juggernaut filtered combat log has 500 events."""
        assert len(combat_log_juggernaut_2) == 500
...
class TestMatch8594217096FarmingPatterns:
    ...
    def test_juggernaut_neutral_creeps(self, juggernaut_farming_2):
        """Juggernaut killed 25 neutral creeps in 0-15 minutes."""
        assert juggernaut_farming_2.summary.total_neutral_creeps == 25

    def test_juggernaut_total_creeps(self, juggernaut_farming_2):
        """Juggernaut killed 126 total creeps in 0-15 minutes."""
        assert len(juggernaut_farming_2.creep_kills) == 126

    def test_juggernaut_jungle_percentage(self, juggernaut_farming_2):
        """Juggernaut's jungle percentage is ~23%."""
        assert 20 <= juggernaut_farming_2.summary.jungle_percentage <= 26
    ...
    def test_void_spirit_neutral_creeps(self, void_spirit_farming_2):
        """Void Spirit killed 8 neutral creeps in 0-15 minutes."""
        assert void_spirit_farming_2.summary.total_neutral_creeps == 8

    def test_void_spirit_total_creeps(self, void_spirit_farming_2):
        """Void Spirit killed 98 total creeps in 0-15 minutes."""
        assert len(void_spirit_farming_2.creep_kills) == 98

    def test_void_spirit_jungle_percentage(self, void_spirit_farming_2):
        """Void Spirit's jungle percentage is ~8%."""
        assert 5 <= void_spirit_farming_2.summary.jungle_percentage <= 12
