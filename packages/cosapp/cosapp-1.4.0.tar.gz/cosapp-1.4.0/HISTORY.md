...
- Add the possibility to declare unknowns and equations in implicit time drivers (MR [#447](https://gitlab.com/cosapp/cosapp/-/merge_requests/447)).
- Simplify `System.add_inward` and `add_outward` (MR [#448](https://gitlab.com/cosapp/cosapp/-/merge_requests/448)).

### Bug fixes & Code improvements

- Fix `WeakSet` pickling for Python 3.14 (MR [#451](https://gitlab.com/cosapp/cosapp/-/merge_requests/451)).
- Fix minor bugs in tests on dynamic systems (MR [#450](https://gitlab.com/cosapp/cosapp/-/merge_requests/450)).
- Fix bugs with implicit time drivers (MR [#449](https://gitlab.com/cosapp/cosapp/-/merge_requests/449)).
- Fix bug with nested solvers (MR [#443](https://gitlab.com/cosapp/cosapp/-/merge_requests/443)).

### Documentation & Maintenance

- New `Docker` container serving `JupyterLite` image (MR [#444](https://gitlab.com/cosapp/cosapp/-/merge_requests/444)).
- Update CI script (MR [#442](https://gitlab.com/cosapp/cosapp/-/merge_requests/442)).
