...
def decode(data: Any):
    """Decode a data structure optionally containing objects handled
    by DataTypeDecoder.
...
def read_complex(real: float | None = None, imag: float | None = None) -> complex:
    """
...
def write_complex(value: complex | np.number) -> dict[str, Any]:
    """
...
def read_numpy_array(
    shape: list[int],
    sparse_entries: list[dict[str, Any]] | None = None,
    dense_entries: dict[str, list[float | int]] | None = None,
) -> np.ndarray:
    """
    ...
    dense_entries : dict[str, list[float or int]], optional
